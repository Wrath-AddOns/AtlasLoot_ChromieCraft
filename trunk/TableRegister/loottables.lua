...
AtlasLoot_LootTableRegister = {
	...
	-----------------------------------
		...
		["Pandaria"] = {
			["Bosses"] = {
				{ "AUGUSTCELESTIALSWORLDBOSSES", 1, EncounterJournalID = 857 },
		...
		["SiegeofOrgrimmar"] = {
			["Bosses"] = {
				{ "SoOImmerseus", 2, EncounterJournalID = 852 },
				{ "SoOFallenProtectors", 3, EncounterJournalID = 849 },
				{ "SoONorushen", 7, EncounterJournalID = 866 },
				{ "SoOShaofPride", 9, EncounterJournalID = 867 },
				{ "SoOGalakras", 10, EncounterJournalID = 868 },
				{ "SoOIronJuggernaut", 11, EncounterJournalID = 864 },
				{ "SoODarkShaman", 12, EncounterJournalID = 856 },
				{ "SoONazgrim", 15, EncounterJournalID = 850 },
				{ "SoOMalkorok", 16, EncounterJournalID = 846 },
				{ "SoOSpoils", 17, EncounterJournalID = 870 },
				{ "SoOThok", 18, EncounterJournalID = 851 },
				{ "SoOBlackfuse", 20, EncounterJournalID = 865 },
				{ "SoOParagons", 21, EncounterJournalID = 853 },
				{ "SoOGarrosh", 31, EncounterJournalID = 869 },
				{ "SoOShared", 33 },
				{ "SoOTrash", 34 },
			},
