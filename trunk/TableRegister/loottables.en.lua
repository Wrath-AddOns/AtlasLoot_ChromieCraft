...
-----------------------
	...
	AtlasLoot_TableNames["ANKrikthir"] = { BabbleBoss["Krik'thir the Gatewatcher"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["ANHadronox"] = { BabbleBoss["Hadronox"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["ANAnubarak"] = { BabbleBoss["Anub'arak"], "AtlasLootWotLK" };
    --Ahn'kahet: The Old Kingdom
	AtlasLoot_TableNames["Ahnkahet"] = { BabbleZone["Ahn'kahet: The Old Kingdom"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["AKTaldaram"] = { BabbleBoss["Prince Taldaram"], "AtlasLootWotLK" };
...
--------------------
  ...
  --Auch: Sethekk Halls
	...
	AtlasLoot_TableNames["AuchSethekkTheSagaofTerokk"] = { "The Saga of Terokk", "AtlasLootBurningCrusade" };
  ...
  --Auch: Shadow Labyrinth
	...
	AtlasLoot_TableNames["AuchShadowFirstFragmentGuardian"] = { "First Fragment Guardian", "AtlasLootBurningCrusade" };
  ...
  --CFR: The Steamvault
	...
	AtlasLoot_TableNames["CFRSteamSecondFragmentGuardian"] = { "Second Fragment Guardian", "AtlasLootBurningCrusade" };
  ...
  --HC: Shattered Halls
	...
	AtlasLoot_TableNames["HCHallsExecutioner"] = { "Shattered Hand Executioner", "AtlasLootBurningCrusade" };
  ...
  --TK: The Arcatraz
	...
	AtlasLoot_TableNames["TKArcThirdFragmentGuardian"] = { "Third Fragment Guardian", "AtlasLootBurningCrusade" };
  ...
  --TK: The Mechanar
	...
	AtlasLoot_TableNames["TKMechOverchargedManacell"] = { "Overcharged Manacell", "AtlasLootBurningCrusade" };
...
------------------------
	...
	AtlasLoot_TableNames["Aquatic"] = { AL["Pets"].." - "..AL["Aquatic"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Birds"] = { AL["Pets"].." - "..AL["Birds"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Invertebrates"] = { AL["Pets"].." - "..AL["Invertebrates"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Mammals1"] = { AL["Pets"].." - "..AL["Mammals"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Mechanical"] = { AL["Pets"].." - "..AL["Mechanical"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Mythical1"] = { AL["Pets"].." - "..AL["Mythical"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Reptiles"] = { AL["Pets"].." - "..AL["Reptiles"], "AtlasLootWotLK" };
...
--------------
  ...
  --BlackSmithing
	...
	AtlasLoot_TableNames["SmithingMaster1"] = { BLACKSMITHING..": "..MASTER.." - Classic", "AtlasLootCrafting" };
	AtlasLoot_TableNames["SmithingMaster2"] = { BLACKSMITHING..": "..MASTER.." - Classic", "AtlasLootCrafting" };
	AtlasLoot_TableNames["SmithingMaster3"] = { BLACKSMITHING..": "..MASTER.." - Classic", "AtlasLootCrafting" };
	AtlasLoot_TableNames["SmithingMaster4"] = { BLACKSMITHING..": "..MASTER.." - The Burning Crusade", "AtlasLootCrafting" };
	AtlasLoot_TableNames["SmithingMaster5"] = { BLACKSMITHING..": "..MASTER.." - The Burning Crusade", "AtlasLootCrafting" };
	AtlasLoot_TableNames["SmithingMaster6"] = { BLACKSMITHING..": "..MASTER.." - The Burning Crusade", "AtlasLootCrafting" };
...
-----------
  ...
  --World PvP
	...
	AtlasLoot_TableNames["LakeWintergrasp1"] = { "Lake Wintergrasp", "AtlasLootWotLK" };
	AtlasLoot_TableNames["LakeWintergrasp2"] = { "Lake Wintergrasp", "AtlasLootWotLK" };
  --Misc Other PvP
	...
	AtlasLoot_TableNames["PvP80Weapons1"] = { AL["PvP Weapons (Level 80)"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["PvP80Weapons2"] = { AL["PvP Weapons (Level 80)"], "AtlasLootWotLK" };
...
-------------
  ...
  --Menus, the entry does nothing, but makes the generalised loot table code less complex
	...
	AtlasLoot_TableNames["HONORMENU"] = { AL["PvP Honor System"], "Menu" };
	AtlasLoot_TableNames["ARENAMENU"] = { AL["Arena PvP System"], "Menu" };
