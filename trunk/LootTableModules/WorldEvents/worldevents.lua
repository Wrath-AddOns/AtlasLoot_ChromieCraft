	...
	AtlasLoot_Data["Darkmoon"] = {
		["Normal"] = {
			...
			};
			{
				...
				{ 9, 93860, "", "=q7=Bloodstained Dreadmist Robe", "=ds=#s5#, #a1#", "#DARKMOON:44# #ITEMID:48691#"};
				{ 10, 93865, "", "=q7=Majestic Ironfeather Breastplate", "=ds=#s5#, #a2#", "#DARKMOON:44# #ITEMID:48687#"};
				{ 11, 93863, "", "=q7=Supple Shadowcraft Tunic", "=ds=#s5#, #a2#", "#DARKMOON:44# #ITEMID:48689#"};
				{ 12, 93888, "", "=q7=Furious Deathdealer Breastplate", "=ds=#s5#, #a3#", "#DARKMOON:44# #ITEMID:48677#"};
				{ 13, 93885, "", "=q7=Awakened Vest of Elements", "=ds=#s5#, #a3#", "#DARKMOON:44# #ITEMID:48683#"};
				{ 14, 93892, "", "=q7=Brushed Breastplate of Might", "=ds=#s5#, #a4#", "#DARKMOON:44# #ITEMID:69889#"};
				{ 15, 93891, "", "=q7=Gleaming Breastplate of Valor", "=ds=#s5#, #a4#", "#DARKMOON:44# #ITEMID:48685#"};
			...
			{
				{ 1, 93897, "", "=q7=Piercing Eye of the Beast", "=ds=#s14#", "#DARKMOON:60# #ITEMID:42992#"};
				{ 2, 93896, "", "=q7=Forceful Hand of Justice", "=ds=#s14#", "#DARKMOON:60# #ITEMID:42991#"};
				{ 4, 93857, "", "=q7=Vengeful Heartseeker", "=ds=#h1#, #w4#", "#DARKMOON:44# #ITEMID:42944#"};
				{ 5, 93845, "", "=q7=Gore-Steeped Skullforge Reaver", "=ds=#h1#, #w10#", "#DARKMOON:44# #ITEMID:69893#"};
				{ 6, 93856, "", "=q7=Noble Dal'Rend's Sacred Charge", "=ds=#h1#, #w10#", "#DARKMOON:44# #ITEMID:42945#"};
				{ 7, 93843, "", "=q7=Hardened Arcanite Reaper", "=ds=#h2#, #w1#", "#DARKMOON:64# #ITEMID:42943#"};
				{ 8, 93853, "", "=q7=Pious Aurastone Hammer", "=ds=#h1#, #w6#", "#DARKMOON:44# #ITEMID:42948#"};
				{ 9, 93847, "", "=q7=Crushing Mass of McGowan", "=ds=#h1#, #w6#", "#DARKMOON:44# #ITEMID:48716#"};
				{ 10, 93846, "", "=q7=Re-Engineered Lava Dredger", "=ds=#h2#, #w6#", "#DARKMOON:64# #ITEMID:48718#"};
				{ 11, 93844, "", "=q7=Refinished Warden Staff", "=ds=#w9#", "#DARKMOON:64# #ITEMID:79131#"};
				{ 12, 93854, "", "=q7=Scholarly Headmaster's Charge", "=ds=#w9#", "#DARKMOON:64# #ITEMID:42947#"};
				{ 13, 93855, "", "=q7=War-Torn Ancient Bone Bow", "=ds=#w2#", "#DARKMOON:64# #ITEMID:42946#"};
