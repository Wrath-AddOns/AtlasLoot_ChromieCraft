		...
		["Normal"] = {
			{
				...
				{ 5, 83791, "", "=q1=Plans: Breastplate of Ancient Steel", "=ds=#p2# (600)", "20 #kyparite#"};
				{ 6, 83792, "", "=q1=Plans: Gauntlets of Ancient Steel", "=ds=#p2# (600)", "20 #kyparite#"};
				{ 7, 83787, "", "=q1=Plans: Ghost Reaver's Breastplate", "=ds=#p2# (600)", "20 #kyparite#"};
				{ 8, 83788, "", "=q1=Plans: Ghost Reaver's Gauntlets", "=ds=#p2# (600)", "20 #kyparite#"};
				{ 9, 84196, "", "=q1=Plans: Living Steel Belt Buckle", "=ds=#p2# (600)", "20 #kyparite#"};
				{ 10, 83789, "", "=q1=Plans: Living Steel Breastplate", "=ds=#p2# (600)", "20 #kyparite#"};
				{ 11, 83790, "", "=q1=Plans: Living Steel Gauntlets", "=ds=#p2# (600)", "20 #kyparite#"};
				{ 12, 84197, "", "=q1=Plans: Masterwork Forgewire Axe", "=ds=#p2# (600)", "20 #kyparite#"};
				{ 13, 84198, "", "=q1=Plans: Masterwork Ghost Shard", "=ds=#p2# (600)", "20 #kyparite#"};
				{ 14, 84200, "", "=q1=Plans: Masterwork Ghost-Forged Blade", "=ds=#p2# (600)", "20 #kyparite#"};
				{ 15, 84217, "", "=q1=Plans: Masterwork Phantasmal Hammer", "=ds=#p2# (600)", "20 #kyparite#"};
				{ 16, 84218, "", "=q1=Plans: Masterwork Spiritblade Decimator", "=ds=#p2# (600)", "20 #kyparite#"};
