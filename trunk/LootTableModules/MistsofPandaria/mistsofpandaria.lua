		...
		["Normal"] = {
			{
				...
				{ 2, 99057, "", "=q4=Helmet of Cyclopean Dread", "=ds=#s1#, #a4#"};
				{ 3, 99059, "", "=q4=Pauldrons of Cyclopean Dread", "=ds=#s3#, #a4#"};
				{ 4, 99066, "", "=q4=Breastplate of Cyclopean Dread", "=ds=#s5#, #a4#"};
				{ 5, 99067, "", "=q4=Gauntlets of Cyclopean Dread", "=ds=#s9#, #a4#"};
				{ 6, 99058, "", "=q4=Greaves of Cyclopean Dread", "=ds=#s11#, #a4#"};
				{ 8, 0, "spell_deathknight_frostpresence", "=q6=#t16s10_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99571, "", "=q4=Helmet of Cyclopean Dread", "=ds=#s1#, #a4#"};
				{ 10, 99639, "", "=q4=Pauldrons of Cyclopean Dread", "=ds=#s3#, #a4#"};
				{ 11, 99608, "", "=q4=Breastplate of Cyclopean Dread", "=ds=#s5#, #a4#"};
				{ 12, 99609, "", "=q4=Gauntlets of Cyclopean Dread", "=ds=#s9#, #a4#"};
				{ 13, 99572, "", "=q4=Greaves of Cyclopean Dread", "=ds=#s11#, #a4#"};
				{ 16, 0, "spell_deathknight_frostpresence", "=q6=#t16s10_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99194, "", "=q4=Helmet of Cyclopean Dread", "=ds=#s1#, #a4#"};
				{ 18, 99187, "", "=q4=Pauldrons of Cyclopean Dread", "=ds=#s3#, #a4#"};
				{ 19, 99192, "", "=q4=Breastplate of Cyclopean Dread", "=ds=#s5#, #a4#"};
				{ 20, 99193, "", "=q4=Gauntlets of Cyclopean Dread", "=ds=#s9#, #a4#"};
				{ 21, 99186, "", "=q4=Greaves of Cyclopean Dread", "=ds=#s11#, #a4#"};
				{ 23, 0, "spell_deathknight_frostpresence", "=q6=#t16s10_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99337, "", "=q4=Helmet of Cyclopean Dread", "=ds=#s1#, #a4#"};
				{ 25, 99339, "", "=q4=Pauldrons of Cyclopean Dread", "=ds=#s3#, #a4#"};
				{ 26, 99335, "", "=q4=Breastplate of Cyclopean Dread", "=ds=#s5#, #a4#"};
				{ 27, 99336, "", "=q4=Gauntlets of Cyclopean Dread", "=ds=#s9#, #a4#"};
				{ 28, 99338, "", "=q4=Greaves of Cyclopean Dread", "=ds=#s11#, #a4#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"].." - "..AL["DPS"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99049, "", "=q4=Faceguard of Cyclopean Dread", "=ds=#s1#, #a4#"};
				{ 3, 99040, "", "=q4=Shoulderguards of Cyclopean Dread", "=ds=#s3#, #a4#"};
				{ 4, 99060, "", "=q4=Chestguard of Cyclopean Dread", "=ds=#s5#, #a4#"};
				{ 5, 99048, "", "=q4=Handguards of Cyclopean Dread", "=ds=#s9#, #a4#"};
				{ 6, 99039, "", "=q4=Legguards of Cyclopean Dread", "=ds=#s11#, #a4#"};
				{ 8, 0, "spell_deathknight_bloodpresence", "=q6=#t16s10_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99605, "", "=q4=Faceguard of Cyclopean Dread", "=ds=#s1#, #a4#"};
				{ 10, 99652, "", "=q4=Shoulderguards of Cyclopean Dread", "=ds=#s3#, #a4#"};
				{ 11, 99640, "", "=q4=Chestguard of Cyclopean Dread", "=ds=#s5#, #a4#"};
				{ 12, 99604, "", "=q4=Handguards of Cyclopean Dread", "=ds=#s9#, #a4#"};
				{ 13, 99564, "", "=q4=Legguards of Cyclopean Dread", "=ds=#s11#, #a4#"};
				{ 16, 0, "spell_deathknight_bloodpresence", "=q6=#t16s10_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99190, "", "=q4=Faceguard of Cyclopean Dread", "=ds=#s1#, #a4#"};
				{ 18, 99179, "", "=q4=Shoulderguards of Cyclopean Dread", "=ds=#s3#, #a4#"};
				{ 19, 99188, "", "=q4=Chestguard of Cyclopean Dread", "=ds=#s5#, #a4#"};
				{ 20, 99189, "", "=q4=Handguards of Cyclopean Dread", "=ds=#s9#, #a4#"};
				{ 21, 99191, "", "=q4=Legguards of Cyclopean Dread", "=ds=#s11#, #a4#"};
				{ 23, 0, "spell_deathknight_bloodpresence", "=q6=#t16s10_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99323, "", "=q4=Faceguard of Cyclopean Dread", "=ds=#s1#, #a4#"};
				{ 25, 99325, "", "=q4=Shoulderguards of Cyclopean Dread", "=ds=#s3#, #a4#"};
				{ 26, 99330, "", "=q4=Chestguard of Cyclopean Dread", "=ds=#s5#, #a4#"};
				{ 27, 99331, "", "=q4=Handguards of Cyclopean Dread", "=ds=#s9#, #a4#"};
				{ 28, 99324, "", "=q4=Legguards of Cyclopean Dread", "=ds=#s11#, #a4#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"].." - "..AL["Tanking"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99013, "", "=q4=Helm of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 3, 99016, "", "=q4=Mantle of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 4, 99015, "", "=q4=Robes of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 5, 99012, "", "=q4=Handwraps of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 6, 99014, "", "=q4=Legwraps of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 8, 0, "spell_nature_healingtouch", "=q6=#t16s1_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99638, "", "=q4=Helm of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 10, 99583, "", "=q4=Mantle of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 11, 99582, "", "=q4=Robes of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 12, 99637, "", "=q4=Handwraps of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 13, 99581, "", "=q4=Legwraps of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 16, 0, "spell_nature_healingtouch", "=q6=#t16s1_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99178, "", "=q4=Helm of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 18, 99173, "", "=q4=Mantle of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 19, 99172, "", "=q4=Robes of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 20, 99185, "", "=q4=Handwraps of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 21, 99171, "", "=q4=Legwraps of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 23, 0, "spell_nature_healingtouch", "=q6=#t16s1_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99436, "", "=q4=Helm of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 25, 99431, "", "=q4=Mantle of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 26, 99430, "", "=q4=Robes of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 27, 99435, "", "=q4=Handwraps of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 28, 99429, "", "=q4=Legwraps of the Shattered Vale", "=ds=#s11#, #a2#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["DRUID"].." - "..ALIL["Restoration"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99043, "", "=q4=Headpiece of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 3, 99022, "", "=q4=Spaulders of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 4, 99041, "", "=q4=Raiment of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 5, 99042, "", "=q4=Grips of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 6, 99044, "", "=q4=Legguards of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 8, 0, "ability_druid_catform", "=q6=#t16s1_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99599, "", "=q4=Headpiece of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 10, 99589, "", "=q4=Spaulders of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 11, 99632, "", "=q4=Raiment of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 12, 99633, "", "=q4=Grips of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 13, 99600, "", "=q4=Legguards of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 16, 0, "ability_druid_catform", "=q6=#t16s1_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99182, "", "=q4=Headpiece of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 18, 99184, "", "=q4=Spaulders of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 19, 99180, "", "=q4=Raiment of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 20, 99181, "", "=q4=Grips of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 21, 99183, "", "=q4=Legguards of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 23, 0, "ability_druid_catform", "=q6=#t16s1_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99328, "", "=q4=Headpiece of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 25, 99322, "", "=q4=Spaulders of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 26, 99326, "", "=q4=Raiment of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 27, 99327, "", "=q4=Grips of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 28, 99329, "", "=q4=Legguards of the Shattered Vale", "=ds=#s11#, #a2#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["DRUID"].." - "..ALIL["Feral"],
		...
		["Normal"] = {
			{
				...
				{ 2, 98995, "", "=q4=Cover of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 3, 98998, "", "=q4=Shoulderwraps of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 4, 98997, "", "=q4=Vestment of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 5, 98994, "", "=q4=Gloves of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 6, 98996, "", "=q4=Leggings of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 8, 0, "spell_nature_starfall", "=q6=#t16s1_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99618, "", "=q4=Cover of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 10, 99621, "", "=q4=Shoulderwraps of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 11, 99620, "", "=q4=Vestment of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 12, 99617, "", "=q4=Gloves of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 13, 99619, "", "=q4=Leggings of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 16, 0, "spell_nature_starfall", "=q6=#t16s1_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99175, "", "=q4=Cover of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 18, 99169, "", "=q4=Shoulderwraps of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 19, 99177, "", "=q4=Vestment of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 20, 99174, "", "=q4=Gloves of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 21, 99176, "", "=q4=Leggings of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 23, 0, "spell_nature_starfall", "=q6=#t16s1_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99433, "", "=q4=Cover of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 25, 99428, "", "=q4=Shoulderwraps of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 26, 99427, "", "=q4=Vestment of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 27, 99432, "", "=q4=Gloves of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 28, 99434, "", "=q4=Leggings of the Shattered Vale", "=ds=#s11#, #a2#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["DRUID"].." - "..ALIL["Balance"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99001, "", "=q4=Headguard of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 3, 98978, "", "=q4=Shoulderguards of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 4, 98999, "", "=q4=Tunic of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 5, 99000, "", "=q4=Handguards of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 6, 98981, "", "=q4=Breeches of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 8, 0, "ability_racial_bearform", "=q6=#t16s1_4#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99624, "", "=q4=Headguard of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 10, 99664, "", "=q4=Shoulderguards of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 11, 99622, "", "=q4=Tunic of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 12, 99623, "", "=q4=Handguards of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 13, 99610, "", "=q4=Breeches of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 16, 0, "ability_racial_bearform", "=q6=#t16s1_4#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99163, "", "=q4=Headguard of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 18, 99166, "", "=q4=Shoulderguards of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 19, 99170, "", "=q4=Tunic of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 20, 99163, "", "=q4=Handguards of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 21, 99165, "", "=q4=Breeches of the Shattered Vale", "=ds=#s11#, #a2#"};
				{ 23, 0, "ability_racial_bearform", "=q6=#t16s1_4#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99421, "", "=q4=Headguard of the Shattered Vale", "=ds=#s1#, #a2#"};
				{ 25, 99423, "", "=q4=Shoulderguards of the Shattered Vale", "=ds=#s3#, #a2#"};
				{ 26, 99419, "", "=q4=Tunic of the Shattered Vale", "=ds=#s5#, #a2#"};
				{ 27, 99420, "", "=q4=Handguards of the Shattered Vale", "=ds=#s9#, #a2#"};
				{ 28, 99422, "", "=q4=Breeches of the Shattered Vale", "=ds=#s11#, #a2#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["DRUID"].." - "..ALIL["Guardian"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99080, "", "=q4=Headguard of the Unblinking Vigil", "=ds=#s1#, #a3#"};
				{ 3, 99082, "", "=q4=Spaulders of the Unblinking Vigil", "=ds=#s3#, #a3#"};
				{ 4, 99085, "", "=q4=Tunic of the Unblinking Vigil", "=ds=#s5#, #a3#"};
				{ 5, 99086, "", "=q4=Gloves of the Unblinking Vigil", "=ds=#s9#, #a3#"};
				{ 6, 99081, "", "=q4=Legguards of the Unblinking Vigil", "=ds=#s11#, #a3#"};
				{ 8, 0, "inv_weapon_bow_07", "=q6=#t16s2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99660, "", "=q4=Headguard of the Unblinking Vigil", "=ds=#s1#, #a3#"};
				{ 10, 99574, "", "=q4=Spaulders of the Unblinking Vigil", "=ds=#s3#, #a3#"};
				{ 11, 99577, "", "=q4=Tunic of the Unblinking Vigil", "=ds=#s5#, #a3#"};
				{ 12, 99578, "", "=q4=Gloves of the Unblinking Vigil", "=ds=#s9#, #a3#"};
				{ 13, 99573, "", "=q4=Legguards of the Unblinking Vigil", "=ds=#s11#, #a3#"};
				{ 16, 0, "inv_weapon_bow_07", "=q6=#t16s2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99157, "", "=q4=Headguard of the Unblinking Vigil", "=ds=#s1#, #a3#"};
				{ 18, 99159, "", "=q4=Spaulders of the Unblinking Vigil", "=ds=#s3#, #a3#"};
				{ 19, 99167, "", "=q4=Tunic of the Unblinking Vigil", "=ds=#s5#, #a3#"};
				{ 20, 99168, "", "=q4=Gloves of the Unblinking Vigil", "=ds=#s9#, #a3#"};
				{ 21, 99158, "", "=q4=Legguards of the Unblinking Vigil", "=ds=#s11#, #a3#"};
				{ 23, 0, "inv_weapon_bow_07", "=q6=#t16s2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99402, "", "=q4=Headguard of the Unblinking Vigil", "=ds=#s1#, #a3#"};
				{ 25, 99404, "", "=q4=Spaulders of the Unblinking Vigil", "=ds=#s3#, #a3#"};
				{ 26, 99405, "", "=q4=Tunic of the Unblinking Vigil", "=ds=#s5#, #a3#"};
				{ 27, 99406, "", "=q4=Gloves of the Unblinking Vigil", "=ds=#s9#, #a3#"};
				{ 28, 99403, "", "=q4=Legguards of the Unblinking Vigil", "=ds=#s11#, #a3#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["HUNTER"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99084, "", "=q4=Chronomancer Hood", "=ds=#s1#, #a1#"};
				{ 3, 99079, "", "=q4=Chronomancer Mantle", "=ds=#s3#, #a1#"};
				{ 4, 99078, "", "=q4=Chronomancer Robes", "=ds=#s5#, #a1#"};
				{ 5, 99083, "", "=q4=Chronomancer Gloves", "=ds=#s9#, #a1#"};
				{ 6, 99077, "", "=q4=Chronomancer Leggings", "=ds=#s11#, #a1#"};
				{ 8, 0, "inv_staff_13", "=q6=#t16s3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99576, "", "=q4=Chronomancer Hood", "=ds=#s1#, #a1#"};
				{ 10, 99659, "", "=q4=Chronomancer Mantle", "=ds=#s3#, #a1#"};
				{ 11, 99658, "", "=q4=Chronomancer Robes", "=ds=#s5#, #a1#"};
				{ 12, 99575, "", "=q4=Chronomancer Gloves", "=ds=#s9#, #a1#"};
				{ 13, 99657, "", "=q4=Chronomancer Leggings", "=ds=#s11#, #a1#"};
				{ 16, 0, "inv_staff_13", "=q6=#t16s3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99161, "", "=q4=Chronomancer Hood", "=ds=#s1#, #a1#"};
				{ 18, 99153, "", "=q4=Chronomancer Mantle", "=ds=#s3#, #a1#"};
				{ 19, 99152, "", "=q4=Chronomancer Robes", "=ds=#s5#, #a1#"};
				{ 20, 99160, "", "=q4=Chronomancer Gloves", "=ds=#s9#, #a1#"};
				{ 21, 99162, "", "=q4=Chronomancer Leggings", "=ds=#s11#, #a1#"};
				{ 23, 0, "inv_staff_13", "=q6=#t16s3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99398, "", "=q4=Chronomancer Hood", "=ds=#s1#, #a1#"};
				{ 25, 99401, "", "=q4=Chronomancer Mantle", "=ds=#s3#, #a1#"};
				{ 26, 99400, "", "=q4=Chronomancer Robes", "=ds=#s5#, #a1#"};
				{ 27, 99397, "", "=q4=Chronomancer Gloves", "=ds=#s9#, #a1#"};
				{ 28, 99399, "", "=q4=Chronomancer Leggings", "=ds=#s11#, #a1#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["MAGE"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99065, "", "=q4=Crown of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 3, 99051, "", "=q4=Shoulderguards of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 4, 99063, "", "=q4=Chestguard of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 5, 99064, "", "=q4=Gauntlets of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 6, 99050, "", "=q4=Legguards of Seven Sacred Seals", "=ds=#s11#, #a2#"};
				{ 8, 0, "spell_monk_brewmaster_spec", "=q6=#t16s11_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99607, "", "=q4=Crown of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 10, 99565, "", "=q4=Shoulderguards of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 11, 99643, "", "=q4=Chestguard of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 12, 99644, "", "=q4=Gauntlets of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 13, 99606, "", "=q4=Legguards of Seven Sacred Seals", "=ds=#s11#, #a2#"};
				{ 16, 0, "spell_monk_brewmaster_spec", "=q6=#t16s11_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99142, "", "=q4=Crown of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 18, 99144, "", "=q4=Shoulderguards of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 19, 99140, "", "=q4=Chestguard of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 20, 99141, "", "=q4=Gauntlets of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 21, 99143, "", "=q4=Legguards of Seven Sacred Seals", "=ds=#s11#, #a2#"};
				{ 23, 0, "spell_monk_brewmaster_spec", "=q6=#t16s11_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99384, "", "=q4=Crown of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 25, 99386, "", "=q4=Shoulderguards of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 26, 99382, "", "=q4=Chestguard of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 27, 99383, "", "=q4=Gauntlets of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 28, 99385, "", "=q4=Legguards of Seven Sacred Seals", "=ds=#s11#, #a2#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["MONK"].." - "..ALIL["Brewmaster"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99073, "", "=q4=Headpiece of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 3, 99075, "", "=q4=Spaulders of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 4, 99071, "", "=q4=Tunic of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 5, 99072, "", "=q4=Grips of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 6, 99074, "", "=q4=Leggings of Seven Sacred Seals", "=ds=#s11#, #a2#"};
				{ 8, 0, "spell_monk_windwalker_spec", "=q6=#t16s11_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99653, "", "=q4=Headpiece of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 10, 99655, "", "=q4=Spaulders of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 11, 99555, "", "=q4=Tunic of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 12, 99556, "", "=q4=Grips of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 13, 99654, "", "=q4=Leggings of Seven Sacred Seals", "=ds=#s11#, #a2#"};
				{ 16, 0, "spell_monk_windwalker_spec", "=q6=#t16s11_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99156, "", "=q4=Headpiece of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 18, 99146, "", "=q4=Spaulders of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 19, 99154, "", "=q4=Tunic of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 20, 99155, "", "=q4=Grips of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 21, 99145, "", "=q4=Leggings of Seven Sacred Seals", "=ds=#s11#, #a2#"};
				{ 23, 0, "spell_monk_windwalker_spec", "=q6=#t16s11_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99393, "", "=q4=Headpiece of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 25, 99395, "", "=q4=Spaulders of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 26, 99396, "", "=q4=Tunic of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 27, 99392, "", "=q4=Grips of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 28, 99394, "", "=q4=Leggings of Seven Sacred Seals", "=ds=#s11#, #a2#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["MONK"].." - "..ALIL["Windwalker"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99069, "", "=q4=Helm of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 3, 99062, "", "=q4=Mantle of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 4, 99061, "", "=q4=Vest of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 5, 99068, "", "=q4=Handwraps of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 6, 99070, "", "=q4=Legwraps of Seven Sacred Seals", "=ds=#s11#, #a2#"};
				{ 8, 0, "spell_monk_mistweaver_spec", "=q6=#t16s11_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99553, "", "=q4=Helm of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 10, 99642, "", "=q4=Mantle of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 11, 99641, "", "=q4=Vest of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 12, 99552, "", "=q4=Handwraps of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 13, 99554, "", "=q4=Legwraps of Seven Sacred Seals", "=ds=#s11#, #a2#"};
				{ 16, 0, "spell_monk_mistweaver_spec", "=q6=#t16s11_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99148, "", "=q4=Helm of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 18, 99151, "", "=q4=Mantle of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 19, 99150, "", "=q4=Vest of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 20, 99147, "", "=q4=Handwraps of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 21, 99149, "", "=q4=Legwraps of Seven Sacred Seals", "=ds=#s11#, #a2#"};
				{ 23, 0, "spell_monk_mistweaver_spec", "=q6=#t16s11_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99389, "", "=q4=Helm of Seven Sacred Seals", "=ds=#s1#, #a2#"};
				{ 25, 99381, "", "=q4=Mantle of Seven Sacred Seals", "=ds=#s3#, #a2#"};
				{ 26, 99391, "", "=q4=Vest of Seven Sacred Seals", "=ds=#s5#, #a2#"};
				{ 27, 99388, "", "=q4=Handwraps of Seven Sacred Seals", "=ds=#s9#, #a2#"};
				{ 28, 99390, "", "=q4=Legwraps of Seven Sacred Seals", "=ds=#s11#, #a2#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["MONK"].." - "..ALIL["Mistweaver"],
		...
		["Normal"] = {
			{
				...
				{ 2, 98979, "", "=q4=Headguard of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 3, 99076, "", "=q4=Mantle of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 4, 99003, "", "=q4=Breastplate of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 5, 98982, "", "=q4=Gloves of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 6, 98980, "", "=q4=Greaves of Winged Triumph", "=ds=#s11#, #a4#"};
				{ 8, 0, "Spell_Holy_HolyBolt", "=q6=#t16s4_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99665, "", "=q4=Headguard of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 10, 99656, "", "=q4=Mantle of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 11, 99626, "", "=q4=Breastplate of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 12, 99648, "", "=q4=Gloves of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 13, 99666, "", "=q4=Greaves of Winged Triumph", "=ds=#s11#, #a4#"};
				{ 16, 0, "Spell_Holy_HolyBolt", "=q6=#t16s4_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99135, "", "=q4=Headguard of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 18, 99125, "", "=q4=Mantle of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 19, 99133, "", "=q4=Breastplate of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 20, 99134, "", "=q4=Gloves of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 21, 99124, "", "=q4=Greaves of Winged Triumph", "=ds=#s11#, #a4#"};
				{ 23, 0, "Spell_Holy_HolyBolt", "=q6=#t16s4_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99376, "", "=q4=Headguard of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 25, 99378, "", "=q4=Mantle of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 26, 99374, "", "=q4=Breastplate of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 27, 99375, "", "=q4=Gloves of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 28, 99377, "", "=q4=Greaves of Winged Triumph", "=ds=#s11#, #a4#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." - "..ALIL["Holy"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99029, "", "=q4=Faceguard of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 3, 99027, "", "=q4=Shoulderguards of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 4, 99031, "", "=q4=Chestguard of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 5, 99028, "", "=q4=Handguards of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 6, 99026, "", "=q4=Legguards of Winged Triumph", "=ds=#s11#, #a4#"};
				{ 8, 0, "spell_holy_devotionaura", "=q6=#t16s4_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99596, "", "=q4=Faceguard of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 10, 99594, "", "=q4=Shoulderguards of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 11, 99598, "", "=q4=Chestguard of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 12, 99595, "", "=q4=Handguards of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 13, 99593, "", "=q4=Legguards of Winged Triumph", "=ds=#s11#, #a4#"};
				{ 16, 0, "spell_holy_devotionaura", "=q6=#t16s4_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99128, "", "=q4=Faceguard of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 18, 99130, "", "=q4=Shoulderguards of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 19, 99126, "", "=q4=Chestguard of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 20, 99127, "", "=q4=Handguards of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 21, 99129, "", "=q4=Legguards of Winged Triumph", "=ds=#s11#, #a4#"};
				{ 23, 0, "spell_holy_devotionaura", "=q6=#t16s4_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99370, "", "=q4=Faceguard of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 25, 99364, "", "=q4=Shoulderguards of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 26, 99368, "", "=q4=Chestguard of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 27, 99369, "", "=q4=Handguards of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 28, 99371, "", "=q4=Legguards of Winged Triumph", "=ds=#s11#, #a4#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." - "..ALIL["Protection"],
		...
		["Normal"] = {
			{
				...
				{ 2, 98985, "", "=q4=Helmet of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 3, 98987, "", "=q4=Pauldrons of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 4, 99052, "", "=q4=Battleplate of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 5, 99002, "", "=q4=Gauntlets of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 6, 98986, "", "=q4=Legplates of Winged Triumph", "=ds=#s11#, #a4#"};
				{ 8, 0, "Spell_Holy_AuraOfLight", "=q6=#t16s4_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99651, "", "=q4=Helmet of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 10, 99662, "", "=q4=Pauldrons of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 11, 99566, "", "=q4=Battleplate of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 12, 99625, "", "=q4=Gauntlets of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 13, 99661, "", "=q4=Legplates of Winged Triumph", "=ds=#s11#, #a4#"};
				{ 16, 0, "Spell_Holy_AuraOfLight", "=q6=#t16s4_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99138, "", "=q4=Helmet of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 18, 99132, "", "=q4=Pauldrons of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 19, 99136, "", "=q4=Battleplate of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 20, 99134, "", "=q4=Gauntlets of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 21, 99139, "", "=q4=Legplates of Winged Triumph", "=ds=#s11#, #a4#"};
				{ 23, 0, "Spell_Holy_AuraOfLight", "=q6=#t16s4_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99379, "", "=q4=Helmet of Winged Triumph", "=ds=#s1#, #a4#"};
				{ 25, 99373, "", "=q4=Pauldrons of Winged Triumph", "=ds=#s3#, #a4#"};
				{ 26, 99387, "", "=q4=Battleplate of Winged Triumph", "=ds=#s5#, #a4#"};
				{ 27, 99380, "", "=q4=Gauntlets of Winged Triumph", "=ds=#s9#, #a4#"};
				{ 28, 99372, "", "=q4=Legplates of Winged Triumph", "=ds=#s11#, #a4#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." - "..ALIL["Retribution"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99020, "", "=q4=Hood of the Ternion Glory", "=ds=#s1#, #a1#"};
				{ 3, 99005, "", "=q4=Shoulderguards of the Ternion Glory", "=ds=#s3#, #a1#"};
				{ 4, 99004, "", "=q4=Raiment of the Ternion Glory", "=ds=#s5#, #a1#"};
				{ 5, 99019, "", "=q4=Gloves of the Ternion Glory", "=ds=#s9#, #a1#"};
				{ 6, 99021, "", "=q4=Leggings of the Ternion Glory", "=ds=#s11#, #a1#"};
				{ 8, 0, "spell_shadow_shadowwordpain", "=q6=#t16s5_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99587, "", "=q4=Hood of the Ternion Glory", "=ds=#s1#, #a1#"};
				{ 10, 99628, "", "=q4=Shoulderguards of the Ternion Glory", "=ds=#s3#, #a1#"};
				{ 11, 99627, "", "=q4=Raiment of the Ternion Glory", "=ds=#s5#, #a1#"};
				{ 12, 99586, "", "=q4=Gloves of the Ternion Glory", "=ds=#s9#, #a1#"};
				{ 13, 99588, "", "=q4=Leggings of the Ternion Glory", "=ds=#s11#, #a1#"};
				{ 16, 0, "spell_shadow_shadowwordpain", "=q6=#t16s5_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99122, "", "=q4=Hood of the Ternion Glory", "=ds=#s1#, #a1#"};
				{ 18, 99111, "", "=q4=Shoulderguards of the Ternion Glory", "=ds=#s3#, #a1#"};
				{ 19, 99110, "", "=q4=Raiment of the Ternion Glory", "=ds=#s5#, #a1#"};
				{ 20, 99121, "", "=q4=Gloves of the Ternion Glory", "=ds=#s9#, #a1#"};
				{ 21, 99123, "", "=q4=Leggings of the Ternion Glory", "=ds=#s11#, #a1#"};
				{ 23, 0, "spell_shadow_shadowwordpain", "=q6=#t16s5_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99360, "", "=q4=Hood of the Ternion Glory", "=ds=#s1#, #a1#"};
				{ 25, 99363, "", "=q4=Shoulderguards of the Ternion Glory", "=ds=#s3#, #a1#"};
				{ 26, 99362, "", "=q4=Raiment of the Ternion Glory", "=ds=#s5#, #a1#"};
				{ 27, 99359, "", "=q4=Gloves of the Ternion Glory", "=ds=#s9#, #a1#"};
				{ 28, 99361, "", "=q4=Leggings of the Ternion Glory", "=ds=#s11#, #a1#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["PRIEST"].." - "..ALIL["Shadow"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99024, "", "=q4=Cowl of the Ternion Glory", "=ds=#s1#, #a1#"};
				{ 3, 99018, "", "=q4=Mantle of the Ternion Glory", "=ds=#s3#, #a1#"};
				{ 4, 99017, "", "=q4=Robes of the Ternion Glory", "=ds=#s5#, #a1#"};
				{ 5, 99023, "", "=q4=Handwraps of the Ternion Glory", "=ds=#s9#, #a1#"};
				{ 6, 99025, "", "=q4=Legwraps of the Ternion Glory", "=ds=#s11#, #a1#"};
				{ 8, 0, "spell_holy_guardianspirit", "=q6=#t16s5_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99591, "", "=q4=Cowl of the Ternion Glory", "=ds=#s1#, #a1#"};
				{ 10, 99585, "", "=q4=Mantle of the Ternion Glory", "=ds=#s3#, #a1#"};
				{ 11, 99584, "", "=q4=Robes of the Ternion Glory", "=ds=#s5#, #a1#"};
				{ 12, 99590, "", "=q4=Handwraps of the Ternion Glory", "=ds=#s9#, #a1#"};
				{ 13, 99592, "", "=q4=Legwraps of the Ternion Glory", "=ds=#s11#, #a1#"};
				{ 16, 0, "spell_holy_guardianspirit", "=q6=#t16s5_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99117, "", "=q4=Cowl of the Ternion Glory", "=ds=#s1#, #a1#"};
				{ 18, 99120, "", "=q4=Mantle of the Ternion Glory", "=ds=#s3#, #a1#"};
				{ 19, 99119, "", "=q4=Robes of the Ternion Glory", "=ds=#s5#, #a1#"};
				{ 20, 99131, "", "=q4=Handwraps of the Ternion Glory", "=ds=#s9#, #a1#"};
				{ 21, 99118, "", "=q4=Legwraps of the Ternion Glory", "=ds=#s11#, #a1#"};
				{ 23, 0, "spell_holy_guardianspirit", "=q6=#t16s5_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99366, "", "=q4=Cowl of the Ternion Glory", "=ds=#s1#, #a1#"};
				{ 25, 99358, "", "=q4=Mantle of the Ternion Glory", "=ds=#s3#, #a1#"};
				{ 26, 99357, "", "=q4=Robes of the Ternion Glory", "=ds=#s5#, #a1#"};
				{ 27, 99365, "", "=q4=Handwraps of the Ternion Glory", "=ds=#s9#, #a1#"};
				{ 28, 99367, "", "=q4=Legwraps of the Ternion Glory", "=ds=#s11#, #a1#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["PRIEST"].." - "..ALIL["Holy"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99008, "", "=q4=Helmet of the Barbed Assassin", "=ds=#s1#, #a2#"};
				{ 3, 99010, "", "=q4=Spaulders of the Barbed Assassin", "=ds=#s3#, #a2#"};
				{ 4, 99006, "", "=q4=Tunic of the Barbed Assassin", "=ds=#s5#, #a2#"};
				{ 5, 99007, "", "=q4=Gloves of the Barbed Assassin", "=ds=#s9#, #a2#"};
				{ 6, 99009, "", "=q4=Legguards of the Barbed Assassin", "=ds=#s11#, #a2#"};
				{ 8, 0, "inv_throwingknife_04", "=q6=#t16s6#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99631, "", "=q4=Helmet of the Barbed Assassin", "=ds=#s1#, #a2#"};
				{ 10, 99635, "", "=q4=Spaulders of the Barbed Assassin", "=ds=#s3#, #a2#"};
				{ 11, 99629, "", "=q4=Tunic of the Barbed Assassin", "=ds=#s5#, #a2#"};
				{ 12, 99630, "", "=q4=Gloves of the Barbed Assassin", "=ds=#s9#, #a2#"};
				{ 13, 99634, "", "=q4=Legguards of the Barbed Assassin", "=ds=#s11#, #a2#"};
				{ 16, 0, "inv_throwingknife_04", "=q6=#t16s6#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99114, "", "=q4=Helmet of the Barbed Assassin", "=ds=#s1#, #a2#"};
				{ 18, 99116, "", "=q4=Spaulders of the Barbed Assassin", "=ds=#s3#, #a2#"};
				{ 19, 99112, "", "=q4=Tunic of the Barbed Assassin", "=ds=#s5#, #a2#"};
				{ 20, 99113, "", "=q4=Gloves of the Barbed Assassin", "=ds=#s9#, #a2#"};
				{ 21, 99115, "", "=q4=Legguards of the Barbed Assassin", "=ds=#s11#, #a2#"};
				{ 23, 0, "inv_throwingknife_04", "=q6=#t16s6#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99348, "", "=q4=Helmet of the Barbed Assassin", "=ds=#s1#, #a2#"};
				{ 25, 99350, "", "=q4=Spaulders of the Barbed Assassin", "=ds=#s3#, #a2#"};
				{ 26, 99356, "", "=q4=Tunic of the Barbed Assassin", "=ds=#s5#, #a2#"};
				{ 27, 99355, "", "=q4=Gloves of the Barbed Assassin", "=ds=#s9#, #a2#"};
				{ 28, 99349, "", "=q4=Legguards of the Barbed Assassin", "=ds=#s11#, #a2#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["ROGUE"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99089, "", "=q4=Headpiece of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 3, 99091, "", "=q4=Shoulderwraps of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 4, 99087, "", "=q4=Hauberk of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 5, 99088, "", "=q4=Gloves of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 6, 99090, "", "=q4=Kilt of Celestial Harmony", "=ds=#s11#, #a3#"};
				{ 8, 0, "Spell_Nature_Lightning", "=q6=#t16s7_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99645, "", "=q4=Headpiece of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 10, 99647, "", "=q4=Shoulderwraps of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 11, 99579, "", "=q4=Hauberk of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 12, 99580, "", "=q4=Gloves of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 13, 99646, "", "=q4=Kilt of Celestial Harmony", "=ds=#s11#, #a3#"};
				{ 16, 0, "Spell_Nature_Lightning", "=q6=#t16s7_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99093, "", "=q4=Headpiece of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 18, 99095, "", "=q4=Shoulderwraps of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 19, 99106, "", "=q4=Hauberk of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 20, 99092, "", "=q4=Gloves of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 21, 99094, "", "=q4=Kilt of Celestial Harmony", "=ds=#s11#, #a3#"};
				{ 23, 0, "Spell_Nature_Lightning", "=q6=#t16s7_3#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99332, "", "=q4=Headpiece of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 25, 99334, "", "=q4=Shoulderwraps of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 26, 99344, "", "=q4=Hauberk of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 27, 99345, "", "=q4=Gloves of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 28, 99333, "", "=q4=Kilt of Celestial Harmony", "=ds=#s11#, #a3#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." - "..ALIL["Elemental"],
		...
		["Normal"] = {
			{
				...
				{ 2, 98983, "", "=q4=Helmet of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 3, 98977, "", "=q4=Spaulders of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 4, 98992, "", "=q4=Cuirass of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 5, 98993, "", "=q4=Grips of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 6, 98984, "", "=q4=Legguards of Celestial Harmony", "=ds=#s11#, #a3#"};
				{ 8, 0, "spell_nature_lightningshield", "=q6=#t16s7_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99649, "", "=q4=Helmet of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 10, 99663, "", "=q4=Spaulders of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 11, 99615, "", "=q4=Cuirass of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 12, 99616, "", "=q4=Grips of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 13, 99650, "", "=q4=Legguards of Celestial Harmony", "=ds=#s11#, #a3#"};
				{ 16, 0, "spell_nature_lightningshield", "=q6=#t16s7_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99103, "", "=q4=Helmet of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 18, 99105, "", "=q4=Spaulders of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 19, 99101, "", "=q4=Cuirass of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 20, 99102, "", "=q4=Grips of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 21, 99104, "", "=q4=Legguards of Celestial Harmony", "=ds=#s11#, #a3#"};
				{ 23, 0, "spell_nature_lightningshield", "=q6=#t16s7_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99341, "", "=q4=Helmet of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 25, 99343, "", "=q4=Spaulders of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 26, 99347, "", "=q4=Cuirass of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 27, 99340, "", "=q4=Grips of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 28, 99342, "", "=q4=Legguards of Celestial Harmony", "=ds=#s11#, #a3#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." - "..ALIL["Enhancement"],
		...
		["Normal"] = {
			{
				...
				{ 2, 98989, "", "=q4=Faceguard of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 3, 98991, "", "=q4=Mantle of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 4, 99011, "", "=q4=Tunic of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 5, 98988, "", "=q4=Handwraps of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 6, 98990, "", "=q4=Legwraps of Celestial Harmony", "=ds=#s11#, #a3#"};
				{ 8, 0, "spell_nature_magicimmunity", "=q6=#t16s7_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99612, "", "=q4=Faceguard of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 10, 99614, "", "=q4=Mantle of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 11, 99636, "", "=q4=Tunic of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 12, 99611, "", "=q4=Handwraps of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 13, 99613, "", "=q4=Legwraps of Celestial Harmony", "=ds=#s11#, #a3#"};
				{ 16, 0, "spell_nature_magicimmunity", "=q6=#t16s7_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99109, "", "=q4=Faceguard of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 18, 99100, "", "=q4=Mantle of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 19, 99107, "", "=q4=Tunic of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 20, 99108, "", "=q4=Handwraps of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 21, 99099, "", "=q4=Legwraps of Celestial Harmony", "=ds=#s11#, #a3#"};
				{ 23, 0, "spell_nature_magicimmunity", "=q6=#t16s7_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99353, "", "=q4=Faceguard of Celestial Harmony", "=ds=#s1#, #a3#"};
				{ 25, 99346, "", "=q4=Mantle of Celestial Harmony", "=ds=#s3#, #a3#"};
				{ 26, 99351, "", "=q4=Tunic of Celestial Harmony", "=ds=#s5#, #a3#"};
				{ 27, 99352, "", "=q4=Handwraps of Celestial Harmony", "=ds=#s9#, #a3#"};
				{ 28, 99354, "", "=q4=Legwraps of Celestial Harmony", "=ds=#s11#, #a3#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." - "..ALIL["Restoration"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99054, "", "=q4=Hood of the Horned Nightmare", "=ds=#s1#, #a1#"};
				{ 3, 99045, "", "=q4=Mantle of the Horned Nightmare", "=ds=#s3#, #a1#"};
				{ 4, 99056, "", "=q4=Robes of the Horned Nightmare", "=ds=#s5#, #a1#"};
				{ 5, 99053, "", "=q4=Gloves of the Horned Nightmare", "=ds=#s9#, #a1#"};
				{ 6, 99055, "", "=q4=Leggings of the Horned Nightmare", "=ds=#s11#, #a1#"};
				{ 8, 0, "spell_nature_drowsy", "=q6=#t16s8#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99568, "", "=q4=Hood of the Horned Nightmare", "=ds=#s1#, #a1#"};
				{ 10, 99601, "", "=q4=Mantle of the Horned Nightmare", "=ds=#s3#, #a1#"};
				{ 11, 99570, "", "=q4=Robes of the Horned Nightmare", "=ds=#s5#, #a1#"};
				{ 12, 99567, "", "=q4=Gloves of the Horned Nightmare", "=ds=#s9#, #a1#"};
				{ 13, 99569, "", "=q4=Leggings of the Horned Nightmare", "=ds=#s11#, #a1#"};
				{ 16, 0, "spell_nature_drowsy", "=q6=#t16s8#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99097, "", "=q4=Hood of the Horned Nightmare", "=ds=#s1#, #a1#"};
				{ 18, 99205, "", "=q4=Mantle of the Horned Nightmare", "=ds=#s3#, #a1#"};
				{ 19, 99204, "", "=q4=Robes of the Horned Nightmare", "=ds=#s5#, #a1#"};
				{ 20, 99096, "", "=q4=Gloves of the Horned Nightmare", "=ds=#s9#, #a1#"};
				{ 21, 99098, "", "=q4=Leggings of the Horned Nightmare", "=ds=#s11#, #a1#"};
				{ 23, 0, "spell_nature_drowsy", "=q6=#t16s8#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99425, "", "=q4=Hood of the Horned Nightmare", "=ds=#s1#, #a1#"};
				{ 25, 99417, "", "=q4=Mantle of the Horned Nightmare", "=ds=#s3#, #a1#"};
				{ 26, 99416, "", "=q4=Robes of the Horned Nightmare", "=ds=#s5#, #a1#"};
				{ 27, 99424, "", "=q4=Gloves of the Horned Nightmare", "=ds=#s9#, #a1#"};
				{ 28, 99426, "", "=q4=Leggings of the Horned Nightmare", "=ds=#s11#, #a1#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["WARLOCK"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99046, "", "=q4=Helmet of the Prehistoric Marauder", "=ds=#s1#, #a4#"};
				{ 3, 99036, "", "=q4=Pauldrons of the Prehistoric Marauder", "=ds=#s3#, #a4#"};
				{ 4, 99047, "", "=q4=Battleplate of the Prehistoric Marauder", "=ds=#s5#, #a4#"};
				{ 5, 99034, "", "=q4=Gauntlets of the Prehistoric Marauder", "=ds=#s9#, #a4#"};
				{ 6, 99035, "", "=q4=Legplates of the Prehistoric Marauder", "=ds=#s11#, #a4#"};
				{ 8, 0, "ability_warrior_innerrage", "=q6=#t16s9_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99602, "", "=q4=Helmet of the Prehistoric Marauder", "=ds=#s1#, #a4#"};
				{ 10, 99561, "", "=q4=Pauldrons of the Prehistoric Marauder", "=ds=#s3#, #a4#"};
				{ 11, 99603, "", "=q4=Battleplate of the Prehistoric Marauder", "=ds=#s5#, #a4#"};
				{ 12, 99559, "", "=q4=Gauntlets of the Prehistoric Marauder", "=ds=#s9#, #a4#"};
				{ 13, 99560, "", "=q4=Legplates of the Prehistoric Marauder", "=ds=#s11#, #a4#"};
				{ 16, 0, "ability_warrior_innerrage", "=q6=#t16s9_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99206, "", "=q4=Helmet of the Prehistoric Marauder", "=ds=#s1#, #a4#"};
				{ 18, 99200, "", "=q4=Pauldrons of the Prehistoric Marauder", "=ds=#s3#, #a4#"};
				{ 19, 99197, "", "=q4=Battleplate of the Prehistoric Marauder", "=ds=#s5#, #a4#"};
				{ 20, 99198, "", "=q4=Gauntlets of the Prehistoric Marauder", "=ds=#s9#, #a4#"};
				{ 21, 99199, "", "=q4=Legplates of the Prehistoric Marauder", "=ds=#s11#, #a4#"};
				{ 23, 0, "ability_warrior_innerrage", "=q6=#t16s9_1#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99418, "", "=q4=Helmet of the Prehistoric Marauder", "=ds=#s1#, #a4#"};
				{ 25, 99414, "", "=q4=Pauldrons of the Prehistoric Marauder", "=ds=#s3#, #a4#"};
				{ 26, 99411, "", "=q4=Battleplate of the Prehistoric Marauder", "=ds=#s5#, #a4#"};
				{ 27, 99412, "", "=q4=Gauntlets of the Prehistoric Marauder", "=ds=#s9#, #a4#"};
				{ 28, 99413, "", "=q4=Legplates of the Prehistoric Marauder", "=ds=#s11#, #a4#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["WARRIOR"].." - "..AL["DPS"],
		...
		["Normal"] = {
			{
				...
				{ 2, 99032, "", "=q4=Faceguard of the Prehistoric Marauder", "=ds=#s1#, #a4#"};
				{ 3, 99030, "", "=q4=Shoulderguards of the Prehistoric Marauder", "=ds=#s3#, #a4#"};
				{ 4, 99037, "", "=q4=Chestguard of the Prehistoric Marauder", "=ds=#s5#, #a4#"};
				{ 5, 99038, "", "=q4=Handguards of the Prehistoric Marauder", "=ds=#s9#, #a4#"};
				{ 6, 99033, "", "=q4=Legguards of the Prehistoric Marauder", "=ds=#s11#, #a4#"};
				{ 8, 0, "ability_warrior_defensivestance", "=q6=#t16s9_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Flexible"]};
				{ 9, 99557, "", "=q4=Faceguard of the Prehistoric Marauder", "=ds=#s1#, #a4#"};
				{ 10, 99597, "", "=q4=Shoulderguards of the Prehistoric Marauder", "=ds=#s3#, #a4#"};
				{ 11, 99562, "", "=q4=Chestguard of the Prehistoric Marauder", "=ds=#s5#, #a4#"};
				{ 12, 99563, "", "=q4=Handguards of the Prehistoric Marauder", "=ds=#s9#, #a4#"};
				{ 13, 99558, "", "=q4=Legguards of the Prehistoric Marauder", "=ds=#s11#, #a4#"};
				{ 16, 0, "ability_warrior_defensivestance", "=q6=#t16s9_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Normal"]};
				{ 17, 99203, "", "=q4=Faceguard of the Prehistoric Marauder", "=ds=#s1#, #a4#"};
				{ 18, 99196, "", "=q4=Shoulderguards of the Prehistoric Marauder", "=ds=#s3#, #a4#"};
				{ 19, 99201, "", "=q4=Chestguard of the Prehistoric Marauder", "=ds=#s5#, #a4#"};
				{ 20, 99202, "", "=q4=Handguards of the Prehistoric Marauder", "=ds=#s9#, #a4#"};
				{ 21, 99195, "", "=q4=Legguards of the Prehistoric Marauder", "=ds=#s11#, #a4#"};
				{ 23, 0, "ability_warrior_defensivestance", "=q6=#t16s9_2#", "=q5="..string.format(AL["Tier %d"], 16).." - "..AL["Heroic"]};
				{ 24, 99409, "", "=q4=Faceguard of the Prehistoric Marauder", "=ds=#s1#, #a4#"};
				{ 25, 99407, "", "=q4=Shoulderguards of the Prehistoric Marauder", "=ds=#s3#, #a4#"};
				{ 26, 99415, "", "=q4=Chestguard of the Prehistoric Marauder", "=ds=#s5#, #a4#"};
				{ 27, 99408, "", "=q4=Handguards of the Prehistoric Marauder", "=ds=#s9#, #a4#"};
				{ 28, 99410, "", "=q4=Legguards of the Prehistoric Marauder", "=ds=#s11#, #a4#"};
			};
		};
		info = {
			name = LOCALIZED_CLASS_NAMES_MALE["WARRIOR"].." - "..ALIL["Protection"],
