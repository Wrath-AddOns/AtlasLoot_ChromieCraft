...
--[[				{ 16, 0, "inv_box_04", "=q6=#j3#", ""};
		...
		["Normal"] = {
			{
				...
				{ 12, 59441, "", "=q4=Prestor's Talisman of Machination", "=ds=#s14#", ""};
				{ 13, 59354, "", "=q4=Jar of Ancient Remedies", "=ds=#s14#", ""};
		...
		["Heroic"] = {
			{
				...
				{ 12, 65026, "", "=q4=Prestor's Talisman of Machination", "=ds=#s14#", ""};
				{ 13, 65029, "", "=q4=Jar of Ancient Remedies", "=ds=#s14#", ""};
		...
		["Normal"] = {
			{
				...
				{ 8, 63379, "", "=q3=Baradin's Wardens Tabard", "=ds=#s7#"};
				{ 9, 65175, "", "=q3=Baradin Footman's Tags", "=ds=#s14#"};
				{ 10, 63355, "", "=q3=Rustberg Gull", "=ds=#e13#"};
				{ 11, 63141, "", "=q3=Tol Barad Searchlight", "=ds="};
				{ 16, 0, "inv_misc_tabard_baradinwardens", "=q6=#r4#", ""};
				{ 17, 62475, "", "=q3=Dagger of Restless Nights", "=ds=#h1#, #w4#"};
				{ 18, 62473, "", "=q3=Blade of the Fearless", "=ds=#h2#, #w10#"};
				{ 19, 62476, "", "=q3=Ravening Slicer", "=ds=#h1#, #w1#"};
				{ 20, 68739, "", "=q3=Darkheart Hacker", "=ds=#h1#, #w1#"};
				{ 21, 62478, "", "=q3=Shimmering Morningstar", "=ds=#h3#, #w6#"};
				{ 22, 62474, "", "=q3=Spear of Trailing Shadows", "=ds=#w7#"};
				{ 23, 62477, "", "=q3=Insidious Staff", "=ds=#w9#"};
				{ 24, 62479, "", "=q3=Sky Piercer", "=ds=#w3#"};
				{ 25, 63377, "", "=q3=Baradin's Wardens Battle Standard", "=ds=#e14#"};
			};
			{
				{ 1, 0, "inv_misc_tabard_baradinwardens", "=q6=#r5#", ""};
				{ 2, 62469, "", "=q4=Impatience of Youth", "=ds=#s14#"};
				{ 3, 62472, "", "=q4=Mandala of Stirring Patterns", "=ds=#s14#"};
				{ 4, 62471, "", "=q4=Mirror of Broken Images", "=ds=#s14#"};
				{ 5, 62470, "", "=q4=Stump of Time", "=ds=#s14#"};
				{ 6, 62468, "", "=q4=Unsolvable Riddle", "=ds=#s14#"};
				{ 7, 64998, "", "=q4=Reins of the Spectral Steed", "=ds=#e12#"};
				{ 8, 63039, "", "=q4=Reins of the Drake of the West Wind", "=ds=#e27#"};
			};
		};
		info = {
		...
		["Normal"] = {
			{
				...
				{ 8, 63378, "", "=q3=Hellscream's Reach Tabard", "=ds=#s7#"};
				{ 9, 65176, "", "=q3=Baradin Grunt's Talisman", "=ds=#s14#"};
				{ 10, 64996, "", "=q3=Rustberg Gull", "=ds=#e13#"};
				{ 11, 64997, "", "=q3=Tol Barad Searchlight", "=ds="};
				{ 16, 0, "inv_misc_tabard_hellscream", "=q6=#r4#", ""};
				{ 17, 62456, "", "=q3=Dagger of Restless Nights", "=ds=#h1#, #w4#"};
				{ 18, 62454, "", "=q3=Blade of the Fearless", "=ds=#h2#, #w10#"};
				{ 19, 62457, "", "=q3=Ravening Slicer", "=ds=#h1#, #w1#"};
				{ 20, 68740, "", "=q3=Darkheart Hacker", "=ds=#h1#, #w1#"};
				{ 21, 62459, "", "=q3=Shimmering Morningstar", "=ds=#h3#, #w6#"};
				{ 22, 62455, "", "=q3=Spear of Trailing Shadows", "=ds=#w7#"};
				{ 23, 62458, "", "=q3=Insidious Staff", "=ds=#w9#"};
				{ 24, 62460, "", "=q3=Sky Piercer", "=ds=#w3#"};
				{ 25, 63376, "", "=q3=Hellscream's Reach Battle Standard", "=ds=#e14#"};
			};
			{
				{ 1, 0, "inv_misc_tabard_hellscream", "=q6=#r5#", ""};
				{ 2, 62464, "", "=q4=Impatience of Youth", "=ds=#s14#"};
				{ 3, 62467, "", "=q4=Mandala of Stirring Patterns", "=ds=#s14#"};
				{ 4, 62466, "", "=q4=Mirror of Broken Images", "=ds=#s14#"};
				{ 5, 62465, "", "=q4=Stump of Time", "=ds=#s14#"};
				{ 6, 62463, "", "=q4=Unsolvable Riddle", "=ds=#s14#"};
				{ 7, 64999, "", "=q4=Reins of the Spectral Wolf", "=ds=#e12#"};
				{ 8, 65356, "", "=q4=Reins of the Drake of the West Wind", "=ds=#e27#"};
			};
		};
		info = {
	...
	AtlasLoot_Data["PVP85Accessories"] = {
		["Normal"] = {
			...
			};
			{
				...
				{ 16, 64713, "", "=q4=Bloodthirsty Gladiator's Choker of Accuracy", "=ds=#s2#", "1250 #honor#" },
				{ 17, 64714, "", "=q4=Bloodthirsty Gladiator's Choker of Proficiency", "=ds=#s2#", "1250 #honor#" },
    			{ 18, 64800, "", "=q4=Bloodthirsty Gladiator's Necklace of Proficiency", "=ds=#s2#", "1250 #honor#" },
    			{ 19, 64801, "", "=q4=Bloodthirsty Gladiator's Necklace of Prowess", "=ds=#s2#", "1250 #honor#" },
    			{ 20, 64807, "", "=q4=Bloodthirsty Gladiator's Pendant of Alacrity", "=ds=#s2#", "1250 #honor#" },
    			{ 21, 64808, "", "=q4=Bloodthirsty Gladiator's Pendant of Diffusion", "=ds=#s2#", "1250 #honor#" },
    			{ 22, 64809, "", "=q4=Bloodthirsty Gladiator's Pendant of Meditation", "=ds=#s2#", "1250 #honor#" },
			};
		};
		info = {
	...
	AtlasLoot_Data["PVP85Trinkets"] = {
		["Normal"] = {
			{
				{ 1, 61033, "", "=q3=Vicious Gladiator's Badge of Conquest", "=ds=#s14#", "1650 #conquest#" },
				{ 2, 61035, "", "=q3=Vicious Gladiator's Badge of Dominance", "=ds=#s14#", "1650 #conquest#" },
				{ 3, 61034, "", "=q3=Vicious Gladiator's Badge of Victory", "=ds=#s14#", "1650 #conquest#" },
				{ 5, 61026, "", "=q3=Vicious Gladiator's Emblem of Cruelty", "=ds=#s14#", "1650 #conquest#" },
				{ 6, 61031, "", "=q3=Vicious Gladiator's Emblem of Meditation", "=ds=#s14#", "1650 #conquest#" },
				{ 7, 61032, "", "=q3=Vicious Gladiator's Emblem of Tenacity", "=ds=#s14#", "1650 #conquest#" },
				{
					{ 9, 60801, "", "=q3=Vicious Gladiator's Medallion of Cruelty", "=ds=#s14#", "1650 #conquest#" },
					{ 9, 60794, "", "=q3=Vicious Gladiator's Medallion of Cruelty", "=ds=#s14#", "1650 #conquest#" },
				};
				{
					{ 10, 60806, "", "=q3=Vicious Gladiator's Medallion of Meditation", "=ds=#s14#", "1650 #conquest#" },
					{ 10, 60799, "", "=q3=Vicious Gladiator's Medallion of Meditation", "=ds=#s14#", "1650 #conquest#" },
				};
				{
					{ 11, 60807, "", "=q3=Vicious Gladiator's Medallion of Tenacity", "=ds=#s14#", "1650 #conquest#" },
					{ 11, 60800, "", "=q3=Vicious Gladiator's Medallion of Tenacity", "=ds=#s14#", "1650 #conquest#" },
				};
				{ 13, 61047, "", "=q3=Vicious Gladiator's Insignia of Conquest", "=ds=#s14#", "1650 #conquest#" },
				{ 14, 61045, "", "=q3=Vicious Gladiator's Insignia of Dominance", "=ds=#s14#", "1650 #conquest#" },
				{ 15, 61046, "", "=q3=Vicious Gladiator's Insignia of Victory", "=ds=#s14#", "1650 #conquest#" },
