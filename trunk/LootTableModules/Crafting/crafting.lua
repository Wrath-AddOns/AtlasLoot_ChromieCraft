...
---- Jewelcrafting Daily
	...
	AtlasLoot_Data["SmithingArmorMoP"] = {
		["Normal"] = {
			{
				{ 1, "s137769", "94266", "=q4=Haunted Steel Greathelm", "=ds=#s1#, #a4# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 2, "s137767", "94264", "=q4=Haunted Steel Headcover", "=ds=#s1#, #a4# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 3, "s137771", "94268", "=q4=Haunted Steel Headguard", "=ds=#s1#, #a4# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 4, "s137766", "94263", "=q4=Haunted Steel Greaves", "=ds=#s12#, #a4# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 5, "s137768", "94265", "=q4=Haunted Steel Treads", "=ds=#s12#, #a4# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 6, "s137770", "94267", "=q4=Haunted Steel Warboots", "=ds=#s12#, #a4# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				...
				{ 19, "s140844", "93455", "=q3=Crafted Dreadful Gladiator's Dreadplate Helm", "=ds=#s1#, #a4# / =q1=#sk# 600", "=ds="};
				{ 20, "s140842", "93457", "=q3=Crafted Dreadful Gladiator's Dreadplate Shoulders", "=ds=#s3#, #a4# / =q1=#sk# 600", "=ds="};
				{ 21, "s140846", "93453", "=q3=Crafted Dreadful Gladiator's Dreadplate Chestpiece", "=ds=#s5#, #a4# / =q1=#sk# 600", "=ds="};
				{ 22, "s140845", "93454", "=q3=Crafted Dreadful Gladiator's Dreadplate Gauntlets", "=ds=#s9#, #a4# / =q1=#sk# 600", "=ds="};
				{ 23, "s140843", "93456", "=q3=Crafted Dreadful Gladiator's Dreadplate Legguards", "=ds=#s11#, #a4# / =q1=#sk# 600", "=ds="};
				{ 24, "s137773", "93529", "=q3=Crafted Dreadful Gladiator's Scaled Helm", "=ds=#s1#, #a4# / =q1=#sk# 600", "=ds="};
				{ 25, "s137775", "93531", "=q3=Crafted Dreadful Gladiator's Scaled Shoulders", "=ds=#s3#, #a4# / =q1=#sk# 600", "=ds="};
				{ 26, "s140841", "93527", "=q3=Crafted Dreadful Gladiator's Scaled Chestpiece", "=ds=#s5#, #a4# / =q1=#sk# 600", "=ds="};
				{ 27, "s137772", "93528", "=q3=Crafted Dreadful Gladiator's Scaled Gauntlets", "=ds=#s9#, #a4# / =q1=#sk# 600", "=ds="};
				{ 28, "s137774", "93530", "=q3=Crafted Dreadful Gladiator's Scaled Legguards", "=ds=#s11#, #a4# / =q1=#sk# 600", "=ds="};
				{ 29, "s137784", "93540", "=q3=Crafted Dreadful Gladiator's Ornamented Headcover", "=ds=#s1#, #a4# / =q1=#sk# 600", "=ds="};
				{ 30, "s137786", "93542", "=q3=Crafted Dreadful Gladiator's Ornamented Spaulders", "=ds=#s3#, #a4# / =q1=#sk# 600", "=ds="};
			};
			{
				{ 1, "s137782", "93538", "=q3=Crafted Dreadful Gladiator's Ornamented Chestguard", "=ds=#s5#, #a4# / =q1=#sk# 600", "=ds="};
				{ 2, "s137783", "93539", "=q3=Crafted Dreadful Gladiator's Ornamented Gloves", "=ds=#s9#, #a4# / =q1=#sk# 600", "=ds="};
				{ 3, "s137785", "93541", "=q3=Crafted Dreadful Gladiator's Ornamented Legplates", "=ds=#s11#, #a4# / =q1=#sk# 600", "=ds="};
				{ 4, "s137795", "93622", "=q3=Crafted Dreadful Gladiator's Plate Helm", "=ds=#s1#, #a4# / =q1=#sk# 600", "=ds="};
				{ 5, "s137797", "93624", "=q3=Crafted Dreadful Gladiator's Plate Shoulders", "=ds=#s3#, #a4# / =q1=#sk# 600", "=ds="};
				{ 6, "s137793", "93620", "=q3=Crafted Dreadful Gladiator's Plate Chestpiece", "=ds=#s5#, #a4# / =q1=#sk# 600", "=ds="};
				{ 7, "s137794", "93621", "=q3=Crafted Dreadful Gladiator's Plate Gauntlets", "=ds=#s9#, #a4# / =q1=#sk# 600", "=ds="};
				{ 8, "s137796", "93623", "=q3=Crafted Dreadful Gladiator's Plate Legguards", "=ds=#s11#, #a4# / =q1=#sk# 600", "=ds="};
				{ 9, "s137792", "93548", "=q3=Crafted Dreadful Gladiator's Armplates of Alacrity", "=ds=#s8#, #a4# / =q1=#sk# 600", "=ds="};
				{ 10, "s137791", "93547", "=q3=Crafted Dreadful Gladiator's Armplates of Proficiency", "=ds=#s8#, #a4# / =q1=#sk# 600", "=ds="};
				{ 11, "s137781", "93537", "=q3=Crafted Dreadful Gladiator's Bracers of Meditation", "=ds=#s8#, #a4# / =q1=#sk# 600", "=ds="};
				{ 12, "s137780", "93536", "=q3=Crafted Dreadful Gladiator's Bracers of Prowess", "=ds=#s8#, #a4# / =q1=#sk# 600", "=ds="};
				{ 13, "s137776", "93532", "=q3=Crafted Dreadful Gladiator's Clasp of Cruelty", "=ds=#s10#, #a4# / =q1=#sk# 600", "=ds="};
				{ 14, "s137777", "93533", "=q3=Crafted Dreadful Gladiator's Clasp of Meditation", "=ds=#s10#, #a4# / =q1=#sk# 600", "=ds="};
				{ 15, "s137787", "93543", "=q3=Crafted Dreadful Gladiator's Girdle of Accuracy", "=ds=#s10#, #a4# / =q1=#sk# 600", "=ds="};
				{ 16, "s137788", "93544", "=q3=Crafted Dreadful Gladiator's Girdle of Prowess", "=ds=#s10#, #a4# / =q1=#sk# 600", "=ds="};
				{ 17, "s137778", "93534", "=q3=Crafted Dreadful Gladiator's Greaves of Alacrity", "=ds=#s12#, #a4# / =q1=#sk# 600", "=ds="};
				{ 18, "s137779", "93535", "=q3=Crafted Dreadful Gladiator's Greaves of Meditation", "=ds=#s12#, #a4# / =q1=#sk# 600", "=ds="};
				{ 19, "s137790", "93546", "=q3=Crafted Dreadful Gladiator's Warboots of Alacrity", "=ds=#s12#, #a4# / =q1=#sk# 600", "=ds="};
				{ 20, "s137789", "93545", "=q3=Crafted Dreadful Gladiator's Warboots of Cruelty", "=ds=#s12#, #a4# / =q1=#sk# 600", "=ds="};
	...
	AtlasLoot_Data["SmithingWeaponMoP"] = {
		["Normal"] = {
			{
				{ 1, "s138892", "94591", "=q3=Blazefury, Reborn", "=ds=#h1#, #w10# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 2, "s138890", "94589", "=q3=Blazeguard, Reborn", "=ds=#h1#, #w10# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 3, "s138888", "94587", "=q3=Fireguard, Reborn", "=ds=#h1#, #w10# / =ds=#sr# 600", "=ds=#QUESTID:32621#"};
				{ 4, "s138881", "94580", "=q3=Bloodmoon, Reborn", "=ds=#h2#, #w1# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 5, "s138879", "94578", "=q3=Mooncleaver, Reborn", "=ds=#h2#, #w1# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 6, "s138877", "94576", "=q3=Lunar Crescent, Reborn", "=ds=#h2#, #w1# / =ds=#sr# 600", "=ds=#QUESTID:32621#"};
				{ 7, "s138886", "94585", "=q3=Dragonstrike, Reborn", "=ds=#h1#, #w6# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 8, "s138885", "94584", "=q3=Dragonmaw, Reborn", "=ds=#h1#, #w6# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 9, "s138882", "94581", "=q3=Drakefist Hammer, Reborn", "=ds=#h1#, #w6# / =ds=#sr# 600", "=ds=#QUESTID:32621#"};
				{ 10, "s138893", "94592", "=q3=Lionheart Executioner, Reborn", "=ds=#h2#, #w10# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 11, "s138891", "94590", "=q3=Lionheart Champion, Reborn", "=ds=#h2#, #w10# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 12, "s138889", "94588", "=q3=Lionheart Blade, Reborn", "=ds=#h2#, #w10# / =ds=#sr# 600", "=ds=#QUESTID:32621#"};
				{ 13, "s138887", "94586", "=q3=Stormherald, Reborn", "=ds=#h2#, #w6# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 14, "s138884", "94583", "=q3=Deep Thunder, Reborn", "=ds=#h2#, #w6# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 15, "s138883", "94582", "=q3=Thunder, Reborn", "=ds=#h2#, #w6# / =ds=#sr# 600", "=ds=#QUESTID:32621#"};
				{ 16, "s138880", "94579", "=q3=Wicked Edge of the Planes, Reborn", "=ds=#h1#, #w1# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 17, "s138878", "94577", "=q3=Black Planar Edge, Reborn", "=ds=#h1#, #w1# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 18, "s138876", "94575", "=q3=The Planar Edge, Reborn", "=ds=#h1#, #w1# / =ds=#sr# 600", "=ds=#QUESTID:32621#"};
	...
	AtlasLoot_Data["SmithingTrainingProjects"] = {
		["Normal"] = {
			{
				{ 1, "s140168", "95486", "=q0=Training Project: Ghost Iron Statue", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 2, "s140167", "95485", "=q0=Training Project: Ghost Iron Pans", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 3, "s140166", "95484", "=q0=Training Project: Ghost Iron Frames", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 4, "s140165", "95483", "=q0=Training Project: Ghost Iron Picks", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 5, "s139764", "95370", "=q0=Training Project: Ghost Iron Crate", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 6, "s139763", "95369", "=q0=Training Project: Ghost Iron Bells", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 7, "s139762", "95368", "=q0=Training Project: Ghost Iron Bowls", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 8, "s139761", "95367", "=q0=Training Project: Ghost Iron Cups", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 9, "s139760", "95366", "=q0=Training Project: Ghost Iron Pot", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 10, "s139759", "95365", "=q0=Training Project: Ghost Iron Wire", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 11, "s139757", "95364", "=q0=Training Project: Ghost Iron Saw", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 12, "s139756", "95363", "=q0=Training Project: Ghost Iron Barrel", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 13, "s139755", "95362", "=q0=Training Project: Ghost Iron Needles", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 14, "s139754", "95361", "=q0=Training Project: Ghost Iron Spade", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 15, "s139753", "95359", "=q0=Training Project: Decorative Spoons", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 16, "s139751", "95358", "=q0=Training Project: Ghost Iron Spatulas", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 17, "s139750", "95357", "=q0=Training Project: Ghost Iron Hook", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 18, "s139749", "95356", "=q0=Training Project: Ghost Iron Poker", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 19, "s139748", "95355", "=q0=Training Project: Ghost Iron Ladle", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 20, "s139747", "95354", "=q0=Training Project: Ghost Iron Wok", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 21, "s139746", "95353", "=q0=Training Project: Simple Eating Utensils", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
				{ 22, "s139745", "95351", "=q0=Training Project: Ghost Iron Pins", "=ds=#sr# ??", "=ds="..AL["Trainer"]};
			};
		};
		info = {
	...
	AtlasLoot_Data["SmithingMisc"] = {
		["Normal"] = {
			{
				{ 1, "s138646", "94111", "=q3=Lightning Steel Ingot", "=ds=#sr# 600", "=ds=#QUESTID:32621#"};
				{ 2, "s126869", "80431", "=q1=Folded Ghost Iron", "=ds=#sr# 525", "=ds="..AL["Trainer"]};
		...
		["Normal"] = {
			{
				...
				{ 2, "s139197", "92747", "=q3=Advanced Refrigeration Unit", "=ds=#sr# 600", "=ds=#QUESTID:32630#"};
				...
				{ 5, "s84430", "68049", "=q1=Heat-Treated Spinning Lure", "=ds=#sr# 510", "=ds="..AL["Trainer"]};
				...
				{ 15, "s56477", "42546", "=q1=Mana Injector Kit", "=ds=#sr# 415", "=ds="..AL["Trainer"]};
				{ 16, "s55252", "40769", "=q1=Scrapbot Construction Kit", "=ds=#sr# 415", "=ds=#QUESTID:12889#"};
				{ 17, "s67920", "48933", "=q3=Wormhole Generator: Northrend", "=ds=#sr# 415", "=ds="..AL["Trainer"]};
				{ 18, "s56476", "37567", "=q1=Healing Injector Kit", "=ds=#sr# 410", "=ds="..AL["Trainer"]};
				...
				{ 23, "s44391", "34113", "=q1=Field Repair Bot 110G", "=ds=#sr# 360", "=ds="..AL["Drop"]};
				...
				{ 26, "s30552", "33093", "=q1=Mana Potion Injector", "=ds=#sr# 345", "=ds="..AL["Drop"]};
				{ 27, "s30551", "33092", "=q1=Healing Potion Injector", "=ds=#sr# 330", "=ds="..AL["Drop"]};
				{ 28, "s30337", "23767", "=q2=Crashin' Thrashin' Robot", "=ds=#sr# 325", "=ds="..AL["Drop"]};
				{ 29, "s30348", "23774", "=q2=Fel Iron Toolbox", "=ds=#sr# 325", "=ds="..AL["Vendor"]};
				{ 30, "s30568", "23841", "=q1=Gnomish Flame Turret", "=ds=#sr# 325", "=ds="..AL["Trainer"]};
			};
			{
				{ 1, "s30548", "23821", "=q1=Zapthrottle Mote Extractor", "=ds=#sr# 305", "=ds="..BabbleInventory["Quest"]};
				{ 2, "s22704", "18232", "=q1=Field Repair Bot 74A", "=ds=#sr# 300", "=ds="..BabbleZone["Blackrock Depths"]};
				{ 3, "s19814", "16023", "=q1=Masterwork Target Dummy", "=ds=#sr# 275", "=ds="..AL["Vendor"]};
				{ 4, "s28327", "22728", "=q1=Steam Tonk Controller", "=ds=#sr# 275", "=ds="..BabbleFaction["Darkmoon Faire"]};
				{ 5, "s23096", "18645", "=q2=Gnomish Alarm-O-Bot", "=ds=#sr# 265", "=ds="..BabbleZone["Blackrock Depths"]};
				{ 6, "s23078", "18587", "=q1=Goblin Jumper Cables XL", "=ds=#sr# 265", "=ds="..BabbleZone["Blackrock Depths"]};
				...
				{ 17, "s3959", "4388", "=q1=Discombobulator Ray", "=ds=#sr# 160", "=ds="..BabbleZone["Gnomeregan"]};
				{ 18, "s3957", "4386", "=q1=Ice Deflector", "=ds=#sr# 155", "=ds=???"}; --schematic removed with Cata
				{ 19, "s9271", "6533", "=q1=Aquadynamic Fish Attractor", "=ds=#sr# 150", "=ds="..AL["Trainer"]};
				{ 20, "s6458", "5507", "=q1=Ornate Spyglass", "=ds=#sr# 135", "=ds="..AL["Trainer"]};
				{ 21, "s3944", "4376", "=q1=Flame Deflector", "=ds=#sr# 125", "=ds="..BabbleZone["Gnomeregan"]};
	...
	AtlasLoot_Data["EngineeringReagents"] = {
		["Normal"] = {
			{
				{ 1, "s139176", "94113", "=q3=Stabilized Lightning Source", "=ds=#sr# 600", "=ds=#QUESTID:32630#"};
				{ 2, "s127113", "77467", "=q1=Ghost Iron Bolts", "=ds=#sr# 500", "=ds="..AL["Trainer"]};
				{ 3, "s127114", "77468", "=q1=High-Explosive Gunpowder", "=ds=#sr# 500", "=ds="..AL["Trainer"]};
				{ 4, "s94748", "67749", "=q1=Electrified Ether", "=ds=#sr# 445", "=ds="..AL["Trainer"]};
				{ 5, "s84403", "60224", "=q1=Handful of Obsidium Bolts", "=ds=#sr# 425", "=ds="..AL["Trainer"]};
				{ 6, "s56471", "39683", "=q1=Froststeel Tube", "=ds=#sr# 390", "=ds="..AL["Trainer"]};
				{ 7, "s56464", "39682", "=q1=Overcharged Capacitor", "=ds=#sr# 375", "=ds="..AL["Trainer"]};
				{ 8, "s56349", "39681", "=q1=Handful of Cobalt Bolts", "=ds=#sr# 350", "=ds="..AL["Trainer"]};
				{ 9, "s53281", "39690", "=q1=Volatile Blasting Trigger", "=ds=#sr# 350", "=ds="..AL["Trainer"]};
				...
				{ 13, "s39971", "32423", "=q1=Icy Blasting Primers", "=ds=#sr# 335", "=ds="..AL["Trainer"]};
				...
				{ 16, "s30303", "23781", "=q1=Elemental Blasting Powder", "=ds=#sr# 300", "=ds="..AL["Trainer"]};
				...
				{ 20, "s39895", "7191", "=q1=Fused Wiring", "=ds=#sr# 275", "=ds="..AL["Vendor"]};
			...
			{
				{ 1, "s12584", "10558", "=q1=Gold Power Core", "=ds=#sr# 150", "=ds="..AL["Trainer"]};
	...
	AtlasLoot_Data["EngineeringPetMount"] = {
		["Normal"] = {
			{
				{ 1, "s139196", "94903", "=q1=Pierre", "=ds=#sr# 600", "=ds=#QUESTID:32630#"};
				{ 2, "s127135", "87526", "=q3=Mechanical Pandaren Dragonling", "=ds=#sr# 575", "=ds="..AL["Trainer"] };
				{ 3, "s84413", "60216", "=q3=De-Weaponized Mechanical Companion", "=ds=#sr# 475", "=ds="..AL["Trainer"].. ", #p17#" };
				{ 4, "s84412", "59597", "=q3=Personal World Destroyer", "=ds=#sr# 475", "=ds="..AL["Trainer"].. ", #p18#"};
				{ 5, "s19793", "15996", "=q1=Lifelike Mechanical Toad", "=ds=#sr# 265", "=ds="..AL["World Drop"] };
				{ 6, "s26011", "21277", "=q1=Tranquil Mechanical Yeti", "=ds=#sr# 250", "=ds="..AL["Quest Reward"] };
				{ 7, "s15633", "11826", "=q1=Lil' Smoky", "=ds=#sr# 205", "=ds="..BabbleZone["Gnomeregan"] };
				{ 8, "s15628", "11825", "=q1=Pet Bombling", "=ds=#sr# 205", "=ds="..BabbleZone["Gnomeregan"] };
				{ 9, "s3928", "4401", "=q1=Mechanical Squirrel Box", "=ds=#sr# 75", "=ds="..AL["World Drop"] };
				{ 16, "s139192", "95416", "=q4=Sky Claw", "=ds=#sr# 600", "=ds=#QUESTID:32630#"};
				...
				{ 19, "s60866", "41508", "=q4=Mechano-Hog", "=ds=#sr# 450", "=ds="..BabbleFaction["Horde Expedition"].." - "..BabbleFaction["Exalted"] };
				{ 20, "s60867", "44413", "=q4=Mekgineer's Chopper", "=ds=#sr# 450", "=ds="..BabbleFaction["Alliance Vanguard"].." - "..BabbleFaction["Exalted"] };
		...
		["Normal"] = {
			{
				...
				{ 11, "s57014", "42917", "=q1=Glyph of Solace", "=ds=#sr# 385", "=ds="..GetSpellInfo(61177) };
				{ 12, "s56996", "42899", "=q1=Glyph of Liberation", "=ds=#sr# 385", "=ds="..GetSpellInfo(61177) };
				{ 13, "s57012", "42915", "=q1=Glyph of Mend Pet", "=ds=#sr# 385", "=ds="..GetSpellInfo(61177) };
		...
		["Normal"] = {
			{
				...
				{ 20, "s136274", "93409", "=q4=Assassin's Serpent's Eye", "=ds=#sr# 575", "=ds="..AL["Trainer"] };
				{ 21, "s136270", "93405", "=q4=Lucent Serpent's Eye", "=ds=#sr# 575", "=ds="..AL["Trainer"] };
				{ 22, "s136275", "93410", "=q4=Mysterious Serpent's Eye", "=ds=#sr# 575", "=ds="..AL["Trainer"] };
				{ 23, "s136269", "93404", "=q4=Resplendent Serpent's Eye", "=ds=#sr# 575", "=ds="..AL["Trainer"] };
				{ 24, "s136273", "93408", "=q4=Tense Serpent's Eye", "=ds=#sr# 575", "=ds="..AL["Trainer"] };
				{ 25, "s136272", "93406", "=q4=Willful Serpent's Eye", "=ds=#sr# 575", "=ds="..AL["Trainer"] };
				{ 27, 76734, "", "=q3=Serpent's Eye", "=ds=#e8#", "#SPIRITOFHARMONY:1#"..AL["Vendor"] };
			};
		};
		info = {
		...
		["Normal"] = {
			{
				...
				{ 11, "s140060", "76132", "=q3=Primal Diamond", "=ds=#sr# 500", "=ds=" };
				{ 12, "s140050", "95469", "=q3=Serpent's Heart", "=ds=#sr# 500", "=ds=" };
	...
	AtlasLoot_Data["LeatherLeatherArmorMoP"] = {
		["Normal"] = {
			{
				{ 1, "s138590", "94270", "=q4=Quilen Hide Helm", "=ds=#s1#, #a2# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 2, "s138594", "94274", "=q4=Spirit Keeper Helm", "=ds=#s1#, #a2# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 3, "s138589", "94269", "=q4=Quilen Hide Boots", "=ds=#s12#, #a2# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 4, "s138593", "94273", "=q4=Spirit Keeper Footguards", "=ds=#s12#, #a2# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				...
				{ 13, "s137826", "93476", "=q3=Crafted Dreadful Gladiator's Wyrmhide Helm", "=ds=#s1#, #a2# / =q1=#sk# 600", "=ds="};
				{ 14, "s137829", "93479", "=q3=Crafted Dreadful Gladiator's Wyrmhide Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 600", "=ds="};
				{ 15, "s137828", "93478", "=q3=Crafted Dreadful Gladiator's Wyrmhide Robes", "=ds=#s5#, #a2# / =q1=#sk# 600", "=ds="};
				{ 16, "s137825", "93475", "=q3=Crafted Dreadful Gladiator's Wyrmhide Gloves", "=ds=#s9#, #a2# / =q1=#sk# 600", "=ds="};
				{ 17, "s137827", "93477", "=q3=Crafted Dreadful Gladiator's Wyrmhide Legguards", "=ds=#s11#, #a2# / =q1=#sk# 600", "=ds="};
				{ 18, "s137810", "93459", "=q3=Crafted Dreadful Gladiator's Dragonhide Helm", "=ds=#s1#, #a2# / =q1=#sk# 600", "=ds="};
				{ 19, "s137813", "93462", "=q3=Crafted Dreadful Gladiator's Dragonhide Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 600", "=ds="};
				{ 20, "s137812", "93461", "=q3=Crafted Dreadful Gladiator's Dragonhide Robes", "=ds=#s5#, #a2# / =q1=#sk# 600", "=ds="};
				{ 21, "s137809", "93458", "=q3=Crafted Dreadful Gladiator's Dragonhide Gloves", "=ds=#s9#, #a2# / =q1=#sk# 600", "=ds="};
				{ 22, "s137811", "93460", "=q3=Crafted Dreadful Gladiator's Dragonhide Legguards", "=ds=#s11#, #a2# / =q1=#sk# 600", "=ds="};
				{ 23, "s137818", "93467", "=q3=Crafted Dreadful Gladiator's Kodohide Helm", "=ds=#s1#, #a2# / =q1=#sk# 600", "=ds="};
				{ 24, "s137821", "93470", "=q3=Crafted Dreadful Gladiator's Kodohide Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 600", "=ds="};
				{ 25, "s137820", "93469", "=q3=Crafted Dreadful Gladiator's Kodohide Robes", "=ds=#s5#, #a2# / =q1=#sk# 600", "=ds="};
				{ 26, "s137817", "93466", "=q3=Crafted Dreadful Gladiator's Kodohide Gloves", "=ds=#s9#, #a2# / =q1=#sk# 600", "=ds="};
				{ 27, "s137819", "93468", "=q3=Crafted Dreadful Gladiator's Kodohide Legguards", "=ds=#s11#, #a2# / =q1=#sk# 600", "=ds="};
				{ 28, "s137839", "93519", "=q3=Crafted Dreadful Gladiator's Copperskin Helm", "=ds=#s1#, #a2# / =q1=#sk# 600", "=ds="};
				{ 29, "s137841", "93523", "=q3=Crafted Dreadful Gladiator's Copperskin Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 600", "=ds="};
				{ 30, "s137842", "93525", "=q3=Crafted Dreadful Gladiator's Copperskin Tunic", "=ds=#s5#, #a2# / =q1=#sk# 600", "=ds="};
			};
			{
				{ 1, "s137838", "93517", "=q3=Crafted Dreadful Gladiator's Copperskin Gloves", "=ds=#s9#, #a2# / =q1=#sk# 600", "=ds="};
				{ 2, "s137840", "93521", "=q3=Crafted Dreadful Gladiator's Copperskin Legguards", "=ds=#s11#, #a2# / =q1=#sk# 600", "=ds="};
				{ 3, "s137834", "93509", "=q3=Crafted Dreadful Gladiator's Ironskin Helm", "=ds=#s1#, #a2# / =q1=#sk# 600", "=ds="};
				{ 4, "s137836", "93513", "=q3=Crafted Dreadful Gladiator's Ironskin Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 600", "=ds="};
				{ 5, "s137837", "93515", "=q3=Crafted Dreadful Gladiator's Ironskin Tunic", "=ds=#s5#, #a2# / =q1=#sk# 600", "=ds="};
				{ 6, "s137833", "93507", "=q3=Crafted Dreadful Gladiator's Ironskin Gloves", "=ds=#s9#, #a2# / =q1=#sk# 600", "=ds="};
				{ 7, "s137835", "93511", "=q3=Crafted Dreadful Gladiator's Ironskin Legguards", "=ds=#s11#, #a2# / =q1=#sk# 600", "=ds="};
				{ 8, "s137848", "93571", "=q3=Crafted Dreadful Gladiator's Leather Helm", "=ds=#s1#, #a2# / =q1=#sk# 600", "=ds="};
				{ 9, "s137850", "93573", "=q3=Crafted Dreadful Gladiator's Leather Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 600", "=ds="};
				{ 10, "s137846", "93569", "=q3=Crafted Dreadful Gladiator's Leather Tunic", "=ds=#s5#, #a2# / =q1=#sk# 600", "=ds="};
				{ 11, "s137847", "93570", "=q3=Crafted Dreadful Gladiator's Leather Gloves", "=ds=#s9#, #a2# / =q1=#sk# 600", "=ds="};
				{ 12, "s137849", "93572", "=q3=Crafted Dreadful Gladiator's Leather Legguards", "=ds=#s11#, #a2# / =q1=#sk# 600", "=ds="};
				{ 13, "s137832", "93506", "=q3=Crafted Dreadful Gladiator's Armwraps of Accuracy", "=ds=#s8#, #a2# / =q1=#sk# 600", "=ds="};
				{ 14, "s137845", "93568", "=q3=Crafted Dreadful Gladiator's Armwraps of Alacrity", "=ds=#s8#, #a2# / =q1=#sk# 600", "=ds="};
				{ 15, "s137816", "93506", "=q3=Crafted Dreadful Gladiator's Bindings of Meditation", "=ds=#s8#, #a2# / =q1=#sk# 600", "=ds="};
				{ 16, "s137824", "93474", "=q3=Crafted Dreadful Gladiator's Bindings of Prowess", "=ds=#s8#, #a2# / =q1=#sk# 600", "=ds="};
				{ 17, "s137822", "93472", "=q3=Crafted Dreadful Gladiator's Belt of Cruelty", "=ds=#s10#, #a2# / =q1=#sk# 600", "=ds="};
				{ 18, "s137814", "93463", "=q3=Crafted Dreadful Gladiator's Belt of Meditation", "=ds=#s10#, #a2# / =q1=#sk# 600", "=ds="};
				{ 19, "s137843", "93566", "=q3=Crafted Dreadful Gladiator's Waistband of Accuracy", "=ds=#s10#, #a2# / =q1=#sk# 600", "=ds="};
				{ 20, "s137830", "93504", "=q3=Crafted Dreadful Gladiator's Waistband of Cruelty", "=ds=#s10#, #a2# / =q1=#sk# 600", "=ds="};
				{ 21, "s137831", "93505", "=q3=Crafted Dreadful Gladiator's Boots of Alacrity", "=ds=#s12#, #a2# / =q1=#sk# 600", "=ds="};
				{ 22, "s137844", "93567", "=q3=Crafted Dreadful Gladiator's Boots of Cruelty", "=ds=#s12#, #a2# / =q1=#sk# 600", "=ds="};
				{ 23, "s137823", "93473", "=q3=Crafted Dreadful Gladiator's Leather Footguards of Alacrity", "=ds=#s12#, #a2# / =q1=#sk# 600", "=ds="};
				{ 24, "s137815", "93464", "=q3=Crafted Dreadful Gladiator's Leather Footguards of Meditation", "=ds=#s12#, #a2# / =q1=#sk# 600", "=ds="};
	...
	AtlasLoot_Data["LeatherMailArmorMoP"] = {
		["Normal"] = {
			{
				{ 1, "s138596", "94276", "=q4=Cloud Serpent Helm", "=ds=#s1#, #a3# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 2, "s138592", "94272", "=q4=Dreadrunner Helm", "=ds=#s1#, #a3# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 3, "s138595", "94275", "=q4=Cloud Serpent Sabatons", "=ds=#s12#, #a3# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 4, "s138591", "94271", "=q4=Dreadrunner Sabatons", "=ds=#s12#, #a3# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				...
				{ 13, "s137859", "93496", "=q3=Crafted Dreadful Gladiator's Chain Helm", "=ds=#s1#, #a3# / =q1=#sk# 600", "=ds="};
				{ 14, "s137861", "93498", "=q3=Crafted Dreadful Gladiator's Chain Spaulders", "=ds=#s3#, #a3# / =q1=#sk# 600", "=ds="};
				{ 15, "s137857", "93494", "=q3=Crafted Dreadful Gladiator's Chain Armor", "=ds=#s5#, #a3# / =q1=#sk# 600", "=ds="};
				{ 16, "s137858", "93495", "=q3=Crafted Dreadful Gladiator's Chain Gauntlets", "=ds=#s9#, #a3# / =q1=#sk# 600", "=ds="};
				{ 17, "s137860", "93497", "=q3=Crafted Dreadful Gladiator's Chain Leggings", "=ds=#s11#, #a3# / =q1=#sk# 600", "=ds="};
				{ 18, "s137880", "93592", "=q3=Crafted Dreadful Gladiator's Mail Helm", "=ds=#s1#, #a3# / =q1=#sk# 600", "=ds="};
				{ 19, "s137882", "93594", "=q3=Crafted Dreadful Gladiator's Mail Spaulders", "=ds=#s3#, #a3# / =q1=#sk# 600", "=ds="};
				{ 20, "s137878", "93590", "=q3=Crafted Dreadful Gladiator's Mail Armor", "=ds=#s5#, #a3# / =q1=#sk# 600", "=ds="};
				{ 21, "s137879", "93591", "=q3=Crafted Dreadful Gladiator's Mail Gauntlets", "=ds=#s9#, #a3# / =q1=#sk# 600", "=ds="};
				{ 22, "s137881", "93593", "=q3=Crafted Dreadful Gladiator's Mail Leggings", "=ds=#s11#, #a3# / =q1=#sk# 600", "=ds="};
				{ 23, "s137874", "93586", "=q3=Crafted Dreadful Gladiator's Linked Helm", "=ds=#s1#, #a3# / =q1=#sk# 600", "=ds="};
				{ 24, "s137876", "93588", "=q3=Crafted Dreadful Gladiator's Linked Spaulders", "=ds=#s3#, #a3# / =q1=#sk# 600", "=ds="};
				{ 25, "s137872", "93584", "=q3=Crafted Dreadful Gladiator's Linked Armor", "=ds=#s5#, #a3# / =q1=#sk# 600", "=ds="};
				{ 26, "s137873", "93585", "=q3=Crafted Dreadful Gladiator's Linked Gauntlets", "=ds=#s9#, #a3# / =q1=#sk# 600", "=ds="};
				{ 27, "s137875", "93587", "=q3=Crafted Dreadful Gladiator's Linked Leggings", "=ds=#s11#, #a3# / =q1=#sk# 600", "=ds="};
				{ 28, "s137869", "93581", "=q3=Crafted Dreadful Gladiator's Ringmail Helm", "=ds=#s1#, #a3# / =q1=#sk# 600", "=ds="};
				{ 29, "s137871", "93583", "=q3=Crafted Dreadful Gladiator's Ringmail Spaulders", "=ds=#s3#, #a3# / =q1=#sk# 600", "=ds="};
				{ 30, "s137867", "93579", "=q3=Crafted Dreadful Gladiator's Ringmail Armor", "=ds=#s5#, #a3# / =q1=#sk# 600", "=ds="};
			};
			{
				{ 1, "s137868", "93580", "=q3=Crafted Dreadful Gladiator's Ringmail Gauntlets", "=ds=#s9#, #a3# / =q1=#sk# 600", "=ds="};
				{ 2, "s137870", "93582", "=q3=Crafted Dreadful Gladiator's Ringmail Leggings", "=ds=#s11#, #a3# / =q1=#sk# 600", "=ds="};
				{ 3, "s137866", "93578", "=q3=Crafted Dreadful Gladiator's Armbands of Meditation", "=ds=#s8#, #a3# / =q1=#sk# 600", "=ds="};
				{ 4, "s137865", "93577", "=q3=Crafted Dreadful Gladiator's Armbands of Prowess", "=ds=#s8#, #a3# / =q1=#sk# 600", "=ds="};
				{ 5, "s137856", "93493", "=q3=Crafted Dreadful Gladiator's Wristguards of Accuracy", "=ds=#s8#, #a3# / =q1=#sk# 600", "=ds="};
				{ 6, "s137855", "93492", "=q3=Crafted Dreadful Gladiator's Wristguards of Alacrity", "=ds=#s8#, #a3# / =q1=#sk# 600", "=ds="};
				{ 7, "s137852", "93489", "=q3=Crafted Dreadful Gladiator's Links of Accuracy", "=ds=#s10#, #a3# / =q1=#sk# 600", "=ds="};
				{ 8, "s137851", "93488", "=q3=Crafted Dreadful Gladiator's Links of Cruelty", "=ds=#s10#, #a3# / =q1=#sk# 600", "=ds="};
				{ 9, "s137877", "93589", "=q3=Crafted Dreadful Gladiator's Waistguard of Cruelty", "=ds=#s10#, #a3# / =q1=#sk# 600", "=ds="};
				{ 10, "s137862", "93574", "=q3=Crafted Dreadful Gladiator's Waistguard of Meditation", "=ds=#s10#, #a3# / =q1=#sk# 600", "=ds="};
				{ 11, "s137863", "93575", "=q3=Crafted Dreadful Gladiator's Mail Footguards of Alacrity", "=ds=#s12#, #a3# / =q1=#sk# 600", "=ds="};
				{ 12, "s137864", "93576", "=q3=Crafted Dreadful Gladiator's Mail Footguards of Meditation", "=ds=#s12#, #a3# / =q1=#sk# 600", "=ds="};
				{ 13, "s137854", "93491", "=q3=Crafted Dreadful Gladiator's Sabatons of Alacrity", "=ds=#s12#, #a3# / =q1=#sk# 600", "=ds="};
				{ 14, "s137853", "93490", "=q3=Crafted Dreadful Gladiator's Sabatons of Cruelty", "=ds=#s12#, #a3# / =q1=#sk# 600", "=ds="};
		...
		["Normal"] = {
			{
				...
				{ 2, "s140040", "72163", "=q3=Magnificence of Leather", "=ds=#sr# 500", "=ds=" };
				{ 3, "s140041", "72163", "=q3=Magnificence of Scales", "=ds=#sr# 500", "=ds=" };
	...
	AtlasLoot_Data["TailoringArmorMoP"] = {
		["Normal"] = {
			{
				{ 1, "s138598", "94278", "=q4=Falling Blossom Cowl", "=ds=#s1#, #a1# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 2, "s138600", "94280", "=q4=Falling Blossom Hood", "=ds=#s1#, #a1# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 3, "s138599", "94279", "=q4=Falling Blossom Sandals", "=ds=#s12#, #a1# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				{ 4, "s138597", "94277", "=q4=Falling Blossom Treads", "=ds=#s12#, #a1# / =q1=#sk# 600", "=ds="..AL["Drop"]..": "..AtlasLoot:GetMapNameByID(930)};
				...
				{ 13, "s137922", "93500", "=q3=Crafted Dreadful Gladiator's Silk Cowl", "=ds=#s1#, #a1# / =q1=#sk# 600", "=ds="};
				{ 14, "s137925", "93503", "=q3=Crafted Dreadful Gladiator's Silk Amice", "=ds=#s3#, #a1# / =q1=#sk# 600", "=ds="};
				{ 15, "s137924", "93502", "=q3=Crafted Dreadful Gladiator's Silk Robe", "=ds=#s5#, #a1# / =q1=#sk# 600", "=ds="};
				{ 16, "s137921", "93499", "=q3=Crafted Dreadful Gladiator's Silk Handguards", "=ds=#s9#, #a1# / =q1=#sk# 600", "=ds="};
				{ 17, "s137923", "93501", "=q3=Crafted Dreadful Gladiator's Silk Trousers", "=ds=#s11#, #a1# / =q1=#sk# 600", "=ds="};
				{ 18, "s137932", "93556", "=q3=Crafted Dreadful Gladiator's Satin Hood", "=ds=#s1#, #a1# / =q1=#sk# 600", "=ds="};
				{ 19, "s137935", "93559", "=q3=Crafted Dreadful Gladiator's Satin Mantle", "=ds=#s3#, #a1# / =q1=#sk# 600", "=ds="};
				{ 20, "s137934", "93558", "=q3=Crafted Dreadful Gladiator's Satin Robe", "=ds=#s5#, #a1# / =q1=#sk# 600", "=ds="};
				{ 21, "s137931", "93555", "=q3=Crafted Dreadful Gladiator's Satin Gloves", "=ds=#s9#, #a1# / =q1=#sk# 600", "=ds="};
				{ 22, "s137933", "93557", "=q3=Crafted Dreadful Gladiator's Satin Leggings", "=ds=#s11#, #a1# / =q1=#sk# 600", "=ds="};
				{ 23, "s137927", "93551", "=q3=Crafted Dreadful Gladiator's Mooncloth Helm", "=ds=#s1#, #a1# / =q1=#sk# 600", "=ds="};
				{ 24, "s137930", "93554", "=q3=Crafted Dreadful Gladiator's Mooncloth Mantle", "=ds=#s3#, #a1# / =q1=#sk# 600", "=ds="};
				{ 25, "s137929", "93553", "=q3=Crafted Dreadful Gladiator's Mooncloth Robe", "=ds=#s5#, #a1# / =q1=#sk# 600", "=ds="};
				{ 26, "s137926", "93555", "=q3=Crafted Dreadful Gladiator's Mooncloth Gloves", "=ds=#s9#, #a1# / =q1=#sk# 600", "=ds="};
				{ 27, "s137928", "93552", "=q3=Crafted Dreadful Gladiator's Mooncloth Leggings", "=ds=#s11#, #a1# / =q1=#sk# 600", "=ds="};
				{ 28, "s137939", "93616", "=q3=Crafted Dreadful Gladiator's Felweave Cowl", "=ds=#s1#, #a1# / =q1=#sk# 600", "=ds="};
				{ 29, "s137942", "93619", "=q3=Crafted Dreadful Gladiator's Felweave Amice", "=ds=#s3#, #a1# / =q1=#sk# 600", "=ds="};
				{ 30, "s137941", "93618", "=q3=Crafted Dreadful Gladiator's Felweave Raiment", "=ds=#s5#, #a1# / =q1=#sk# 600", "=ds="};
			};
			{
				{ 1, "s137938", "93615", "=q3=Crafted Dreadful Gladiator's Felweave Handguards", "=ds=#s9#, #a1# / =q1=#sk# 600", "=ds="};
				{ 2, "s137940", "93617", "=q3=Crafted Dreadful Gladiator's Felweave Trousers", "=ds=#s11#, #a1# / =q1=#sk# 600", "=ds="};
				{ 3, "s137907", "93420", "=q3=Crafted Dreadful Gladiator's Cape of Cruelty", "=ds=#s4# / =q1=#sk# 600", "=ds="};
				{ 4, "s137908", "93421", "=q3=Crafted Dreadful Gladiator's Cape of Prowess", "=ds=#s4# / =q1=#sk# 600", "=ds="};
				{ 5, "s137936", "93607", "=q3=Crafted Dreadful Gladiator's Cloak of Alacrity", "=ds=#s4# / =q1=#sk# 600", "=ds="};
				{ 6, "s137937", "93608", "=q3=Crafted Dreadful Gladiator's Cloak of Prowess", "=ds=#s4# / =q1=#sk# 600", "=ds="};
				{ 7, "s137918", "93437", "=q3=Crafted Dreadful Gladiator's Drape of Cruelty", "=ds=#s4# / =q1=#sk# 600", "=ds="};
				{ 8, "s137920", "93439", "=q3=Crafted Dreadful Gladiator's Drape of Meditation", "=ds=#s4# / =q1=#sk# 600", "=ds="};
				{ 9, "s137919", "93438", "=q3=Crafted Dreadful Gladiator's Drape of Prowess", "=ds=#s4# / =q1=#sk# 600", "=ds="};
				{ 10, "s137915", "93434", "=q3=Crafted Dreadful Gladiator's Cuffs of Accuracy", "=ds=#s8#, #a1# / =q1=#sk# 600", "=ds="};
				{ 11, "s137917", "93436", "=q3=Crafted Dreadful Gladiator's Cuffs of Meditation", "=ds=#s8#, #a1# / =q1=#sk# 600", "=ds="};
				{ 12, "s137916", "93435", "=q3=Crafted Dreadful Gladiator's Cuffs of Prowess", "=ds=#s8#, #a1# / =q1=#sk# 600", "=ds="};
				{ 13, "s137910", "93429", "=q3=Crafted Dreadful Gladiator's Cord of Accuracy", "=ds=#s10#, #a1# / =q1=#sk# 600", "=ds="};
				{ 14, "s137909", "93428", "=q3=Crafted Dreadful Gladiator's Cord of Cruelty", "=ds=#s10#, #a1# / =q1=#sk# 600", "=ds="};
				{ 15, "s137911", "93430", "=q3=Crafted Dreadful Gladiator's Cord of Meditation", "=ds=#s10#, #a1# / =q1=#sk# 600", "=ds="};
				{ 16, "s137913", "93432", "=q3=Crafted Dreadful Gladiator's Treads of Alacrity", "=ds=#s12#, #a1# / =q1=#sk# 600", "=ds="};
				{ 17, "s137912", "93431", "=q3=Crafted Dreadful Gladiator's Treads of Cruelty", "=ds=#s12#, #a1# / =q1=#sk# 600", "=ds="};
				{ 18, "s137914", "93433", "=q3=Crafted Dreadful Gladiator's Treads of Meditation", "=ds=#s12#, #a1# / =q1=#sk# 600", "=ds="};
