...
---- Jewelcrafting Daily
	...
	AtlasLoot_Data["EngineeringReagents"] = {
		["Normal"] = {
			{
				{ 1, "s127113", "77467", "=q1=Ghost Iron Bolts", "=ds=#sr# 500", "=ds="..AL["Trainer"], amount = 2};
				{ 2, "s127114", "77468", "=q1=High-Explosive Gunpowder", "=ds=#sr# 500", "=ds="..AL["Trainer"], amount = 2};
				...
				{ 8, "s53281", "39690", "=q1=Volatile Blasting Trigger", "=ds=#sr# 350", "=ds="..AL["Trainer"], amount = 2};
				...
				{ 12, "s39971", "32423", "=q1=Icy Blasting Primers", "=ds=#sr# 335", "=ds="..AL["Trainer"], amount = 10};
				...
				{ 15, "s30303", "23781", "=q1=Elemental Blasting Powder", "=ds=#sr# 300", "=ds="..AL["Trainer"], amount = 4};
				...
				{ 19, "s39895", "7191", "=q1=Fused Wiring", "=ds=#sr# 275", "=ds="..AL["Vendor"], amount = 5};
				...
				{ 30, "s12584", "10558", "=q1=Gold Power Core", "=ds=#sr# 150", "=ds="..AL["Trainer"], amount = 3};
			};
			{
		...
		["Normal"] = {
			{
				...
				{ 5, "s30344", "23771", "=q1=Green Smoke Flare", "=ds=#sr# 335", "=ds="..AL["Vendor"], amount = 3};
				{ 6, "s32814", "25886", "=q1=Purple Smoke Flare", "=ds=#sr# 335", "=ds="..AL["World Drop"], amount = 3};
				{ 7, "s30341", "23768", "=q1=White Smoke Flare", "=ds=#sr# 335", "=ds="..AL["Vendor"], amount = 3};
				{ 9, "s26443", "21570", "=q1=Cluster Launcher", "=ds=#sr# 275", "=ds="..AL["Lunar Festival"], amount = 2};
				{ 10, "s26426", "21714", "=q1=Large Blue Rocket Cluster", "=ds=#sr# 275", "=ds="..AL["Lunar Festival"], amount = 3};
				{ 11, "s26427", "21716", "=q1=Large Green Rocket Cluster", "=ds=#sr# 275", "=ds="..AL["Lunar Festival"], amount = 3};
				{ 12, "s26428", "21718", "=q1=Large Red Rocket Cluster", "=ds=#sr# 275", "=ds="..AL["Lunar Festival"], amount = 3};
				{ 14, "s23507", "19026", "=q1=Snake Burst Firework", "=ds=#sr# 250", "=ds="..AL["Vendor"], amount = 4};
