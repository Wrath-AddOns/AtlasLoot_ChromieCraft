...
---- Jewelcrafting Daily
	...
	AtlasLoot_Data["SmithingWeaponMoP"] = {
		["Normal"] = {
			{
				{ 1, "s138892", "94591", "=q4=Blazefury, Reborn", "=ds=#h1#, #w10# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 2, "s138881", "94580", "=q4=Bloodmoon, Reborn", "=ds=#h2#, #w1# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 3, "s138886", "94585", "=q4=Dragonstrike, Reborn", "=ds=#h1#, #w6# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 4, "s138893", "94592", "=q4=Lionheart Executioner, Reborn", "=ds=#h2#, #w10# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 5, "s138887", "94586", "=q4=Stormherald, Reborn", "=ds=#h2#, #w6# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 6, "s138880", "94579", "=q4=Wicked Edge of the Planes, Reborn", "=ds=#h1#, #w1# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 7, "s138878", "94577", "=q4=Black Planar Edge, Reborn", "=ds=#h1#, #w1# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 8, "s138890", "94589", "=q4=Blazeguard, Reborn", "=ds=#h1#, #w10# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 9, "s138884", "94583", "=q4=Deep Thunder, Reborn", "=ds=#h2#, #w6# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 10, "s138885", "94584", "=q4=Dragonmaw, Reborn", "=ds=#h1#, #w6# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 11, "s138891", "94590", "=q4=Lionheart Champion, Reborn", "=ds=#h2#, #w10# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 12, "s138879", "94578", "=q4=Mooncleaver, Reborn", "=ds=#h2#, #w1# / =ds=#sr# 600", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
