		...
		["Normal"] = {
			{
				...
				{ 9, "s73495", "52308", "=q2=Hessonite Band", "=ds="};
				{ 10, "s73494", "52306", "=q2=Jasper Ring", "=ds=#sr# 425"};
				{ 11, "s56497", "42643", "=q4=Titanium Earthguard Ring", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 12, "s56496", "42642", "=q4=Titanium Impact Band", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 13, "s56498", "42644", "=q4=Titanium Spellshock Ring", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 14, "s58954", "43582", "=q4=Titanium Frostguard Ring", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 15, "s38503", "31398", "=q4=The Frozen Eye", "=ds=#sr# 375"};
				{ 16, "s38504", "31399", "=q4=The Natural Ward", "=ds=#sr# 375"};
				{ 17, "s46124", "34361", "=q4=Hard Khorium Band", "=ds=#sr# 365"};
				{ 18, "s46122", "34362", "=q4=Loop of Forged Power", "=ds=#sr# 365"};
				{ 19, "s46123", "34363", "=q4=Ring of Flowing Life", "=ds=#sr# 365"};
				{ 20, "s64727", "45808", "=q3=Runed Mana Band", "=ds="};
				{ 21, "s64728", "45809", "=q3=Scarlet Signet", "=ds="};
				{ 22, "s58147", "43250", "=q3=Ring of Earthen Might", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 23, "s58150", "43253", "=q3=Ring of Northern Tears", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 24, "s58148", "43251", "=q3=Ring of Scarlet Shadows", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 25, "s58507", "43498", "=q3=Savage Titanium Band", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 26, "s58492", "43482", "=q3=Savage Titanium Ring", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 27, "s58149", "43252", "=q3=Windfire Band", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 28, "s56197", "42340", "=q3=Dream Signet", "=ds="..AL["Trainer"] };
				{ 29, "s58143", "43246", "=q3=Earthshadow Ring", "=ds="..AL["Trainer"] };
				{ 30, "s58144", "43247", "=q3=Jade Ring of Slaying", "=ds="..AL["Trainer"] };
			};
			{
		...
		["Normal"] = {
			{
				...
				{ 8, "s73497", "52309", "=q2=Nightstone Choker", "=ds="};
				{ 9, "s73496", "52307", "=q2=Alicite Pendant", "=ds=#sr# 435"};
				{ 10, "s56500", "42646", "=q4=Titanium Earthguard Chain", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 11, "s56499", "42645", "=q4=Titanium Impact Choker", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 12, "s56501", "42647", "=q4=Titanium Spellshock Necklace", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 13, "s46126", "34360", "=q4=Amulet of Flowing Life", "=ds=#sr# 365"};
				{ 14, "s46127", "34358", "=q4=Hard Khorium Choker", "=ds=#sr# 365"};
				{ 15, "s46125", "34359", "=q4=Pendant of Sunfire", "=ds=#sr# 365"};
				{ 16, "s64725", "45812", "=q3=Emerald Choker", "=ds="};
				{ 17, "s64726", "45813", "=q3=Sky Sapphire Amulet", "=ds="};
				{ 18, "s56196", "42339", "=q3=Blood Sun Necklace", "=ds="..AL["Trainer"] };
				{ 19, "s56195", "42338", "=q3=Jade Dagger Pendant", "=ds="..AL["Trainer"] };
				{ 20, "s31076", "24121", "=q3=Chain of the Twilight Owl", "=ds=#sr# 365"};
				{ 21, "s31072", "24117", "=q3=Embrace of the Dawn", "=ds=#sr# 365"};
				{ 22, "s31070", "24114", "=q3=Braided Eternium Chain", "=ds=#sr# 360"};
				{ 23, "s31071", "24116", "=q3=Eye of the Night", "=ds=#sr# 360"};
				{ 24, "s31062", "24092", "=q3=Pendant of Frozen Flame", "=ds=#sr# 360"};
				{ 25, "s31065", "24097", "=q3=Pendant of Shadow's End", "=ds=#sr# 360"};
				{ 26, "s31063", "24093", "=q3=Pendant of Thawing", "=ds=#sr# 360"};
				{ 27, "s31066", "24098", "=q3=Pendant of the Null Rune", "=ds=#sr# 360"};
				{ 28, "s31064", "24095", "=q3=Pendant of Withering", "=ds=#sr# 360"};
				{ 29, "s31068", "24110", "=q3=Living Ruby Pendant", "=ds=#sr# 355"};
				{ 30, "s31067", "24106", "=q3=Thick Felsteel Necklace", "=ds=#sr# 355"};
			};
			{
				{ 1, "s40514", "32508", "=q3=Necklace of the Deep", "=ds=#sr# 340"};
				{ 2, "s26915", "21792", "=q3=Necklace of the Diamond Tower", "=ds=#sr# 305"};
				{ 3, "s26911", "21791", "=q3=Living Emerald Pendant", "=ds=#sr# 290"};
				{ 4, "s26897", "21766", "=q3=Opal Necklace of Impact", "=ds=#sr# 250"};
				{ 5, "s63743", "45627", "=q3=Amulet of Truesight", "=ds="};
				{ 6, "s58142", "43245", "=q2=Crystal Chalcedony Amulet", "=ds="..AL["Trainer"] };
				{ 7, "s58141", "43244", "=q2=Crystal Citrine Necklace", "=ds="..AL["Trainer"] };
				{ 8, "s31051", "24077", "=q2=Thick Adamantite Necklace", "=ds=#sr# 335"};
				{ 9, "s26908", "21790", "=q2=Sapphire Pendant of Winter Night", "=ds=#sr# 280"};
				{ 10, "s26883", "21764", "=q2=Ruby Pendant of Fire", "=ds=#sr# 235"};
				{ 11, "s26876", "21755", "=q2=Aquamarine Pendant of the Warrior", "=ds=#sr# 220"};
				{ 12, "s25622", "20967", "=q2=Citrine Pendant of Golden Healing", "=ds=#sr# 190"};
				{ 13, "s25618", "20966", "=q2=Jade Pendant of Blasting", "=ds=#sr# 160"};
				{ 14, "s25320", "20831", "=q2=Heavy Golden Necklace of Battle", "=ds=#sr# 150"};
				{ 15, "s25610", "20950", "=q2=Pendant of the Agate Shield", "=ds=#sr# 120"};
				{ 16, "s25339", "20830", "=q2=Amulet of the Moon", "=ds=#sr# 110"};
				{ 17, "s25498", "20909", "=q2=Barbaric Iron Collar", "=ds=#sr# 110"};
				{ 18, "s38175", "31154", "=q2=Bronze Torc", "=ds=#sr# 80"};
				{ 19, "s36523", "30419", "=q2=Brilliant Necklace", "=ds=#sr# 75"};
				{ 20, "s26927", "21933", "=q2=Thick Bronze Necklace", "=ds=#sr# 50"};
				{ 21, "s26928", "21934", "=q2=Ornate Tigerseye Necklace", "=ds=#sr# 30"};
				{ 22, "s32178", "25438", "=q2=Malachite Pendant", "=ds=#sr# 20"};
			};
		};
		info = {
		...
		["Normal"] = {
			{
				...
				{ 16, "s78468", "56542", "=q3=Bloodied Leather Belt", "=ds=#sr# 520", "=ds="..AL["Vendor"] };
				{ 17, "s78469", "56543", "=q3=Bloodied Leather Helm", "=ds=#sr# 520", "=ds="..AL["Vendor"] };
				{ 18, "s78467", "56541", "=q3=Bloodied Wyrmhide Chest", "=ds=#sr# 520", "=ds="..AL["Vendor"] };
				{ 19, "s78464", "56540", "=q3=Bloodied Wyrmhide Shoulders", "=ds=#sr# 520", "=ds="..AL["Vendor"] };
				{ 20, "s78454", "56530", "=q3=Bloodied Leather Boots", "=ds=#sr# 515", "=ds="..AL["Vendor"] };
				{ 21, "s78455", "56531", "=q3=Bloodied Leather Shoulders", "=ds=#sr# 515", "=ds="..AL["Vendor"] };
				{ 22, "s78453", "56529", "=q3=Bloodied Wyrmhide Boots", "=ds=#sr# 515", "=ds="..AL["Vendor"] };
				{ 23, "s78452", "56528", "=q3=Bloodied Wyrmhide Gloves", "=ds=#sr# 515", "=ds="..AL["Vendor"] };
				{ 24, "s78446", "56522", "=q3=Bloodied Leather Bracers", "=ds=#sr# 510", "=ds="..AL["Vendor"] };
				{ 25, "s78447", "56523", "=q3=Bloodied Leather Gloves", "=ds=#sr# 510", "=ds="..AL["Vendor"] };
				{ 26, "s78445", "56521", "=q3=Bloodied Wyrmhide Belt", "=ds=#sr# 510", "=ds="..AL["Vendor"] };
				{ 27, "s78444", "56520", "=q3=Bloodied Wyrmhide Bracers", "=ds=#sr# 510", "=ds="..AL["Vendor"] };
			};
		};
		info = {
			name = LEATHERWORKING..": "..AL["Leather Armor"],
		...
		["Normal"] = {
			{
				...
				{ 16, "s78473", "56546", "=q3=Bloodied Dragonscale Belt", "=ds=#sr# 520", "=ds="..AL["Vendor"] };
				{ 17, "s78474", "56547", "=q3=Bloodied Dragonscale Helm", "=ds=#sr# 520", "=ds="..AL["Vendor"] };
				{ 18, "s78471", "56545", "=q3=Bloodied Scale Legs", "=ds=#sr# 520", "=ds="..AL["Vendor"] };
				{ 19, "s78470", "56544", "=q3=Bloodied Scale Shoulders", "=ds=#sr# 520", "=ds="..AL["Vendor"] };
				{ 20, "s78458", "56534", "=q3=Bloodied Dragonscale Boots", "=ds=#sr# 515", "=ds="..AL["Vendor"] };
				{ 21, "s78459", "56535", "=q3=Bloodied Dragonscale Gloves", "=ds=#sr# 515", "=ds="..AL["Vendor"] };
				{ 22, "s78457", "56533", "=q3=Bloodied Scale Belt", "=ds=#sr# 515", "=ds="..AL["Vendor"] };
				{ 23, "s78456", "56532", "=q3=Bloodied Scale Boots", "=ds=#sr# 515", "=ds="..AL["Vendor"] };
				{ 24, "s78450", "56526", "=q3=Bloodied Dragonscale Bracers", "=ds=#sr# 510", "=ds="..AL["Vendor"] };
				{ 25, "s78451", "56527", "=q3=Bloodied Dragonscale Shoulders", "=ds=#sr# 510", "=ds="..AL["Vendor"] };
				{ 26, "s78448", "56524", "=q3=Bloodied Scale Bracers", "=ds=#sr# 510", "=ds="..AL["Vendor"] };
				{ 27, "s78449", "56525", "=q3=Bloodied Scale Gloves", "=ds=#sr# 510", "=ds="..AL["Vendor"] };
			};
		};
		info = {
			name = LEATHERWORKING..": "..AL["Mail Armor"],
		...
		["Normal"] = {
			{
				...
				{ 5, "s60637", "43566", "=q4=Ice Striker's Cloak", "=ds=#sr# 440", "=ds="..AL["Trainer"] };
				{ 6, "s78439", "56519", "=q3=Cloak of War", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
				{ 7, "s78438", "56518", "=q3=Cloak of Beasts", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
				{ 8, "s78405", "56489", "=q2=Hardened Scale Cloak", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
				{ 9, "s78380", "56480", "=q2=Savage Cloak", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
		...
		["Normal"] = {
			{
				...
				{ 10, "s101600", "Trade_LeatherWorking", "=ds=Dragonbone Leg Reinforcements", "=ds=#sr# 465", "=ds="..AL["Trainer"] };
				{ 11, "s78419", "56502", "=q3=Scorched Leg Armor", "=ds=#sr# 465", "=ds="..AL["Trainer"] };
				{ 12, "s78420", "56503", "=q3=Twilight Leg Armor", "=ds=#sr# 465", "=ds="..AL["Trainer"] };
				{ 13, "s78437", "56517", "=q2=Heavy Savage Armor Kit", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
