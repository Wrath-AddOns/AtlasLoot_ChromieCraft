	...
	AtlasLoot_Data["JewelMeta"] = {
		["Normal"] = {
			...
			};
			{
				...
				{ 16, "s55407", "41376", "=q3=Revitalizing Skyflare Diamond", "=ds=#sr# 420", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 17, "s55384", "41377", "=q3=Shielded Skyflare Diamond", "=ds=#sr# 420", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
