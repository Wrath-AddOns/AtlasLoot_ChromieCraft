		...
		["Normal"] = {
			{
				...
				{ 7, "s101789", "71868", "=q4=Purified Shadow Spinel", "=ds=#sr# 525", "=ds=Dragon Soul" };
				{ 8, "s101786", "71865", "=q4=Retaliating Shadow Spinel", "=ds=#sr# 525", "=ds=Dragon Soul" };
				{ 9, "s101790", "71869", "=q4=Shifting Shadow Spinel", "=ds=#sr# 525", "=ds=Dragon Soul" };
				{ 10, "s101794", "71873", "=q4=Sovereign Shadow Spinel", "=ds=#sr# 525", "=ds=Dragon Soul" };
				{ 11, "s101792", "71871", "=q4=Timeless Shadow Spinel", "=ds=#sr# 525", "=ds=Dragon Soul" };
				{ 12, "s101785", "71864", "=q4=Veiled Shadow Spinel", "=ds=#sr# 525", "=ds=Dragon Soul" };
				{ 16, "s73360", "52203", "=q3=Accurate Demonseye", "=ds=#sr# 465", "=ds="..AL["Vendor"] };
				{ 17, "s73352", "52210", "=q3=Defender's Demonseye", "=ds=#sr# 465", "=ds="..AL["Vendor"] };
				{ 18, "s73356", "52213", "=q3=Etched Demonseye", "=ds=#sr# 465", "=ds="..AL["Vendor"] };
				{ 19, "s73357", "52220", "=q3=Glinting Demonseye", "=ds=#sr# 465", "=ds="..AL["Vendor"] };
				{ 20, "s73354", "52221", "=q3=Guardian's Demonseye", "=ds=#sr# 465", "=ds="..AL["Vendor"] };
				{ 21, "s73355", "52236", "=q3=Purified Demonseye", "=ds=#sr# 465", "=ds="..AL["Vendor"] };
				{ 22, "s73358", "52234", "=q3=Retaliating Demonseye", "=ds=#sr# 465", "=ds="..AL["Vendor"] };
				{ 23, "s73351", "52238", "=q3=Shifting Demonseye", "=ds=#sr# 465", "=ds="..AL["Vendor"] };
				{ 24, "s73350", "52243", "=q3=Souvereign Demonseye", "=ds=#sr# 465", "=ds="..AL["Vendor"] };
				{ 25, "s73353", "52248", "=q3=Timeless Demonseye", "=ds=#sr# 465", "=ds="..AL["Vendor"] };
				{ 26, "s73359", "52217", "=q3=Veiled Demonseye", "=ds=#sr# 465", "=ds="..AL["Vendor"] };
			};
			{
