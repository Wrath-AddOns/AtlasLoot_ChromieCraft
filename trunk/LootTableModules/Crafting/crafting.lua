		...
		["Normal"] = {
			{
				...
				{ 17, 69821, "", "=q3=Pterrorday Hatchling", "=ds=#sr# 120", "=ds=#e13#"};
		...
		["Normal"] = {
			{
				...
				{ 6, "s73494", "52306", "=q2=Jasper Ring", "=ds=#sr# 425"};
				{ 7, "s56497", "42643", "=q4=Titanium Earthguard Ring", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 8, "s56496", "42642", "=q4=Titanium Impact Band", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 9, "s56498", "42644", "=q4=Titanium Spellshock Ring", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 10, "s58954", "43582", "=q4=Titanium Frostguard Ring", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 11, "s38503", "31398", "=q4=The Frozen Eye", "=ds=#sr# 375"};
				{ 12, "s38504", "31399", "=q4=The Natural Ward", "=ds=#sr# 375"};
				{ 13, "s46124", "34361", "=q4=Hard Khorium Band", "=ds=#sr# 365"};
				{ 14, "s46122", "34362", "=q4=Loop of Forged Power", "=ds=#sr# 365"};
				{ 15, "s46123", "34363", "=q4=Ring of Flowing Life", "=ds=#sr# 365"};
				{ 16, "s64727", "45808", "=q3=Runed Mana Band", "=ds="};
				{ 17, "s64728", "45809", "=q3=Scarlet Signet", "=ds="};
				{ 18, "s58147", "43250", "=q3=Ring of Earthern Might", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 19, "s58150", "43253", "=q3=Ring of Northern Tears", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 20, "s58148", "43251", "=q3=Ring of Scarlet Shadows", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 21, "s58507", "43498", "=q3=Savage Titanium Band", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 22, "s58492", "43482", "=q3=Savage Titanium Ring", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 23, "s58149", "43252", "=q3=Windfire Band", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 24, "s56197", "42340", "=q3=Dream Signet", "=ds="..AL["Trainer"] };
				{ 25, "s58143", "43246", "=q3=Earthshadow Ring", "=ds="..AL["Trainer"] };
				{ 26, "s58144", "43247", "=q3=Jade Ring of Slaying", "=ds="..AL["Trainer"] };
				{ 27, "s31057", "24086", "=q3=Arcane Khorium Band", "=ds=#sr# 365"};
				{ 28, "s31061", "24089", "=q3=Blazing Eternium Band", "=ds=#sr# 365"};
				{ 29, "s31056", "24085", "=q3=Khorium Band of Leaves", "=ds=#sr# 360"};
				{ 30, "s37855", "30825", "=q3=Ring of Arcane Shielding", "=ds=#sr# 360"};
			};
			{
				{ 1, "s31060", "24088", "=q3=Delicate Eternium Ring", "=ds=#sr# 355"};
				{ 2, "s31054", "24080", "=q3=Khorium Band of Frost", "=ds=#sr# 355"};
				{ 3, "s31055", "24082", "=q3=Khorium Inferno Band", "=ds=#sr# 355"};
				{ 4, "s31053", "24079", "=q3=Khorium Band of Shadows", "=ds=#sr# 350"};
				{ 5, "s31058", "24087", "=q3=Heavy Felsteel Ring", "=ds=#sr# 345"};
				{ 6, "s41415", "32774", "=q3=The Black Pearl", "=ds=#sr# 330"};
				{ 7, "s41414", "32772", "=q3=Brilliant Pearl Band", "=ds=#sr# 325"};
				{ 8, "s26916", "21779", "=q3=Band of Natural Fire", "=ds=#sr# 310"};
				{ 9, "s26903", "21768", "=q3=Sapphire Signet", "=ds=#sr# 275"};
				{ 10, "s26896", "21753", "=q3=Gem Studded Band", "=ds=#sr# 250"};
				{ 11, "s26874", "20964", "=q3=Aquamarine Signet", "=ds=#sr# 210"};
				{ 12, "s34959", "29158", "=q3=Truesilver Commander's Ring", "=ds=#sr# 200"};
				{ 13, "s34955", "29157", "=q3=Golden Ring of Power", "=ds=#sr# 180"};
				{ 14, "s37818", "30804", "=q3=Bronze Band of Force", "=ds=#sr# 65"};
				{ 15, "s25305", "20826", "=q3=Heavy Silver Ring", "=ds=#sr# 90"};
				{ 16, "s58146", "43249", "=q2=Shadowmight Ring", "=ds="..AL["Trainer"] };
				{ 17, "s58145", "43248", "=q2=Stoneguard Band", "=ds="..AL["Trainer"] };
				{ 18, "s56193", "42336", "=q2=Bloodstone Band", "=ds="..AL["Trainer"] };
				{ 19, "s56194", "42337", "=q2=Sun Rock Ring", "=ds="..AL["Trainer"] };
				{ 20, "s31052", "24078", "=q2=Heavy Adamantite Ring", "=ds=#sr# 335"};
				{ 21, "s31050", "24076", "=q2=Azure Moonstone Ring", "=ds=#sr# 320"};
				{ 22, "s31048", "24074", "=q2=Fel Iron Blood Ring", "=ds=#sr# 310"};
				{ 23, "s31049", "24075", "=q2=Golden Draenite Ring", "=ds=#sr# 310"};
				{ 24, "s34961", "29160", "=q2=Emerald Lion Ring", "=ds=#sr# 290"};
				{ 25, "s26910", "21778", "=q2=Ring of Bitter Shadows", "=ds=#sr# 285"};
				{ 26, "s34960", "29159", "=q2=Glowing Thorium Band", "=ds=#sr# 280"};
				{ 27, "s26907", "21775", "=q2=Onslaught Ring", "=ds=#sr# 280"};
				{ 28, "s36526", "30422", "=q2=Diamond Focus Ring", "=ds=#sr# 265"};
				{ 29, "s26902", "21767", "=q2=Simple Opal Ring", "=ds=#sr# 260"};
				{ 30, "s26887", "21754", "=q2=The Aquamarine Ward", "=ds=#sr# 245"};
			};
			{
				{ 1, "s26885", "21765", "=q2=Truesilver Healing Ring", "=ds=#sr# 240"};
				{ 2, "s36525", "30421", "=q2=Red Ring of Destruction", "=ds=#sr# 230"};
				{ 3, "s25621", "20961", "=q2=Citrine Ring of Rapid Healing", "=ds=#sr# 180"};
				{ 4, "s25620", "20960", "=q2=Engraved Truesilver Ring", "=ds=#sr# 170"};
				{ 5, "s25619", "20959", "=q2=The Jade Eye", "=ds=#sr# 170"};
				{ 6, "s25617", "20958", "=q2=Blazing Citrine Ring", "=ds=#sr# 150"};
				{ 7, "s25613", "20955", "=q2=Golden Dragon Ring", "=ds=#sr# 135"};
				{ 8, "s25323", "20833", "=q2=Wicked Moonstone Ring", "=ds=#sr# 125"};
				{ 9, "s36524", "30420", "=q2=Heavy Jade Ring", "=ds=#sr# 105"};		
				{ 10, "s25318", "20828", "=q2=Ring of Twilight Shadows", "=ds=#sr# 100"};
				{ 11, "s25317", "20827", "=q2=Ring of Silver Might", "=ds=#sr# 80"};
				{ 12, "s25287", "20823", "=q2=Gloom Band", "=ds=#sr# 70"};
				{ 13, "s25284", "20820", "=q2=Simple Pearl Ring", "=ds=#sr# 60"};
				{ 14, "s25490", "20907", "=q2=Solid Bronze Ring", "=ds=#sr# 50"};
				{ 15, "s25280", "20818", "=q2=Elegant Silver Ring", "=ds=#sr# 50"};
				{ 16, "s25283", "20821", "=q2=Inlaid Malachite Ring", "=ds=#sr# 30"};
				{ 17, "s32179", "25439", "=q2=Tigerseye Band", "=ds=#sr# 20"};
				{ 18, "s26926", "21932", "=q2=Heavy Copper Ring", "=ds=#sr# 5"};
				{ 19, "s25493", "20906", "=q2=Braided Copper Ring", "=ds=#sr# 1"};
				{ 20, "s26925", "21931", "=q2=Woven Copper Ring", "=ds=#sr# 1"};
			};
		};
		info = {
