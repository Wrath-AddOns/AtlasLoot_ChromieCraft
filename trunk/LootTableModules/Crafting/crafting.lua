	...
	AtlasLoot_Data["EnchantingChest"] = {
		["Normal"] = {
			...
			};
			{
				...
				{ 18, "s44509", "Spell_Holy_GreaterHeal", "=ds=Enchant Chest - Greater Mana Restoration", "=ds=#sr# 420", "=ds="..AL["Trainer"]};
				{ 19, "s47766", "inv_enchant_formulagood_01", "=ds=Enchant Chest - Greater Defense", "=ds=#sr# 400", "=ds="..AL["Trainer"]};
				{ 20, "s46594", "inv_misc_note_01", "=ds=Enchant Chest - Defense", "=ds=#sr# 360", "=ds="..AL["Vendor"]};
				{ 21, "s33990", "Spell_Holy_GreaterHeal", "=ds=Enchant Chest - Major Spirit", "=ds=#sr# 320", "=ds="..AL["Trainer"]};
				{ 22, "s33991", "Spell_Holy_GreaterHeal", "=ds=Enchant Chest - Restore Mana Prime", "=ds=#sr# 300", "=ds="..AL["Trainer"]};
				{ 23, "s13538", "Spell_Holy_GreaterHeal", "=ds=Enchant Chest - Lesser Absorption", "=ds=#sr# 140", "=ds="..AL["Trainer"]};
				{ 24, "s7426", "Spell_Holy_GreaterHeal", "=ds=Enchant Chest - Minor Absorption", "=ds=#sr# 40", "=ds="..AL["Trainer"]};
			};
		};
		info = {
