	...
	AtlasLoot_Data["AlchemyPotion"] = {
		["Normal"] = {
			...
			};
			{
				...
				{ 5, "s28579", "22849", "=q1=Ironshield Potion", "=ds=#sr# 365", "=ds="..AtlasLoot:EJ_GetBossName("Captain Skarloc", 539)..": "..BabbleZone["Old Hillsbrad Foothills"]};
				...
				{ 8, "s28572", "22842", "=q1=Major Frost Protection Potion", "=ds=#sr# 360", "=ds="..AtlasLoot:EJ_GetBossName("Nexus-Prince Shaffar", 537)..": "..BabbleZone["Mana-Tombs"]};
			...
			};
			{
				...
				{ 16, "s11452", "9030", "=q1=Restorative Potion", "=ds=#sr# 210", "=ds="..BabbleInventory["Quest"]..": "..BabbleZone["Badlands"]};
				{ 17, "s11448", "6149", "=q1=Greater Mana Potion", "=ds=#sr# 205", "=ds="..AL["Trainer"]};
				{ 18, "s7258", "6050", "=q1=Frost Protection Potion", "=ds=#sr# 190", "=ds="..AL["Vendor"]};
				{ 19, "s7259", "6052", "=q1=Nature Protection Potion", "=ds=#sr# 190", "=ds="..AL["Vendor"]};
				{ 20, "s6618", "5633", "=q1=Great Rage Potion", "=ds=#sr# 175", "=ds="..AL["Vendor"]};
				{ 21, "s3448", "3823", "=q1=Lesser Invisibility Potion", "=ds=#sr# 165", "=ds="..AL["Trainer"]};
				{ 22, "s7257", "6049", "=q1=Fire Protection Potion", "=ds=#sr# 165", "=ds="..AL["Vendor"]};
				{ 23, "s3452", "3827", "=q1=Mana Potion", "=ds=#sr# 160", "=ds="..AL["Trainer"]};
				{ 24, "s7181", "1710", "=q1=Greater Healing Potion", "=ds=#sr# 155", "=ds="..AL["Trainer"]};
				{ 25, "s6624", "5634", "=q1=Free Action Potion", "=ds=#sr# 150", "=ds="..AL["Vendor"]};
				{ 26, "s7256", "6048", "=q1=Shadow Protection Potion", "=ds=#sr# 135", "=ds="..AL["Vendor"]};
				{ 27, "s3173", "3385", "=q1=Lesser Mana Potion", "=ds=#sr# 120", "=ds="..AL["Trainer"]};
				{ 28, "s3174", "3386", "=q1=Potion of Curing", "=ds=#sr# 120", "=ds="..AL["World Drop"]};
				{ 29, "s3447", "929", "=q1=Healing Potion", "=ds=#sr# 110", "=ds="..AL["Trainer"]};
				{ 30, "s7255", "6051", "=q1=Holy Protection Potion", "=ds=#sr# 100", "=ds="..AL["Vendor"]};
			};
			{
				{ 1, "s7841", "6372", "=q1=Swim Speed Potion", "=ds=#sr# 100", "=ds="..AL["Trainer"]};
				{ 2, "s4508", "4596", "=q1=Discolored Healing Potion", "=ds=#sr# 90", "=ds="..AL["No Longer Available"]};
				{ 3, "s2332", "2456", "=q1=Minor Rejuvenation Potion", "=ds=#sr# 90", "=ds="..AL["Trainer"]};
				{ 4, "s6617", "5631", "=q1=Rage Potion", "=ds=#sr# 60", "=ds="..AL["Vendor"]};
				{ 5, "s2335", "2459", "=q1=Swiftness Potion", "=ds=#sr# 60", "=ds="..AL["World Drop"]};
				{ 6, "s2337", "858", "=q1=Lesser Healing Potion", "=ds=#sr# 55", "=ds="..AL["Trainer"]};
				{ 7, "s2331", "2455", "=q1=Minor Mana Potion", "=ds=#sr# 25", "=ds="..AL["Trainer"]};
				{ 8, "s2330", "118", "=q1=Minor Healing Potion", "=ds=#sr# 1", "=ds="..AL["Trainer"]};
			};
		};
		info = {
		...
		["Normal"] = {
			{
				...
				{ 4, "s94162", "67438", "=q1=Flask of Flowing Water", "=ds=#sr# 500", "=ds="..AL["Trainer"]};
				{ 5, "s80719", "58085", "=q1=Flask of Steelskin", "=ds=#sr# 500", "=ds="..AL["Trainer"]};
				{ 7, "s53903", "46377", "=q1=Flask of Endless Rage", "=ds=#sr# 435", "=ds="..AL["Trainer"]};
				{ 8, "s54213", "46378", "=q1=Flask of Pure Mojo", "=ds=#sr# 435", "=ds="..AL["Trainer"]};
				{ 9, "s53902", "46379", "=q1=Flask of Stoneblood", "=ds=#sr# 435", "=ds="..AL["Trainer"]};
				{ 10, "s53901", "46376", "=q1=Flask of the Frost Wyrm", "=ds=#sr# 435", "=ds="..AL["Trainer"]};
				{ 11, "s53899", "40079", "=q1=Lesser Flask of Toughness", "=ds=#sr# 375", "=ds="..AL["Trainer"]};
				{ 16, "s28590", "22861", "=q1=Flask of Blinding Light", "=ds=#sr# 300", "=ds="..AL["Discovery"]};
				{ 17, "s28587", "22851", "=q1=Flask of Fortification", "=ds=#sr# 300", "=ds="..AL["Discovery"]};
				{ 18, "s28588", "22853", "=q1=Flask of Mighty Restoration", "=ds=#sr# 300", "=ds="..AL["Discovery"]};
				{ 19, "s28591", "22866", "=q1=Flask of Pure Death", "=ds=#sr# 300", "=ds="..AL["Discovery"]};
				{ 20, "s28589", "22854", "=q1=Flask of Relentless Assault", "=ds=#sr# 300", "=ds="..AL["Discovery"]};
				{ 22, "s17636", "13511", "=q1=Flask of Distilled Wisdom", "=ds=#sr# 300", "=ds="..BabbleFaction["Cenarion Expedition"].." - "..BabbleFaction["Exalted"]};
				{ 23, "s17637", "13512", "=q1=Flask of Supreme Power", "=ds=#sr# 300", "=ds="..BabbleFaction["Keepers of Time"].." - "..BabbleFaction["Exalted"]};
				{ 24, "s17635", "13510", "=q1=Flask of the Titans", "=ds=#sr# 300", "=ds="..BabbleFaction["The Sha'tar"].." - "..BabbleFaction["Exalted"]};
			};
		};
		info = {
		...
		["Normal"] = {
			{
				...
				{ 16, "s11454", "9060", "=q1=Inlaid Mithril Cylinder", "=ds=#sr# 200", "=ds="..AL["Crafted"]..": "..GetSpellInfo(4036).." (205)"};
				{ 17, "s8768", "7071", "=q1=Iron Buckle", "=ds=#sr# 150", "=ds="..AL["Trainer"]};
			};
		};
		info = {
		...
		["Normal"] = {
			{
				...
				{ 16, "s74216", "Spell_Holy_GreaterHeal", "=ds=Enchant Ring - Agility", "=ds=#sr# 475", "=ds="..AL["Trainer"]};
				{ 17, "s74218", "Spell_Holy_GreaterHeal", "=ds=Enchant Ring - Stamina", "=ds=#sr# 475", "=ds="..AL["Trainer"]};
				{ 18, "s74217", "Spell_Holy_GreaterHeal", "=ds=Enchant Ring - Intellect", "=ds=#sr# 475", "=ds="..AL["Trainer"]};
				{ 19, "s74215", "Spell_Holy_GreaterHeal", "=ds=Enchant Ring - Strength", "=ds=#sr# 475", "=ds="..AL["Trainer"]};
				{ 20, "s44645", "Spell_Holy_GreaterHeal", "=ds=Enchant Ring - Assault", "=ds=#sr# 400", "=ds="..AL["Trainer"]};
				{ 21, "s44636", "Spell_Holy_GreaterHeal", "=ds=Enchant Ring - Lesser Intellect", "=ds=#sr# 400", "=ds="..AL["Trainer"]};
				{ 22, "s59636", "Spell_Holy_GreaterHeal", "=ds=Enchant Ring - Lesser Stamina", "=ds=#sr# 400", "=ds="..AL["Trainer"]};
				{ 24, "s27927", "inv_misc_note_01", "=ds=Enchant Ring - Stats", "=ds=#sr# 375", "=ds="..AL["Vendor"]};
				{ 25, "s27924", "inv_misc_note_01", "=ds=Enchant Ring - Minor Intellect", "=ds=#sr# 360", "=ds="..AL["Vendor"]};
				{ 26, "s27920", "inv_misc_note_01", "=ds=Enchant Ring - Striking", "=ds=#sr# 360", "=ds="..AL["Vendor"]};
			};
		};
		info = {
		...
		["Normal"] = {
			{
				...
				{ 2, "s86652", "87562", "=q3=Rosethorn Staff", "=ds=#sr# 515", "=ds="..AL["Trainer"] };
				{ 3, "s86653", "87561", "=q3=Silver Inlaid Staff", "=ds=#sr# 515", "=ds="..AL["Trainer"] };
				{ 4, "s86649", "87566", "=q3=Runed Staff", "=ds=#sr# 505", "=ds="..AL["Trainer"] };
				{ 5, "s86648", "87565", "=q3=Key to the Planes", "=ds=#sr# 450", "=ds="..AL["Trainer"] };
		...
		["Normal"] = {
			{
				...
				{ 11, "s78379", "56477", "=q1=Savage Armor Kit", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
				{ 12, "s62448", "44963", "=q4=Earthen Leg Armor", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
				{ 13, "s50965", "38373", "=q4=Frosthide Leg Armor", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
				{ 14, "s50967", "38374", "=q4=Icescale Leg Armor", "=ds=#sr# 425", "=ds="..AL["Trainer"] };
				{ 15, "s50964", "38371", "=q3=Jormungar Leg Armor", "=ds=#sr# 405", "=ds="..AL["Trainer"] };
				{ 16, "s57683", "Trade_LeatherWorking", "=ds=Fur Lining - Attack Power", "=ds=#sr# 400", "=ds="..AL["Trainer"] };
				{ 17, "s57691", "Trade_LeatherWorking", "=ds=Fur Lining - Spell Power", "=ds=#sr# 400", "=ds="..AL["Trainer"] };
				{ 18, "s57690", "Trade_LeatherWorking", "=ds=Fur Lining - Stamina", "=ds=#sr# 400", "=ds="..AL["Trainer"] };
				{ 19, "s50966", "38372", "=q3=Nerubian Leg Armor", "=ds=#sr# 400", "=ds="..AL["Trainer"] };
				{ 20, "s60584", "Trade_LeatherWorking", "=ds=Nerubian Leg Reinforcements", "=ds=#sr# 400", "=ds="..AL["Trainer"] };
				{ 21, "s50963", "38376", "=q2=Heavy Borean Armor Kit", "=ds=#sr# 395", "=ds="..AL["Trainer"] };
				{ 22, "s35557", "29536", "=q4=Nethercleft Leg Armor", "=ds=#sr# 365", "=ds="..BabbleFaction["Cenarion Expedition"].." - "..BabbleFaction["Exalted"] };
				{
					{ 23, "s35554", "29535", "=q4=Nethercobra Leg Armor", "=ds=#sr# 365", "=ds="..BabbleFaction["Thrallmar"].." - "..BabbleFaction["Exalted"] };
					{ 23, "s35554", "29535", "=q4=Nethercobra Leg Armor", "=ds=#sr# 365", "=ds="..BabbleFaction["Honor Hold"].." - "..BabbleFaction["Exalted"] };
				};
				{ 24, "s44770", "34207", "=q2=Glove Reinforcements", "=ds=#sr# 350", "=ds="..AL["Trainer"] };
				{ 25, "s50962", "38375", "=q1=Borean Armor Kit", "=ds=#sr# 350", "=ds="..AL["Trainer"] };
				{ 26, "s44970", "34330", "=q1=Heavy Knothide Armor Kit", "=ds=#sr# 350", "=ds="..AL["Trainer"] };
