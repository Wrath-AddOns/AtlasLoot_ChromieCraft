		...
		["Normal"] = {
			{
				...
				{ 18, "s29657", "23530", "=q2=Felsteel Shield Spike", "=ds=#sr# 360", "=ds="..BabbleFaction["Thrallmar"].."/"..BabbleFaction["Honor Hold"]};
...
--[[AtlasLoot_Data["Cooking"] = {
		...
		["Normal"] = {
			{
				...
				{ 20, "s14891", "11371", "=q1=Smelt Dark Iron", "=ds=#sr# 230", "=ds="..BabbleInventory["Quest"]..": "..BabbleZone["Blackrock Depths"] };
		...
		["Normal"] = {
			{
				...
				{ 11, "s75296", "54492", "=q3=Fireweave Gloves", "=ds=#sr# 520"};
				{ 12, "s75294", "54490", "=q3=Fireweave Boots", "=ds=#sr# 515"};
				{ 13, "s75295", "54497", "=q3=Emberfire Gloves", "=ds=#sr# 515"};
				{ 14, "s75292", "54487", "=q3=Fireweave Shoulders", "=ds=#sr# 510"};
				{ 15, "s75269", "54489", "=q3=Fireweave Belt", "=ds=#sr# 510"};
				{ 16, "s75293", "54500", "=q3=Emberfire Belt", "=ds=#sr# 510"};
				{ 17, "s75291", "54502", "=q3=Emberfire Shoulders", "=ds=#sr# 505"};
				{ 18, "s75270", "54501", "=q3=Emberfire Bracers", "=ds=#sr# 500"};
				{ 19, "s75266", "54485", "=q3=Spiritmend Cowl", "=ds=#sr# 485"};
				{ 20, "s75267", "54486", "=q2=Spiritmend Robe", "=ds=#sr# 485"};
				{ 21, "s75263", "54483", "=q2=Spiritmend Leggings", "=ds=#sr# 480"};
				{ 22, "s75262", "54484", "=q2=Spiritmend Gloves", "=ds=#sr# 480"};
				{ 23, "s75261", "54482", "=q2=Spiritmend Boots", "=ds=#sr# 475"};
				{ 24, "s75260", "54479", "=q3=Spiritmend Shoulders", "=ds=#sr# 475"};
			...
			{
				{ 1, "s75249", "54473", "=q2=Deathsilk Bracers", "=ds=#sr# 445"};
				{ 2, "s75248", "54471", "=q2=Deathsilk Belt", "=ds=#sr# 445"};
				{ 3, "s75288", "54441", "=q1=Black Embersilk Gown", "=ds="..AL["Vendor"]..": "..BabbleZone["Twilight Highlands"]};
			};
		};
		info = {
			name = TAILORING..": " ..AL["Cloth Armor"],
		...
		["Normal"] = {
			{
				...
				{ 2, "s75268", "54446", "=q2=Hyjal Expedition Bag", "=ds=#sr# 490"};
				{ 3, "s75264", "54443", "=q2=Embersilk Bag", "=ds=#sr# 480"};
				{ 4, "s75265", "54445", "=q3=Otherworldly Bag", "=ds=#sr# 480"};
				{ 5, "s56007", "41599", "=q2=Frostweave Bag", "=ds=#sr# 410"};
				{ 6, "s56005", "41600", "=q3=Glacial Bag", "=ds="..BabbleFaction["The Sons of Hodir"]..": "..BabbleFaction["Exalted"] };
				{ 7, "s56006", "41598", "=q3=Mysterious Bag", "=ds="..BabbleFaction["The Wyrmrest Accord"]..": "..BabbleFaction["Revered"] };
				{ 8, "s56004", "41597", "=q3=Abyssal Bag", "=ds="..BabbleFaction["Knights of the Ebon Blade"]..": "..BabbleFaction["Revered"] };
				{ 9, "s63924", "45773", "=q3=Emerald Bag", "=ds="..BabbleFaction["The Kalu'ak"]..": "..BabbleFaction["Revered"] };
				{ 10, "s26759", "21872", "=q3=Ebon Shadowbag", "=ds=#sr# 375"};
				{ 11, "s50194", "38225", "=q3=Mycah's Botanical Bag", "=ds="..BabbleFaction["Sporeggar"]..": "..BabbleFaction["Revered"] };
				{ 12, "s26763", "21876", "=q3=Primal Mooncloth Bag", "=ds=#sr# 375"};
				{ 13, "s26755", "21858", "=q3=Spellfire Bag", "=ds=#sr# 375"};
				{ 14, "s31459", "24270", "=q2=Bag of Jewels", "=ds=#sr# 340"};
				{ 15, "s26749", "21843", "=q2=Imbued Netherweave Bag", "=ds=#sr# 340"};
				{ 16, "s26746", "21841", "=q2=Netherweave Bag", "=ds=#sr# 315"};
				{ 17, "s26087", "21342", "=q4=Core Felcloth Bag", "=ds=#sr# 300"};
				{ 18, "s18455", "14156", "=q3=Bottomless Bag", "=ds=#sr# 300"};
				{ 19, "s27660", "22249", "=q2=Big Bag of Enchantment", "=ds=#sr# 300"};
				{ 20, "s18445", "14155", "=q2=Mooncloth Bag", "=ds=#sr# 300"};
				{ 21, "s27725", "22252", "=q2=Satchel of Cenarius", "=ds=#sr# 300"};
				{ 22, "s26086", "21341", "=q3=Felcloth Bag", "=ds=#sr# 280"};
				{ 23, "s27659", "22248", "=q2=Enchanted Runecloth Bag", "=ds=#sr# 275"};
				{ 24, "s27724", "22251", "=q2=Cenarion Herb Bag", "=ds=#sr# 275"};
				{ 25, "s26085", "21340", "=q2=Soul Pouch", "=ds=#sr# 260"};
				{ 26, "s27658", "22246", "=q2=Enchanted Mageweave Pouch", "=ds=#sr# 225"};
				{ 27, "s18405", "14046", "=q1=Runecloth Bag", "=ds=#sr# 260"};
				{ 28, "s12079", "10051", "=q1=Red Mageweave Bag", "=ds=#sr# 235"};
				{ 29, "s12065", "10050", "=q1=Mageweave Bag", "=ds=#sr# 225"};
				{ 30, "s6695", "5765", "=q1=Black Silk Pack", "=ds=#sr# 185"};
			};
			{
				{ 1, "s6693", "5764", "=q1=Green Silk Pack", "=ds=#sr# 175"};
				{ 2, "s3813", "4245", "=q1=Small Silk Pack", "=ds=#sr# 150"};
				{ 3, "s6688", "5763", "=q1=Red Woolen Bag", "=ds=#sr# 115"};
				{ 4, "s3758", "4241", "=q1=Green Woolen Bag", "=ds=#sr# 95"};
				{ 5, "s3757", "4240", "=q1=Woolen Bag", "=ds=#sr# 80"};
				{ 6, "s6686", "5762", "=q1=Red Linen Bag", "=ds=#sr# 70"};
				{ 7, "s3755", "4238", "=q1=Linen Bag", "=ds=#sr# 45"};
			};
		};
		info = {
	...
	AtlasLoot_Data["TailoringMisc"] = {
		["Normal"] = {
			{
				{ 1, "s75175", "INV_Misc_Thread_01", "=ds=Darkglow Embroidery", "=ds=#sr# 500" };
				{ 2, "s75172", "INV_Misc_Thread_01", "=ds=Lightweave Embroidery", "=ds=#sr# 500" };
				{ 3, "s75178", "INV_Misc_Thread_01", "=ds=Swordguard Embroidery", "=ds=#sr# 500" };
				{ 4, "s55769", "INV_Misc_Thread_01", "=ds=Darkglow Embroidery", "=ds=#sr# 420" };
				{ 5, "s55642", "INV_Misc_Thread_01", "=ds=Lightweave Embroidery", "=ds=#sr# 420" };
				{ 6, "s55777", "INV_Misc_Thread_01", "=ds=Swordguard Embroidery", "=ds=#sr# 420" };
				{ 7, "s75154", "Spell_Nature_AstralRecalGroup", "=ds=Master's Spellthread", "=ds=#sr# 475" };
				{ 8, "s75155", "Spell_Nature_AstralRecalGroup", "=ds=Sanctified Spellthread", "=ds=#sr# 475" };
				{ 9, "s56034", "Spell_Nature_AstralRecalGroup", "=ds=Master's Spellthread", "=ds=#sr# 405" };
				{ 10, "s56039", "Spell_Nature_AstralRecalGroup", "=ds=Sanctified Spellthread - Rank 1", "=ds=#sr# 405" };
				{ 11, "s75309", "54448", "=q4=Powerful Enchanted Spellthread", "=ds="..AL["Vendor"]..": "..BabbleZone["Twilight Highlands"]};
				{ 12, "s75310", "54450", "=q4=Powerful Ghostly Spellthread", "=ds="..AL["Vendor"]..": "..BabbleZone["Twilight Highlands"]};
				{ 13, "s56009", "41602", "=q4=Brilliant Spellthread", "=ds="..BabbleFaction["Argent Crusade"]..": "..BabbleFaction["Exalted"] };
				{ 14, "s56011", "41604", "=q4=Sapphire Spellthread", "=ds="..BabbleFaction["Kirin Tor"]..": "..BabbleFaction["Exalted"] };
				{ 15, "s75597", "54797", "=q4=Frosty Flying Carpet", "=ds="..AL["Vendor"]..": "..BabbleZone["Dalaran"] };
				{ 16, "s60971", "44558", "=q4=Magnificent Flying Carpet", "=ds=#sr# 425" };
				{ 17, "s31433", "24276", "=q4=Golden Spellthread", "=ds=#sr# 375"};
				{ 18, "s31432", "24274", "=q4=Runic Spellthread", "=ds=#sr# 375"};
				{ 19, "s94743", "54440", "=q3=Dream of Destruction", "=ds=#sr# 525"};
				{ 20, "s75141", "54440", "=q3=Dream of Skywall", "=ds=#sr# 515"};
				{ 21, "s75145", "54440", "=q3=Dream of Ragnaros", "=ds=#sr# 510"};
				{ 22, "s75142", "54440", "=q3=Dream of Deepholm", "=ds=#sr# 505"};
				{ 23, "s75144", "54440", "=q3=Dream of Hyjal", "=ds=#sr# 500"};
				{ 24, "s75146", "54440", "=q3=Dream of Azshara", "=ds=#sr# 500"};
				{ 25, "s75255", "54449", "=q3=Enchanted Spellthread", "=ds=#sr# 460"};
				{ 26, "s75250", "54447", "=q3=Enchanted Spellthread", "=ds=#sr# 450"};
				{ 27, "s56002", "41593", "=q3=Ebonweave", "=ds=#sr# 415"};
				{ 28, "s56001", "41594", "=q3=Moonshroud", "=ds=#sr# 415"};
				{ 29, "s56003", "41595", "=q3=Spellweave", "=ds=#sr# 415"};
				{ 30, "s56010", "41603", "=q3=Azure Spellthread", "=ds=#sr# 400"};
			};
			{
				{ 1, "s56008", "41601", "=q3=Shining Spellthread", "=ds=#sr# 400"};
				{ 2, "s26751", "21845", "=q3=Primal Mooncloth", "=ds=#sr# 350"};
				{ 3, "s36686", "24272", "=q3=Shadowcloth", "=ds=#sr# 350"};
				{ 4, "s31373", "24271", "=q3=Spellcloth", "=ds=#sr# 350"};
				{ 5, "s31430", "24273", "=q3=Mystic Spellthread", "=ds=#sr# 335"};
				{ 6, "s31431", "24275", "=q3=Silver Spellthread", "=ds=#sr# 335"};
				{ 7, "s60969", "44554", "=q3=Flying Carpet", "=ds=#sr# 300"};
				...
				{ 15, "s26745", "21840", "=q1=Bolt of Netherweave", "=ds=#sr# 300"};
				{ 16, "s31460", "24268", "=q1=Netherweave Net", "=ds=#sr# 300"};
				{ 17, "s18401", "14048", "=q1=Bolt of Runecloth", "=ds=#sr# 250"};
				{ 18, "s18560", "14342", "=q1=Mooncloth", "=ds=#sr# 250"};
				{ 19, "s3865", "4339", "=q1=Bolt of Mageweave", "=ds=#sr# 175"};
				{ 20, "s3839", "4305", "=q1=Bolt of Silk Cloth", "=ds=#sr# 125"};
				{ 21, "s2964", "2997", "=q1=Bolt of Woolen Cloth", "=ds=#sr# 75"};
				{ 22, "s2963", "2996", "=q1=Bolt of Linen Cloth", "=ds=#sr# 1"};
			};
		};
		info = {
