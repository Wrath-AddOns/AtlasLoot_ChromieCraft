...
---- Jewelcrafting Daily
		...
		["Normal"] = {
			{
				...
				{ 6, "s139197", "92747", "=q3=Advanced Refrigeration Unit", "=ds=#sr# 500", "=ds=#QUESTID:32630#"};
	...
	AtlasLoot_Data["EngineeringReagents"] = {
		["Normal"] = {
			{
				{ 1, "s139176", "94113", "=q3=Stabilized Lightning Source", "=ds=#sr# 500", "=ds=#QUESTID:32630#"};
		...
		["Normal"] = {
			{
				...
				{ 2, "s139196", "94903", "=q1=Pierre", "=ds=#sr# 500", "=ds=#QUESTID:32630#"};
				...
				{ 18, "s139192", "95416", "=q4=Sky Claw", "=ds=#sr# 500", "=ds=#QUESTID:32630#"};
