...
--- World Bosses
	...
	AtlasLoot_Data["ArenaDruidFeral"] = {
		...
		{ 9, 31968, "", "=q4=Merciless Gladiator's Dragonhide Helm", "=ds=", "=ds=#s1#", ""};
		{ 10, 31971, "", "=q4=Merciless Gladiator's Dragonhide Spaulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 31972, "", "=q4=Merciless Gladiator's Dragonhide Tunic", "=ds=", "=ds=#s5#", ""};
		{ 12, 31967, "", "=q4=Merciless Gladiator's Dragonhide Gloves", "=ds=", "=ds=#s9#", ""};
		{ 13, 31969, "", "=q4=Merciless Gladiator's Dragonhide Legguards", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Ability_Druid_Maul", "=q6=#arenas1_1#", "=q1=#m36#"};
		{ 17, 33672, "", "=q4=Vengeful Gladiator's Dragonhide Helm", "=ds=", "=ds=#s1#", ""};
		{ 18, 33674, "", "=q4=Vengeful Gladiator's Dragonhide Spaulders", "=ds=#s3#", ""};
		{ 19, 33675, "", "=q4=Vengeful Gladiator's Dragonhide Tunic", "=ds=", "=ds=#s5#", ""};
		{ 20, 33671, "", "=q4=Vengeful Gladiator's Dragonhide Gloves", "=ds=", "=ds=#s9#", ""};
		{ 21, 33673, "", "=q4=Vengeful Gladiator's Dragonhide Legguards", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaDruidBalance"] = {
		...
		{ 9, 32057, "", "=q4=Merciless Gladiator's Wyrmhide Helm", "=ds=", "=ds=#s1#", ""};
		{ 10, 32059, "", "=q4=Merciless Gladiator's Wyrmhide Spaulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 32060, "", "=q4=Merciless Gladiator's Wyrmhide Tunic", "=ds=", "=ds=#s5#", ""};
		{ 12, 32056, "", "=q4=Merciless Gladiator's Wyrmhide Gloves", "=ds=", "=ds=#s9#", ""};
		{ 13, 32058, "", "=q4=Merciless Gladiator's Wyrmhide Legguards", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Nature_InsectSwarm", "=q6=#arenas1_2#", "=q1=#m36#"};
		{ 17, 33768, "", "=q4=Vengeful Gladiator's Wyrmhide Helm", "=ds=", "=ds=#s1#", ""};
		{ 18, 33770, "", "=q4=Vengeful Gladiator's Wyrmhide Spaulders", "=ds=#s3#", ""};
		{ 19, 33771, "", "=q4=Vengeful Gladiator's Wyrmhide Tunic", "=ds=", "=ds=#s5#", ""};
		{ 20, 33767, "", "=q4=Vengeful Gladiator's Wyrmhide Gloves", "=ds=", "=ds=#s9#", ""};
		{ 21, 33769, "", "=q4=Vengeful Gladiator's Wyrmhide Legguards", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaDruidRestoration"] = {
		...
		{ 9, 31988, "", "=q4=Merciless Gladiator's Kodohide Helm", "=ds=", "=ds=#s1#", ""};
		{ 10, 31990, "", "=q4=Merciless Gladiator's Kodohide Spaulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 31991, "", "=q4=Merciless Gladiator's Kodohide Tunic", "=ds=", "=ds=#s5#", ""};
		{ 12, 31987, "", "=q4=Merciless Gladiator's Kodohide Gloves", "=ds=", "=ds=#s9#", ""};
		{ 13, 31989, "", "=q4=Merciless Gladiator's Kodohide Legguards", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Nature_Regeneration", "=q6=#arenas1_3#", "=q1=#m36#"};
		{ 17, 33691, "", "=q4=Vengeful Gladiator's Kodohide Helm", "=ds=", "=ds=#s1#", ""};
		{ 18, 33693, "", "=q4=Vengeful Gladiator's Kodohide Spaulders", "=ds=#s3#", ""};
		{ 19, 33694, "", "=q4=Vengeful Gladiator's Kodohide Tunic", "=ds=", "=ds=#s5#", ""};
		{ 20, 33690, "", "=q4=Vengeful Gladiator's Kodohide Gloves", "=ds=", "=ds=#s9#", ""};
		{ 21, 33692, "", "=q4=Vengeful Gladiator's Kodohide Legguards", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaHunter"] = {
		...
		{ 9, 31962, "", "=q4=Merciless Gladiator's Chain Helm", "=ds=", "=ds=#s1#", ""};
		{ 10, 31964, "", "=q4=Merciless Gladiator's Chain Spaulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 31960, "", "=q4=Merciless Gladiator's Chain Armor", "=ds=", "=ds=#s5#", ""};
		{ 12, 31961, "", "=q4=Merciless Gladiator's Chain Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 13, 31963, "", "=q4=Merciless Gladiator's Chain Leggings", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Ability_Hunter_RunningShot", "=q6=#arenas2#", "=q1=#m36#"};
		{ 17, 33666, "", "=q4=Vengeful Gladiator's Chain Helm", "=ds=", "=ds=#s1#", ""};
		{ 18, 33668, "", "=q4=Vengeful Gladiator's Chain Spaulders", "=ds=#s3#", ""};
		{ 19, 33664, "", "=q4=Vengeful Gladiator's Chain Armor", "=ds=", "=ds=#s5#", ""};
		{ 20, 33665, "", "=q4=Vengeful Gladiator's Chain Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 21, 33667, "", "=q4=Vengeful Gladiator's Chain Leggings", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaMage"] = {
		...
		{ 9, 32048, "", "=q4=Merciless Gladiator's Silk Cowl", "=ds=", "=ds=#s1#", ""};
		{ 10, 32047, "", "=q4=Merciless Gladiator's Silk Amice", "=ds=", "=ds=#s3#", ""};
		{ 11, 32050, "", "=q4=Merciless Gladiator's Silk Raiment", "=ds=", "=ds=#s5#", ""};
		{ 12, 32049, "", "=q4=Merciless Gladiator's Silk Handguards", "=ds=", "=ds=#s9#", ""};
		{ 13, 32051, "", "=q4=Merciless Gladiator's Silk Trousers", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Frost_IceStorm", "=q6=#arenas3#", "=q1=#m36#"};
		{ 17, 33758, "", "=q4=Vengeful Gladiator's Silk Cowl", "=ds=", "=ds=#s1#", ""};
		{ 18, 33757, "", "=q4=Vengeful Gladiator's Silk Amice", "=ds=#s3#", ""};
		{ 19, 33760, "", "=q4=Vengeful Gladiator's Silk Raiment", "=ds=", "=ds=#s5#", ""};
		{ 20, 33759, "", "=q4=Vengeful Gladiator's Silk Handguards", "=ds=", "=ds=#s9#", ""};
		{ 21, 33761, "", "=q4=Vengeful Gladiator's Silk Trousers", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaPaladinProtection"] = {
		...
		{ 9, 31997, "", "=q4=Merciless Gladiator's Lamellar Helm", "=ds=", "=ds=#s1#", ""};
		{ 10, 31996, "", "=q4=Merciless Gladiator's Lamellar Shoulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 31992, "", "=q4=Merciless Gladiator's Lamellar Chestpiece", "=ds=", "=ds=#s5#", ""};
		{ 12, 31993, "", "=q4=Merciless Gladiator's Lamellar Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 13, 31995, "", "=q4=Merciless Gladiator's Lamellar Legguards", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Holy_SealOfMight", "=q6=#arenas4_1#", "=q1=#m36#"};
		{ 17, 33697, "", "=q4=Vengeful Gladiator's Lamellar Helm", "=ds=", "=ds=#s1#", ""};
		{ 18, 33699, "", "=q4=Vengeful Gladiator's Lamellar Shoulders", "=ds=#s3#", ""};
		{ 19, 33695, "", "=q4=Vengeful Gladiator's Lamellar Chestpiece", "=ds=", "=ds=#s5#", ""};
		{ 20, 33696, "", "=q4=Vengeful Gladiator's Lamellar Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 21, 33698, "", "=q4=Vengeful Gladiator's Lamellar Legguards", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaPaladinRetribution"] = {
		...
		{ 9, 32041, "", "=q4=Merciless Gladiator's Scaled Helm", "=ds=", "=ds=#s1#", ""};
		{ 10, 32043, "", "=q4=Merciless Gladiator's Scaled Shoulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 32039, "", "=q4=Merciless Gladiator's Scaled Chestpiece", "=ds=", "=ds=#s5#", ""};
		{ 12, 32040, "", "=q4=Merciless Gladiator's Scaled Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 13, 32042, "", "=q4=Merciless Gladiator's Scaled Legguards", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Holy_AuraOfLight", "=q6=#arenas4_2#", "=q1=#m36#"};
		{ 17, 33751, "", "=q4=Vengeful Gladiator's Scaled Helm", "=ds=", "=ds=#s1#", ""};
		{ 18, 33753, "", "=q4=Vengeful Gladiator's Scaled Shoulders", "=ds=#s3#", ""};
		{ 19, 33749, "", "=q4=Vengeful Gladiator's Scaled Chestpiece", "=ds=", "=ds=#s5#", ""};
		{ 20, 33750, "", "=q4=Vengeful Gladiator's Scaled Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 21, 33752, "", "=q4=Vengeful Gladiator's Scaled Legguards", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaPaladinHoly"] = {
		...
		{ 9, 32022, "", "=q4=Merciless Gladiator's Ornamented Headcover", "=ds=", "=ds=#s1#", ""};
		{ 10, 32024, "", "=q4=Merciless Gladiator's Ornamented Spaulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 32020, "", "=q4=Merciless Gladiator's Ornamented Chestguard", "=ds=", "=ds=#s5#", ""};
		{ 12, 32021, "", "=q4=Merciless Gladiator's Ornamented Gloves", "=ds=", "=ds=#s9#", ""};
		{ 13, 32023, "", "=q4=Merciless Gladiator's Ornamented Legplates", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Holy_HolyBolt", "=q6=#arenas4_3#", "=q1=#m36#"};
		{ 17, 33724, "", "=q4=Vengeful Gladiator's Ornamented Headcover", "=ds=", "=ds=#s1#", ""};
		{ 18, 33726, "", "=q4=Vengeful Gladiator's Ornamented Spaulders", "=ds=#s3#", ""};
		{ 19, 33722, "", "=q4=Vengeful Gladiator's Ornamented Chestguard", "=ds=", "=ds=#s5#", ""};
		{ 20, 33723, "", "=q4=Vengeful Gladiator's Ornamented Gloves", "=ds=", "=ds=#s9#", ""};
		{ 21, 33725, "", "=q4=Vengeful Gladiator's Ornamented Legplates", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaPriestShadow"] = {
		...
		{ 9, 32035, "", "=q4=Merciless Gladiator's Satin Hood", "=ds=", "=ds=#s1#", ""};
		{ 10, 32037, "", "=q4=Merciless Gladiator's Satin Mantle", "=ds=", "=ds=#s3#", ""};
		{ 11, 32038, "", "=q4=Merciless Gladiator's Satin Robe", "=ds=", "=ds=#s5#", ""};
		{ 12, 32034, "", "=q4=Merciless Gladiator's Satin Gloves", "=ds=", "=ds=#s9#", ""};
		{ 13, 32036, "", "=q4=Merciless Gladiator's Satin Leggings", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Shadow_AntiShadow", "=q6=#arenas5_1#", "=q1=#m36#"};
		{ 17, 33745, "", "=q4=Vengeful Gladiator's Satin Hood", "=ds=", "=ds=#s1#", ""};
		{ 18, 33747, "", "=q4=Vengeful Gladiator's Satin Mantle", "=ds=#s3#", ""};
		{ 19, 33748, "", "=q4=Vengeful Gladiator's Satin Robe", "=ds=", "=ds=#s5#", ""};
		{ 20, 33744, "", "=q4=Vengeful Gladiator's Satin Gloves", "=ds=", "=ds=#s9#", ""};
		{ 21, 33746, "", "=q4=Vengeful Gladiator's Satin Leggings", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaPriestHoly"] = {
		...
		{ 9, 32016, "", "=q4=Merciless Gladiator's Mooncloth Hood", "=ds=", "=ds=#s1#", ""};
		{ 10, 32018, "", "=q4=Merciless Gladiator's Mooncloth Mantle", "=ds=", "=ds=#s3#", ""};
		{ 11, 32019, "", "=q4=Merciless Gladiator's Mooncloth Robe", "=ds=", "=ds=#s5#", ""};
		{ 12, 32015, "", "=q4=Merciless Gladiator's Mooncloth Gloves", "=ds=", "=ds=#s9#", ""};
		{ 13, 32017, "", "=q4=Merciless Gladiator's Mooncloth Leggings", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Holy_PowerWordShield", "=q6=#arenas5_2#", "=q1=#m36#"};
		{ 17, 33718, "", "=q4=Vengeful Gladiator's Mooncloth Hood", "=ds=", "=ds=#s1#", ""};
		{ 18, 33720, "", "=q4=Vengeful Gladiator's Mooncloth Mantle", "=ds=#s3#", ""};
		{ 19, 33721, "", "=q4=Vengeful Gladiator's Mooncloth Robe", "=ds=", "=ds=#s5#", ""};
		{ 20, 33717, "", "=q4=Vengeful Gladiator's Mooncloth Gloves", "=ds=", "=ds=#s9#", ""};
		{ 21, 33719, "", "=q4=Vengeful Gladiator's Mooncloth Leggings", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaRogue"] = {
		...
		{ 9, 31999, "", "=q4=Merciless Gladiator's Leather Helm", "=ds=", "=ds=#s1#", ""};
		{ 10, 32001, "", "=q4=Merciless Gladiator's Leather Spaulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 32002, "", "=q4=Merciless Gladiator's Leather Tunic", "=ds=", "=ds=#s5#", ""};
		{ 12, 31998, "", "=q4=Merciless Gladiator's Leather Gloves", "=ds=", "=ds=#s9#", ""};
		{ 13, 32000, "", "=q4=Merciless Gladiator's Leather Legguards", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Ability_BackStab", "=q6=#arenas6#", "=q1=#m36#"};
		{ 17, 33701, "", "=q4=Vengeful Gladiator's Leather Helm", "=ds=", "=ds=#s1#", ""};
		{ 18, 33703, "", "=q4=Vengeful Gladiator's Leather Spaulders", "=ds=#s3#", ""};
		{ 19, 33704, "", "=q4=Vengeful Gladiator's Leather Tunic", "=ds=", "=ds=#s5#", ""};
		{ 20, 33700, "", "=q4=Vengeful Gladiator's Leather Gloves", "=ds=", "=ds=#s9#", ""};
		{ 21, 33702, "", "=q4=Vengeful Gladiator's Leather Legguards", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaWarlockDemonology"] = {
		...
		{ 9, 31974, "", "=q4=Merciless Gladiator's Dreadweave Hood", "=ds=", "=ds=#s1#", ""};
		{ 10, 31976, "", "=q4=Merciless Gladiator's Dreadweave Mantle", "=ds=", "=ds=#s3#", ""};
		{ 11, 31977, "", "=q4=Merciless Gladiator's Dreadweave Robe", "=ds=", "=ds=#s5#", ""};
		{ 12, 31973, "", "=q4=Merciless Gladiator's Dreadweave Gloves", "=ds=", "=ds=#s9#", ""};
		{ 13, 31975, "", "=q4=Merciless Gladiator's Dreadweave Leggings", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Shadow_CurseOfTounges", "=q6=#arenas8_1#", "=q1=#m36#"};
		{ 17, 33677, "", "=q4=Vengeful Gladiator's Dreadweave Hood", "=ds=", "=ds=#s1#", ""};
		{ 18, 33679, "", "=q4=Vengeful Gladiator's Dreadweave Mantle", "=ds=#s3#", ""};
		{ 19, 33680, "", "=q4=Vengeful Gladiator's Dreadweave Robe", "=ds=", "=ds=#s5#", ""};
		{ 20, 33676, "", "=q4=Vengeful Gladiator's Dreadweave Gloves", "=ds=", "=ds=#s9#", ""};
		{ 21, 33678, "", "=q4=Vengeful Gladiator's Dreadweave Leggings", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaWarlockDestruction"] = {
		...
		{ 9, 31980, "", "=q4=Merciless Gladiator's Felweave Cowl", "=ds=", "=ds=#s1#", ""};
		{ 10, 31979, "", "=q4=Merciless Gladiator's Felweave Amice", "=ds=", "=ds=#s3#", ""};
		{ 11, 31982, "", "=q4=Merciless Gladiator's Felweave Raiment", "=ds=", "=ds=#s5#", ""};
		{ 12, 31981, "", "=q4=Merciless Gladiator's Felweave Handguards", "=ds=", "=ds=#s9#", ""};
		{ 13, 31983, "", "=q4=Merciless Gladiator's Felweave Trousers", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Shadow_CurseOfTounges", "=q6=#arenas8_2#", "=q1=#m36#"};
		{ 17, 33683, "", "=q4=Vengeful Gladiator's Felweave Cowl", "=ds=", "=ds=#s1#", ""};
		{ 18, 33682, "", "=q4=Vengeful Gladiator's Felweave Amice", "=ds=#s3#", ""};
		{ 19, 33685, "", "=q4=Vengeful Gladiator's Felweave Raiment", "=ds=", "=ds=#s5#", ""};
		{ 20, 33684, "", "=q4=Vengeful Gladiator's Felweave Handguards", "=ds=", "=ds=#s9#", ""};
		{ 21, 33686, "", "=q4=Vengeful Gladiator's Felweave Trousers", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaShamanEnhancement"] = {
		...
		{ 9, 32006, "", "=q4=Merciless Gladiator's Linked Helm", "=ds=", "=ds=#s1#", ""};
		{ 10, 32008, "", "=q4=Merciless Gladiator's Linked Spaulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 32004, "", "=q4=Merciless Gladiator's Linked Armor", "=ds=", "=ds=#s5#", ""};
		{ 12, 32005, "", "=q4=Merciless Gladiator's Linked Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 13, 32007, "", "=q4=Merciless Gladiator's Linked Leggings", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_FireResistanceTotem_01", "=q6=#arenas7_1#", "=q1=#m36#"};
		{ 17, 33708, "", "=q4=Vengeful Gladiator's Linked Helm", "=ds=", "=ds=#s1#", ""};
		{ 18, 33710, "", "=q4=Vengeful Gladiator's Linked Spaulders", "=ds=#s3#", ""};
		{ 19, 33706, "", "=q4=Vengeful Gladiator's Linked Armor", "=ds=", "=ds=#s5#", ""};
		{ 20, 33707, "", "=q4=Vengeful Gladiator's Linked Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 21, 33709, "", "=q4=Vengeful Gladiator's Linked Leggings", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaShamanElemental"] = {
		...
		{ 9, 32011, "", "=q4=Merciless Gladiator's Mail Helm", "=ds=", "=ds=#s1#", ""};
		{ 10, 32013, "", "=q4=Merciless Gladiator's Mail Spaulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 32009, "", "=q4=Merciless Gladiator's Mail Armor", "=ds=", "=ds=#s5#", ""};
		{ 12, 32010, "", "=q4=Merciless Gladiator's Mail Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 13, 32012, "", "=q4=Merciless Gladiator's Mail Leggings", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Nature_Lightning", "=q6=#arenas7_2#", "=q1=#m36#"};
		{ 17, 33713, "", "=q4=Vengeful Gladiator's Mail Helm", "=ds=", "=ds=#s1#", ""};
		{ 18, 33715, "", "=q4=Vengeful Gladiator's Mail Spaulders", "=ds=#s3#", ""};
		{ 19, 33711, "", "=q4=Vengeful Gladiator's Mail Armor", "=ds=", "=ds=#s5#", ""};
		{ 20, 33712, "", "=q4=Vengeful Gladiator's Mail Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 21, 33714, "", "=q4=Vengeful Gladiator's Mail Leggings", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaShamanRestoration"] = {
		...
		{ 9, 32031, "", "=q4=Merciless Gladiator's Ringmail Helm", "=ds=", "=ds=#s1#", ""};
		{ 10, 32033, "", "=q4=Merciless Gladiator's Ringmail Spaulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 32029, "", "=q4=Merciless Gladiator's Ringmail Armor", "=ds=", "=ds=#s5#", ""};
		{ 12, 32030, "", "=q4=Merciless Gladiator's Ringmail Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 13, 32032, "", "=q4=Merciless Gladiator's Ringmail Leggings", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Spell_Nature_HealingWaveGreater", "=q6=#arenas7_3#", "=q1=#m36#"};
		{ 17, 33740, "", "=q4=Vengeful Gladiator's Ringmail Helm", "=ds=", "=ds=#s1#", ""};
		{ 18, 33742, "", "=q4=Vengeful Gladiator's Ringmail Spaulders", "=ds=#s3#", ""};
		{ 19, 33738, "", "=q4=Vengeful Gladiator's Ringmail Armor", "=ds=", "=ds=#s5#", ""};
		{ 20, 33739, "", "=q4=Vengeful Gladiator's Ringmail Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 21, 33741, "", "=q4=Vengeful Gladiator's Ringmail Leggings", "=ds=", "=ds=#s11#", ""};
	...
	AtlasLoot_Data["ArenaWarrior"] = {
		...
		{ 9, 30488, "", "=q4=Merciless Gladiator's Plate Helm", "=ds=", "=ds=#s1#", ""};
		{ 10, 30490, "", "=q4=Merciless Gladiator's Plate Shoulders", "=ds=", "=ds=#s3#", ""};
		{ 11, 30486, "", "=q4=Merciless Gladiator's Plate Chestpiece", "=ds=", "=ds=#s5#", ""};
		{ 12, 30487, "", "=q4=Merciless Gladiator's Plate Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 13, 30489, "", "=q4=Merciless Gladiator's Plate Legguards", "=ds=", "=ds=#s11#", ""};
		{ 16, 0, "Ability_Warrior_BattleShout", "=q6=#arenas9#", "=q1=#m36#"};
		{ 17, 33730, "", "=q4=Vengeful Gladiator's Plate Helm", "=ds=", "=ds=#s1#", ""};
		{ 18, 33732, "", "=q4=Vengeful Gladiator's Plate Shoulders", "=ds=#s3#", ""};
		{ 19, 33728, "", "=q4=Vengeful Gladiator's Plate Chestpiece", "=ds=", "=ds=#s5#", ""};
		{ 20, 33729, "", "=q4=Vengeful Gladiator's Plate Gauntlets", "=ds=", "=ds=#s9#", ""};
		{ 21, 33731, "", "=q4=Vengeful Gladiator's Plate Legguards", "=ds=", "=ds=#s11#", ""};
