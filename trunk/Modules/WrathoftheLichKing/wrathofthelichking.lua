...
---- Emblem of Heroism Items
	...
	AtlasLoot_Data["Naxx80Faerlina"] = {
		...
		{ 19, 39735, "", "=q4=Belt of False Dignity", "=ds=#s10#, #a1#"};
		{ 20, 39727, "", "=q4=Dislocating Handguards", "=ds=#s9#, #a2#"};
		{ 21, 39723, "", "=q4=Fire-Scorched Greathelm", "=ds=#s1#, #a4#"};
		{ 22, 39729, "", "=q4=Bracers of the Tyrant", "=ds=#s8#, #a4#"};
		{ 23, 40075, "", "=q4=Ruthlessness", "=ds=#s13#"};
		{ 24, 40108, "", "=q4=Seized Beauty", "=ds=#s13#"};
		{ 25, 39757, "", "=q4=Idol of Worship", "=ds=#s16#, #w14#"};
		{ 26, 39728, "", "=q4=Totem of Misery", "=ds=#s16#, #w15#"};
	};

	AtlasLoot_Data["Naxx80Maexxna"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j37#", ""};
		{ 2, 39225, "", "=q4=Cloak of Armed Strife", "=ds=#s4#"};
		{ 3, 39230, "", "=q4=Spaulders of the Monstrosity", "=ds=#s3#, #a2#"};
		{ 4, 39224, "", "=q4=Leggings of Discord", "=ds=#s11#, #a2#"};
		{ 5, 39228, "", "=q4=Web Cocoon Grips", "=ds=#s9#, #a4#"};
		{ 6, 39232, "", "=q4=Pendant of Lost Vocations", "=ds=#s2#"};
		{ 7, 39231, "", "=q4=Timeworn Silken Band", "=ds=#s13#"};
		{ 8, 39229, "", "=q4=Embrace of the Spider", "=ds=#s14#"};
		{ 9, 39226, "", "=q4=Maexxna's Femur", "=ds=#h1#, #w6#"};
		{ 10, 39221, "", "=q4=Wraith Spear", "=ds=#w7#"};	
		{ 11, 39233, "", "=q4=Aegis of Damnation", "=ds=#w8#"};
		{ 16, 0, "INV_Box_01", "=q6=#j38#", ""};
		{ 17, 40252, "", "=q4=Cloak of the Shadowed Sun", "=ds=#s4#"};
		{ 18, 40060, "", "=q4=Distorted Limbs", "=ds=#s11#, #a1#"};
		{ 19, 39765, "", "=q4=Sinner's Bindings", "=ds=#s8#, #a2#"};
		{ 20, 39761, "", "=q4=Infectious Skitterer Leggings", "=ds=#s11#, #a2#"};
		{ 21, 39760, "", "=q4=Helm of Diminished Pride", "=ds=#s1#, #a4#"};
		{ 22, 39764, "", "=q4=Bindings of the Hapless Prey", "=ds=#s8#, #a4#"};
		{ 23, 40258, "", "=q4=Forethought Talisman", "=ds=#s14#"};
	};
...
--Plate
	...
	AtlasLoot_Data["DeadlyGladiatorWeapons1"] = {
		...
		{ 5, 42454, "", "=q4=Deadly Gladiator's Mutilator", "=ds=", "1350 #arena# #reqrating# 2030"};
	...
	AtlasLoot_Data["Mounts31"] = {
		{ 1, 0, "INV_Box_01", "=q6=Vendor", ""};
		{ 2, 44225, "", "=q4=Reins of the Armored Brown Bear", "=ec1=#m7#"};
		{ 3, 44226, "", "=q4=Reins of the Armored Brown Bear", "=ec1=#m6#"};
		{ 4, 44230, "", "=q4=Reins of the Wooly Mammoth ", "=ec1=#m7#"};
		{ 5, 44231, "", "=q4=Reins of the Wooly Mammoth ", "=ec1=#m6#"};
		{ 6, 44235, "", "=q4=Reins of the Traveler's Tundra Mammoth", "=ec1=#m7#"};
		{ 7, 44234, "", "=q4=Reins of the Traveler's Tundra Mammoth", "=ec1=#m6#"};
		{ 8, 44689, "", "=q4=Armored Snowy Gryphon", "=ec1=#m7#"};
		{ 9, 44690, "", "=q4=Armored Blue Wind Rider", "=ec1=#m6#"};
		{ 11, 0, "INV_Box_01", "=q6=#j34#", ""};
		{ 12, 43956, "", "=q4=Reins of the Black War Mammoth", "=ec1=#m7#"};
		{ 13, 44077, "", "=q4=Reins of the Black War Mammoth", "=ec1=#m6#"};
		{ 16, 0, "INV_Box_01", "=q6=#j35#", ""};
		{ 17, 43951, "", "=q4=Reins of the Bronze Drake", "=ds=Infinite Corruptor Heroic CoT: Stratholme"};
		{ 18, 44151, "", "=q4=Reins of the Blue Proto-Drake", "=ds=Skadi the Ruthless Heroic Utgarde Pinnacle"};
		{ 19, 43986, "", "=q4=Reins of the Black Drake", "=ds=10 man Obsidian Sanctuary Hard mode"};
		{ 20, 43954, "", "=q4=Reins of the Twilight Drake", "=ds=25 man Obsidian Sanctuary Hard mode"};
		{ 21, 43953, "", "=q4=Reins of the Blue Drake", "=ds=10 man Malygos"};
		{ 22, 43952, "", "=q4=Reins of the Azure Drake", "=ds=25 man Malygos"};
		{ 24, 0, "INV_Box_01", "=q6=Faction Mounts", ""};
		{ 27, 43958, "", "=q4=Reins of the Ice Mammoth", "=ec1=#m7# The Sons of Hodir"};
		{ 28, 44080, "", "=q4=Reins of the Ice Mammoth", "=ec1=#m6# The Sons of Hodir"};
		{ 25, 43961, "", "=q4=Reins of the Grand Ice Mammoth", "=ec1=#m7# The Sons of Hodir"};
		{ 26, 44086, "", "=q4=Reins of the Grand Ice Mammoth", "=ec1=#m6# The Sons of Hodir"};
		{ 29, 43955, "", "=q4=Reins of the Red Drake", "=ds=The Wyrmrest Accord - Exalted"};
		Next = "Mounts32";
		Back = "MOUNTMENU";
	};
	...
	AtlasLoot_Data["Mounts32"] = {
		...
		{ 17, 44223, "", "=q4=Reins of the Black War Bear", "=ec1=#m7#"};
		{ 18, 44224, "", "=q4=Reins of the Black War Bear", "=ec1=#m6#"};
		{ 19, 0, "", "=q4=Black Proto-Drake", "=ds=#m34# #m33#"};
		{ 20, 0, "", "=q4=Plagued Proto-Drake", "=ds="};
		{ 21, 0, "", "=q4=Red Proto-Drake", "=ds="};
		{ 22, 0, "", "=q4=Violet Proto-Drake", "=ds="};
		{ 23, 44178, "", "=q4=Reins of the Albino Drake", "=ds="};
		{ 25, 0, "INV_Box_01", "=q6=Unkown", ""};
		{ 26, 43962, "", "=q4=Reins of the White Polar Bear", "=ds="};
		{ 27, 44168, "", "=q4=Reins of the Time-Lost Proto-Drake", "=ds="};
		{ 28, 0, "", "=q4=White Proto-Drake", "=ds="};
		Prev = "Mounts31";
		Back = "MOUNTMENU";
	};
	...
	AtlasLoot_Data["EmblemofHeroism"] = {
		...
		{ 10, 42950, "", "=q7=Champion Herod's Shoulder", "=ds=#s3#, #a3#", "60 #eofheroism#", "" };
		{ 11, 42951, "", "=q7=Mystical Pauldrons of Elements", "=ds=#s3#, #a3#", "60 #eofheroism#", "" };
