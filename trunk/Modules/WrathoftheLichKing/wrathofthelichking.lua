...
---- Emblem of Triumph Items
	...
	AtlasLoot_Data["TrialoftheCrusaderTwinValkyrs_A"] = {
		...
		{ 13, 47741, "", "=q4=Baelgun's Heavy Crossbow", "=ds=#w3#"};
		{ 14, 47740, "", "=q4=The Diplomat", "=ds=#w5#"};
...
--Plate
	...
	AtlasLoot_Data["T9DeathKnightDPS_H"] = {
		...
		{ 11, 48499, "", "=q4=Koltira's Gauntlets of Triumph", "=ds=#s9#, #a4#", "45 #eoftriumph# 1 #trophyofthecrusade#"};
		{ 12, 48497, "", "=q4=Koltira's Legplates of Triumph", "=ds=#s11#, #a4#", "75 #eoftriumph# 1 #trophyofthecrusade#"};
