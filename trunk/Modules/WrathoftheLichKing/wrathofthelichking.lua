...
---- Emblem of Conquest Items
	...
	AtlasLoot_Data["Naxx80AnubRekhan25Man"] = {
		...
		{ 20, 39714, "", "=q4=Webbed Death", "=ds=#h1#, #w4#"};
		{ 21, 40208, "", "=q4=Cryptfiend's Bite", "=ds=#w7#"};
		{ 22, 39716, "", "=q4=Shield of Assimilation", "=ds=#w8#"};
		{ 23, 39712, "", "=q4=Gemmed Wand of the Nerubians", "=ds=#w12#"};
	...
	AtlasLoot_Data["Naxx80Noth25Man"] = {
		{ 1, 40602, "", "=q4=Robes of Mutation", "=ds=#s5#, #a1#"};
		{ 2, 40198, "", "=q4=Bands of Impurity", "=ds=#s8#, #a1#"};
		{ 3, 40197, "", "=q4=Gloves of the Fallen Wizard", "=ds=#s9#, #a1#"};
		{ 4, 40186, "", "=q4=Thrusting Bands", "=ds=#s8#, #a2#"};
		{ 5, 40200, "", "=q4=Belt of Potent Chanting", "=ds=#s10#, #a2#"};
		{ 6, 40193, "", "=q4=Tunic of Masked Suffering", "=ds=#s5#, #a3#"};
		{ 7, 40196, "", "=q4=Legguards of the Undisturbed", "=ds=#s11#, #a3#"};
		{ 8, 40184, "", "=q4=Crippled Treads", "=ds=#s12#, #a3#"};
		{ 9, 40185, "", "=q4=Shoulderguards of Opportunity", "=ds=#s3#, #a4#"};
		{ 10, 40188, "", "=q4=Gauntlets of the Disobediant", "=ds=#s9#, #a4#"};
		{ 11, 40187, "", "=q4=Poignant Sabatons", "=ds=#s12#, #a4#"};
		{ 12, 40071, "", "=q4=Chains of Adoration", "=ds=#s2#"};
		{ 13, 40065, "", "=q4=Fool's Trial", "=ds=#s2#"};
		{ 14, 40069, "", "=q4=Heritage", "=ds=#s2#"};
		{ 15, 40064, "", "=q4=Thunderstorm Amulet", "=ds=#s2#"};
		...
		{ 17, 40075, "", "=q4=Ruthlessness", "=ds=#s13#"};
		{ 18, 40107, "", "=q4=Sand-Worn Band", "=ds=#s13#"};
		{ 29, 40074, "", "=q4=Strong-Handed Ring", "=ds=#s13#"};
		{ 20, 40192, "", "=q4=Accursed Spine", "=ds=#s15#" };
		{ 21, 40191, "", "=q4=Libram of Radiance", "=ds=#s16#, #w16#"};
		{ 22, 40189, "", "=q4=Angry Dread", "=ds=#h1#, #w6#"};
		{ 23, 40190, "", "=q4=Spinning Fate", "=ds=#w11#"};
	...
	AtlasLoot_Data["UlduarLeviathan"] = {
		...
		{ 3, 45288, "", "=q4=Firestrider Chestguard", "=ds=#s5#, #a3#"};
		{ 4, 45283, "", "=q4=Flamewatch Armguards", "=ds=#s8#, #a4#"};
		{ 5, 45285, "", "=q4=Might of the Leviathan", "=ds=#s2#"};
		{ 6, 45292, "", "=q4=Energy Siphon", "=ds=#s14#"};
		{ 7, 45286, "", "=q4=Pyrite Infuser", "=ds=#s14#"};
		{ 8, 45284, "", "=q4=Kinetic Ripper", "=ds=#h4#, #w13#"};
		{ 9, 45287, "", "=q4=Firesoul", "=ds=#h3#, #w10#"};
	...
	AtlasLoot_Data["UlduarLeviathan25Man"] = {
		...
		{ 4, 45117, "", "=q4=Constructor's Handwraps", "=ds=#s9#, #a1#"};
		{ 5, 45119, "", "=q4=Embrace of the Leviathan", "=ds=#s10#, #a1#"};
		{ 6, 45108, "", "=q4=Mechanist's Bindings", "=ds=#s8#, #a2#"};
		{ 7, 45118, "", "=q4=Steamworker's Goggles", "=ds=#s1#, #a3#"};
		{ 8, 45109, "", "=q4=Gloves of the Fiery Behemoth", "=ds=#s9#, #a3#"};
		{ 9, 45107, "", "=q4=Iron Riveted War Helm", "=ds=#s1#, #a4#"};
		{ 10, 45111, "", "=q4=Mimiron's Inferno Couplings", "=ds=#s8#, #a4#"};
		{ 11, 45116, "", "=q4=Freya's Choker of Warding", "=ds=#s2#"};
		{ 12, 45113, "", "=q4=Glowing Ring of Reclamation", "=ds=#s13#"};
		{ 13, 45106, "", "=q4=Strength of the Automaton", "=ds=#s13#"};
		{ 14, 45112, "", "=q4=The Leviathan's Coil", "=ds=#s13#"};
		{ 15, 45115, "", "=q4=Overcharged Fuel Rod", "=ds=#s15#"};
	...
	AtlasLoot_Data["UlduarRazorscale25Man"] = {
		{ 1, 45038, "", "=q5=Fragment of Val'anyr", "=ds=#m3#"};
		{ 2, 46017, "", "=q5=Val'anyr, Hammer of Ancient Kings", "=q1=#m4#: =ds=#h1#, #w6#"};
		{ 4, 45138, "", "=q4=Drape of the Drakerider", "=ds=#s4#"};
		{ 5, 45150, "", "=q4=Collar of the Wyrmhunter", "=ds=#s1#, #a1#"};
		{ 6, 45146, "", "=q4=Shackles of the Odalisque", "=ds=#s8#, #a1#"};
		{ 7, 45149, "", "=q4=Bracers of the Broodmother", "=ds=#s8#, #a2#"};
		{ 8, 45141, "", "=q4=Proto-hide Leggings", "=ds=#s11#, #a2#"};
		{ 9, 45151, "", "=q4=Belt of the Fallen Wyrm", "=ds=#s10#, #a3#"};
		{ 10, 45143, "", "=q4=Saronite Mesh Legguards", "=ds=#s11#, #a3#"};
		{ 11, 45140, "", "=q4=Razorscale Shoulderguards", "=ds=#s3#, #a4#"};
		{ 12, 45139, "", "=q4=Dragonslayer's Brace", "=ds=#s10#, #a4#"};
		{ 13, 45148, "", "=q4=Living Flame", "=ds=#s14#"};
		{ 14, 45510, "", "=q4=Libram of Discord", "=ds=#s16#, #w16#"};
		{ 15, 45144, "", "=q4=Sigil of Deflection", "=ds=#s16#, #w21#"};
		{ 16, 45142, "", "=q4=Remorse", "=ds=#h1#, #w10#"};
		{ 17, 45147, "", "=q4=Guiding Star", "=ds=#h3#, #w6#"};
		{ 18, 45137, "", "=q4=Veranus' Bane", "=ds=#w5#"};
	...
	AtlasLoot_Data["UlduarIgnis25Man"] = {
		...
		{ 5, 45185, "", "=q4=Flamewrought Cinch", "=ds=#s10#, #a2#"};
		{ 6, 45162, "", "=q4=Flamestalker Boots", "=ds=#s12#, #a2#"};
		...
		{ 12, 45157, "", "=q4=Cindershard Ring", "=ds=#s13#"};
		{ 13, 45168, "", "=q4=Pyrelight Circle", "=ds=#s13#"};
	...
	AtlasLoot_Data["UlduarDeconstructor"] = {
		...
		{ 8, 45675, "", "=q4=Power Enhancing Loop", "=ds=#s13#"};
		{ 9, 45685, "", "=q4=Plasma Foil", "=ds=#h3#, #w4#"};
		{ 10, 45682, "", "=q4=Pulsing Spellshield", "=ds=#w8#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 17, 45869, "", "=q4=Fluxing Energy Coils", "=ds=#s8#, #a2#"};
		{ 18, 45867, "", "=q4=Breastplate of the Stoneshaper", "=ds=#s5#, #a3#"};
		{ 19, 45871, "", "=q4=Seal of Ulduar", "=ds=#s13#"};
		{ 20, 45868, "", "=q4=Aesir's Edge", "=ds=#h2#, #w10#"};
		{ 21, 45870, "", "=q4=Magnetized Projectile Emitter", "=ds=#w5#"};
		Prev = "UlduarIgnis";
	...
	AtlasLoot_Data["UlduarDeconstructor25Man"] = {
		{ 1, 45038, "", "=q5=Fragment of Val'anyr", "=ds=#m3#"};
		{ 2, 46017, "", "=q5=Val'anyr, Hammer of Ancient Kings", "=q1=#m4#: =ds=#h1#, #w6#"};
		{ 4, 45253, "", "=q4=Mantle of Wavering Calm", "=ds=#s3#, #a1#"};
		{ 5, 45258, "", "=q4=Sandals of Rash Temperament", "=ds=#s12#, #a1#"};
		{ 6, 45260, "", "=q4=Boots of Hasty Revival", "=ds=#s12#, #a2#"};
		{ 7, 45259, "", "=q4=Quartz-studded Harness", "=ds=#s5#, #a3#"};
		{ 8, 45249, "", "=q4=Brass-lined Boots", "=ds=#s12#, #a3#"};
		{ 9, 45251, "", "=q4=Shoulderplates of the Deconstructor", "=ds=#s3#, #a4#"};
		{ 10, 45252, "", "=q4=Horologist's Wristguards", "=ds=#s8#, #a4#"};
		{ 11, 45248, "", "=q4=Clockwork Legplates", "=ds=#s11#, #a4#"};
		{ 12, 45250, "", "=q4=Crazed Construct Ring", "=ds=#s13#"};
		{ 13, 45247, "", "=q4=Signet of the Earthshaker", "=ds=#s13#"};
		{ 14, 45254, "", "=q4=Sigil of the Vengeful Heart", "=ds=#s16#, #w21#"};
		{ 15, 45255, "", "=q4=Thunderfall Totem", "=ds=#s16#, #w15#"};
		{ 16, 45246, "", "=q4=Golem-Shard Sticker", "=ds=#h1#, #w4#"};
		{ 17, 45256, "", "=q4=Twisted Visage", "=ds=#w9#"};
		{ 18, 45257, "", "=q4=Quartz Crystal Wand", "=ds=#w12#", "" };
		{ 20, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 21, 45446, "", "=q4=Grasps of Reason", "=ds=#s8#, #a1#"};
		{ 22, 45444, "", "=q4=Gloves of the Steady Hand", "=ds=#s9#, #a2#"};
		{ 23, 45445, "", "=q4=Breastplate of the Devoted", "=ds=#s5#, #a4#"};
		{ 24, 45443, "", "=q4=Charm of Meticulous Timing", "=ds=#s2#"};
		{ 25, 45442, "", "=q4=Sorthalis, Hammer of the Watchers", "=ds=#h1#, #w6#"};
		Prev = "UlduarIgnis25Man";
		Next = "UlduarIronCouncil25Man";
	};

	AtlasLoot_Data["UlduarIronCouncil"] = {
		{ 1, 45322, "", "=q4=Cloak of the Iron Council", "=ds=#s4#"};
		...
		{ 9, 45332, "", "=q4=Stormtip", "=ds=#h3#, #w4#"};
		{ 10, 45331, "", "=q4=Rune-Etched Nightblade", "=ds=#h1#, #w10#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 17, 45455, "", "=q4=Belt of the Crystal Tree", "=ds=#s10#, #a2#"};
		{ 18, 45330, "", "=q4=Greaves of Iron Intensity", "=ds=#s12#, #a4#"};
		{ 19, 45447, "", "=q4=Watchful Eye", "=ds=#s2#"};
		{ 20, 45456, "", "=q4=Loop of the Agile", "=ds=#s13#"};
		{ 21, 45449, "", "=q4=The Masticator", "=ds=#h3#, #w13#"};
		{ 22, 45448, "", "=q4=Perilous Bite", "=ds=#h1#, #w4#"};
		{ 23, 45506, "", "=q4=Archivum Data Disc", "=ds=#m2#"};
	...
	AtlasLoot_Data["UlduarIronCouncil25Man"] = {
		{ 1, 45038, "", "=q5=Fragment of Val'anyr", "=ds=#m3#"};
		{ 2, 46017, "", "=q5=Val'anyr, Hammer of Ancient Kings", "=q1=#m4#: =ds=#h1#, #w6#"};
		{ 4, 45224, "", "=q4=Drape of the Lithe", "=ds=#s4#"};
		{ 5, 45240, "", "=q4=Raiments of the Iron Council", "=ds=#s5#, #a1#"};
		{ 6, 45238, "", "=q4=Overload Legwraps", "=ds=#s11#, #a1#"};
		{ 7, 45237, "", "=q4=Phaelia's Vestments of the Sprouting Seed", "=ds=#s5#, #a2#"};
		{ 8, 45232, "", "=q4=Runed Ironhide Boots", "=ds=#s12#, #a2#"};
		{ 9, 45227, "", "=q4=Iron-studded Mantle", "=ds=#s3#, #a3#"};
		{ 10, 45239, "", "=q4=Runeshaper's Gloves", "=ds=#s9#, #a3#"};
		{ 11, 45226, "", "=q4=Ancient Iron Heaume", "=ds=#s1#, #a4#"};
		{ 12, 45225, "", "=q4=Steelbreaker's Embrace", "=ds=#s5#, #a4#"};
		{ 13, 45228, "", "=q4=Handguards of the Enclave", "=ds=#s9#, #a4#"};
		{ 14, 45193, "", "=q4=Insurmountable Fervor", "=ds=#s2#"};
		{ 15, 45236, "", "=q4=Unblinking Eye", "=ds=#s2#"};
		{ 16, 45235, "", "=q4=Radiant Seal", "=ds=#s13#"};
		{ 17, 45233, "", "=q4=Rune Edge", "=ds=#h2#, #w10#"};
		{ 18, 45234, "", "=q4=Rapture", "=ds=#w9#"};
		{ 20, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 21, 45242, "", "=q4=Drape of Mortal Downfall", "=ds=#s4#"};
		{ 22, 45245, "", "=q4=Shoulderpads of the Intruder", "=ds=#s3#, #a2#"};
		{ 23, 45244, "", "=q4=Greaves of Swift Vengeance", "=ds=#s12#, #a3#"};
		{ 24, 45241, "", "=q4=Belt of Colossal Rage", "=ds=#s10#, #a4#"};
		{ 25, 45243, "", "=q4=Sapphire Amulet of Renewal", "=ds=#s2#"};
		{ 26, 45607, "", "=q4=Fang of Oblivion", "=ds=#h1#, #w4#"};
		{ 27, 45857, "", "=q4=Archivum Data Disc", "=ds=#m2#"};
		Prev = "UlduarDeconstructor25Man";
		Next = "UlduarKologarn25Man";
	};

	AtlasLoot_Data["UlduarKologarn"] = {
		{ 1, 45704, "", "=q4=Shawl of the Shattered Giant", "=ds=#s4#"};
		{ 2, 45701, "", "=q4=Greaves of the Earthbinder", "=ds=#s12#, #a3#"};
		{ 3, 45697, "", "=q4=Shoulderguards of the Solemn Watch", "=ds=#s3#, #a4#"};
		{ 4, 45698, "", "=q4=Sabatons of the Iron Watcher", "=ds=#s12#, #a4#"};
		{ 5, 45696, "", "=q4=Mark of the Unyielding", "=ds=#s2#"};
		{ 6, 45699, "", "=q4=Pendant of the Piercing Glare", "=ds=#s2#"};
		{ 7, 45702, "", "=q4=Emerald Signet Ring", "=ds=#s13#"};
	...
	AtlasLoot_Data["UlduarKologarn25Man"] = {
		{ 1, 45038, "", "=q5=Fragment of Val'anyr", "=ds=#m3#"};
		{ 2, 46017, "", "=q5=Val'anyr, Hammer of Ancient Kings", "=q1=#m4#: =ds=#h1#, #w6#"};
		{ 4, 45272, "", "=q4=Robes of the Umbral Brute", "=ds=#s5#, #a1#"};
		{ 5, 45275, "", "=q4=Bracers of Unleashed Magic", "=ds=#s8#, #a1#"};
		{ 6, 45273, "", "=q4=Handwraps of Plentiful Recovery", "=ds=#s9#, #a1#"};
		{ 7, 45265, "", "=q4=Shoulderpads of the Monolith", "=ds=#s3#, #a2#"};
		{ 8, 45274, "", "=q4=Leggings of the Stoneweaver", "=ds=#s11#, #a3#"};
		{ 9, 45264, "", "=q4=Decimator's Armguards", "=ds=#s8#, #a4#"};
		{ 10, 45269, "", "=q4=Unfaltering Armguards", "=ds=#s8#, #a4#"};
		{ 11, 45268, "", "=q4=Gloves of the Pythonic Guardian", "=ds=#s9#, #a4#"};
		{ 12, 45267, "", "=q4=Saronite Plated Legguards", "=ds=#s11#, #a4#"};
		{ 13, 45262, "", "=q4=Necklace of Unerring Mettle", "=ds=#s2#"};
		{ 14, 45263, "", "=q4=Wrathstone", "=ds=#s14#"};
		{ 15, 45271, "", "=q4=Ironmender", "=ds=#s15#"};
	...
	AtlasLoot_Data["UlduarAlgalon"] = {
		...
		{ 2, 46045, "", "=q4=Pulsar Gloves", "=ds=#s9#, #a1#"};
		...
		{ 11, 46040, "", "=q4=Strength of the Heavens", "=ds=#s2#"};
		{ 12, 46048, "", "=q4=Band of Lights", "=ds=#s13#"};
		{ 13, 46038, "", "=q4=Dark Matter", "=ds=#s13#"};
		{ 14, 46046, "", "=q4=Nebula Band", "=ds=#s13#"};
		{ 15, 46051, "", "=q4=Meteorite Crystal", "=ds=#s14#"};
		{ 16, 46052, "", "=q4=Reply-Code Alpha", "=ds=#m2#"};
	...
	AtlasLoot_Data["UlduarAlgalon25Man"] = {
		...
		{ 8, 45607, "", "=q4=Fang of Oblivion", "=ds=#h1#, #w4#"};
		{ 9, 45612, "", "=q4=Constellus", "=ds=#h3#, #w6#"};
		{ 10, 45613, "", "=q4=Dreambinder", "=ds=#w9#"};
		{ 11, 45587, "", "=q4=Bulwark of Algalon", "=ds=#w8#"};
		{ 12, 45570, "", "=q4=Skyforge Crossbow", "=ds=#w3#"};
		{ 16, 46053, "", "=q4=Reply-Code Alpha", "=ds=#m2#"};
	...
	AtlasLoot_Data["UlduarAuriaya25Man"] = {
		{ 1, 45038, "", "=q5=Fragment of Val'anyr", "=ds=#m3#"};
		{ 2, 46017, "", "=q5=Val'anyr, Hammer of Ancient Kings", "=q1=#m4#: =ds=#h1#, #w6#"};
		{ 4, 45319, "", "=q4=Cloak of the Makers", "=ds=#s4#"};
		{ 5, 45435, "", "=q4=Cowl of the Absolute", "=ds=#s1#, #a1#"};
		{ 6, 45441, "", "=q4=Sandals of the Ancient Keeper", "=ds=#s12#, #a1#"};
		{ 7, 45439, "", "=q4=Unwavering Stare", "=ds=#s1#, #a2#"};
		{ 8, 45325, "", "=q4=Gloves of the Stonereaper", "=ds=#s9#, #a2#"};
		{ 9, 45440, "", "=q4=Amice of the Stoic Watch", "=ds=#s3#, #a3#"};
		{ 10, 45320, "", "=q4=Shoulderplates of the Eternal", "=ds=#s3#, #a4#"};
		{ 11, 45334, "", "=q4=Unbreakable Chestguard", "=ds=#s5#, #a4#"};
		{ 12, 45434, "", "=q4=Greaves of the Rockmender", "=ds=#s12#, #a4#"};
		{ 13, 45326, "", "=q4=Platinum Band of the Aesir", "=ds=#s13#"};
		{ 14, 45438, "", "=q4=Ring of the Faithful Servant", "=ds=#s13#"};
		{ 15, 45436, "", "=q4=Libram of the Resolute", "=ds=#s16#, #w16#"};
		{ 16, 45437, "", "=q4=Runescribed Blade", "=ds=#h3#, #w10#"};
		{ 17, 45315, "", "=q4=Stonerender", "=ds=#h1#, #w6#"};
		{ 18, 45327, "", "=q4=Siren's Cry", "=ds=#w2#"};
		Prev = "UlduarKologarn25Man";
		Next = "UlduarHodir25Man";
	};

	AtlasLoot_Data["UlduarHodir"] = {
		{ 1, 45873, "", "=q4=Winter's Frigid Embrace", "=ds=#s4#"};
		{ 2, 45464, "", "=q4=Cowl of Icy Breaths", "=ds=#s1#, #a1#"};
		{ 3, 45874, "", "=q4=Signet of Winter", "=ds=#s13#"};
		{ 4, 45458, "", "=q4=Stormedge", "=ds=#h2#, #w1#"};
		{ 5, 45872, "", "=q4=Avalanche", "=ds=#w2#"};
		{ 7, 45650, "", "=q4=Leggings of the Wayward Conqueror", "=ds=#e15#"};
		{ 8, 45651, "", "=q4=Leggings of the Wayward Protector", "=ds=#e15#"};
		{ 9, 45652, "", "=q4=Leggings of the Wayward Vanquisher", "=ds=#e15#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 17, 45888, "", "=q4=Bitter Cold Armguards", "=ds=#s8#, #a4#"};
		{ 18, 45876, "", "=q4=Shiver", "=ds=#h1#, #w6#"};
		{ 19, 45886, "", "=q4=Icecore Staff", "=ds=#w9#"};
		{ 20, 45887, "", "=q4=Ice Layered Barrier", "=ds=#w8#"};
		{ 21, 45877, "", "=q4=The Boreal Guard", "=ds=#w8#"};
		{ 23, 45786, "", "=q1=Hodir's Sigil", "=ds=#m3#"};
		Prev = "UlduarAuriaya";
		Next = "UlduarThorim";
	};
	...
	AtlasLoot_Data["UlduarHodir25Man"] = {
		{ 1, 45038, "", "=q5=Fragment of Val'anyr", "=ds=#m3#"};
		{ 2, 46017, "", "=q5=Val'anyr, Hammer of Ancient Kings", "=q1=#m4#: =ds=#h1#, #w6#"};
		{ 4, 45453, "", "=q4=Winter's Icy Embrace", "=ds=#s5#, #a2#"};
		{ 5, 45454, "", "=q4=Frost-bound Chain Bracers", "=ds=#s8#, #a3#"};
		{ 6, 45452, "", "=q4=Frostplate Greaves", "=ds=#s11#, #a4#"};
		{ 7, 45451, "", "=q4=Frozen Loop", "=ds=#s13#"};
		{ 8, 45450, "", "=q4=Northern Barrier", "=ds=#w8#"};
		{ 10, 45632, "", "=q4=Breastplate of the Wayward Conqueror", "=ds=#e15#"};
		{ 11, 45633, "", "=q4=Breastplate of the Wayward Protector", "=ds=#e15#"};
		{ 12, 45634, "", "=q4=Breastplate of the Wayward Vanquisher", "=ds=#e15#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		...
		{ 21, 45612, "", "=q4=Constellus", "=ds=#h3#, #w6#"};
		{ 22, 45457, "", "=q4=Staff of Endless Winter", "=ds=#w9#"};
		{ 24, 45815, "", "=q1=Hodir's Sigil", "=ds=#m3#"};
		Prev = "UlduarAuriaya25Man";
		Next = "UlduarThorim25Man";
	};

	AtlasLoot_Data["UlduarThorim"] = {
		{ 1, 45893, "", "=q4=Guise of the Midgard Serpent", "=ds=#s1#, #a2#"};
		{ 2, 45927, "", "=q4=Handwraps of Resonance", "=ds=#s9#, #a1#"};
		{ 3, 45894, "", "=q4=Leggings of Unstable Discharge", "=ds=#s11#, #a1#"};
		{ 4, 45895, "", "=q4=Belt of the Blood Pit", "=ds=#s10#, #a3#"};
		{ 5, 45892, "", "=q4=Legacy of Thunder", "=ds=#h1# #w6#"};
		{ 7, 45659, "", "=q4=Spaulders of the Wayward Conqueror", "=ds=#e15#"};
		{ 8, 45660, "", "=q4=Spaulders of the Wayward Protector", "=ds=#e15#"};
		{ 9, 45661, "", "=q4=Spaulders of the Wayward Vanquisher", "=ds=#e15#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 17, 45928, "", "=q4=Gauntlets of the Thunder God", "=ds=#s9#, #a4#"};
		{ 18, 45933, "", "=q4=Pendant of the Shallow Grave", "=ds=#s2#"};
		{ 19, 45931, "", "=q4=Mjolnir Runestone", "=ds=#s14#"};	
		{ 20, 45929, "", "=q4=Sif's Remembrance", "=ds=#s14#"};
		{ 21, 45930, "", "=q4=Combatant's Bootblade", "=ds=#h1# #w4#"};
		{ 23, 45784, "", "=q1=Thorim's Sigil", "=ds=#m3#"};
		Prev = "UlduarHodir";
		Next = "UlduarFreya";
	};
	...
	AtlasLoot_Data["UlduarThorim25Man"] = {
		{ 1, 45038, "", "=q5=Fragment of Val'anyr", "=ds=#m3#"};
		{ 2, 46017, "", "=q5=Val'anyr, Hammer of Ancient Kings", "=q1=#m4#: =ds=#h1#, #w6#"};
		{ 4, 45468, "", "=q4=Leggings of Lost Love", "=ds=#s11#, #a1#"};
		{ 5, 45467, "", "=q4=Belt of the Betrayed", "=ds=#s10#, #a3#"};
		{ 6, 45469, "", "=q4=Sif's Promise", "=ds=#s13#"};	
		{ 7, 45466, "", "=q4=Scale of Fates", "=ds=#s14#"};
		{ 8, 45463, "", "=q4=Vulmir, the Northern Tempest", "=ds=#h1# #w6#"};	
		{ 10, 45638, "", "=q4=Crown of the Wayward Conqueror", "=ds=#e15#"};
		{ 11, 45639, "", "=q4=Crown of the Wayward Protector", "=ds=#e15#"};
		{ 12, 45640, "", "=q4=Crown of the Wayward Vanquisher", "=ds=#e15#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 17, 45473, "", "=q4=Embrace of the Gladiator", "=ds=#s5#, #a2#"};
		{ 18, 45474, "", "=q4=Pauldrons of the Combatant", "=ds=#s3#, #a3#"};
		{ 19, 45472, "", "=q4=Warhelm of the Champion", "=ds=#s1#, #a4#"};	
		{ 20, 45471, "", "=q4=Fate's Clutch", "=ds=#s13#"};
		{ 21, 45570, "", "=q4=Skyforge Crossbow", "=ds=#w3#"};
		{ 22, 45470, "", "=q4=Wisdom's Hold", "=ds=#w8#"};
		{ 24, 45817, "", "=q1=Thorim's Sigil", "=ds=#m3#"};
		Prev = "UlduarHodir25Man";
		Next = "UlduarFreya25Man";
	};

	AtlasLoot_Data["UlduarFreya"] = {
		{ 1, 45940, "", "=q4=Tunic of the Limber Stalker", "=ds=#s5#, #a2#"};
		{ 2, 45941, "", "=q4=Chestguard of the Lasher", "=ds=#s5#, #a3#"};
		{ 3, 45935, "", "=q4=Ironbark Faceguard", "=ds=#s1#, #a4#"};
		{ 4, 45936, "", "=q4=Legplates of Flourishing Resolve", "=ds=#s11#, #a4#"};
		{ 5, 45934, "", "=q4=Unraveling Reach", "=ds=#w9#"};
		{ 7, 45644, "", "=q4=Gloves of the Wayward Conqueror", "=ds=#e15#"};		
		{ 8, 45645, "", "=q4=Gloves of the Wayward Protector", "=ds=#e15#"};
		{ 9, 45646, "", "=q4=Gloves of the Wayward Vanquisher", "=ds=#e15#"};
		{ 11, 46110, "", "=q3=Alchemist's Cache", "=ds=#p1# (425)"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 17, 45943, "", "=q4=Gloves of Whispering Winds", "=ds=#s9#, #a3#"};
		{ 18, 45945, "", "=q4=Seed of Budding Carnage", "=ds=#s2#"};
		{ 19, 45946, "", "=q4=Fire Orchid Signet", "=ds=#s13#"};
		{ 20, 45947, "", "=q4=Serilas, Blood Blade of Invar One-Arm", "=ds=#h1# #w10#"};
		{ 21, 45294, "", "=q4=Petrified Ivy Sprig", "=ds=#w12#"};
		{ 23, 45788, "", "=q1=Freya's Sigil", "=ds=#m3#"};
		Prev = "UlduarThorim";
		Next = "UlduarMimiron";
	};
	...
	AtlasLoot_Data["UlduarFreya25Man"] = {
		{ 1, 45038, "", "=q5=Fragment of Val'anyr", "=ds=#m3#"};
		{ 2, 46017, "", "=q5=Val'anyr, Hammer of Ancient Kings", "=q1=#m4#: =ds=#h1#, #w6#"};
		{ 4, 45483, "", "=q4=Boots of the Servant", "=ds=#s12#, #a1#"};
		{ 5, 45482, "", "=q4=Leggings of the Lifetender", "=ds=#s11#, #a2#"};
		{ 6, 45481, "", "=q4=Gauntlets of Ruthless Reprisal", "=ds=#s9#, #a4#"};
		{ 7, 45480, "", "=q4=Nymph Heart Charm", "=ds=#s2#"};
		{ 8, 45479, "", "=q4=The Lifebinder", "=ds=#w9#"};
		{ 10, 45653, "", "=q4=Legplates of the Wayward Conqueror", "=ds=#e15#"};
		{ 11, 45654, "", "=q4=Legplates of the Wayward Protector", "=ds=#e15#"};
		{ 12, 45655, "", "=q4=Legplates of the Wayward Vanquisher", "=ds=#e15#"};
		{ 14, 46110, "", "=q3=Alchemist's Cache", "=ds=#p1# (425)"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 17, 45486, "", "=q4=Drape of the Sullen Goddess", "=ds=#s4#"};
		{ 18, 45488, "", "=q4=Leggings of the Enslaved Idol", "=ds=#s11#, #a1#"};
		{ 19, 45487, "", "=q4=Handguards of Revitalization", "=ds=#s9#, #a4#"};
		{ 20, 45485, "", "=q4=Bronze Pendant of the Vanir", "=ds=#s2#"};
		{ 21, 45484, "", "=q4=Bladetwister", "=ds=#h1#, #w4#"};
		{ 22, 45613, "", "=q4=Dreambinder", "=ds=#w9#"};
		{ 24, 45814, "", "=q1=Freya's Sigil", "=ds=#m3#"};
		Prev = "UlduarThorim25Man";
		Next = "UlduarMimiron25Man";
	};

	AtlasLoot_Data["UlduarMimiron"] = {
		{ 1, 45973, "", "=q4=Stylish Power Cape", "=ds=#s4#"};
		{ 2, 45976, "", "=q4=Static Charge Handwraps", "=ds=#s9#, #a1#"};
		{ 3, 45974, "", "=q4=Shoulderguards of Assimilation", "=ds=#s3#, #a2#"};
		{ 4, 45975, "", "=q4=Cable of the Metrognome", "=ds=#s10#, #a4#"};
		{ 5, 45972, "", "=q4=Pulse Baton", "=ds=#h3#, #w6#"};
		{ 7, 45647, "", "=q4=Helm of the Wayward Conqueror", "=ds=#e15#"};
		{ 8, 45648, "", "=q4=Helm of the Wayward Protector", "=ds=#e15#"};
		{ 9, 45649, "", "=q4=Helm of the Wayward Vanquisher", "=ds=#e15#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 17, 45993, "", "=q4=Mimiron's Flight Goggles", "=ds=#s1#, #a2#"};
		{ 18, 45989, "", "=q4=Tempered Mercury Greaves", "=ds=#s12#, #a3#"};
		{ 19, 45982, "", "=q4=Fused Alloy Legplates", "=ds=#s11#, #a4#"};
		{ 20, 45988, "", "=q4=Greaves of the Iron Army", "=ds=#s12#, #a4#"};
		{ 21, 45990, "", "=q4=Fusion Blade", "=ds=#h1#, #w10#"};
		{ 23, 45787, "", "=q1=Mimiron's Sigil", "=ds=#m3#"};
		Prev = "UlduarFreya";
		Next = "UlduarVezax";
	};
	...
	AtlasLoot_Data["UlduarMimiron25Man"] = {
		{ 1, 45038, "", "=q5=Fragment of Val'anyr", "=ds=#m3#"};
		{ 2, 46017, "", "=q5=Val'anyr, Hammer of Ancient Kings", "=q1=#m4#: =ds=#h1#, #w6#"};
		{ 4, 45493, "", "=q4=Asimov's Drape", "=ds=#s4#"};
		{ 5, 45492, "", "=q4=Malleable Steelweave Mantle", "=ds=#s3#, #a2#"};
		{ 6, 45491, "", "=q4=Waistguard of the Creator", "=ds=#s10#, #a2#"};
		{ 7, 45490, "", "=q4=Pandora's Plea", "=ds=#s14#"};
		{ 8, 45489, "", "=q4=Insanity's Grip", "=ds=#h3#, #w13#"};
		{ 10, 45641, "", "=q4=Gauntlets of the Wayward Conqueror", "=ds=#e15#"};
		{ 11, 45642, "", "=q4=Gauntlets of the Wayward Protector", "=ds=#e15#"};
		{ 12, 45643, "", "=q4=Gauntlets of the Wayward Vanquisher", "=ds=#e15#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 17, 45496, "", "=q4=Titanskin Cloak", "=ds=#s4#"};
		...
		{ 24, 45816, "", "=q1=Mimiron's Sigil", "=ds=#m3#"};
		Prev = "UlduarFreya25Man";
		Next = "UlduarVezax25Man";
	};

	AtlasLoot_Data["UlduarVezax"] = {
		{ 1, 46014, "", "=q4=Saronite Animus Cloak", "=ds=#s4#"};
		{ 2, 46013, "", "=q4=Underworld Mantle", "=ds=#s3#, #a1#"};
		{ 3, 46012, "", "=q4=Vestments of the Piercing Light", "=ds=#s5#, #a1#"};
		{ 4, 46009, "", "=q4=Bindings of the Depths", "=ds=#s8#, #a2#"};
		{ 5, 46346, "", "=q4=Boots of Unsettled Prey", "=ds=#s12#, #a3#"};
		{ 6, 45997, "", "=q4=Gauntlets of the Wretched", "=ds=#s9#, #a4#"};
		{ 7, 46008, "", "=q4=Choker of the Abyss", "=ds=#s2#"};
		{ 8, 46015, "", "=q4=Pendant of Endless Despair", "=ds=#s2#"};
		{ 9, 46010, "", "=q4=Darkstone Ring", "=ds=#s13#"};
		{ 10, 46011, "", "=q4=Shadowbite", "=ds=#h1#, #w4#"};
		{ 11, 45996, "", "=q4=Hoperender", "=ds=#w7#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 17, 46032, "", "=q4=Drape of the Faceless General", "=ds=#s4#"};
		{ 18, 46034, "", "=q4=Leggings of Profound Darkness", "=ds=#s11#, #a1#"};
		{ 19, 46036, "", "=q4=Void Sabre", "=ds=#h1#, #w10#"};
		{ 20, 46035, "", "=q4=Aesuga, Hand of the Ardent Champion", "=ds=#h1#, #w6#"};
		{ 21, 46033, "", "=q4=Tortured Earth", "=ds=#w9#"};
		Prev = "UlduarMimiron";
	...
	AtlasLoot_Data["UlduarVezax25Man"] = {
		...
		{ 20, 0, "INV_Box_01", "=q6=#j53#"};
		{ 21, 45520, "", "=q4=Handwraps of the Vigilant", "=ds=#s9#, #a1#"};
		{ 22, 45519, "", "=q4=Vestments of the Blind Denizen", "=ds=#s5#, #a2#"};
		{ 23, 45517, "", "=q4=Pendulum of Infinity", "=ds=#s2#"};
	...
	AtlasLoot_Data["UlduarYoggSaron"] = {
		{ 1, 46030, "", "=q4=Treads of the Dragon Council", "=ds=#s12#, #a1#"};
		{ 2, 46019, "", "=q4=Leggings of the Insatiable", "=ds=#s11#, #a3#"};
		{ 3, 46028, "", "=q4=Faceguard of the Eyeless Horror", "=ds=#s1#, #a4#"};
		{ 4, 46022, "", "=q4=Pendant of a Thousand Maws", "=ds=#s2#"};
		{ 5, 46021, "", "=q4=Royal Seal of King Llane", "=ds=#s14#"};
		{ 6, 46024, "", "=q4=Kingsbane", "=ds=#h1#, #w4#"};
		{ 7, 46016, "", "=q4=Abaddon", "=ds=#h2#, #w10#"};
		{ 8, 46031, "", "=q4=Touch of Madness", "=ds=#h1#, #w1#"};
		{ 9, 46025, "", "=q4=Devotion", "=ds=#w9#"};
		{ 10, 46018, "", "=q4=Deliverance", "=ds=#w3#"};
		{ 12, 45632, "", "=q4=Breastplate of the Wayward Conqueror", "=ds=#e15#"};
		{ 13, 45633, "", "=q4=Breastplate of the Wayward Protector", "=ds=#e15#"};
		{ 14, 45637, "", "=q4=Chestguard of the Wayward Vanquisher", "=ds=#e15#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
	...
	AtlasLoot_Data["UlduarYoggSaron25Man"] = {
		{ 1, 45038, "", "=q5=Fragment of Val'anyr", "=ds=#m3#"};
		{ 2, 46017, "", "=q5=Val'anyr, Hammer of Ancient Kings", "=q1=#m4#: =ds=#h1#, #w6#"};
		{ 4, 45529, "", "=q4=Shawl of Haunted Memories", "=ds=#s4#"};
		{ 5, 45532, "", "=q4=Cowl of Dark Whispers", "=ds=#s1#, #a1#"};
		{ 6, 45523, "", "=q4=Garona's Guise", "=ds=#s1#, #a2#"};
		{ 7, 45524, "", "=q4=Chestguard of Insidious Intent", "=ds=#s5#, #a3#"};
		{ 8, 45531, "", "=q4=Chestguard of the Fallen God", "=ds=#s5#, #a3#"};
		{ 9, 45525, "", "=q4=Godbane Signet", "=ds=#s13#"};
		{ 10, 45530, "", "=q4=Sanity's Bond", "=ds=#s13#"};
		{ 11, 45522, "", "=q4=Blood of the Old God", "=ds=#s14#"};
		{ 12, 45527, "", "=q4=Soulscribe", "=ds=#h3#, #w4#"};
		{ 13, 45521, "", "=q4=Earthshaper", "=ds=#h2#, #w6#"};
		...
		{ 20, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 21, 45537, "", "=q4=Treads of the False Oracle", "=ds=#s12#, #a1#"};
		{ 22, 45536, "", "=q4=Legguards of Cunning Deception", "=ds=#s11#, #a2#"};
		{ 23, 45534, "", "=q4=Seal of the Betrayed King", "=ds=#s13#"};
		{ 24, 45535, "", "=q4=Show of Faith", "=ds=#s14#"};
		{ 25, 45533, "", "=q4=Dark Edge of Depravity", "=ds=#h2#, #w1#"};
	...
	AtlasLoot_Data["UlduarTrash"] = {
		...
		{ 10, 46350, "", "=q4=Pillar of Fortitude", "=ds=#w9#"};
		{ 11, 46342, "", "=q4=Golemheart Longbow", "=ds=#w2#"};	
	};

	AtlasLoot_Data["UlduarTrash25Man"] = {
		{ 1, 45541, "", "=q4=Shroud of Alteration", "=ds=#s4#"};
		{ 2, 45549, "", "=q4=Grips of Chaos", "=ds=#s8#, #a1#"};
		{ 3, 45547, "", "=q4=Relic Hunter's Cord", "=ds=#s10#, #a2#"};
		{ 4, 45548, "", "=q4=Belt of the Sleeper", "=ds=#s10#, #a2#"};
		{ 5, 45543, "", "=q4=Shoulders of Misfortune", "=ds=#s3#, #a3#"};
		{ 6, 45544, "", "=q4=Leggings of the Tortured Earth", "=ds=#s11#, #a3#"};
		{ 7, 45542, "", "=q4=Greaves of the Stonewarder", "=ds=#s12#, #a4#"};
		{ 8, 45540, "", "=q4=Bladebearer's Signet", "=ds=#s13#"};
		{ 9, 45539, "", "=q4=Pendant of Focused Energies", "=ds=#s2#"};	
		{ 10, 45538, "", "=q4=Titanstone Pendant", "=ds=#s2#"};
		{ 11, 46138, "", "=q4=Idol of the Flourishing Life", "=ds=#s16#, #w14#"};
		{ 12, 45605, "", "=q4=Daschal's Bite", "=ds=#h1# #w4#"};
	};
...
--Plate
	...
	AtlasLoot_Data["NaxxShamanRestoration"] = {
		...
		{ 16, 0, "Spell_Nature_HealingWaveGreater", "=q6=#t8s7_3#", "=q5=("..AL["10 Man"]..")"};
		...
		{ 23, 0, "Spell_Nature_HealingWaveGreater", "=q6=#t8s7_3#", "=q5=("..AL["25 Man"]..")"};
	...
	AtlasLoot_Data["NaxxShamanEnhancement"] = {
		...
		{ 16, 0, "Spell_FireResistanceTotem_01", "=q6=#t8s7_2#", "=q5=("..AL["10 Man"]..")"};
		...
		{ 23, 0, "Spell_FireResistanceTotem_01", "=q6=#t8s7_2#", "=q5=("..AL["25 Man"]..")"};
	...
	AtlasLoot_Data["NaxxShamanElemental"] = {
		...
		{ 16, 0, "Spell_Nature_Lightning", "=q6=#t8s7_1#", "=q5=("..AL["10 Man"]..")"};
		...
		{ 23, 0, "Spell_Nature_Lightning", "=q6=#t8s7_1#", "=q5=("..AL["25 Man"]..")"};
	...
	AtlasLoot_Data["NaxxWarriorProtection"] = {
		...
		{ 26, 46164, "", "=q4=Conqueror's Siegebreaker Breastplate", "=ds="..BabbleBoss.Hodir};
	...
	AtlasLoot_Data["PetsQuestCrafted1"] = {
		...
		{ 11, 31760, "", "=q1=Miniwing", "=ds="};
		{ 12, 12529, "", "=q1=Smolderweb Carrier", "=ds="};
		{ 13, 11474, "", "=q1=Sprite Darter Egg", "=ds="};
		{ 14, 12264, "", "=q1=Worg Carrier", "=ds="};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Crafted"], ""};
		{ 17, 15996, "", "=q1=Lifelike Mechanical Toad", "=ds="};
		{ 18, 11826, "", "=q1=Lil' Smoky", "=ds="};
		{ 19, 10398, "", "=q1=Mechanical Chicken", "=ds="};
		{ 20, 4401, "", "=q1=Mechanical Squirrel Box", "=ds="};
		{ 21, 11825, "", "=q1=Pet Bombling", "=ds="};
		{ 22, 21277, "", "=q1=Tranquil Mechanical Yeti", "=ds="};
		Prev = "PetsMerchant2";
		Next = "PetsRare1";
		Back = "PETMENU";
	};
	...
	AtlasLoot_Data["PetsRare1"] = {
		...
		{ 23, 43698, "", "=q1=Giant Sewer Rat", "=ds="};
	...
	AtlasLoot_Data["PetsEvent1"] = {
		...
		{ 3, 32616, "", "=q3=Egbert's Egg", "=ds="};
		{ 4, 32622, "", "=q3=Elekk Training Collar", "=ds="};
		{ 5, 34955, "", "=q3=Scorched Stone", "=ds="};
		{ 6, 33154, "", "=q3=Sinister Squashling", "=ds="};
		{ 7, 32617, "", "=q3=Sleepy Willy", "=ds="};
		{ 8, 44794, "", "=q3=Spring Rabbit's Foot", "=ds="};
		{ 9, 32233, "", "=q3=Wolpertinger's Tankard", "=ds="};
		{ 10, 21301, "", "=q1=Green Helper Box", "=ds="};
		{ 11, 21308, "", "=q1=Jingling Bell", "=ds="};
		{ 12, 23007, "", "=q1=Piglet's Collar", "=ds="};
		{ 13, 23015, "", "=q1=Rat Cage", "=ds="};
		{ 14, 21305, "", "=q1=Red Helper Box", "=ds="};
		{ 15, 21309, "", "=q1=Snowman Kit", "=ds="};
		{ 16, 22235, "", "=q1=Truesilver Shafted Arrow", "=ds="};
		{ 17, 23002, "", "=q1=Turtle Box", "=ds="};
		Prev = "PetsRare1";
	...
	AtlasLoot_Data["PetsPromotional1"] = {
		...
		{ 4, 20371, "", "=q3=Blue Murloc Egg", "=ds="};
		{ 5, 13584, "", "=q3=Diablo Stone", "=ds="};
		{ 6, 39286, "", "=q3=Frosty's Collar", "=ds="};
		{ 7, 37297, "", "=q3=Gold Medallion", "=ds="};
		{ 8, 30360, "", "=q3=Lurky's Egg", "=ds="};
		{ 9, 45180, "", "=q3=Murkimus' Little Spear", "=ds="};
		{ 10, 25535, "", "=q3=Netherwhelp's Collar", "=ds="};
		{ 11, 13583, "", "=q3=Panda Collar", "=ds="};
		{ 12, 22114, "", "=q3=Pink Murloc Egg", "=ds="};
		{ 13, 34492, "", "=q3=Rocket Chicken", "=ds="};
		{ 14, 38050, "", "=q3=Soul-Trader Beacon", "=ds="};
		{ 15, 39656, "", "=q3=Tyrael's Hilt", "=ds="};
		{ 16, 13582, "", "=q3=Zergling Leash", "=ds="};
		Prev = "PetsEvent1";
		Back = "PETMENU";
	};
