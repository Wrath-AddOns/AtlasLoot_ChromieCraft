...
---- Emblem of Triumph Items
	...
	AtlasLoot_Data["VoAArchavon5"] = {
		...
		{ 16, 45624, "", "=q4=Emblem of Conquest", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["VaultofArchavonKoralon_A25Man"] = {
		{ 1, 0, "INV_Box_01", "=q6="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], "=q5="};
	...
	AtlasLoot_Data["VaultofArchavonKoralon2_A25Man"] = {
		...
		Prev = "VaultofArchavonKoralon_A25Man";
	...
	AtlasLoot_Data["TrialoftheCrusaderNorthrendBeasts_A25Man"] = {
		...
		{ 12, 46959, "", "=q4=Band of the Violent Temperment", "=ds=#s13#"};
		{ 13, 46979, "", "=q4=Blade of Tarasque", "=ds=#h3#, #w4#"};
		{ 14, 46958, "", "=q4=Steel Bladebreaker", "=ds=#h1#, #w4#"};
		{ 15, 46963, "", "=q4=Crystal Plated Vanguard", "=ds=#w8#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderNorthrendBeasts_H25Man"] = {
		...
		{ 12, 47252, "", "=q4=Ring of the Violent Temperament", "=ds=#s13#"};
		{ 13, 47261, "", "=q4=Barb of Tarasque", "=ds=#h3#, #w4#"};
		{ 14, 47255, "", "=q4=Stygian Bladebreaker", "=ds=#h1#, #w4#"};
		{ 15, 47260, "", "=q4=Forlorn Barrier", "=ds=#w8#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderLordJaraxxus_A"] = {
		...
		{ 9, 47619, "", "=q4=Amulet of Binding Elements", "=ds=#s2#"};
		{ 10, 47679, "", "=q4=Endurance of the Infernal", "=ds=#s2#"};
		{ 11, 47618, "", "=q4=Firestorm Ring", "=ds=#s13#"};
		{ 12, 47703, "", "=q4=Planestalker Signet", "=ds=#s13#"};
		{ 13, 47676, "", "=q4=Dirk of the Night Watch", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderLordJaraxxus_H"] = {
		...
		{ 9, 47872, "", "=q4=Fortitude of the Infernal", "=ds=#s2#"};
		{ 10, 47864, "", "=q4=Pendant of Binding Elements", "=ds=#s2#"};
		{ 11, 47862, "", "=q4=Firestorm Band", "=ds=#s13#"};
		{ 12, 47868, "", "=q4=Planestalker Band", "=ds=#s13#"};
		{ 13, 47871, "", "=q4=Orcish Deathblade", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderLordJaraxxus_A25Man"] = {
		...
		{ 10, 47043, "", "=q4=Charge of the Demon Lord", "=ds=#s2#"};
		{ 11, 47223, "", "=q4=Ring of the Darkmender", "=ds=#s13#"};
		{ 12, 47041, "", "=q4=Solace of the Defeated", "=ds=#s14#"};
		{ 13, 47053, "", "=q4=Symbol of Transgression", "=ds=#s15#"};
		{ 14, 46996, "", "=q4=Lionhead Slasher", "=ds=#h1#, #w1#"};
		{ 15, 46994, "", "=q4=Talonstrike", "=ds=#w3#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderLordJaraxxus_H25Man"] = {
		...
		{ 10, 47272, "", "=q4=Charge of the Eredar", "=ds=#s2#"};
		{ 11, 47278, "", "=q4=Circle of the Darkmender", "=ds=#s13#"};
		{ 12, 47271, "", "=q4=Solace of the Fallen", "=ds=#s14#"};
		{ 13, 47276, "", "=q4=Talisman of Heedless Sins", "=ds=#s15#"};
		{ 14, 47266, "", "=q4=Blood Fury", "=ds=#h1#, #w1#"};
		{ 15, 47267, "", "=q4=Death's Head Crossbow", "=ds=#w3#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderFactionChampions_A"] = {
		...
		{ 6, 47728, "", "=q4=Binding Light", "=ds=#s14#"};
		{ 7, 47727, "", "=q4=Fervor of the Frostborn", "=ds=#s14#"};
		{ 8, 47726, "", "=q4=Talisman of Volatile Power", "=ds=#s14#"};
		{ 9, 47725, "", "=q4=Victor's Call", "=ds=#s14#"};
		{ 10, 47724, "", "=q4=Blade of the Silver Disciple", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderFactionChampions_H"] = {
		...
		{ 6, 47880, "", "=q4=Binding Stone", "=ds=#s14#"};
		{ 7, 47882, "", "=q4=Eitrigg's Oath", "=ds=#s14#"};
		{ 8, 47879, "", "=q4=Fetish of Volatile Power", "=ds=#s14#"};
		{ 9, 47881, "", "=q4=Vengeance of the Forsaken", "=ds=#s14#"};
		{ 10, 47874, "", "=q4=Sunreaver Disciple's Blade", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderFactionChampions_A25Man"] = {
		...
		{ 12, 47070, "", "=q4=Ring of Callous Aggression", "=ds=#s13#"};
		{ 13, 47080, "", "=q4=Satrina's Impeding Scarab", "=ds=#s14#"};
		{ 14, 47069, "", "=q4=Justicebringer", "=ds=#h2#, #w1#"};
		{ 15, 47079, "", "=q4=Bastion of Purity", "=ds=#w8#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderFactionChampions_H25Man"] = {
		...
		{ 12, 47282, "", "=q4=Band of Callous Aggression", "=ds=#s13#"};
		{ 13, 47290, "", "=q4=Juggernaut's Vitality", "=ds=#s14#"};
		{ 14, 47285, "", "=q4=Dual-blade Butcher", "=ds=#h2#, #w1#"};
		{ 15, 47287, "", "=q4=Bastion of Resolve", "=ds=#w8#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderTwinValkyrs_A"] = {
		...
		{ 7, 47747, "", "=q4=Darkbane Pendant", "=ds=#s2#"};
		{ 8, 47700, "", "=q4=Loop of the Twin Val'kyr", "=ds=#s13#"};
		{ 9, 47742, "", "=q4=Chalice of Benedictus", "=ds=#s15#"};
		{ 10, 47736, "", "=q4=Icefall Blade", "=ds=#h1#, #w4#"};
		{ 11, 47737, "", "=q4=Reckoning", "=ds=#h2#, #w10#"};
		{ 12, 47743, "", "=q4=Enlightenment", "=ds=#w9#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderTwinValkyrs_H"] = {
		...
		{ 7, 47890, "", "=q4=Darkbane Amulet", "=ds=#s2#"};
		{ 8, 47888, "", "=q4=Band of the Twin Val'kyr", "=ds=#s13#"};
		{ 9, 47913, "", "=q4=Lightbane Focus", "=ds=#s15#"};
		{ 10, 47886, "", "=q4=Nemesis Blade", "=ds=#h1#, #w4#"};
		{ 11, 47884, "", "=q4=Edge of Agony", "=ds=#h2#, #w10#"};
		{ 12, 47892, "", "=q4=Illumination", "=ds=#w9#"};
		{ 13, 47883, "", "=q4=Widebarrel Flintlock", "=ds=#w5#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderTwinValkyrs_A25Man"] = {
		...
		{ 9, 47116, "", "=q4=The Arbiter's Muse", "=ds=#s2#"};
		{ 10, 47105, "", "=q4=The Executioner's Malice", "=ds=#s2#"};
		{ 11, 47139, "", "=q4=Wail of the Val'kyr", "=ds=#s2#"};
		{ 12, 47115, "", "=q4=Death's Verdict", "=ds=#s14#"};
		{ 13, 47138, "", "=q4=Chalice of Searing Light", "=ds=#s15#"};
		{ 14, 47104, "", "=q4=Twin Spike", "=ds=#h1#, #w4#"};
		{ 15, 47114, "", "=q4=Lupine Longstaff", "=ds=#w9#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderTwinValkyrs_H25Man"] = {
		...
		{ 9, 47307, "", "=q4=Cry of the Val'kyr", "=ds=#s2#"};
		{ 10, 47305, "", "=q4=Legionnaire's Gorget", "=ds=#s2#"};
		{ 11, 47297, "", "=q4=The Executioner's Vice", "=ds=#s2#"};
		{ 12, 47303, "", "=q4=Death's Choice", "=ds=#s14#"};
		{ 13, 47309, "", "=q4=Mystifying Charm", "=ds=#s15#"};
		{ 14, 47300, "", "=q4=Gouge of the Frigid Heart", "=ds=#h1#, #w4#"};
		{ 15, 47302, "", "=q4=Twin's Pact", "=ds=#w9#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderAnubarak_A"] = {
		...
		{ 9, 47810, "", "=q4=Crusader's Glory", "=ds=#h1#, #w10#" };
		{ 10, 47814, "", "=q4=Westfall Saber", "=ds=#h1#, #w10#" };
		{ 11, 47808, "", "=q4=The Lion's Maw", "=ds=#h1#, #w1#" };
		{ 12, 47809, "", "=q4=Argent Resolve", "=ds=#h3#, #w6#" };
		{ 13, 47816, "", "=q4=The Grinder", "=ds=#h1#, #w6#" };
		{ 14, 47834, "", "=q4=Fordragon Blades", "=ds=#w7#" };
		{ 15, 47815, "", "=q4=Cold Convergence", "=ds=#w9#" };
		{ 16, 47835, "", "=q4=Bulwark of the Royal Guard", "=ds=#w8#" };
	...
	AtlasLoot_Data["TrialoftheCrusaderAnubarak_H"] = {
		...
		{ 9, 47899, "", "=q4=Ardent Guard", "=ds=#h1#, #w10#" };
		{ 10, 47903, "", "=q4=Forsaken Bonecarver", "=ds=#h1#, #w10#" };
		{ 11, 47898, "", "=q4=Frostblade Hatchet", "=ds=#h1#, #w1#" };
		{ 12, 47894, "", "=q4=Mace of the Earthborn Chieftain", "=ds=#h3#, #w6#" };
		{ 13, 47905, "", "=q4=Blackhorn Bludgeon", "=ds=#h1#, #w6#" };
		{ 14, 47911, "", "=q4=Anguish", "=ds=#w7#" };
		{ 15, 47900, "", "=q4=Perdition", "=ds=#w9#" };
		{ 16, 47910, "", "=q4=Aegis of the Coliseum", "=ds=#w8#" };
	...
	AtlasLoot_Data["TrialoftheCrusaderAnubarak_A25Man"] = {
		...
		{ 15, 47054, "", "=q4=Band of Deplorable Violence", "=ds=#s13#"};
		{ 16, 47149, "", "=q4=Signet of the Traitor King", "=ds=#s13#"};
		{ 17, 47182, "", "=q4=Reign of the Unliving", "=ds=#s14#"};
		{ 18, 47148, "", "=q4=Stormpike Cleaver", "=ds=#h1#, #w1#"};
		{ 19, 47193, "", "=q4=Misery's End", "=ds=#h3#, #w6#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderNorthrendBeasts_AHEROIC"] = {
		...
		{ 10, 47915, "", "=q4=Collar of Ceaseless Torment", "=ds=#s2#"};
		{ 11, 47920, "", "=q4=Gormok's Band", "=ds=#s13#"};
		{ 12, 47922, "", "=q4=Rod of Imprisoned Souls", "=ds=#w12#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderNorthrendBeasts_HHEROIC"] = {
		...
		{ 10, 47988, "", "=q4=Collar of Unending Torment", "=ds=#s2#"};
		{ 11, 47993, "", "=q4=Carnivorous Band", "=ds=#s13#"};
		{ 12, 47995, "", "=q4=Scepter of Imprisoned Souls", "=ds=#w12#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderNorthrendBeasts_A25ManHEROIC"] = {
		...
		{ 12, 46966, "", "=q4=Band of the Violent Temperment", "=ds=#s13#"};
		{ 13, 46980, "", "=q4=Blade of Tarasque", "=ds=#h3#, #w4#"};
		{ 14, 46969, "", "=q4=Steel Bladebreaker", "=ds=#h1#, #w4#"};
		{ 15, 46964, "", "=q4=Crystal Plated Vanguard", "=ds=#w8#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderNorthrendBeasts_H25ManHEROIC"] = {
		...
		{ 12, 47413, "", "=q4=Ring of the Violent Temperament", "=ds=#s13#"};
		{ 13, 47422, "", "=q4=Barb of Tarasque", "=ds=#h3#, #w4#"};
		{ 14, 47416, "", "=q4=Stygian Bladebreaker", "=ds=#h1#, #w4#"};
		{ 15, 47421, "", "=q4=Forlorn Barrier", "=ds=#w8#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderLordJaraxxus_AHEROIC"] = {
		...
		{ 9, 47930, "", "=q4=Amulet of Binding Elements", "=ds=#s2#"};
		{ 10, 47939, "", "=q4=Endurance of the Infernal", "=ds=#s2#"};
		{ 11, 47928, "", "=q4=Firestorm Ring", "=ds=#s13#"};
		{ 12, 47934, "", "=q4=Planestalker Signet", "=ds=#s13#"};
		{ 13, 47938, "", "=q4=Dirk of the Night Watch", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderLordJaraxxus_HHEROIC"] = {
		...
		{ 9, 48011, "", "=q4=Fortitude of the Infernal", "=ds=#s2#"};
		{ 10, 48003, "", "=q4=Pendant of Binding Elements", "=ds=#s2#"};
		{ 11, 48001, "", "=q4=Firestorm Band", "=ds=#s13#"};
		{ 12, 48007, "", "=q4=Planestalker Band", "=ds=#s13#"};
		{ 13, 48010, "", "=q4=Orcish Deathblade", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderLordJaraxxus_A25ManHEROIC"] = {
		...
		{ 10, 47060, "", "=q4=Charge of the Demon Lord", "=ds=#s2#"};
		{ 11, 47224, "", "=q4=Ring of the Darkmender", "=ds=#s13#"};
		{ 12, 47059, "", "=q4=Solace of the Defeated", "=ds=#s14#"};
		{ 13, 47064, "", "=q4=Symbol of Transgression", "=ds=#s15#"};
		{ 14, 47001, "", "=q4=Lionhead Slasher", "=ds=#h1#, #w1#"};
		{ 15, 46995, "", "=q4=Talonstrike", "=ds=#w3#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderLordJaraxxus_H25ManHEROIC"] = {
		...
		{ 10, 47433, "", "=q4=Charge of the Eredar", "=ds=#s2#"};
		{ 11, 47439, "", "=q4=Circle of the Darkmender", "=ds=#s13#"};
		{ 12, 47432, "", "=q4=Solace of the Fallen", "=ds=#s14#"};
		{ 13, 47437, "", "=q4=Talisman of Heedless Sins", "=ds=#s15#"};
		{ 14, 47427, "", "=q4=Blood Fury", "=ds=#h1#, #w1#"};
		{ 15, 47428, "", "=q4=Death's Head Crossbow", "=ds=#w3#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderFactionChampions_AHEROIC"] = {
		...
		{ 6, 47947, "", "=q4=Binding Light", "=ds=#s14#"};
		{ 7, 47949, "", "=q4=Fervor of the Frostborn", "=ds=#s14#"};
		{ 8, 47946, "", "=q4=Talisman of Volatile Power", "=ds=#s14#"};
		{ 9, 47948, "", "=q4=Victor's Call", "=ds=#s14#"};
		{ 10, 47941, "", "=q4=Blade of the Silver Disciple", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderFactionChampions_HHEROIC"] = {
		...
		{ 6, 48019, "", "=q4=Binding Stone", "=ds=#s14#"};
		{ 7, 48021, "", "=q4=Eitrigg's Oath", "=ds=#s14#"};
		{ 8, 48018, "", "=q4=Fetish of Volatile Power", "=ds=#s14#"};
		{ 9, 48020, "", "=q4=Vengeance of the Forsaken", "=ds=#s14#"};
		{ 10, 48013, "", "=q4=Sunreaver Disciple's Blade", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderFactionChampions_A25ManHEROIC"] = {
		...
		{ 12, 47075, "", "=q4=Ring of Callous Aggression", "=ds=#s13#"};
		{ 13, 47088, "", "=q4=Satrina's Impeding Scarab", "=ds=#s14#"};
		{ 14, 47078, "", "=q4=Justicebringer", "=ds=#h2#, #w1#"};
		{ 15, 47085, "", "=q4=Bastion of Purity", "=ds=#w8#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderFactionChampions_H25ManHEROIC"] = {
		...
		{ 12, 47443, "", "=q4=Band of Callous Aggression", "=ds=#s13#"};
		{ 13, 47451, "", "=q4=Juggernaut's Vitality", "=ds=#s14#"};
		{ 14, 47446, "", "=q4=Dual-blade Butcher", "=ds=#h2#, #w1#"};
		{ 15, 47448, "", "=q4=Bastion of Resolve", "=ds=#w8#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderTwinValkyrs_AHEROIC"] = {
		...
		{ 7, 47957, "", "=q4=Darkbane Pendant", "=ds=#s2#"};
		{ 8, 47955, "", "=q4=Loop of the Twin Val'kyr", "=ds=#s13#"};
		{ 9, 47958, "", "=q4=Chalice of Benedictus", "=ds=#s15#"};
		{ 10, 47953, "", "=q4=Icefall Blade", "=ds=#h1#, #w4#"};
		{ 11, 47951, "", "=q4=Reckoning", "=ds=#h2#, #w10#"};
		{ 12, 47960, "", "=q4=Enlightenment", "=ds=#w9#"};
		{ 13, 47950, "", "=q4=The Diplomat", "=ds=#w5#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderTwinValkyrs_HHEROIC"] = {
		...
		{ 7, 48030, "", "=q4=Darkbane Amulet", "=ds=#s2#"};
		{ 8, 48027, "", "=q4=Band of the Twin Val'kyr", "=ds=#s13#"};
		{ 9, 48032, "", "=q4=Lightbane Focus", "=ds=#s15#"};
		{ 10, 48025, "", "=q4=Nemesis Blade", "=ds=#h1#, #w4#"};
		{ 11, 48023, "", "=q4=Edge of Agony", "=ds=#h2#, #w10#"};
		{ 12, 48036, "", "=q4=Illumination", "=ds=#w9#"};
		{ 13, 48022, "", "=q4=Widebarrel Flintlock", "=ds=#w5#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderTwinValkyrs_A25ManHEROIC"] = {
		...
		{ 9, 47133, "", "=q4=The Arbiter's Muse", "=ds=#s2#"};
		{ 10, 47110, "", "=q4=The Executioner's Malice", "=ds=#s2#"};
		{ 11, 47144, "", "=q4=Wail of the Val'kyr", "=ds=#s2#"};
		{ 12, 47131, "", "=q4=Death's Verdict", "=ds=#s14#"};
		{ 13, 47146, "", "=q4=Chalice of Searing Light", "=ds=#s15#"};
		{ 14, 47113, "", "=q4=Twin Spike", "=ds=#h1#, #w4#"};
		{ 15, 47130, "", "=q4=Lupine Longstaff", "=ds=#w9#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderTwinValkyrs_H25ManHEROIC"] = {
		...
		{ 9, 47468, "", "=q4=Cry of the Val'kyr", "=ds=#s2#"};
		{ 10, 47466, "", "=q4=Legionnaire's Gorget", "=ds=#s2#"};
		{ 11, 47458, "", "=q4=The Executioner's Vice", "=ds=#s2#"};
		{ 12, 47464, "", "=q4=Death's Choice", "=ds=#s14#"};
		{ 13, 47470, "", "=q4=Mystifying Charm", "=ds=#s15#"};
		{ 14, 47461, "", "=q4=Gouge of the Frigid Heart", "=ds=#h1#, #w4#"};
		{ 15, 47463, "", "=q4=Twin's Pact", "=ds=#w9#"};
		{ 16, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderAnubarak_AHEROIC"] = {
		...
		{ 9, 47967, "", "=q4=Crusader's Glory", "=ds=#h1#, #w10#" };
		{ 10, 47971, "", "=q4=Westfall Saber", "=ds=#h1#, #w10#" };
		{ 11, 47966, "", "=q4=The Lion's Maw", "=ds=#h1#, #w1#" };
		{ 12, 47962, "", "=q4=Argent Resolve", "=ds=#h3#, #w6#" };
		{ 13, 47973, "", "=q4=The Grinder", "=ds=#h1#, #w6#" };
		{ 14, 47979, "", "=q4=Fordragon Blades", "=ds=#w7#" };
		{ 15, 47968, "", "=q4=Cold Convergence", "=ds=#w9#" };
		{ 16, 47978, "", "=q4=Bulwark of the Royal Guard", "=ds=#w8#" };
		{ 17, 47963, "", "=q4=Vigilant Ward", "=ds=#w8#" };
		{ 18, 47975, "", "=q4=Baelgun's Heavy Crossbow", "=ds=#w3#" };
	...
	AtlasLoot_Data["TrialoftheCrusaderAnubarak_HHEROIC"] = {
		...
		{ 9, 48044, "", "=q4=Ardent Guard", "=ds=#h1#, #w10#" };
		{ 10, 48048, "", "=q4=Forsaken Bonecarver", "=ds=#h1#, #w10#" };
		{ 11, 48043, "", "=q4=Frostblade Hatchet", "=ds=#h1#, #w1#" };
		{ 12, 48039, "", "=q4=Mace of the Earthborn Chieftain", "=ds=#h3#, #w6#" };
		{ 13, 48050, "", "=q4=Blackhorn Bludgeon", "=ds=#h1#, #w6#" };
		{ 14, 48056, "", "=q4=Anguish", "=ds=#w7#" };
		{ 15, 48045, "", "=q4=Perdition", "=ds=#w9#" };
		{ 16, 48055, "", "=q4=Aegis of the Coliseum", "=ds=#w8#" };
		{ 17, 48040, "", "=q4=Pride of the Kor'kron", "=ds=#w8#" };
		{ 18, 48052, "", "=q4=Darkmaw Crossbow", "=ds=#w3#" };
	...
	AtlasLoot_Data["TrialoftheCrusaderAnubarak_A25ManHEROIC"] = {
		...
		{ 15, 47237, "", "=q4=Band of Deplorable Violence", "=ds=#s13#"};
		{ 16, 47157, "", "=q4=Signet of the Traitor King", "=ds=#s13#"};
		{ 17, 47188, "", "=q4=Reign of the Unliving", "=ds=#s14#"};
		{ 18, 47156, "", "=q4=Stormpike Cleaver", "=ds=#h1#, #w1#"};
		{ 19, 47206, "", "=q4=Misery's End", "=ds=#h3#, #w6#"};
		{ 20, 47239, "", "=q4=Archon Glaive", "=ds=#w7#"};
		{ 22, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderAnubarak_H25ManHEROIC"] = {
		...
		{ 20, 47491, "", "=q4=Hellion Glaive", "=ds=#w7#"};
		{ 22, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderTribute_AHEROIC"] = {
		{ 1, 0, "INV_Box_01", "=q6="..AL["Bonus Loot"], "=q5="..AL["A Tribute to Skill (25)"]};
		...
		{ 10, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
		{ 12, 0, "INV_Box_01", "=q6="..AL["Bonus Loot"], "=q5="..AL["A Tribute to Insanity (50)"]};
		{ 13, 49047, "", "=q4=Swift Alliance Steed", "=ds=#e12# =ec1=#m7#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderTribute_HHEROIC"] = {
		...
		{ 10, 47242, "", "=q4=Trophy of the Crusade", "=ds=#e15#"};
		{ 12, 0, "INV_Box_01", "=q6="..AL["Bonus Loot"], "=q5="..AL["A Tribute to Insanity (50)"]};
		{ 13, 49046, "", "=q4=Swift Horde Wolf", "=ds=#e12# =ec1=#m6#"};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Bonus Loot"], "=q5="..AL["A Tribute to Mad Skill (45)"]};
	...
	AtlasLoot_Data["TrialoftheCrusaderTribute_A25ManHEROIC"] = {
		{ 1, 0, "INV_Box_01", "=q6="..AL["Bonus Loot"], "=q5="..AL["A Tribute to Skill (25)"]};
		{ 2, 47517, "", "=q4=Blade of the Unbroken Covenant", "=ds=#h3#, #w10#"};
		{ 3, 47506, "", "=q4=Silverwing Defender", "=ds=#h1#, #w10#"};
		{ 4, 47515, "", "=q4=Decimation", "=ds=#h2#, #w10#"};
		{ 5, 47526, "", "=q4=Remorseless", "=ds=#h1#, #w6#"};
		{ 6, 47519, "", "=q4=Catastrophe", "=ds=#h2#, #w6#"};
		{ 7, 47524, "", "=q4=Clemency", "=ds=#w9#"};
		{ 8, 47521, "", "=q4=BRK-1000", "=ds=#w5#"};
		{ 10, 47557, "", "=q4=Regalia of the Grand Conqueror", "=ds=#e15#"};
		{ 11, 47557, "", "=q4=Regalia of the Grand Protector", "=ds=#e15#"};
		{ 12, 47558, "", "=q4=Regalia of the Grand Vanquisher", "=ds=#e15#"};
		--{ 14, 0, "INV_Box_01", "=q6="..AL["Bonus Loot"], "=q5="..AL["A Tribute to Insanity (50)"]};
		--{ 15, 49047, "", "=q4=Swift Alliance Steed", "=ds=#e12# =ec1=#m7#"};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Bonus Loot"], "=q5="..AL["A Tribute to Mad Skill (45)"]};
		{ 17, 47553, "", "=q4=Bolvar's Devotion", "=ds=#s4#"};
		{ 18, 47552, "", "=q4=Jaina's Radiance", "=ds=#s4#"};
		{ 19, 47549, "", "=q4=Magni's Resolution", "=ds=#s4#"};
		{ 20, 47545, "", "=q4=Vereesa's Dexterity", "=ds=#s4#"};
		{ 21, 47547, "", "=q4=Varian's Furor", "=ds=#s4#"};
		{ 23, 47557, "", "=q4=Regalia of the Grand Conqueror", "=ds=#e15#"};
		{ 24, 47557, "", "=q4=Regalia of the Grand Protector", "=ds=#e15#"};
		{ 25, 47558, "", "=q4=Regalia of the Grand Vanquisher", "=ds=#e15#"};
	...
	AtlasLoot_Data["TrialoftheCrusaderTribute_H25ManHEROIC"] = {
		{ 1, 0, "INV_Box_01", "=q6="..AL["Bonus Loot"], "=q5="..AL["A Tribute to Skill (25)"]};
		{ 2, 47518, "", "=q4=Mortalis", "=ds=#h3#, #w10#"};
		{ 3, 47513, "", "=q4=Ogrim's Deflector", "=ds=#h1#, #w10#"};
		{ 4, 47516, "", "=q4=Fleshrender", "=ds=#h2#, #w10#"};
		{ 5, 47528, "", "=q4=Cudgel of the Damned", "=ds=#h1#, #w6#"};
		{ 6, 47520, "", "=q4=Grievance", "=ds=#h2#, #w6#"};
		{ 7, 47525, "", "=q4=Sufferance", "=ds=#w9#"};
		{ 8, 47523, "", "=q4=Fezzik's Autocannon", "=ds=#w5#"};
		{ 10, 47557, "", "=q4=Regalia of the Grand Conqueror", "=ds=#e15#"};
		{ 11, 47557, "", "=q4=Regalia of the Grand Protector", "=ds=#e15#"};
		{ 12, 47558, "", "=q4=Regalia of the Grand Vanquisher", "=ds=#e15#"};
		--{ 14, 0, "INV_Box_01", "=q6="..AL["Bonus Loot"], "=q5="..AL["A Tribute to Insanity (50)"]};
		--{ 15, 49046, "", "=q4=Swift Horde Wolf", "=ds=#e12# =ec1=#m6#"};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Bonus Loot"], "=q5="..AL["A Tribute to Mad Skill (45)"]};
		{ 17, 47551, "", "=q4=Aethas' Intensity", "=ds=#s4#"};
		{ 18, 47550, "", "=q4=Cairne's Endurance", "=ds=#s4#"};
		{ 19, 47548, "", "=q4=Garrosh's Rage", "=ds=#s4#"};
		{ 20, 47554, "", "=q4=Lady Liadrin's Conviction", "=ds=#s4#"};
		{ 21, 47546, "", "=q4=Sylvanas' Cunning", "=ds=#s4#"};
		{ 23, 47557, "", "=q4=Regalia of the Grand Conqueror", "=ds=#e15#"};
		{ 24, 47557, "", "=q4=Regalia of the Grand Protector", "=ds=#e15#"};
		{ 25, 47558, "", "=q4=Regalia of the Grand Vanquisher", "=ds=#e15#"};
	...
	AtlasLoot_Data["PvP80DeathKnight"] = {
		...
		{ 9, 40820, "", "=q4=Hateful Gladiator's Dreadplate Helm", "=ds=", "45 #eofvalor#"};
		{ 10, 40860, "", "=q4=Hateful Gladiator's Dreadplate Shoulders", "=ds=", "30 #eofvalor#"};
		{ 11, 40781, "", "=q4=Hateful Gladiator's Dreadplate Chestpiece", "=ds=", "45 #eofvalor#"};
		{ 12, 40803, "", "=q4=Hateful Gladiator's Dreadplate Gauntlets", "=ds=", "30 #eofvalor#"};
		{ 13, 40841, "", "=q4=Hateful Gladiator's Dreadplate Legguards", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas10#", ""};
		{ 17, 40824, "", "=q4=Deadly Gladiator's Dreadplate Helm", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 40863, "", "=q4=Deadly Gladiator's Dreadplate Shoulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 40784, "", "=q4=Deadly Gladiator's Dreadplate Chestpiece", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 40806, "", "=q4=Deadly Gladiator's Dreadplate Gauntlets", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 40845, "", "=q4=Deadly Gladiator's Dreadplate Legguards", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas10#", ""};
		{ 24, 40827, "", "=q4=Furious Gladiator's Dreadplate Helm", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 40868, "", "=q4=Furious Gladiator's Dreadplate Shoulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 40787, "", "=q4=Furious Gladiator's Dreadplate Chestpiece", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 40809, "", "=q4=Furious Gladiator's Dreadplate Gauntlets", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80DeathKnight2"] = {
		...
		{ 4, 40791, "", "=q4=Relentless Gladiator's Dreadplate Chestpiece", "=ds=", "2150 #arena# #reqrating# 1600"};
	...
	AtlasLoot_Data["PvP80DruidBalance"] = {
		...
		{ 9, 41325, "", "=q4=Hateful Gladiator's Wyrmhide Helm", "=ds=", "45 #eofvalor#"};
		{ 10, 41279, "", "=q4=Hateful Gladiator's Wyrmhide Spaulders", "=ds=", "30 #eofvalor#"};
		{ 11, 41314, "", "=q4=Hateful Gladiator's Wyrmhide Robes", "=ds=", "45 #eofvalor#"};
		{ 12, 41291, "", "=q4=Hateful Gladiator's Wyrmhide Gloves", "=ds=", "30 #eofvalor#"};
		{ 13, 41302, "", "=q4=Hateful Gladiator's Wyrmhide Legguards", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_Nature_InsectSwarm", "=q6=#arenas1_2#", ""};
		{ 17, 41326, "", "=q4=Deadly Gladiator's Wyrmhide Helm", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 41280, "", "=q4=Deadly Gladiator's Wyrmhide Spaulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 41315, "", "=q4=Deadly Gladiator's Wyrmhide Robes", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 41292, "", "=q4=Deadly Gladiator's Wyrmhide Gloves", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 41303, "", "=q4=Deadly Gladiator's Wyrmhide Legguards", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas1_2#", ""};
		{ 24, 41327, "", "=q4=Furious Gladiator's Wyrmhide Helm", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 41281, "", "=q4=Furious Gladiator's Wyrmhide Spaulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 41316, "", "=q4=Furious Gladiator's Wyrmhide Robes", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 41293, "", "=q4=Furious Gladiator's Wyrmhide Gloves", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80DruidBalance2"] = {
		...
		{ 4, 41317, "", "=q4=Relentless Gladiator's Wyrmhide Robes", "=ds=", "2150 #arena# #reqrating# 1600"};
	...
	AtlasLoot_Data["PvP80DruidFeral"] = {
		...
		{ 9, 41676, "", "=q4=Hateful Gladiator's Dragonhide Helm", "=ds=", "45 #eofvalor#"};
		{ 10, 41713, "", "=q4=Hateful Gladiator's Dragonhide Spaulders", "=ds=", "30 #eofvalor#"};
		{ 11, 41659, "", "=q4=Hateful Gladiator's Dragonhide Robes", "=ds=", "45 #eofvalor#"};
		{ 12, 41771, "", "=q4=Hateful Gladiator's Dragonhide Gloves", "=ds=", "30 #eofvalor#"};
		{ 13, 41665, "", "=q4=Hateful Gladiator's Dragonhide Legguards", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Ability_Druid_Maul", "=q6=#arenas1_1#", ""};
		{ 17, 41677, "", "=q4=Deadly Gladiator's Dragonhide Helm", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 41714, "", "=q4=Deadly Gladiator's Dragonhide Spaulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 41660, "", "=q4=Deadly Gladiator's Dragonhide Robes", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 41772, "", "=q4=Deadly Gladiator's Dragonhide Gloves", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 41666, "", "=q4=Deadly Gladiator's Dragonhide Legguards", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas1_1#", ""};
		{ 24, 41678, "", "=q4=Furious Gladiator's Dragonhide Helm", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 41715, "", "=q4=Furious Gladiator's Dragonhide Spaulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 41661, "", "=q4=Furious Gladiator's Dragonhide Robes", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 41773, "", "=q4=Furious Gladiator's Dragonhide Gloves", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80DruidFeral2"] = {
		...
		{ 4, 41662, "", "=q4=Relentless Gladiator's Dragonhide Robes", "=ds=", "2150 #arena# #reqrating# 1600"};
	...
	AtlasLoot_Data["PvP80DruidRestoration"] = {
		...
		{ 9, 41319, "", "=q4=Hateful Gladiator's Kodohide Helm", "=ds=", "45 #eofvalor#"};
		{ 10, 41273, "", "=q4=Hateful Gladiator's Kodohide Spaulders", "=ds=", "30 #eofvalor#"};
		{ 11, 41308, "", "=q4=Hateful Gladiator's Kodohide Robes", "=ds=", "45 #eofvalor#"};
		{ 12, 41284, "", "=q4=Hateful Gladiator's Kodohide Gloves", "=ds=", "30 #eofvalor#"};
		{ 13, 41296, "", "=q4=Hateful Gladiator's Kodohide Legguards", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_Nature_Regeneration", "=q6=#arenas1_3#", ""};
		{ 17, 41320, "", "=q4=Deadly Gladiator's Kodohide Helm", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 41274, "", "=q4=Deadly Gladiator's Kodohide Spaulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 41309, "", "=q4=Deadly Gladiator's Kodohide Robes", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 41286, "", "=q4=Deadly Gladiator's Kodohide Gloves", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 41297, "", "=q4=Deadly Gladiator's Kodohide Legguards", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas1_3#", ""};
		{ 24, 41321, "", "=q4=Furious Gladiator's Kodohide Helm", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 41275, "", "=q4=Furious Gladiator's Kodohide Spaulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 41310, "", "=q4=Furious Gladiator's Kodohide Robes", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 41287, "", "=q4=Furious Gladiator's Kodohide Gloves", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80DruidRestoration2"] = {
		...
		{ 4, 41311, "", "=q4=Relentless Gladiator's Kodohide Robes", "=ds=", "2150 #arena# #reqrating# 1600"};
	...
	AtlasLoot_Data["PvP80Hunter"] = {
		...
		{ 9, 41155, "", "=q4=Hateful Gladiator's Chain Helm", "=ds=", "45 #eofvalor#"};
		{ 10, 41215, "", "=q4=Hateful Gladiator's Chain Spaulders", "=ds=", "30 #eofvalor#"};
		{ 11, 41085, "", "=q4=Hateful Gladiator's Chain Armor", "=ds=", "45 #eofvalor#"};
		{ 12, 41141, "", "=q4=Hateful Gladiator's Chain Gauntlets", "=ds=", "30 #eofvalor#"};
		{ 13, 41203, "", "=q4=Hateful Gladiator's Chain Leggings", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Ability_Hunter_RunningShot", "=q6=#arenas2#", ""};
		{ 17, 41156, "", "=q4=Deadly Gladiator's Chain Helm", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 41216, "", "=q4=Deadly Gladiator's Chain Spaulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 41086, "", "=q4=Deadly Gladiator's Chain Armor", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 41142, "", "=q4=Deadly Gladiator's Chain Gauntlets", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 41204, "", "=q4=Deadly Gladiator's Chain Leggings", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas2#", ""};
		{ 24, 41157, "", "=q4=Furious Gladiator's Chain Helm", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 41217, "", "=q4=Furious Gladiator's Chain Spaulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 41087, "", "=q4=Furious Gladiator's Chain Armor", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 41143, "", "=q4=Furious Gladiator's Chain Gauntlets", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80Hunter2"] = {
		...
		{ 4, 41088, "", "=q4=Relentless Gladiator's Chain Armor", "=ds=", "2150 #arena# #reqrating# 1600"};
	...
	AtlasLoot_Data["PvP80Mage"] = {
		...
		{ 9, 41944, "", "=q4=Hateful Gladiator's Silk Cowl", "=ds=", "45 #eofvalor#"};
		{ 10, 41963, "", "=q4=Hateful Gladiator's Silk Amice", "=ds=", "30 #eofvalor#"};
		{ 11, 41950, "", "=q4=Hateful Gladiator's Silk Raiment", "=ds=", "45 #eofvalor#"};
		{ 12, 41969, "", "=q4=Hateful Gladiator's Silk Handguards", "=ds=", "30 #eofvalor#"};
		{ 13, 41957, "", "=q4=Hateful Gladiator's Silk Trousers", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_Frost_IceStorm", "=q6=#arenas3#", ""};
		{ 17, 41945, "", "=q4=Deadly Gladiator's Silk Cowl", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 41964, "", "=q4=Deadly Gladiator's Silk Amice", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 41951, "", "=q4=Deadly Gladiator's Silk Raiment", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 41970, "", "=q4=Deadly Gladiator's Silk Handguards", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 41958, "", "=q4=Deadly Gladiator's Silk Trousers", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas3#", ""};
		{ 24, 41946, "", "=q4=Furious Gladiator's Silk Cowl", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 41965, "", "=q4=Furious Gladiator's Silk Amice", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 41953, "", "=q4=Furious Gladiator's Silk Raiment", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 41971, "", "=q4=Furious Gladiator's Silk Handguards", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80Mage2"] = {
		...
		{ 4, 41954, "", "=q4=Relentless Gladiator's Silk Raiment", "=ds=", "2150 #arena# #reqrating# 1600"};
	...
	AtlasLoot_Data["PvP80PaladinRetribution"] = {
		...
		{ 9, 40821, "", "=q4=Hateful Gladiator's Scaled Helm", "=ds=", "45 #eofvalor#"};
		{ 10, 40861, "", "=q4=Hateful Gladiator's Scaled Shoulders", "=ds=", "30 #eofvalor#"};
		{ 11, 40782, "", "=q4=Hateful Gladiator's Scaled Chestpiece", "=ds=", "45 #eofvalor#"};
		{ 12, 40802, "", "=q4=Hateful Gladiator's Scaled Gauntlets", "=ds=", "30 #eofvalor#"};
		{ 13, 40842, "", "=q4=Hateful Gladiator's Scaled Legguards", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_Holy_AuraOfLight", "=q6=#arenas4_2#", ""};
		{ 17, 40825, "", "=q4=Deadly Gladiator's Scaled Helm", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 40864, "", "=q4=Deadly Gladiator's Scaled Shoulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 40785, "", "=q4=Deadly Gladiator's Scaled Chestpiece", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 40805, "", "=q4=Deadly Gladiator's Scaled Gauntlets", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 40846, "", "=q4=Deadly Gladiator's Scaled Legguards", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas4_2#", ""};
		{ 24, 40828, "", "=q4=Furious Gladiator's Scaled Helm", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 40869, "", "=q4=Furious Gladiator's Scaled Shoulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 40788, "", "=q4=Furious Gladiator's Scaled Chestpiece", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 40808, "", "=q4=Furious Gladiator's Scaled Gauntlets", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80PaladinRetribution2"] = {
		...
		{ 4, 40792, "", "=q4=Relentless Gladiator's Scaled Chestpiece", "=ds=", "2150 #arena# #reqrating# 1600"};
		{ 5, 40812, "", "=q4=Relentless Gladiator's Scaled Gauntlets", "=ds=", "1300 #arena# #reqrating# 1400"};
		{ 6, 40852, "", "=q4=Relentless Gladiator's Scaled Legguards", "=ds=", "2150 #arena# #reqrating# 1550"};
		Back = "LEVEL80PVPSETS2";
	};
	...
	AtlasLoot_Data["PvP80PaladinHoly"] = {
		...
		{ 9, 40931, "", "=q4=Hateful Gladiator's Ornamented Headcover", "=ds=", "45 #eofvalor#"};
		{ 10, 40961, "", "=q4=Hateful Gladiator's Ornamented Spaulders", "=ds=", "30 #eofvalor#"};
		{ 11, 40904, "", "=q4=Hateful Gladiator's Ornamented Gloves", "=ds=", "45 #eofvalor#"};
		{ 12, 40925, "", "=q4=Hateful Gladiator's Ornamented Chestguard", "=ds=", "30 #eofvalor#"};
		{ 13, 40937, "", "=q4=Hateful Gladiator's Ornamented Legplates", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_Holy_HolyBolt", "=q6=#arenas4_3#", ""};
		{ 17, 40932, "", "=q4=Deadly Gladiator's Ornamented Headcover", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 40962, "", "=q4=Deadly Gladiator's Ornamented Spaulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 40905, "", "=q4=Deadly Gladiator's Ornamented Chestguard", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 40926, "", "=q4=Deadly Gladiator's Ornamented Gloves", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 40938, "", "=q4=Deadly Gladiator's Ornamented Legplates", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas4_3#", ""};
		{ 24, 40933, "", "=q4=Furious Gladiator's Ornamented Headcover", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 40963, "", "=q4=Furious Gladiator's Ornamented Spaulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 40907, "", "=q4=Furious Gladiator's Ornamented Chestguard", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 40927, "", "=q4=Furious Gladiator's Ornamented Gloves", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80PaladinHoly2"] = {
		...
		{ 4, 40910, "", "=q4=Relentless Gladiator's Ornamented Chestguard", "=ds=", "2150 #arena# #reqrating# 1600"};
		{ 5, 40928, "", "=q4=Relentless Gladiator's Ornamented Gloves", "=ds=", "1300 #arena# #reqrating# 1400"};
		{ 6, 40940, "", "=q4=Relentless Gladiator's Ornamented Legplates", "=ds=", "2150 #arena# #reqrating# 1550"};
		Back = "LEVEL80PVPSETS2";
	};
	...
	AtlasLoot_Data["PvP80PriestShadow"] = {
		...
		{ 9, 41913, "", "=q4=Hateful Gladiator's Satin Hood", "=ds=", "45 #eofvalor#"};
		{ 10, 41931, "", "=q4=Hateful Gladiator's Satin Mantle", "=ds=", "30 #eofvalor#"};
		{ 11, 41919, "", "=q4=Hateful Gladiator's Satin Robe", "=ds=", "45 #eofvalor#"};
		{ 12, 41938, "", "=q4=Hateful Gladiator's Satin Gloves", "=ds=", "30 #eofvalor#"};
		{ 13, 41925, "", "=q4=Hateful Gladiator's Satin Leggings", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_Shadow_AntiShadow", "=q6=#arenas5_1#", ""};
		{ 17, 41914, "", "=q4=Deadly Gladiator's Satin Hood", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 41933, "", "=q4=Deadly Gladiator's Satin Mantle", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 41920, "", "=q4=Deadly Gladiator's Satin Robe", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 41939, "", "=q4=Deadly Gladiator's Satin Gloves", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 41926, "", "=q4=Deadly Gladiator's Satin Leggings", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas5_1#", ""};
		{ 24, 41915, "", "=q4=Furious Gladiator's Satin Hood", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 41934, "", "=q4=Furious Gladiator's Satin Mantle", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 41921, "", "=q4=Furious Gladiator's Satin Robe", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 41940, "", "=q4=Furious Gladiator's Satin Gloves", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80PriestShadow2"] = {
		...
		{ 4, 41922, "", "=q4=Relentless Gladiator's Satin Robe", "=ds=", "2150 #arena# #reqrating# 1600"};
		{ 5, 41941, "", "=q4=Relentless Gladiator's Satin Gloves", "=ds=", "1300 #arena# #reqrating# 1400"};
		{ 6, 41928, "", "=q4=Relentless Gladiator's Satin Leggings", "=ds=", "2150 #arena# #reqrating# 1550"};
		Back = "LEVEL80PVPSETS2";
	};
	...
	AtlasLoot_Data["PvP80PriestHoly"] = {
		...
		{ 9, 41852, "", "=q4=Hateful Gladiator's Mooncloth Hood", "=ds=", "45 #eofvalor#"};
		{ 10, 41867, "", "=q4=Hateful Gladiator's Mooncloth Mantle", "=ds=", "30 #eofvalor#"};
		{ 11, 41857, "", "=q4=Hateful Gladiator's Mooncloth Robe", "=ds=", "45 #eofvalor#"};
		{ 12, 41872, "", "=q4=Hateful Gladiator's Mooncloth Gloves", "=ds=", "30 #eofvalor#"};
		{ 13, 41862, "", "=q4=Hateful Gladiator's Mooncloth Leggings", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_Holy_PowerWordShield", "=q6=#arenas5_2#", ""};
		{ 17, 41853, "", "=q4=Deadly Gladiator's Mooncloth Hood", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 41868, "", "=q4=Deadly Gladiator's Mooncloth Mantle", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 41858, "", "=q4=Deadly Gladiator's Mooncloth Robe", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 41873, "", "=q4=Deadly Gladiator's Mooncloth Gloves", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 41863, "", "=q4=Deadly Gladiator's Mooncloth Leggings", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas5_2#", ""};
		{ 24, 41854, "", "=q4=Furious Gladiator's Mooncloth Hood", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 41869, "", "=q4=Furious Gladiator's Mooncloth Mantle", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 41859, "", "=q4=Furious Gladiator's Mooncloth Robe", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 41874, "", "=q4=Furious Gladiator's Mooncloth Gloves", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80Rogue"] = {
		...
		{ 9, 41670, "", "=q4=Hateful Gladiator's Leather Helm", "=ds=", "45 #eofvalor#"};
		{ 10, 41681, "", "=q4=Hateful Gladiator's Leather Spaulders", "=ds=", "30 #eofvalor#"};
		{ 11, 41648, "", "=q4=Hateful Gladiator's Leather Tunic", "=ds=", "45 #eofvalor#"};
		{ 12, 41765, "", "=q4=Hateful Gladiator's Leather Gloves", "=ds=", "30 #eofvalor#"};
		{ 13, 41653, "", "=q4=Hateful Gladiator's Leather Legguards", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Ability_BackStab", "=q6=#arenas6#", ""};
		{ 17, 41671, "", "=q4=Deadly Gladiator's Leather Helm", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 41682, "", "=q4=Deadly Gladiator's Leather Spaulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 41649, "", "=q4=Deadly Gladiator's Leather Tunic", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 41766, "", "=q4=Deadly Gladiator's Leather Gloves", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 41654, "", "=q4=Deadly Gladiator's Leather Legguards", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas6#", ""};
		{ 24, 41672, "", "=q4=Furious Gladiator's Leather Helm", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 41683, "", "=q4=Furious Gladiator's Leather Spaulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 41650, "", "=q4=Furious Gladiator's Leather Tunic", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 41767, "", "=q4=Furious Gladiator's Leather Gloves", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80Rogue2"] = {
		...
		{ 4, 41651, "", "=q4=Relentless Gladiator's Leather Tunic", "=ds=", "2150 #arena# #reqrating# 1600"};
		{ 5, 41768, "", "=q4=Relentless Gladiator's Leather Gloves", "=ds=", "1300 #arena# #reqrating# 1400"};
		{ 6, 41656, "", "=q4=Relentless Gladiator's Leather Legguards", "=ds=", "2150 #arena# #reqrating# 1550"};
		Back = "LEVEL80PVPSETS2";
	};
	...
	AtlasLoot_Data["PvP80ShamanElemental"] = {
		...
		{ 9, 41017, "", "=q4=Hateful Gladiator's Mail Helm", "=ds=", "45 #eofvalor#"};
		{ 10, 41042, "", "=q4=Hateful Gladiator's Mail Spaulders", "=ds=", "30 #eofvalor#"};
		{ 11, 40989, "", "=q4=Hateful Gladiator's Mail Armor", "=ds=", "45 #eofvalor#"};
		{ 12, 41005, "", "=q4=Hateful Gladiator's Mail Gauntlets", "=ds=", "30 #eofvalor#"};
		{ 13, 41031, "", "=q4=Hateful Gladiator's Mail Leggings", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_Nature_Lightning", "=q6=#arenas7_2#", ""};
		{ 17, 41018, "", "=q4=Deadly Gladiator's Mail Helm", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 41043, "", "=q4=Deadly Gladiator's Mail Spaulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 40991, "", "=q4=Deadly Gladiator's Mail Armor", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 41006, "", "=q4=Deadly Gladiator's Mail Gauntlets", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 41032, "", "=q4=Deadly Gladiator's Mail Leggings", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas7_2#", ""};
		{ 24, 41019, "", "=q4=Furious Gladiator's Mail Helm", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 41044, "", "=q4=Furious Gladiator's Mail Spaulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 40993, "", "=q4=Furious Gladiator's Mail Armor", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 41007, "", "=q4=Furious Gladiator's Mail Gauntlets", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80ShamanElemental2"] = {
		...
		{ 4, 40995, "", "=q4=Relentless Gladiator's Mail Armor", "=ds=", "2150 #arena# #reqrating# 1600"};
		{ 5, 41008, "", "=q4=Relentless Gladiator's Mail Gauntlets", "=ds=", "1300 #arena# #reqrating# 1400"};
		{ 6, 41034, "", "=q4=Relentless Gladiator's Mail Leggings", "=ds=", "2150 #arena# #reqrating# 1550"};
		Back = "LEVEL80PVPSETS2";
	};
	...
	AtlasLoot_Data["PvP80ShamanEnhancement"] = {
		...
		{ 9, 41149, "", "=q4=Hateful Gladiator's Linked Helm", "=ds=", "45 #eofvalor#"};
		{ 10, 41209, "", "=q4=Hateful Gladiator's Linked Spaulders", "=ds=", "30 #eofvalor#"};
		{ 11, 41079, "", "=q4=Hateful Gladiator's Linked Armor", "=ds=", "45 #eofvalor#"};
		{ 12, 41135, "", "=q4=Hateful Gladiator's Linked Gauntlets", "=ds=", "30 #eofvalor#"};
		{ 13, 41162, "", "=q4=Hateful Gladiator's Linked Leggings", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_FireResistanceTotem_01", "=q6=#arenas7_1#", ""};
		{ 17, 41150, "", "=q4=Deadly Gladiator's Linked Helm", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 41210, "", "=q4=Deadly Gladiator's Linked Spaulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 41080, "", "=q4=Deadly Gladiator's Linked Armor", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 41136, "", "=q4=Deadly Gladiator's Linked Gauntlets", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 41198, "", "=q4=Deadly Gladiator's Linked Leggings", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas7_1#", ""};
		{ 24, 41151, "", "=q4=Furious Gladiator's Linked Helm", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 41211, "", "=q4=Furious Gladiator's Linked Spaulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 41081, "", "=q4=Furious Gladiator's Linked Armor", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 41137, "", "=q4=Furious Gladiator's Linked Gauntlets", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80ShamanEnhancement2"] = {
		...
		{ 4, 41082, "", "=q4=Relentless Gladiator's Linked Armor", "=ds=", "2150 #arena# #reqrating# 1600"};
		{ 5, 41138, "", "=q4=Relentless Gladiator's Linked Gauntlets", "=ds=", "1300 #arena# #reqrating# 1400"};
		{ 6, 41200, "", "=q4=Relentless Gladiator's Linked Leggings", "=ds=", "2150 #arena# #reqrating# 1550"};
		Back = "LEVEL80PVPSETS2";
	};
	...
	AtlasLoot_Data["PvP80ShamanRestoration"] = {
		...
		{ 9, 41011, "", "=q4=Hateful Gladiator's Ringmail Helm", "=ds=", "45 #eofvalor#"};
		{ 10, 41036, "", "=q4=Hateful Gladiator's Ringmail Spaulders", "=ds=", "30 #eofvalor#"};
		{ 11, 40988, "", "=q4=Hateful Gladiator's Ringmail Armor", "=ds=", "45 #eofvalor#"};
		{ 12, 40999, "", "=q4=Hateful Gladiator's Ringmail Gauntlets", "=ds=", "30 #eofvalor#"};
		{ 13, 41025, "", "=q4=Hateful Gladiator's Ringmail Leggings", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_Nature_HealingWaveGreater", "=q6=#arenas7_3#", ""};
		{ 17, 41012, "", "=q4=Deadly Gladiator's Ringmail Helm", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 41037, "", "=q4=Deadly Gladiator's Ringmail Spaulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 40990, "", "=q4=Deadly Gladiator's Ringmail Armor", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 41000, "", "=q4=Deadly Gladiator's Ringmail Gauntlets", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 41026, "", "=q4=Deadly Gladiator's Ringmail Leggings", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas7_3#", ""};
		{ 24, 41013, "", "=q4=Furious Gladiator's Ringmail Helm", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 41038, "", "=q4=Furious Gladiator's Ringmail Spaulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 40992, "", "=q4=Furious Gladiator's Ringmail Armor", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 41001, "", "=q4=Furious Gladiator's Ringmail Gauntlets", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80ShamanRestoration2"] = {
		...
		{ 4, 40994, "", "=q4=Relentless Gladiator's Ringmail Armor", "=ds=", "2150 #arena# #reqrating# 1600"};
		{ 5, 41002, "", "=q4=Relentless Gladiator's Ringmail Gauntlets", "=ds=", "1300 #arena# #reqrating# 1400"};
		{ 6, 41028, "", "=q4=Relentless Gladiator's Ringmail Leggings", "=ds=", "2150 #arena# #reqrating# 1550"};
		Back = "LEVEL80PVPSETS2";
	};
	...
	AtlasLoot_Data["PvP80Warlock"] = {
		...
		{ 9, 41991, "", "=q4=Hateful Gladiator's Felweave Cowl", "=ds=", "45 #eofvalor#"};
		{ 10, 42009, "", "=q4=Hateful Gladiator's Felweave Amice", "=ds=", "30 #eofvalor#"};
		{ 11, 42001, "", "=q4=Hateful Gladiator's Felweave Raiment", "=ds=", "45 #eofvalor#"};
		{ 12, 42015, "", "=q4=Hateful Gladiator's Felweave Handguards", "=ds=", "30 #eofvalor#"};
		{ 13, 42003, "", "=q4=Hateful Gladiator's Felweave Trousers", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Spell_Shadow_CurseOfTounges", "=q6=#arenas8_2#", ""};
		{ 17, 41992, "", "=q4=Deadly Gladiator's Felweave Cowl", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 42010, "", "=q4=Deadly Gladiator's Felweave Amice", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 41997, "", "=q4=Deadly Gladiator's Felweave Raiment", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 42016, "", "=q4=Deadly Gladiator's Felweave Handguards", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 42004, "", "=q4=Deadly Gladiator's Felweave Trousers", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas8_2#", ""};
		{ 24, 41993, "", "=q4=Furious Gladiator's Felweave Cowl", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 42011, "", "=q4=Furious Gladiator's Felweave Amice", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 41998, "", "=q4=Furious Gladiator's Felweave Raiment", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 42017, "", "=q4=Furious Gladiator's Felweave Handguards", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80Warlock2"] = {
		...
		{ 4, 41999, "", "=q4=Relentless Gladiator's Felweave Raiment", "=ds=", "2150 #arena# #reqrating# 1600"};
		{ 5, 42018, "", "=q4=Relentless Gladiator's Felweave Handguards", "=ds=", "1300 #arena# #reqrating# 1400"};
		{ 6, 42006, "", "=q4=Relentless Gladiator's Felweave Trousers", "=ds=", "2150 #arena# #reqrating# 1550"};
		Back = "LEVEL80PVPSETS2";
	};
	...
	AtlasLoot_Data["PvP80Warrior"] = {
		...
		{ 9, 40819, "", "=q4=Hateful Gladiator's Plate Helm", "=ds=", "45 #eofvalor#"};
		{ 10, 40859, "", "=q4=Hateful Gladiator's Plate Shoulders", "=ds=", "30 #eofvalor#"};
		{ 11, 40783, "", "=q4=Hateful Gladiator's Plate Chestpiece", "=ds=", "45 #eofvalor#"};
		{ 12, 40801, "", "=q4=Hateful Gladiator's Plate Gauntlets", "=ds=", "30 #eofvalor#"};
		{ 13, 40840, "", "=q4=Hateful Gladiator's Plate Legguards", "=ds=", "45 #eofvalor#"};
		{ 16, 0, "Ability_Warrior_BattleShout", "=q6=#arenas9#", ""};
		{ 17, 40823, "", "=q4=Deadly Gladiator's Plate Helm", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 18, 40862, "", "=q4=Deadly Gladiator's Plate Shoulders", "=ds=", "31600 #faction# / 9600 #faction# 275 #arena# / 46 #eofconquest#"};
		{ 19, 40786, "", "=q4=Deadly Gladiator's Plate Chestpiece", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 20, 40804, "", "=q4=Deadly Gladiator's Plate Gauntlets", "=ds=", "31600 #faction# / 7200 #faction# 200 #arena# / 46 #eofconquest#"};
		{ 21, 40844, "", "=q4=Deadly Gladiator's Plate Legguards", "=ds=", "49600 #faction# / 12000 #faction# 350 #arena# / 58 #eofconquest#"};
		{ 23, 0, "Ability_Warrior_BattleShout", "=q6=#arenas9#", ""};
		{ 24, 40826, "", "=q4=Furious Gladiator's Plate Helm", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1100 / 75 #eoftriumph#"};
		{ 25, 40866, "", "=q4=Furious Gladiator's Plate Shoulders", "=ds=", "9600 #faction# 550 #arena# #reqrating# 1350 / 50 #eoftriumph#"};
		{ 26, 40789, "", "=q4=Furious Gladiator's Plate Chestpiece", "=ds=", "12000 #faction# 700 #arena# #reqrating# 1000 / 75 #eoftriumph#"};
		{ 27, 40807, "", "=q4=Furious Gladiator's Plate Gauntlets", "=ds=", "7200 #faction# 400 #arena# #reqrating# 800 / 50 #eoftriumph#"};
	...
	AtlasLoot_Data["PvP80Warrior2"] = {
		...
		{ 4, 40790, "", "=q4=Relentless Gladiator's Plate Chestpiece", "=ds=", "2150 #arena# #reqrating# 1600"};
		{ 5, 40810, "", "=q4=Relentless Gladiator's Plate Gauntlets", "=ds=", "1300 #arena# #reqrating# 1400"};
		{ 6, 40850, "", "=q4=Relentless Gladiator's Plate Legguards", "=ds=", "2150 #arena# #reqrating# 1550"};
		Back = "LEVEL80PVPSETS2";
	};
	...
	AtlasLoot_Data["PvP80NonSet1"] = {
		{ 1, 42078, "", "=q4=Relentless Gladiator's Cloak of Ascendancy", "=ds=", "47400 #faction# #reqrating# 1750"};
		{ 2, 42080, "", "=q4=Relentless Gladiator's Cloak of Deliverance", "=ds=", "47400 #faction# #reqrating# 1750"};
		{ 3, 42076, "", "=q4=Relentless Gladiator's Cloak of Dominance", "=ds=", "47400 #faction# #reqrating# 1750"};
		{ 4, 42079, "", "=q4=Relentless Gladiator's Cloak of Salvation", "=ds=", "47400 #faction# #reqrating# 1750"};
		{ 5, 42077, "", "=q4=Relentless Gladiator's Cloak of Subjugation", "=ds=", "47400 #faction# #reqrating# 1750"};
		{ 6, 42081, "", "=q4=Relentless Gladiator's Cloak of Triumph", "=ds=", "47400 #faction# #reqrating# 1750"};
		{ 7, 42082, "", "=q4=Relentless Gladiator's Cloak of Victory", "=ds=", "47400 #faction# #reqrating# 1750"};
		{ 9, 42118, "", "=q4=Relentless Gladiator's Band of Ascendancy", "=ds=", "47400 #faction# #reqrating# 1500"};
		{ 10, 42119, "", "=q4=Relentless Gladiator's Band of Victory", "=ds=", "47400 #faction# #reqrating# 1500"};
		{ 12, 42124, "", "=q4=Medallion of the Alliance", "=ds=", "49600 #faction#"};
		{ 13, 42126, "", "=q4=Medallion of the Horde", "=ds=", "49600 #faction#"};
		{ 16, 42044, "", "=q4=Relentless Gladiator's Pendant of Ascendancy", "=ds=", "47400 #faction# #reqrating# 1450"};
		{ 17, 42046, "", "=q4=Relentless Gladiator's Pendant of Deliverance", "=ds=", "47400 #faction# #reqrating# 1450"};
		{ 18, 42043, "", "=q4=Relentless Gladiator's Pendant of Dominance", "=ds=", "47400 #faction# #reqrating# 1450"};
		{ 19, 42047, "", "=q4=Relentless Gladiator's Pendant of Salvation", "=ds=", "47400 #faction# #reqrating# 1450"};
		{ 20, 42045, "", "=q4=Relentless Gladiator's Pendant of Subjugation", "=ds=", "47400 #faction# #reqrating# 1450"};
		{ 21, 46374, "", "=q4=Relentless Gladiator's Pendant of Sundering", "=ds=", "47400 #faction# #reqrating# 1450"};
		{ 22, 42041, "", "=q4=Relentless Gladiator's Pendant of Triumph", "=ds=", "47400 #faction# #reqrating# 1450"};
		{ 23, 42042, "", "=q4=Relentless Gladiator's Pendant of Victory", "=ds=", "47400 #faction# #reqrating# 1450"};
		{ 25, 42133, "", "=q4=Battlemaster's Fury", "=ds=", "62000 #faction# #reqrating# 1650"};
		{ 26, 42134, "", "=q4=Battlemaster's Precision", "=ds=", "62000 #faction# #reqrating# 1650"};
		{ 27, 42136, "", "=q4=Battlemaster's Rage", "=ds=", "62000 #faction# #reqrating# 1650"};
		{ 28, 42137, "", "=q4=Battlemaster's Ruination", "=ds=", "62000 #faction# #reqrating# 1650"};
		{ 29, 42135, "", "=q4=Battlemaster's Vivacity", "=ds=", "62000 #faction# #reqrating# 1650"};
		Next = "PvP80NonSet2";
	...
	AtlasLoot_Data["PvP80NonSet2"] = {
		...
		{ 4, 42072, "", "=q4=Furious Gladiator's Cloak of Salvation", "=ds=", "38000 #faction#"};
		{ 5, 42070, "", "=q4=Furious Gladiator's Cloak of Subjugation", "=ds=", "38000 #faction#"};
		{ 6, 42074, "", "=q4=Furious Gladiator's Cloak of Triumph", "=ds=", "38000 #faction#"};
		{ 7, 42075, "", "=q4=Furious Gladiator's Cloak of Victory", "=ds=", "38000 #faction#"};
		{ 9, 42116, "", "=q4=Furious Gladiator's Band of Dominance", "=ds=", "38000 #faction#"};
		{ 10, 42117, "", "=q4=Furious Gladiator's Band of Triumph", "=ds=", "38000 #faction#"};
		{ 16, 42037, "", "=q4=Furious Gladiator's Pendant of Ascendancy", "=ds=", "38000 #faction#"};
		{ 17, 42039, "", "=q4=Furious Gladiator's Pendant of Deliverance", "=ds=", "38000 #faction#"};
		{ 18, 42036, "", "=q4=Furious Gladiator's Pendant of Dominance", "=ds=", "38000 #faction#"};
		{ 19, 42040, "", "=q4=Furious Gladiator's Pendant of Salvation", "=ds=", "38000 #faction#"};
		{ 20, 42038, "", "=q4=Furious Gladiator's Pendant of Subjugation", "=ds=", "38000 #faction#"};
		{ 21, 46373, "", "=q4=Furious Gladiator's Pendant of Sundering", "=ds=", "38000 #faction#"};
		{ 22, 42034, "", "=q4=Furious Gladiator's Pendant of Triumph", "=ds=", "38000 #faction#"};
		{ 23, 42035, "", "=q4=Furious Gladiator's Pendant of Victory", "=ds=", "38000 #faction#"};
		Next = "PvP80NonSet3";
		Prev = "PvP80NonSet1";
		Back = "PVP80NONSETEPICS";
	};
...
--Cloth
	AtlasLoot_Data["PvP80NonSet3"] = {
		{ 1, 41910, "", "=q4=Relentless Gladiator's Cuffs of Dominance", "=ds=", "39400 #faction# #reqrating# 1200"};
		{ 2, 41899, "", "=q4=Relentless Gladiator's Cord of Dominance", "=ds=", "62000 #faction# #reqrating# 1250"};
		{ 3, 41904, "", "=q4=Relentless Gladiator's Treads of Dominance", "=ds=", "62000 #faction# #reqrating# 1300"};
		...
		{ 17, 41898, "", "=q4=Furious Gladiator's Cord of Dominance", "=ds=", "49600 #faction#"};
		{ 18, 41903, "", "=q4=Furious Gladiator's Slippers of Dominance", "=ds=", "49600 #faction#"};
		{ 20, 41893, "", "=q4=Furious Gladiator's Cuffs of Salvation", "=ds=", "31600 #faction#"};
		{ 21, 41881, "", "=q4=Furious Gladiator's Cord of Salvation", "=ds=", "49600 #faction#"};
		{ 22, 41885, "", "=q4=Furious Gladiator's Slippers of Salvation", "=ds=", "49600 #faction#"};
		Next = "PvP80NonSet4";
		Prev = "PvP80NonSet2";
		Back = "PVP80NONSETEPICS";
	};
...
--Leather
	AtlasLoot_Data["PvP80NonSet4"] = {
		{ 1, 41641, "", "=q4=Relentless Gladiator's Armwraps of Dominance", "=ds=", "39400 #faction# #reqrating# 1200"};
		{ 2, 41631, "", "=q4=Relentless Gladiator's Belt of Dominance", "=ds=", "62000 #faction# #reqrating# 1250"};
		{ 3, 41636, "", "=q4=Relentless Gladiator's Boots of Dominance", "=ds=", "62000 #faction# #reqrating# 1300"};
		{ 5, 41626, "", "=q4=Relentless Gladiator's Armwraps of Salvation", "=ds=", "39400 #faction# #reqrating# 1200"};
		{ 6, 41618, "", "=q4=Relentless Gladiator's Belt of Salvation", "=ds=", "62000 #faction# #reqrating# 1250"};
		{ 7, 41622, "", "=q4=Relentless Gladiator's Boots of Salvation", "=ds=", "62000 #faction# #reqrating# 1300"};
		{ 9, 41841, "", "=q4=Relentless Gladiator's Armwraps of Triumph", "=ds=", "39400 #faction# #reqrating# 1200"};
		{ 10, 41833, "", "=q4=Relentless Gladiator's Belt of Triumph", "=ds=", "62000 #faction# #reqrating# 1250"};
		{ 11, 41837, "", "=q4=Relentless Gladiator's Boots of Triumph", "=ds=", "62000 #faction# #reqrating# 1300"};
		{ 16, 41640, "", "=q4=Furious Gladiator's Armwraps of Dominance", "=ds=", "31600 #faction#"};
		{ 17, 41630, "", "=q4=Furious Gladiator's Belt of Dominance", "=ds=", "49600 #faction#"};
		{ 18, 41635, "", "=q4=Furious Gladiator's Boots of Dominance", "=ds=", "49600 #faction#"};
		{ 20, 41625, "", "=q4=Furious Gladiator's Armwraps of Salvation", "=ds=", "31600 #faction#"};
		{ 21, 41617, "", "=q4=Furious Gladiator's Belt of Salvation", "=ds=", "49600 #faction#"};
		{ 22, 41621, "", "=q4=Furious Gladiator's Boots of Salvation", "=ds=", "49600 #faction#"};
		{ 24, 41840, "", "=q4=Furious Gladiator's Armwraps of Triumph", "=ds=", "31600 #faction#"};
		{ 25, 41832, "", "=q4=Furious Gladiator's Belt of Triumph", "=ds=", "49600 #faction#"};
		{ 26, 41836, "", "=q4=Furious Gladiator's Boots of Triumph", "=ds=", "49600 #faction#"};
		Next = "PvP80NonSet5";
		Prev = "PvP80NonSet3";
		Back = "PVP80NONSETEPICS";
	};
...
--Mail
	AtlasLoot_Data["PvP80NonSet5"] = {
		{ 1, 41066, "", "=q4=Relentless Gladiator's Wristguards of Dominance", "=ds=", "39400 #faction# #reqrating# 1200"};
		{ 2, 41071, "", "=q4=Relentless Gladiator's Waistguard of Dominance", "=ds=", "62000 #faction# #reqrating# 1250"};
		{ 3, 41076, "", "=q4=Relentless Gladiator's Sabatons of Dominance", "=ds=", "62000 #faction# #reqrating# 1300"};
		{ 5, 41061, "", "=q4=Relentless Gladiator's Wristguards of Salvation", "=ds=", "39400 #faction# #reqrating# 1200"};
		{ 6, 41052, "", "=q4=Relentless Gladiator's Waistguard of Salvation", "=ds=", "62000 #faction# #reqrating# 1250"};
		{ 7, 41056, "", "=q4=Relentless Gladiator's Sabatons of Salvation", "=ds=", "62000 #faction# #reqrating# 1300"};
		{ 9, 41226, "", "=q4=Relentless Gladiator's Wristguards of Triumph", "=ds=", "39400 #faction# #reqrating# 1200"};
		{ 10, 41236, "", "=q4=Relentless Gladiator's Waistguard of Triumph", "=ds=", "62000 #faction# #reqrating# 1250"};
		{ 11, 41231, "", "=q4=Relentless Gladiator's Sabatons of Triumph", "=ds=", "62000 #faction# #reqrating# 1300"};
		{ 16, 41065, "", "=q4=Furious Gladiator's Wristguards of Dominance", "=ds=", "31600 #faction#"};
		{ 17, 41070, "", "=q4=Furious Gladiator's Waistguard of Dominance", "=ds=", "49600 #faction#"};
		{ 18, 41075, "", "=q4=Furious Gladiator's Sabatons of Dominance", "=ds=", "49600 #faction#"};
		{ 20, 41060, "", "=q4=Furious Gladiator's Wristguards of Salvation", "=ds=", "31600 #faction#"};
		{ 21, 41051, "", "=q4=Furious Gladiator's Waistguard of Salvation", "=ds=", "49600 #faction#"};
		{ 22, 41055, "", "=q4=Furious Gladiator's Sabatons of Salvation", "=ds=", "49600 #faction#"};
		{ 24, 41225, "", "=q4=Furious Gladiator's Wristguards of Triumph", "=ds=", "31600 #faction#"};
		{ 25, 41235, "", "=q4=Furious Gladiator's Waistguard of Triumph", "=ds=", "49600 #faction#"};
		{ 26, 41230, "", "=q4=Furious Gladiator's Sabatons of Triumph", "=ds=", "49600 #faction#"};
		Next = "PvP80NonSet6";
		Prev = "PvP80NonSet4";
		Back = "PVP80NONSETEPICS";
	};
...
--Plate
	AtlasLoot_Data["PvP80NonSet6"] = {
		{ 1, 40984, "", "=q4=Relentless Gladiator's Bracers of Salvation", "=ds=", "39400 #faction# #reqrating# 1200"};
		{ 2, 40978, "", "=q4=Relentless Gladiator's Girdle of Salvation", "=ds=", "62000 #faction# #reqrating# 1250"};
		{ 3, 40979, "", "=q4=Relentless Gladiator's Greaves of Salvation", "=ds=", "62000 #faction# #reqrating# 1300"};
		{ 5, 40890, "", "=q4=Relentless Gladiator's Bracers of Triumph", "=ds=", "39400 #faction# #reqrating# 1200"};
		{ 6, 40883, "", "=q4=Relentless Gladiator's Girdle of Triumph", "=ds=", "62000 #faction# #reqrating# 1250"};
		{ 7, 40884, "", "=q4=Relentless Gladiator's Greaves of Triumph", "=ds=", "62000 #faction# #reqrating# 1300"};
		{ 16, 40983, "", "=q4=Furious Gladiator's Bracers of Salvation", "=ds=", "31600 #faction#"};
		{ 17, 40976, "", "=q4=Furious Gladiator's Girdle of Salvation", "=ds=", "49600 #faction#"};
		{ 18, 40977, "", "=q4=Furious Gladiator's Greaves of Salvation", "=ds=", "49600 #faction#"};
		{ 20, 40889, "", "=q4=Furious Gladiator's Bracers of Triumph", "=ds=", "31600 #faction#"};
		{ 21, 40881, "", "=q4=Furious Gladiator's Girdle of Triumph", "=ds=", "49600 #faction#"};
		{ 22, 40882, "", "=q4=Furious Gladiator's Greaves of Triumph", "=ds=", "49600 #faction#"};
		Prev = "PvP80NonSet5";
		Back = "PVP80NONSETEPICS";
	};
    --[[
	...
	AtlasLoot_Data["RelentlessGladiatorWeapons1"] = {
		{ 1, 0, "INV_Box_01", "=q6="..AL["Low Level"], ""};
		{ 2, 42262, "", "=q4=Relentless Gladiator's Right Ripper", "=ds=#h3#, #w13#", "15000 #faction# 1100 #arena# #reqrating# 1800"};
		...
		{ 10, 42287, "", "=q4=Relentless Gladiator's Slicer", "=ds=#h1#, #w10#", "15000 #faction# 1100 #arena# #reqrating# 1800"};
		{ 11, 42292, "", "=q4=Relentless Gladiator's Quickblade", "=ds=#h4#, #w10#", "15000 #faction# 1100 #arena# #reqrating# 1800"};
		{ 12, 42334, "", "=q4=Relentless Gladiator's Greatsword", "=ds=#h2#, #w10#", "50000 #faction# 1400 #arena# #reqrating# 1800"};
		{ 13, 42210, "", "=q4=Relentless Gladiator's Cleaver", "=ds=#h1#, #w1#", "15000 #faction# 1100 #arena# #reqrating# 1800"};
		{ 14, 42234, "", "=q4=Relentless Gladiator's Chopper", "=ds=#h4#, #w1#", "15000 #faction# 1100 #arena# #reqrating# 1800"};
		{ 15, 42229, "", "=q4=Relentless Gladiator's Hacker", "=ds=#h4#, #w1#", "15000 #faction# 1100 #arena# #reqrating# 1800"};
		{ 16, 0, "INV_Box_01", "=q6="..AL["High Level"], ""};
		...
		{ 21, 48408, "", "=q4=Relentless Gladiator's Mageblade", "=ds=#h3#, #w4#", "3585 #arena# #reqrating# 2200"};
		{ 22, 48509, "", "=q4=Relentless Gladiator's Spike", "=ds=#h1#, #w4#", "3000 #arena# #reqrating# 2200"};
		{ 23, 48428, "", "=q4=Relentless Gladiator's Dirk", "=ds=#h4#, #w4#", "1245 #arena# #reqrating# 2200"};
		{ 24, 48442, "", "=q4=Relentless Gladiator's Eviscerator", "=ds=#h4#, #w4#", "1245 #arena# #reqrating# 2200"};
		{ 25, 48513, "", "=q4=Relentless Gladiator's Longblade", "=ds=#h1#, #w10#", "3000 #arena# #reqrating# 2200"};
		{ 26, 48438, "", "=q4=Relentless Gladiator's Swiftblade", "=ds=#h4#, #w10#", "1245 #arena# #reqrating# 2200"};
		{ 27, 48406, "", "=q4=Relentless Gladiator's Claymore", "=ds=#h2#, #w10#", "4250 #arena# #reqrating# 2200"};
		{ 28, 48507, "", "=q4=Relentless Gladiator's Handaxe", "=ds=#h1#, #w1#", "3000 #arena# #reqrating# 2200"};
		{ 29, 48426, "", "=q4=Relentless Gladiator's Dicer", "=ds=#h4#, #w1#", "1245 #arena# #reqrating# 2200"};
		{ 30, 48440, "", "=q4=Relentless Gladiator's Splitter", "=ds=#h4#, #w1#", "1245 #arena# #reqrating# 2200"};
	...
	AtlasLoot_Data["RelentlessGladiatorWeapons2"] = {
		...
		{ 6, 42324, "", "=q4=Relentless Gladiator's Bonegrinder", "=ds=#h2#, #w6#", "50000 #faction# 1400 #arena# #reqrating# 1800"};
		{ 7, 42329, "", "=q4=Relentless Gladiator's Pike", "=ds=#w7#", "50000 #faction# 1400 #arena# #reqrating# 1800"};
		{ 8, 42366, "", "=q4=Relentless Gladiator's Battle Staff", "=ds=#w9#", "50000 #faction# 1400 #arena# #reqrating# 1800"};
		{ 9, 42386, "", "=q4=Relentless Gladiator's Energy Staff", "=ds=#w9#", "50000 #faction# 1400 #arena# #reqrating# 1800"};
		{ 10, 44424, "", "=q4=Relentless Gladiator's Focus Staff", "=ds=#w9#", "50000 #faction# 1400 #arena# #reqrating# 1800"};
		{ 11, 42392, "", "=q4=Relentless Gladiator's Staff", "=ds=#w9#", "50000 #faction# 1400 #arena# #reqrating# 1800"};
		{ 12, 44423, "", "=q4=Relentless Gladiator's War Staff", "=ds=#w9#", "50000 #faction# 1400 #arena# #reqrating# 1800"};
		{ 13, 42492, "", "=q4=Relentless Gladiator's Longbow", "=ds=#w2#", "50000 #faction# 1400 #arena# #reqrating# 1800"};
		...
		{ 21, 48404, "", "=q4=Relentless Gladiator's Crusher", "=ds=#h2#, #w6#", "4250 #arena# #reqrating# 2200"};
		{ 22, 48517, "", "=q4=Relentless Gladiator's Halberd", "=ds=#w7#", "4250 #arena# #reqrating# 2200"};
		{ 23, 48412, "", "=q4=Relentless Gladiator's Acute Staff", "=ds=#w9#", "4250 #arena# #reqrating# 2200"};
		{ 24, 48414, "", "=q4=Relentless Gladiator's Combat Staff", "=ds=#w9#", "4250 #arena# #reqrating# 2200"};
		{ 25, 48523, "", "=q4=Relentless Gladiator's Greatstaff", "=ds=#w9#", "4250 #arena# #reqrating# 2200"};
		{ 26, 48521, "", "=q4=Relentless Gladiator's Light Staff", "=ds=#w9#", "4250 #arena# #reqrating# 2200"};
		{ 27, 48410, "", "=q4=Relentless Gladiator's Skirmish Staff", "=ds=#w9#", "4250 #arena# #reqrating# 2200"};
		{ 28, 48420, "", "=q4=Relentless Gladiator's Recurve", "=ds=#w2#", "4250 #arena# #reqrating# 2200"};
		{ 29, 48422, "", "=q4=Relentless Gladiator's Repeater", "=ds=#w3#", "4250 #arena# #reqrating# 2200"};
		{ 30, 48424, "", "=q4=Relentless Gladiator's Shotgun", "=ds=#w5#", "4250 #arena# #reqrating# 2200"};
	...
	AtlasLoot_Data["RelentlessGladiatorWeapons3"] = {
		{ 1, 42566, "", "=q4=Relentless Gladiator's Barrier", "=ds=#w8#", "300 #arena# #reqrating# 1800"};
		{ 2, 42572, "", "=q4=Relentless Gladiator's Redoubt", "=ds=#w8#", "300 #arena# #reqrating# 1800"};
		{ 3, 42561, "", "=q4=Relentless Gladiator's Shield Wall", "=ds=#w8#", "300 #arena# #reqrating# 1800"};
		{ 4, 42483, "", "=q4=Relentless Gladiator's War Edge", "=ds=#w11#", "1150 #arena# #reqrating# 1800"};
		{ 5, 42515, "", "=q4=Relentless Gladiator's Baton of Light", "=ds=#w12#", "1150 #arena# #reqrating# 1800"};
	...
	AtlasLoot_Data["PvP80ClassItems1"] = {
		...
		{ 6, 42616, "", "=q4=Relentless Gladiator's Libram of Justice", "=ds=#w16#", "1150 #arena# #reqrating# 1800"};
		{ 7, 42622, "", "=q4=Relentless Gladiator's Sigil of Strife", "=ds=#w21#", "1150 #arena# #reqrating# 1800"};
		...
		{ 21, 42615, "", "=q4=Furious Gladiator's Libram of Justice", "6400 #faction# 350 #arena# #reqrating# 700"};
		{ 22, 42621, "", "=q4=Furious Gladiator's Sigil of Strife", "6400 #faction# 350 #arena# #reqrating# 700"};
	...
	AtlasLoot_Data["PvP80ClassItems2"] = {
		...
		{ 6, 42614, "", "=q4=Deadly Gladiator's Libram of Justice", "15300 #faction#"};
		{ 7, 42620, "", "=q4=Deadly Gladiator's Sigil of Strife", "=ds=", "15300 #faction#"};
	...
	AtlasLoot_Data["MountsRare1"] = {
		...
		{ 16, 35513, "", "=q4=Swift White Hawkstrider", "=q2=#n59#, =q1=#z30#"};
		{ 17, 19872, "", "=q4=Swift Razzashi Raptor", "=q2=#n33#, =q1=#z8#", "", "0.43%"};
		{ 18, 19902, "", "=q4=Swift Zulian Tiger", "=q2=#n28#, =q1=#z8#", "", " 0.70%"};
		{ 19, 21218, "", "=q3=Blue Qiraji Resonating Crystal", "=q2=#n11#,  =q1=#z11#", "", "10.91%"};
		...
		{ 26, 44168, "", "=q4=Reins of the Time-Lost Proto-Drake", "=q2=#n155#, =q1=#z37#", ""};
	...
	AtlasLoot_Data["Heirloom"] = {
		...
		{ 30, 49177, "", "=q7=Tome of Cold Weather Flight", "=ds=", "1000 #gold#"};
		Next = "Heirloom2";
		Back = "SETMENU";
	};
	...
	AtlasLoot_Data["EmblemofTriumph1"] = {
		{ 1, 0, "INV_BannerPVP_02", "=q6=#m7#", ""};
		{ 2, 47693, "", "=q4=Hood of Fiery Aftermath", "=ds=#s1#, #a1#", "75 #eoftriumph#" };
		{ 3, 47694, "", "=q4=Helm of Clouded Sight", "=ds=#s1#, #a1#", "75 #eoftriumph#" };
		{ 5, 47690, "", "=q4=Helm of Abundant Growth", "=ds=#s1#, #a2#", "75 #eoftriumph#" };
		{ 6, 47689, "", "=q4=Hood of Lethal Intent", "=ds=#s1#, #a2#", "75 #eoftriumph#" };
		{ 8, 47686, "", "=q4=Helm of Inner Warmth", "=ds=#s1#, #a3#", "75 #eoftriumph#" };
		{ 9, 47685, "", "=q4=Helm of the Brooding Dragon", "=ds=#s1#, #a3#", "75 #eoftriumph#" };
		{ 11, 47677, "", "=q4=Faceplate of the Honorbound", "=ds=#s1#, #a4#", "75 #eoftriumph#" };
		{ 12, 47674, "", "=q4=Helm of Thunderous Rampage", "=ds=#s1#, #a4#", "75 #eoftriumph#" };
		{ 13, 47681, "", "=q4=Heaume of the Restless Watch", "=ds=#s1#, #a4#", "75 #eoftriumph#" };
		{ 16, 0, "INV_BannerPVP_01", "=q6=#m6#", ""};
		{ 17, 47692, "", "=q4=Hood of Smoldering Aftermath", "=ds=#s1#, #a1#", "75 #eoftriumph#" };
		{ 18, 47695, "", "=q4=Hood of Clouded Sight", "=ds=#s1#, #a1#", "75 #eoftriumph#" };
		{ 20, 47691, "", "=q4=Mask of Abundant Growth", "=ds=#s1#, #a2#", "75 #eoftriumph#" };
		{ 21, 47688, "", "=q4=Mask of Lethal Intent", "=ds=#s1#, #a2#", "75 #eoftriumph#" };
		{ 23, 47687, "", "=q4=Headguard of Inner Warmth", "=ds=#s1#, #a3#", "75 #eoftriumph#" };
		{ 24, 47684, "", "=q4=Coif of the Brooding Dragon", "=ds=#s1#, #a3#", "75 #eoftriumph#" };
		{ 26, 47678, "", "=q4=Headplate of the Honorbound", "=ds=#s1#, #a4#", "75 #eoftriumph#" };
		{ 27, 47675, "", "=q4=Faceplate of Thunderous Rampage", "=ds=#s1#, #a4#", "75 #eoftriumph#" };
		{ 28, 47682, "", "=q4=Helm of the Restless Watch", "=ds=#s1#, #a4#", "75 #eoftriumph#" };
	...
	AtlasLoot_Data["EmblemofTriumph2"] = {
		{ 1, 0, "INV_BannerPVP_02", "=q6=#m7#", ""};
		{ 2, 47713, "", "=q4=Mantle of Catastrophic Emanation", "=ds=#s3#, #a1#", "45 #eoftriumph#" };
		{ 3, 47715, "", "=q4=Pauldrons of Revered Mortality", "=ds=#s3#, #a1#", "45 #eoftriumph#" };
		{ 5, 47708, "", "=q4=Duskstalker Shoulderpads", "=ds=#s3#, #a2#", "45 #eoftriumph#" };
		{ 6, 47712, "", "=q4=Shoulders of the Fateful Accord", "=ds=#s3#, #a2#", "45 #eoftriumph#" };
		{ 8, 47707, "", "=q4=Mantle of the Groundbreaker", "=ds=#s3#, #a3#", "45 #eoftriumph#" };
		{ 9, 47704, "", "=q4=Epaulets of the Devourer", "=ds=#s3#, #a3#", "45 #eoftriumph#" };
		{ 11, 47698, "", "=q4=Shoulders of Enduring Order", "=ds=#s3#, #a4#", "45 #eoftriumph#" };
		{ 12, 47702, "", "=q4=Pauldrons of the Cavalier", "=ds=#s3#, #a4#", "45 #eoftriumph#" };
		{ 13, 47697, "", "=q4=Pauldrons of Trembling Rage", "=ds=#s3#, #a4#", "45 #eoftriumph#" };
		{ 16, 0, "INV_BannerPVP_01", "=q6=#m6#", ""};
		{ 17, 47714, "", "=q4=Pauldrons of Catastrophic Emanation", "=ds=#s3#, #a1#", "45 #eoftriumph#" };
		{ 18, 47716, "", "=q4=Mantle of Revered Mortality", "=ds=#s3#, #a1#", "45 #eoftriumph#" };
		{ 20, 47709, "", "=q4=Duskstalker Pauldrons", "=ds=#s3#, #a2#", "45 #eoftriumph#" };
		{ 21, 47710, "", "=q4=Epaulets of the Fateful Accord", "=ds=#s3#, #a2#", "45 #eoftriumph#" };
		{ 23, 47706, "", "=q4=Shoulders of the Groundbreaker", "=ds=#s3#, #a3#", "45 #eoftriumph#" };
		{ 24, 47705, "", "=q4=Pauldrons of the Devourer", "=ds=#s3#, #a3#", "45 #eoftriumph#" };
		{ 26, 47699, "", "=q4=Shoulderguards of Enduring Order", "=ds=#s3#, #a4#", "45 #eoftriumph#" };
		{ 27, 47701, "", "=q4=Shoulders of the Cavalier", "=ds=#s3#, #a4#", "45 #eoftriumph#" };
		{ 28, 47696, "", "=q4=Shoulders of Trembling Rage", "=ds=#s3#, #a4#", "45 #eoftriumph#" };
	...
	AtlasLoot_Data["EmblemofTriumph3"] = {
		{ 1, 47733, "", "=q4=Heartmender Circle", "=ds=#s13#", "35 #eoftriumph#" };
		{ 2, 47732, "", "=q4=Band of the Invoker", "=ds=#s13#", "35 #eoftriumph#" };
		{ 3, 47730, "", "=q4=Dexterous Brightstone Ring", "=ds=#s13#", "35 #eoftriumph#" };
		{ 4, 47729, "", "=q4=Bloodshed Band", "=ds=#s13#", "35 #eoftriumph#" };
		{ 5, 47731, "", "=q4=Clutch of Fortification", "=ds=#s13#", "35 #eoftriumph#" };
		{ 7, 48724, "", "=q4=Talisman of Resurgence", "=ds=#s14#", "50 #eoftriumph#" };
		{ 8, 48722, "", "=q4=Shard of the Crystal Heart", "=ds=#s14#", "50 #eoftriumph#" };
		{ 9, 47734, "", "=q4=Mark of Supremacy", "=ds=#s14#", "50 #eoftriumph#" };
		{ 10, 47735, "", "=q4=Glyph of Indomitability", "=ds=#s14#", "50 #eoftriumph#" };
		{ 16, 47668, "", "=q4=Idol of Mutilation", "=ds=#s16#, #w14#", "25 #eoftriumph#" };
		{ 17, 47671, "", "=q4=Idol of Flaring Growth", "=ds=#s16#, #w14#", "25 #eoftriumph#" };
		{ 18, 47670, "", "=q4=Idol of Lunar Fury", "=ds=#s16#, #w14#", "25 #eoftriumph#" };
		{ 19, 47664, "", "=q4=Libram of Defiance", "=ds=#s16#, #w16#", "25 #eoftriumph#" };
		{ 20, 47662, "", "=q4=Libram of Veracity", "=ds=#s16#, #w16#", "25 #eoftriumph#" };
		{ 21, 47661, "", "=q4=Libram of Valiance", "=ds=#s16#, #w16#", "25 #eoftriumph#" };
		...
		{ 25, 47667, "", "=q4=Totem of Quaking Earth", "=ds=#s16#, #w15#", "25 #eoftriumph#" };
		{ 26, 47666, "", "=q4=Totem of Electrifying Wind", "=ds=#s16#, #w15#", "25 #eoftriumph#" };
