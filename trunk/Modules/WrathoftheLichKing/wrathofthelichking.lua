...
---- Emblem of Conquest Items
	...
	AtlasLoot_Data["UlduarIronCouncil"] = {
		...
		{ 13, 45506, "", "=q1=Archivum Data Disc", "=ds="};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
	...
	AtlasLoot_Data["UlduarIronCouncil25Man"] = {
		...
		{ 4, 45240, "", "=q4=Raiments of the Iron Council", "=ds=#s5#, #a1#"};
		{ 5, 45238, "", "=q4=Overload Legwraps", "=ds=#s11#, #a1#"};
		{ 6, 45237, "", "=q4=Phaelia's Vestments of the Sprouting Seed", "=ds=#s5#, #a2#"};
		{ 7, 45232, "", "=q4=Runed Ironhide Boots", "=ds=#s12#, #a2#"};
		{ 8, 45227, "", "=q4=Iron-studded Mantle", "=ds=#s3#, #a3#"};
		{ 9, 45239, "", "=q4=Runeshaper's Gloves", "=ds=#s9#, #a3#"};
		{ 10, 45226, "", "=q4=Ancient Iron Heaume", "=ds=#s1#, #a4#"};
		{ 11, 45225, "", "=q4=Steelbreaker's Embrace", "=ds=#s5#, #a4#"};
		{ 12, 45228, "", "=q4=Handguards of the Enclave", "=ds=#s9#, #a4#"};
		{ 14, 45506, "", "=q1=Archivum Data Disc", "=ds="};
		{ 16, 45193, "", "=q4=Insurmountable Fervor", "=ds=#s2#"};
		{ 17, 45236, "", "=q4=Unblinking Eye", "=ds=#s2#"};
		{ 18, 45235, "", "=q4=Radiant Seal", "=ds=#s13#"};
		{ 19, 45233, "", "=q4=Rune Edge", "=ds=#h2#, #w10#"};
		{ 20, 45234, "", "=q4=Rapture", "=ds=#w9#"};
		{ 22, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 23, 45242, "", "=q4=Drape of Mortal Downfall", "=ds=#s4#"};
		{ 24, 45241, "", "=q4=Belt of Colossal Rage", "=ds=#s10#, #a4#"};
	};

--NO 10-Man loot known
	...
	AtlasLoot_Data["UlduarKologarn25Man"] = {
		...
		{ 4, 45265, "", "=q4=Shoulderpads of the Monolith", "=ds=#s3#, #a2#"};
		{ 5, 45274, "", "=q4=Leggings of the Stoneweaver", "=ds=#s11#, #a3#"};
		{ 6, 45264, "", "=q4=Decimator's Armguards", "=ds=#s8#, #a4#"};
		{ 7, 45269, "", "=q4=Unfaltering Armguards", "=ds=#s8#, #a4#"};
		{ 8, 45268, "", "=q4=Gloves of the Pythonic Guardian", "=ds=#s9#, #a4#"};
		{ 9, 45267, "", "=q4=Saronite Plated Legguards", "=ds=#s11#, #a4#"};
		{ 10, 45262, "", "=q4=Necklace of Unerring Mettle", "=ds=#s2#"};
		{ 11, 45263, "", "=q4=Wrathstone", "=ds=#s14#"};
		{ 12, 45271, "", "=q4=Ironmender", "=ds=#s15#"};
		{ 13, 45270, "", "=q4=Idol of the Crying Wind", "=ds=#s16#, #w14#"};
		{ 16, 45266, "", "=q4=Malice", "=ds=#h1#, #w10#"};
		{ 17, 45261, "", "=q4=Giant's Bane", "=ds=#w5#"};
		{ 19, 45098, "", "=q4=Pattern: Death-warmed Belt", "=ds=#p7# (450)"};
	};
	...
	AtlasLoot_Data["UlduarHodir25Man"] = {
		{ 1, 45453, "", "=q4=Winter's Icy Embrace", "=ds=#s5#, #a2#"};
		{ 2, 45454, "", "=q4=Frost-bound Chain Bracers", "=ds=#s8#, #a3#"};
		{ 3, 45452, "", "=q4=Frostplate Greaves", "=ds=#s11#, #a4#"};
		{ 4, 45451, "", "=q4=Frozen Loop", "=ds=#s13#"};
		{ 5, 45458, "", "=q4=Stormedge", "=ds=#h2#, #w1#"};
		{ 6, 45450, "", "=q4=Northern Barrier", "=ds=#w8#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
	...
	AtlasLoot_Data["UlduarFreya"] = {
		...
		{ 2, 0, "", "=q4=Chestguard of the Lasher", "=ds=#s5#, #a3#"};
	...
	AtlasLoot_Data["UlduarFreya25Man"] = {
		{ 1, 45479, "", "=q4=The Lifebinder", "=ds=#w9#"};
	};
	...
	AtlasLoot_Data["UlduarMimiron"] = {
		...
		{ 4, 45972, "", "=q4=Pulse Baton", "=ds=#h3#, #w6#"};
	...
	AtlasLoot_Data["UlduarMimiron25Man"] = {
		{ 1, 45493, "", "=q4=Asimov's Drape", "=ds=#s4#"};
		{ 2, 45492, "", "=q4=Malleable Steelweave Mantle", "=ds=#s3#, #a2#"};
		{ 3, 45491, "", "=q4=Waistguard of the Creator", "=ds=#s10#, #a2#"};
		{ 4, 45490, "", "=q4=Pandora's Plea", "=ds=#s14#"};
	...
	AtlasLoot_Data["UlduarVezax25Man"] = {
		...
		{ 13, 45145, "", "=q4=Libram of the Sacred Shield", "=ds=#s16#, #w16#"};
	...
	AtlasLoot_Data["PvP80PriestHoly"] = {
		...
		{ 28, 41864, "", "=q4=Furious Gladiator's Mooncloth Leggings", "=ds="};
		Back = "LEVEL80PVPSETS";
	};
	...
	AtlasLoot_Data["PvP80Rogue"] = {
		...
		{ 27, 41767, "", "=q4=Furious Gladiator's Leather Gloves", "=ds="};
	...
	AtlasLoot_Data["PvP80Warrior"] = {
		...
		{ 28, 40847, "", "=q4=Furious Gladiator's Plate Legguards", "=ds="};
		Back = "LEVEL80PVPSETS";
	};
...
--Plate
	...
	AtlasLoot_Data["LakeWintergrasp1"] = {
        ...
        { 4, 46066, "", "=q4=Titan-forged Raiment of Salvation", "=ds=#s5#, #a1#", "40 #wintergraspmark#" };
        { 5, 46079, "", "=q4=Titan-forged Cord of Dominance", "=ds=#s10#, #a1#", "15 #wintergraspmark#" };
        { 6, 46080, "", "=q4=Titan-forged Cord of Salvation", "=ds=#s10#, #a1#", "15 #wintergraspmark#" };
		{ 7, 44899, "", "=q4=Titan-forged Slippers of Dominance", "=ds=#s12#, #a1#", "15 #wintergraspmark#" };
		{ 8, 44900, "", "=q4=Titan-forged Slippers of Salvation", "=ds=#s12#, #a1#", "15 #wintergraspmark#" };
        { 10, 46083, "", "=q4=Titan-forged Rune of Accuracy", "=ds=#s14#", "25 #wintergraspmark#" };
        { 11, 46085, "", "=q4=Titan-forged Rune of Alacrity", "=ds=#s14#", "25 #wintergraspmark#" };
        { 12, 46081, "", "=q4=Titan-forged Rune of Audacity", "=ds=#s14#", "25 #wintergraspmark#" };
        { 13, 46084, "", "=q4=Titan-forged Rune of Cruelty", "=ds=#s14#", "25 #wintergraspmark#" };
        { 14, 46082, "", "=q4=Titan-forged Rune of Determination", "=ds=#s14#", "25 #wintergraspmark#" };
		{ 16, 44907, "", "=q4=Titan-forged Leather Helm of Dominance", "=ds=#s1#, #a2#", "40 #wintergraspmark#" };
		{ 17, 44906, "", "=q4=Titan-forged Leather Helm of Salvation", "=ds=#s1#, #a2#", "40 #wintergraspmark#" };
		{ 18, 44908, "", "=q4=Titan-forged Leather Helm of Triumph", "=ds=#s1#, #a2#", "40 #wintergraspmark#" };
        { 19, 46064, "", "=q4=Titan-forged Leather Chestguard of Dominance", "=ds=#s5#, #a2#", "40 #wintergraspmark#" };
        { 20, 46063, "", "=q4=Titan-forged Leather Chestguard of Salvation", "=ds=#s5#, #a2#", "40 #wintergraspmark#" };
        { 21, 46062, "", "=q4=Titan-forged Leather Tunic of Triumph", "=ds=#s5#, #a2#", "40 #wintergraspmark#" };
        { 22, 46076, "", "=q4=Titan-forged Belt of Dominance", "=ds=#s10#, #a2#", "15 #wintergraspmark#" };
        { 23, 46077, "", "=q4=Titan-forged Belt of Salvation", "=ds=#s10#, #a2#", "15 #wintergraspmark#" };
        { 24, 46078, "", "=q4=Titan-forged Belt of Triumph", "=ds=#s10#, #a2#", "15 #wintergraspmark#" };
		{ 25, 44891, "", "=q4=Titan-forged Boots of Dominance", "=ds=#s12#, #a2#", "15 #wintergraspmark#" };
		{ 26, 44892, "", "=q4=Titan-forged Boots of Salvation", "=ds=#s12#, #a2#", "15 #wintergraspmark#" };
		{ 27, 44893, "", "=q4=Titan-forged Boots of Triumph", "=ds=#s12#, #a2#", "15 #wintergraspmark#" };
		{ 29, 43956, "", "=q4=Reins of the Black War Mammoth", "=ds=#e12#", "300 #wintergrasp#"};
		{ 30, 44077, "", "=q4=Reins of the Black War Mammoth", "=ds=#e12#", "300 #wintergrasp#"};
		Next = "LakeWintergrasp2";
        Back = "PVPMENU";
	};
    
    AtlasLoot_Data["LakeWintergrasp2"] = {
        { 1, 44903, "", "=q4=Titan-forged Chain Helm of Triumph", "=ds=#s1#, #a3#", "40 #wintergraspmark#" };
		{ 2, 44904, "", "=q4=Titan-forged Mail Helm of Dominance", "=ds=#s1#, #a3#", "40 #wintergraspmark#" };
		{ 3, 44905, "", "=q4=Titan-forged Ringmail Helm of Salvation", "=ds=#s1#, #a3#", "40 #wintergraspmark#" };
        { 4, 46059, "", "=q4=Titan-forged Chain Armor of Triumph", "=ds=#s5#, #a3#", "40 #wintergraspmark#" };
        { 5, 46061, "", "=q4=Titan-forged Mail Armor of Domination", "=ds=#s5#, #a3#", "40 #wintergraspmark#" };
        { 6, 46060, "", "=q4=Titan-forged Ringmail of Salvation", "=ds=#s5#, #a3#", "40 #wintergraspmark#" };
        { 7, 46073, "", "=q4=Titan-forged Waistguard of Dominance", "=ds=#s10#, #a3#", "15 #wintergraspmark#" };
        { 8, 46074, "", "=q4=Titan-forged Waistguard of Salvation", "=ds=#s10#, #a3#", "15 #wintergraspmark#" };
        { 9, 46075, "", "=q4=Titan-forged Waistguard of Triumph", "=ds=#s10#, #a3#", "15 #wintergraspmark#" };
		{ 10, 44896, "", "=q4=Titan-forged Sabatons of Dominance", "=ds=#s12#, #a3#", "15 #wintergraspmark#" };
		{ 11, 44897, "", "=q4=Titan-forged Sabatons of Salvation", "=ds=#s12#, #a3#", "15 #wintergraspmark#" };
		{ 12, 44898, "", "=q4=Titan-forged Sabatons of Triumph", "=ds=#s12#, #a3#", "15 #wintergraspmark#" };
        ...
        { 19, 46057, "", "=q4=Titan-forged Chestguard of Salvation", "=ds=#s5#, #a4#", "40 #wintergraspmark#" };
        { 20, 46071, "", "=q4=Titan-forged Girdle of Salvation", "=ds=#s10#, #a4#", "15 #wintergraspmark#" };
        { 21, 46072, "", "=q4=Titan-forged Girdle of Triumph", "=ds=#s10#, #a4#", "15 #wintergraspmark#" };
		{ 22, 44894, "", "=q4=Titan-forged Greaves of Salvation", "=ds=#s12#, #a4#", "15 #wintergraspmark#" };
		{ 23, 44895, "", "=q4=Titan-forged Greaves of Triumph", "=ds=#s12#, #a4#", "15 #wintergraspmark#" };
        { 25, 44914, "", "=q4=Anvil of Titans", "=ds=#s14#", "25 #wintergraspmark#" };
		{ 26, 44912, "", "=q4=Flow of Knowledge", "=ds=#s14#", "25 #wintergraspmark#" };
        { 27, 46086, "", "=q4=Platinum Disks of Battle", "=ds=#s14#", "25 #wintergraspmark#" };
        { 28, 46087, "", "=q4=Platinum Disks of Sorcery", "=ds=#s14#", "25 #wintergraspmark#" };
        { 29, 46088, "", "=q4=Platinum Disks of Swiftness", "=ds=#s14#", "25 #wintergraspmark#" };
