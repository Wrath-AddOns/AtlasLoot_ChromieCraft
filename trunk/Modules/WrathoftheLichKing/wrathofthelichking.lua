...
---- Emblem of Valor Items
	...
	AtlasLoot_Data["Ahnkahet"] = {
		...
		{ 18, 43279, "", "=q3=Battlechest of the Twilight Cult", "=ds=#s11#, #a4#"};
	...
	AtlasLoot_Data["DrakTharonKeep"] = {
		...
		{ 11, 0, "INV_Box_01", "=q6="..AL["Trash Mobs"], ""};
		{ 12, 35641, "", "=q3=Scytheclaw Boots", "=ds=#s12#, #a2#"};
		{ 13, 35640, "", "=q3=Darkweb Bindings", "=ds=#s8#, #a3#"};
	...
	AtlasLoot_Data["DrakTharonKeepHEROIC"] = {
		...
		{ 11, 37718, "", "=q3=Temple Crystal Fragment", "=ds=#s15#"};
		{ 12, 37721, "", "=q3=Cursed Lich Blade", "=ds=#h3#, #w10#"};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleBoss["King Dred"], ""};
		{ 17, 37725, "", "=q3=Savage Wound Wrap", "=ds=#s8#, #a1#"};
		{ 18, 37724, "", "=q3=Handler's Arm Strap", "=ds=#s8#, #a2#"};
		{ 19, 37726, "", "=q3=King Dred's Helm", "=ds=#s1#, #a3#"};
		{ 20, 37723, "", "=q3=Incisor Fragment", "=ds=#s14#"};
		{ 22, 0, "INV_Box_01", "=q6="..BabbleBoss["The Prophet Tharon'ja"], ""};
		{ 23, 37798, "", "=q4=Overlook Handguards", "=ds=#s9#, #a1#"};
		{ 24, 37791, "", "=q4=Leggings of the Winged Serpent", "=ds=#s11#, #a2#"};
		{ 25, 37788, "", "=q4=Limb Regeneration Bracers", "=ds=#s8#, #a3#"};
		{ 26, 37784, "", "=q4=Keystone Great-Ring", "=ds=#s13#"};
		{ 27, 37735, "", "=q3=Ziggurat Imprinted Chestguard", "=ds=#s5#, #a4#"};
		{ 28, 37732, "", "=q3=Spectral Seal of the Prophet", "=ds=#s13#"};
		{ 29, 37734, "", "=q3=Talisman of Troll Divinity", "=ds=#s14#"};
		{ 30, 37733, "", "=q3=Mojo Masked Crusher", "=ds=#h2#, #w6#"};
	};
	...
	AtlasLoot_Data["VioletHold1"] = {
		...
		{ 20, 43407, "", "=q3=Stormstrike Mace", "=ds=#w6#, #h1#" };
	...
	AtlasLoot_Data["VHCyanigosa"] = {
		...
		{ 8, 35653, "", "=q3=Dungeon Girdle", "=ds=#s10#, #a4#"};
		{ 9, 35652, "", "=q3=Incessant Torch", "=ds=#w12#"};
		{ 10, 35654, "", "=q3=Bindings of the Bastille", "=ds=#s8#, #a1#"};
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
		...
		{ 25, 41791, "", "=q3=Design: Thick Autumn's Glow", "=ds=#p12#"};
		{ 27, 40752, "", "=q4=Emblem of Heroism", "=ds=#e15#"};
		Prev = "VioletHold2";
	};
	...
	AtlasLoot_Data["Gundrak1"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Slad'ran"], ""};
		{ 3, 35584, "", "=q3=Embroidered Gown of Zul'drak", "=ds=#s5#, #a1#"};
		{ 4, 35585, "", "=q3=Cannibal's Legguards", "=ds=#s11#, #a3#"};
		{ 5, 35583, "", "=q3=Witch Doctor's Wildstaff", "=ds=#w9#"};
		{ 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Drakkari Colossus"], ""};
		{ 8, 35591, "", "=q3=Shoulderguards of the Ice Troll", "=ds=#s3#, #a2#"};
		{ 9, 35592, "", "=q3=Hauberk of Totemic Mastery", "=ds=#s5#, #a3#"};
		{ 10, 35590, "", "=q3=Drakkari Hunting Bow", "=ds=#w2#"};
		{ 12, 0, "INV_Box_01", "=q6="..AL["Trash Mobs"], ""};
		{ 13, 37647, "", "=q3=Cloak of Bloodied Waters", "=ds=#s4#"};
		{ 14, 35594, "", "=q3=Snowmelt Silken Cinch", "=ds=#s10#, #a1#"};
		{ 15, 35593, "", "=q3=Steel Bear Trap Bracers", "=ds=#s8#, #a4#"};
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 17, 0, "INV_Box_01", "=q6="..BabbleBoss["Slad'ran"], ""};
		...
		{ 23, 0, "INV_Box_01", "=q6="..BabbleBoss["Drakkari Colossus"], ""};
		{ 24, 37637, "", "=q3=Living Mojo Belt", "=ds=#s10#, #a1#"};
		{ 25, 37636, "", "=q3=Helm of Cheated Fate", "=ds=#s1#, #a2#" };
		{ 26, 37634, "", "=q3=Bracers of the Divine Elemental", "=ds=#s8#, #a2#"};
		{ 27, 37635, "", "=q3=Pauldrons of the Colossus", "=ds=#s3#, #a4#"};
		{ 29, 40752, "", "=q4=Emblem of Heroism", "=ds=#e15#"};
		Next = "Gundrak2";
	};

    AtlasLoot_Data["Gundrak2"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Moorabi"], ""};
		{ 3, 35588, "", "=q3=Forlorn Breastplate of War", "=ds=#s5#, #a4#"};
		{ 4, 35589, "", "=q3=Arcane Focal Signet", "=ds=#s13#"};
		{ 5, 35587, "", "=q3=Frozen Scepter of Necromancy", "=ds=#h3#, #w6#"};
		{ 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Gal'darah"], ""};
		{ 8, 43305, "", "=q3=Shroud of Akali", "=ds=#s4#"};
		{ 9, 43309, "", "=q3=Amulet of the Stampede", "=ds=#s2#"};
		{ 10, 43306, "", "=q3=Gal'darah's Signet", "=ds=#s13#"};
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
	...
	AtlasLoot_Data["GundrakEck"] = {
		...
		{ 7, 40752, "", "=q4=Emblem of Heroism", "=ds=#e15#"};
        Prev = "Gundrak2";
	};
	...
	AtlasLoot_Data["HallsofStoneHEROIC"] = {
		...
		{ 4, 38616, "", "=q3=Maiden's Girdle", "=ds=#s10#, #a2#"};
		{ 5, 38615, "", "=q3=Lightning-Charged Gloves", "=ds=#s9#, #a3#"};
		{ 6, 38617, "", "=q3=Woeful Band", "=ds=#s13#"};
		{ 7, 38618, "", "=q3=Hammer of Grief", "=ds=#h2#, #w6#"};
		{ 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Krystallus"], ""};
		{ 10, 37652, "", "=q3=Spaulders of Krystallus", "=ds=#s3#, #a2#"};
		{ 11, 37650, "", "=q3=Shardling Legguards", "=ds=#s11#, #a4#"};
		{ 12, 37651, "", "=q3=The Prospector's Prize", "=ds=#s13#"};
		{ 13, 37653, "", "=q3=Sword of Justice", "=ds=#h2#, #w10#"};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Trash Mobs"], ""};
		{ 17, 37673, "", "=q3=Dark Runic Mantle", "=ds=#s3#, #a1#"};
		{ 18, 37672, "", "=q3=Patina-Coated Breastplate", "=ds=#s5#, #a4#"};
		{ 20, 0, "INV_Box_01", "=q6="..BabbleBoss["The Tribunal of Ages"], ""};
...
--Buyable Items/Set Tokens
	...
	AtlasLoot_Data["FrenzyheartTribe"] = {
		...
		{ 20, 0, "INV_Misc_Rune_14", "=q1=Ripe Disgusting Jar", "=ds="};
		{ 21, 44719, "", "=q3=Frenzyheart Brew", "=ds="};
		{ 22, 39671, "", "=q1=Resurgent Healing Potion", "=ds=#e2#"};
		{ 23, 40067, "", "=q1=Icy Mana Potion", "=ds=#e2#"};
		{ 24, 40087, "", "=q1=Powerful Rejuvenation Potion", "=ds=#e2#"};
		{ 25, 44716, "", "=q1=Mysterious Fermented Liquid", "=ds=#e4#"};
		Back = "REPMENU_WOTLK";
	};
...
--Cloth
	AtlasLoot_Data["PvP80NonSet3"] = {
		{ 1, 41907, "", "=q4=Hateful Gladiator's Cuffs of Dominance", "=ds=", "31600 #faction# #reqrating# 1660", ""};
		{ 2, 41896, "", "=q4=Hateful Gladiator's Cord of Dominance", "=ds=", "49600 #faction# #reqrating# 1630", ""};
		{ 3, 41901, "", "=q4=Hateful Gladiator's Slippers of Dominance", "=ds=", "49600 #faction# #reqrating# 1720", ""};
		{ 5, 41878, "", "=q4=Hateful Gladiator's Cuffs of Salvation", "=ds=", "31600 #faction# #reqrating# 1660", ""};
		{ 6, 41877, "", "=q4=Hateful Gladiator's Cord of Salvation", "=ds=", "49600 #faction# #reqrating# 1630", ""};
		{ 7, 41879, "", "=q4=Hateful Gladiator's Slippers of Salvation", "=ds=", "49600 #faction# #reqrating# 1720", ""};
...
--Leather
	AtlasLoot_Data["PvP80NonSet4"] = {
		{ 1, 41638, "", "=q4=Hateful Gladiator's Armwraps of Dominance", "=ds=", "31600 #faction# #reqrating# 1660", ""};
		{ 2, 41628, "", "=q4=Hateful Gladiator's Belt of Dominance", "=ds=", "49600 #faction# #reqrating# 1630", ""};
		{ 3, 41633, "", "=q4=Hateful Gladiator's Boots of Dominance", "=ds=", "49600 #faction# #reqrating# 1720", ""};
		{ 5, 41332, "", "=q4=Hateful Gladiator's Armwraps of Salvation", "=ds=", "31600 #faction# #reqrating# 1660", ""};
		{ 6, 41330, "", "=q4=Hateful Gladiator's Belt of Salvation", "=ds=", "49600 #faction# #reqrating# 1630", ""};
		{ 7, 41331, "", "=q4=Hateful Gladiator's Boots of Salvation", "=ds=", "49600 #faction# #reqrating# 1720", ""};
		{ 9, 41830, "", "=q4=Hateful Gladiator's Armwraps of Triumph", "=ds=", "31600 #faction# #reqrating# 1660", ""};
		{ 10, 41827, "", "=q4=Hateful Gladiator's Belt of Triumph", "=ds=", "49600 #faction# #reqrating# 1630", ""};
		{ 11, 41828, "", "=q4=Hateful Gladiator's Boots of Triumph", "=ds=", "49600 #faction# #reqrating# 1720", ""};
...
--Mail
	AtlasLoot_Data["PvP80NonSet5"] = {
		{ 1, 41063, "", "=q4=Hateful Gladiator's Wristguards of Dominance", "=ds=", "31600 #faction# #reqrating# 1660", ""};
		{ 2, 41068, "", "=q4=Hateful Gladiator's Waistguard of Dominance", "=ds=", "49600 #faction# #reqrating# 1630", ""};
		{ 3, 41073, "", "=q4=Hateful Gladiator's Sabatons of Dominance", "=ds=", "49600 #faction# #reqrating# 1720", ""};
		{ 5, 41047, "", "=q4=Hateful Gladiator's Wristguards of Salvation", "=ds=", "31600 #faction# #reqrating# 1660", ""};
		{ 6, 41050, "", "=q4=Hateful Gladiator's Waistguard of Salvation", "=ds=", "49600 #faction# #reqrating# 1630", ""};
		{ 7, 41049, "", "=q4=Hateful Gladiator's Sabatons of Salvation", "=ds=", "49600 #faction# #reqrating# 1720", ""};
		{ 9, 41223, "", "=q4=Hateful Gladiator's Wristguards of Triumph", "=ds=", "31600 #faction# #reqrating# 1660", ""};
		{ 10, 41233, "", "=q4=Hateful Gladiator's Waistguard of Triumph", "=ds=", "49600 #faction# #reqrating# 1630", ""};
		{ 11, 41228, "", "=q4=Hateful Gladiator's Sabatons of Triumph", "=ds=", "49600 #faction# #reqrating# 1720", ""};
...
--Plate
	AtlasLoot_Data["PvP80NonSet6"] = {
		{ 1, 40972, "", "=q4=Hateful Gladiator's Bracers of Salvation", "=ds=", "31600 #faction# #reqrating# 1660", ""};
		{ 2, 40966, "", "=q4=Hateful Gladiator's Girdle of Salvation", "=ds=", "49600 #faction# #reqrating# 1630", ""};
		{ 3, 40973, "", "=q4=Hateful Gladiator's Greaves of Salvation", "=ds=", "49600 #faction# #reqrating# 1720", ""};
		{ 5, 40887, "", "=q4=Hateful Gladiator's Bracers of Triumph", "=ds=", "31600 #faction# #reqrating# 1660", ""};
		{ 6, 40877, "", "=q4=Hateful Gladiator's Girdle of Triumph", "=ds=", "49600 #faction# #reqrating# 1630", ""};
		{ 7, 40878, "", "=q4=Hateful Gladiator's Greaves of Triumph", "=ds=", "49600 #faction# #reqrating# 1720", ""};
	...
	AtlasLoot_Data["DeadlyGladiatorWeapons1"] = {
		{ 1, 42317, "", "=q4=Deadly Gladiator's Decapitator", "=ds=", "4500 #arena# #reqrating# 2030"};
		{ 2, 42322, "", "=q4=Deadly Gladiator's Bonegrinder", "=ds=", "4500 #arena# #reqrating# 2030"};
		{ 3, 42332, "", "=q4=Deadly Gladiator's Greatsword", "=ds=", "4500 #arena# #reqrating# 2030"};
		...
		{ 6, 42227, "", "=q4=Deadly Gladiator's Hacker", "=ds=", "1350 #arena# #reqrating# 2030"};
		{ 7, 42248, "", "=q4=Deadly Gladiator's Shiv", "=ds=", "1350 #arena# #reqrating# 2030"};
		{ 8, 42270, "", "=q4=Deadly Gladiator's Left Ripper", "=ds=", "1350 #arena# #reqrating# 2030"};
		{ 9, 42280, "", "=q4=Deadly Gladiator's Bonecracker", "=ds=", "1350 #arena# #reqrating# 2030"};
		{ 10, 42290, "", "=q4=Deadly Gladiator's Quickblade", "=ds=", "1200 #arena# #reqrating# 2030"};
		...
		{ 18, 42232, "", "=q4=Deadly Gladiator's Chopper", "=ds=", "1350 #arena# #reqrating# 2030"};
		{ 19, 42237, "", "=q4=Deadly Gladiator's Waraxe", "=ds=", "1200 #arena# #reqrating# 2030"};
		{ 20, 42265, "", "=q4=Deadly Gladiator's Left Render", "=ds=", "1350 #arena# #reqrating# 2030"};
	...
	AtlasLoot_Data["DeadlyGladiatorWeapons2"] = {
		...
		{ 19, 42614, "", "=q4=Deadly Gladiator's Libram of Justice", "1200 #arena# #reqrating# 2030"};
		{ 20, 42852, "", "=q4=Deadly Gladiator's Libram of Fortitude", "1200 #arena# #reqrating# 2030"};
		{ 21, 42620, "", "=q4=Deadly Gladiator's Sigil of Strife", "=ds=", "1200 #arena# #reqrating# 2030"};
		{ 22, 42597, "", "=q4=Deadly Gladiator's Totem of the Third Wind", "1200 #arena# #reqrating# 2030"};
		{ 23, 42607, "", "=q4=Deadly Gladiator's Totem of Indomitability", "1200 #arena# #reqrating# 2030"};
		{ 24, 42602, "", "=q4=Deadly Gladiator's Totem of Survival", "1200 #arena# #reqrating# 2030"};
	...
	AtlasLoot_Data["EmblemofHeroism"] = {
		...
		{ 22, 40610, "", "=q4=Chestguard of the Lost Conqueror", "=ds=#e15#", "80 #eofheroism#"};
		{ 23, 40611, "", "=q4=Chestguard of the Lost Protector", "=ds=#e15#", "80 #eofheroism#"};
		{ 24, 40612, "", "=q4=Chestguard of the Lost Vanquisher", "=ds=#e15#", "80 #eofheroism#"};
		{ 25, 40613, "", "=q4=Gloves of the Lost Conqueror", "=ds=#e15#", "60 #eofheroism#"};
		{ 26, 40614, "", "=q4=Gloves of the Lost Protector", "=ds=#e15#", "60 #eofheroism#"};
		{ 27, 40615, "", "=q4=Gloves of the Lost Vanquisher", "=ds=#e15#", "60 #eofheroism#"};
		{ 28, 43102, "", "=q3=Frozen Orb", "=ds=#e15#", "10 #eofheroism#"};
