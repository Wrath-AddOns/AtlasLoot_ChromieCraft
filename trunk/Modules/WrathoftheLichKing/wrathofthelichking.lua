...
--Plate
	...
	AtlasLoot_Data["T9ShamanEnhancement_H"] = {
		...
		{ 9, 48348, "", "=q4=Thrall's Faceguard of Triumph", "=ds=#s1#, #a3#", "75 #eoftriumph# 1 #trophyofthecrusade#"};
		{ 10, 48350, "", "=q4=Thrall's Shoulderguards of Triumph", "=ds=#s3#, #a3#", "45 #eoftriumph# 1 #trophyofthecrusade#"};
		{ 11, 48346, "", "=q4=Thrall's Chestguard of Triumph", "=ds=#s5#, #a3#", "75 #eoftriumph# 1 #trophyofthecrusade#"};
		{ 12, 48347, "", "=q4=Thrall's Grips of Triumph", "=ds=#s9#, #a3#", "45 #eoftriumph# 1 #trophyofthecrusade#"};
		{ 13, 48349, "", "=q4=Thrall's War-Kilt of Triumph", "=ds=#s11#, #a3#", "75 #eoftriumph# 1 #trophyofthecrusade#"};
