...
--Buyable Items/Set Tokens
	...
	AtlasLoot_Data["PvP80DeathKnight"] = {
		...
		{ 2, 40817, "", "=q3=Savage Gladiator's Dreadplate Helm", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 40857, "", "=q3=Savage Gladiator's Dreadplate Shoulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 40779, "", "=q3=Savage Gladiator's Dreadplate Chestpiece", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 40799, "", "=q3=Savage Gladiator's Dreadplate Gauntlets", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 40837, "", "=q3=Savage Gladiator's Dreadplate Legguards", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_Deathknight_DeathStrike", "=q6=#arenas10#", ""};
		{ 9, 40820, "", "=q4=Hateful Gladiator's Dreadplate Helm", "=ds="};
		{ 10, 40860, "", "=q4=Hateful Gladiator's Dreadplate Shoulders", "=ds="};
		{ 11, 40781, "", "=q4=Hateful Gladiator's Dreadplate Chestpiece", "=ds="};
		{ 12, 40803, "", "=q4=Hateful Gladiator's Dreadplate Gauntlets", "=ds="};
		{ 13, 40841, "", "=q4=Hateful Gladiator's Dreadplate Legguards", "=ds="};
	...
	AtlasLoot_Data["PvP80DruidBalance"] = {
		...
		{ 2, 41324, "", "=q3=Savage Gladiator's Wyrmhide Helm", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 41278, "", "=q3=Savage Gladiator's Wyrmhide Spaulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 41313, "", "=q3=Savage Gladiator's Wyrmhide Robes", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 41290, "", "=q3=Savage Gladiator's Wyrmhide Gloves", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 41301, "", "=q3=Savage Gladiator's Wyrmhide Legguards", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_Nature_InsectSwarm", "=q6=#arenas1_1#", ""};
		{ 9, 41325, "", "=q4=Hateful Gladiator's Wyrmhide Helm", "=ds="};
		{ 10, 41279, "", "=q4=Hateful Gladiator's Wyrmhide Spaulders", "=ds="};
		{ 11, 41314, "", "=q4=Hateful Gladiator's Wyrmhide Robes", "=ds="};
		{ 12, 41291, "", "=q4=Hateful Gladiator's Wyrmhide Gloves", "=ds="};
		{ 13, 41302, "", "=q4=Hateful Gladiator's Wyrmhide Legguards", "=ds="};
	...
	AtlasLoot_Data["PvP80DruidFeral"] = {
		...
		{ 2, 41675, "", "=q3=Savage Gladiator's Dragonhide Helm", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 41712, "", "=q3=Savage Gladiator's Dragonhide Spaulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 41658, "", "=q3=Savage Gladiator's Dragonhide Robes", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 41770, "", "=q3=Savage Gladiator's Dragonhide Gloves", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 41664, "", "=q3=Savage Gladiator's Dragonhide Legguards", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Ability_Druid_Maul", "=q6=#arenas1_2#", ""};
		{ 9, 41676, "", "=q4=Hateful Gladiator's Dragonhide Helm", "=ds="};
		{ 10, 41713, "", "=q4=Hateful Gladiator's Dragonhide Spaulders", "=ds="};
		{ 11, 41659, "", "=q4=Hateful Gladiator's Dragonhide Robes", "=ds="};
		{ 12, 41771, "", "=q4=Hateful Gladiator's Dragonhide Gloves", "=ds="};
		{ 13, 41665, "", "=q4=Hateful Gladiator's Dragonhide Legguards", "=ds="};
	...
	AtlasLoot_Data["PvP80DruidRestoration"] = {
		...
		{ 2, 41269, "", "=q3=Savage Gladiator's Kodohide Helm", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 41271, "", "=q3=Savage Gladiator's Kodohide Spaulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 41272, "", "=q3=Savage Gladiator's Kodohide Robes", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 41268, "", "=q3=Savage Gladiator's Kodohide Gloves", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 41270, "", "=q3=Savage Gladiator's Kodohide Legguards", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_Nature_Regeneration", "=q6=#arenas1_3#", ""};
		{ 9, 41319, "", "=q4=Hateful Gladiator's Kodohide Helm", "=ds="};
		{ 10, 41273, "", "=q4=Hateful Gladiator's Kodohide Spaulders", "=ds="};
		{ 11, 41308, "", "=q4=Hateful Gladiator's Kodohide Robes", "=ds="};
		{ 12, 41284, "", "=q4=Hateful Gladiator's Kodohide Gloves", "=ds="};
		{ 13, 41296, "", "=q4=Hateful Gladiator's Kodohide Legguards", "=ds="};
	...
	AtlasLoot_Data["PvP80Hunter"] = {
		...
		{ 2, 41154, "", "=q3=Savage Gladiator's Chain Helm", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 41214, "", "=q3=Savage Gladiator's Chain Spaulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 41084, "", "=q3=Savage Gladiator's Chain Armor", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 41140, "", "=q3=Savage Gladiator's Chain Gauntlets", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 41202, "", "=q3=Savage Gladiator's Chain Leggings", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Ability_Hunter_RunningShot", "=q6=#arenas2#", ""};
		{ 9, 41155, "", "=q4=Hateful Gladiator's Chain Helm", "=ds="};
		{ 10, 41215, "", "=q4=Hateful Gladiator's Chain Spaulders", "=ds="};
		{ 11, 41085, "", "=q4=Hateful Gladiator's Chain Armor", "=ds="};
		{ 12, 41141, "", "=q4=Hateful Gladiator's Chain Gauntlets", "=ds="};
		{ 13, 41203, "", "=q4=Hateful Gladiator's Chain Leggings", "=ds="};
	...
	AtlasLoot_Data["PvP80Mage"] = {
		...
		{ 2, 41943, "", "=q3=Savage Gladiator's Silk Cowl", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 41962, "", "=q3=Savage Gladiator's Silk Amice", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 41949, "", "=q3=Savage Gladiator's Silk Raiment", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 41968, "", "=q3=Savage Gladiator's Silk Handguards", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 41956, "", "=q3=Savage Gladiator's Silk", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_Frost_IceStorm", "=q6=#arenas3#", ""};
		{ 9, 41944, "", "=q4=Hateful Gladiator's Silk Cowl", "=ds="};
		{ 10, 41963, "", "=q4=Hateful Gladiator's Silk Amice", "=ds="};
		{ 11, 41950, "", "=q4=Hateful Gladiator's Silk Raiment", "=ds="};
		{ 12, 41969, "", "=q4=Hateful Gladiator's Silk Handguards", "=ds="};
		{ 13, 41957, "", "=q4=Hateful Gladiator's Silk Trousers", "=ds="};
	...
	AtlasLoot_Data["PvP80PaladinRetribution"] = {
		...
		{ 2, 40818, "", "=q3=Savage Gladiator's Scaled Helm", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 40858, "", "=q3=Savage Gladiator's Scaled Shoulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 40780, "", "=q3=Savage Gladiator's Scaled Chestpiece", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 40798, "", "=q3=Savage Gladiator's Scaled Gauntlets", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 40838, "", "=q3=Savage Gladiator's Scaled Legguards", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_Holy_AuraOfLight", "=q6=#arenas4_1#", ""};
		{ 9, 40821, "", "=q4=Hateful Gladiator's Scaled Helm", "=ds="};
		{ 10, 40861, "", "=q4=Hateful Gladiator's Scaled Shoulders", "=ds="};
		{ 11, 40782, "", "=q4=Hateful Gladiator's Scaled Chestpiece", "=ds="};
		{ 12, 40802, "", "=q4=Hateful Gladiator's Scaled Gauntlets", "=ds="};
		{ 13, 40842, "", "=q4=Hateful Gladiator's Scaled Legguards", "=ds="};
	...
	AtlasLoot_Data["PvP80PaladinHoly"] = {
		...
		{ 2, 40930, "", "=q3=Savage Gladiator's Ornamented Headcover", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 40960, "", "=q3=Savage Gladiator's Ornamented Spaulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 40898, "", "=q3=Savage Gladiator's Ornamented Chestguard", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 40918, "", "=q3=Savage Gladiator's Ornamented Gloves", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 40936, "", "=q3=Savage Gladiator's Ornamented Legplates", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_Holy_HolyBolt", "=q6=#arenas4_2#", ""};
		{ 9, 40931, "", "=q4=Hateful Gladiator's Ornamented Headcover", "=ds="};
		{ 10, 40961, "", "=q4=Hateful Gladiator's Ornamented Spaulders", "=ds="};
		{ 11, 40904, "", "=q4=Hateful Gladiator's Ornamented Gloves", "=ds="};
		{ 12, 40925, "", "=q4=Hateful Gladiator's Ornamented Chestguard", "=ds="};
		{ 13, 40937, "", "=q4=Hateful Gladiator's Ornamented Legplates", "=ds="};
	...
	AtlasLoot_Data["PvP80PriestShadow"] = {
		...
		{ 2, 41912, "", "=q3=Savage Gladiator's Satin Hood", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 41930, "", "=q3=Savage Gladiator's Satin Mantle", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 41918, "", "=q3=Savage Gladiator's Satin Robe", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 41937, "", "=q3=Savage Gladiator's Satin Gloves", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 41924, "", "=q3=Savage Gladiator's Satin Leggings", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_Shadow_AntiShadow", "=q6=#arenas5_1#", ""};
		{ 9, 41913, "", "=q4=Hateful Gladiator's Satin Hood", "=ds="};
		{ 10, 41931, "", "=q4=Hateful Gladiator's Satin Mantle", "=ds="};
		{ 11, 41919, "", "=q4=Hateful Gladiator's Satin Robe", "=ds="};
		{ 12, 41938, "", "=q4=Hateful Gladiator's Satin Gloves", "=ds="};
		{ 13, 41925, "", "=q4=Hateful Gladiator's Satin Leggings", "=ds="};
	...
	AtlasLoot_Data["PvP80PriestHoly"] = {
		...
		{ 2, 41848, "", "=q3=Savage Gladiator's Mooncloth Hood", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 41850, "", "=q3=Savage Gladiator's Mooncloth Mantle", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 41851, "", "=q3=Savage Gladiator's Mooncloth Robe", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 41847, "", "=q3=Savage Gladiator's Mooncloth Gloves", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 41849, "", "=q3=Savage Gladiator's Mooncloth Leggings", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_Holy_PowerWordShield", "=q6=#arenas5_2#", ""};
		{ 9, 41852, "", "=q4=Hateful Gladiator's Mooncloth Hood", "=ds="};
		{ 10, 41867, "", "=q4=Hateful Gladiator's Mooncloth Mantle", "=ds="};
		{ 11, 41857, "", "=q4=Hateful Gladiator's Mooncloth Robe", "=ds="};
		{ 12, 41872, "", "=q4=Hateful Gladiator's Mooncloth Gloves", "=ds="};
		{ 13, 41862, "", "=q4=Hateful Gladiator's Mooncloth Leggings", "=ds="};
	...
	AtlasLoot_Data["PvP80Rogue"] = {
		...
		{ 2, 41644, "", "=q3=Savage Gladiator's Leather Helm", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 41646, "", "=q3=Savage Gladiator's Leather Spaulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 41647, "", "=q3=Savage Gladiator's Leather Tunic", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 41643, "", "=q3=Savage Gladiator's Leather Gloves", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 41645, "", "=q3=Savage Gladiator's Leather Legguards", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Ability_BackStab", "=q6=#arenas6#", ""};
		{ 9, 41670, "", "=q4=Hateful Gladiator's Leather Helm", "=ds="};
		{ 10, 41681, "", "=q4=Hateful Gladiator's Leather Spaulders", "=ds="};
		{ 11, 41648, "", "=q4=Hateful Gladiator's Leather Tunic", "=ds="};
		{ 12, 41765, "", "=q4=Hateful Gladiator's Leather Gloves", "=ds="};
		{ 13, 41653, "", "=q4=Hateful Gladiator's Leather Legguards", "=ds="};
	...
	AtlasLoot_Data["PvP80ShamanElemental"] = {
		...
		{ 2, 41016, "", "=q3=Savage Gladiator's Mail Helm", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 41041, "", "=q3=Savage Gladiator's Mail Spaulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 40987, "", "=q3=Savage Gladiator's Mail Armor", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 41004, "", "=q3=Savage Gladiator's Mail Gauntlets", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 41030, "", "=q3=Savage Gladiator's Mail Leggings", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_Nature_Lightning", "=q6=#arenas7_1#", ""};
		{ 9, 41017, "", "=q4=Hateful Gladiator's Mail Helm", "=ds="};
		{ 10, 41042, "", "=q4=Hateful Gladiator's Mail Spaulders", "=ds="};
		{ 11, 40989, "", "=q4=Hateful Gladiator's Mail Armor", "=ds="};
		{ 12, 41005, "", "=q4=Hateful Gladiator's Mail Gauntlets", "=ds="};
		{ 13, 41031, "", "=q4=Hateful Gladiator's Mail Leggings", "=ds="};
	...
	AtlasLoot_Data["PvP80ShamanEnhancement"] = {
		...
		{ 2, 41148, "", "=q3=Savage Gladiator's Linked Helm", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 41208, "", "=q3=Savage Gladiator's Linked Spaulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 41078, "", "=q3=Savage Gladiator's Linked Armor", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 41134, "", "=q3=Savage Gladiator's Linked Gauntlets", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 41160, "", "=q3=Savage Gladiator's Linked Leggings", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_FireResistanceTotem_01", "=q6=#arenas7_1#", ""};
		{ 9, 41149, "", "=q4=Hateful Gladiator's Linked Helm", "=ds="};
		{ 10, 41209, "", "=q4=Hateful Gladiator's Linked Spaulders", "=ds="};
		{ 11, 41079, "", "=q4=Hateful Gladiator's Linked Armor", "=ds="};
		{ 12, 41135, "", "=q4=Hateful Gladiator's Linked Gauntlets", "=ds="};
		{ 13, 41162, "", "=q4=Hateful Gladiator's Linked Leggings", "=ds="};
	...
	AtlasLoot_Data["PvP80ShamanRestoration"] = {
		...
		{ 2, 41010, "", "=q3=Savage Gladiator's Ringmail Helm", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 41024, "", "=q3=Savage Gladiator's Ringmail Spaulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 40986, "", "=q3=Savage Gladiator's Ringmail Armor", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 40998, "", "=q3=Savage Gladiator's Ringmail Gauntlets", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 41023, "", "=q3=Savage Gladiator's Ringmail Leggings", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_Nature_HealingWaveGreater", "=q6=#arenas7_1#", ""};
		{ 9, 41011, "", "=q4=Hateful Gladiator's Ringmail Helm", "=ds="};
		{ 10, 41036, "", "=q4=Hateful Gladiator's Ringmail Spaulders", "=ds="};
		{ 11, 40988, "", "=q4=Hateful Gladiator's Ringmail Armor", "=ds="};
		{ 12, 40999, "", "=q4=Hateful Gladiator's Ringmail Gauntlets", "=ds="};
		{ 13, 41025, "", "=q4=Hateful Gladiator's Ringmail Leggings", "=ds="};
	...
	AtlasLoot_Data["PvP80Warlock"] = {
		...
		{ 2, 41990, "", "=q3=Savage Gladiator's Felweave Cowl", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 42008, "", "=q3=Savage Gladiator's Felweave Amice", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 41996, "", "=q3=Savage Gladiator's Felweave Raiment", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 42014, "", "=q3=Savage Gladiator's Felweave Handguards", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 42002, "", "=q3=Savage Gladiator's Felweave Trousers", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Spell_Shadow_CurseOfTounges", "=q6=#arenas8_1#", ""};
		{ 9, 41991, "", "=q4=Hateful Gladiator's Felweave Cowl", "=ds="};
		{ 10, 42009, "", "=q4=Hateful Gladiator's Felweave Amice", "=ds="};
		{ 11, 42001, "", "=q4=Hateful Gladiator's Felweave Raiment", "=ds="};
		{ 12, 42015, "", "=q4=Hateful Gladiator's Felweave Handguards", "=ds="};
		{ 13, 42003, "", "=q4=Hateful Gladiator's Felweave Trousers", "=ds="};
...
--These are datamined sets NOT available yet. LK Arena 6
	...
	AtlasLoot_Data["PvP80Warrior"] = {
		...
		{ 2, 40816, "", "=q3=Savage Gladiator's Plate Helm", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 3, 40856, "", "=q3=Savage Gladiator's Plate Shoulders", "=ds=", "4800 #faction# 275 #arena#", ""};
		{ 4, 40778, "", "=q3=Savage Gladiator's Plate Chestpiece", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 5, 40797, "", "=q3=Savage Gladiator's Plate Gauntlets", "=ds=", "3600 #faction# 200 #arena#", ""};
		{ 6, 40836, "", "=q3=Savage Gladiator's Plate Legguards", "=ds=", "6000 #faction# 350 #arena#", ""};
		{ 8, 0, "Ability_Warrior_BattleShout", "=q6=#arenas9#", ""};
		{ 9, 40819, "", "=q4=Hateful Gladiator's Plate Helm", "=ds="};
		{ 10, 40859, "", "=q4=Hateful Gladiator's Plate Shoulders", "=ds="};
		{ 11, 40783, "", "=q4=Hateful Gladiator's Plate Chestpiece", "=ds="};
		{ 12, 40801, "", "=q4=Hateful Gladiator's Plate Gauntlets", "=ds="};
		{ 13, 40840, "", "=q4=Hateful Gladiator's Plate Legguards", "=ds="};
