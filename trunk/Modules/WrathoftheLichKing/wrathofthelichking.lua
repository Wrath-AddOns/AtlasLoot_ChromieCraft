...
--These are datamined sets NOT available yet. LK Arena 6
	...
	AtlasLoot_Data["PvP80NonSet1"] = {
		...
		{ 12, 42129, "", "=q4=Battlemaster's Accuracy", "=ds=", "62000 #faction# #reqrating# 1800", ""};
        { 13, 42131, "", "=q4=Battlemaster's Bravery", "=ds=", "62000 #faction# #reqrating# 1800", ""};
        { 14, 42128, "", "=q4=Battlemaster's Hostility", "=ds=", "62000 #faction# #reqrating# 1800", ""};
        ...
        { 27, 42130, "", "=q4=Battlemaster's Avidity", "=ds=", "62000 #faction# #reqrating# 1800", ""};
        { 28, 42132, "", "=q4=Battlemaster's Conviction", "=ds=", "62000 #faction# #reqrating# 1800", ""};
		Next = "PvP80NonSet2";
