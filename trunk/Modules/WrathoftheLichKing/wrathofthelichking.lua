...
--Plate
	...
	AtlasLoot_Data["PetsPromotional1"] = {
		...
		{ 9, 30360, "", "=q3=Lurky's Egg", "=ds="};
		{ 10, 45180, "", "=q3=Murkimus' Little Spear", "=ds="};
		{ 11, 25535, "", "=q3=Netherwhelp's Collar", "=ds="};
		{ 12, 13583, "", "=q3=Panda Collar", "=ds="};
		{ 13, 22114, "", "=q3=Pink Murloc Egg", "=ds="};
		{ 14, 34492, "", "=q3=Rocket Chicken", "=ds="};
		{ 15, 38050, "", "=q3=Soul-Trader Beacon", "=ds="};
		{ 16, 39656, "", "=q3=Tyrael's Hilt", "=ds="};
		{ 17, 13582, "", "=q3=Zergling Leash", "=ds="};
		Prev = "PetsEvent1";
		Back = "PETMENU";
	};
