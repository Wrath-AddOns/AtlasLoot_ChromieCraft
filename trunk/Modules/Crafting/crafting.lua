...
---- Jewelcrafting
    ...
    AtlasLoot_Data["EngineeringReagents1"] = {
        { 1, "s56471", "39683", "=q1=Froststeel Tube", "=ds=#sr# 390" };
        { 2, "s56464", "39682", "=q1=Overcharged Capacitor", "=ds=#sr# 375"};
        { 3, "s30309", "23787", "=q1=Felsteel Stabilizer", "=ds=#sr# 340"};
		{ 4, "s30307", "23785", "=q1=Hardened Adamantite Tube", "=ds=#sr# 340"};
		{ 5, "s30308", "23786", "=q1=Khorium Power Core", "=ds=#sr# 340"};
        { 6, "s39971", "32423", "=q1=Icy Blasting Primers", "=ds=#sr# 335"};
        { 7, "s30306", "23784", "=q1=Adamantite Frame", "=ds=#sr# 325"};
        { 8, "s30305", "23783", "=q1=Handful of Fel Iron Bolts", "=ds=#sr# 300"};
		{ 9, "s30303", "23781", "=q1=Elemental Blasting Powder", "=ds=#sr# 300"};
		{ 10, "s30304", "23782", "=q1=Fel Iron Casing", "=ds=#sr# 300"};
        { 11, "s19815", "16006", "=q1=Delicate Arcanite Converter", "=ds=#sr# 285"};
        { 12, "s19795", "16000", "=q1=Thorium Tube", "=ds=#sr# 275"};
        { 13, "s39895", "7191", "=q1=Fused Wiring", "=ds=#sr# 275"};
        { 14, "s19791", "15994", "=q1=Thorium Widget", "=ds=#sr# 260"};
        { 15, "s23071", "18631", "=q1=Truesilver Transformer", "=ds=#sr# 260"};
        { 16, "s19788", "15992", "=q1=Dense Blasting Powder", "=ds=#sr# 250"};
        { 17, "s12599", "10561", "=q1=Mithril Casing", "=ds=#sr# 215"};
        { 18, "s12591", "10560", "=q1=Unstable Trigger", "=ds=#sr# 200"};
        { 19, "s12589", "10559", "=q1=Mithril Tube", "=ds=#sr# 195"};
        { 20, "s12590", "10498", "=q1=Gyromatic Micro-Adjustor", "=ds=#sr# 175"};
        { 21, "s12585", "10505", "=q1=Solid Blasting Powder", "=ds=#sr# 175"};
        { 22, "s3961", "4389", "=q1=Gyrochronatom", "=ds=#sr# 170"};
        { 23, "s3958", "4387", "=q1=Iron Strut", "=ds=#sr# 160"};
        { 24, "s12584", "10558", "=q1=Gold Power Core", "=ds=#sr# 150"};
        { 25, "s3953", "4382", "=q1=Bronze Framework", "=ds=#sr# 145"};
        { 26, "s3942", "4375", "=q1=Whirring Bronze Gizmo", "=ds=#sr# 125"};
        { 27, "s3945", "4377", "=q1=Heavy Blasting Powder", "=ds=#sr# 125"};
        { 28, "s3938", "4371", "=q1=Bronze Tube", "=ds=#sr# 105"};
        { 29, "s3973", "4404", "=q1=Silver Contact", "=ds=#sr# 90"};
        { 30, "s3929", "4364", "=q1=Coarse Blasting Powder", "=ds=#sr# 75"};
        Next = "EngineeringReagents2";
        Back = "ENGINEERINGMENU";
    };
    
    AtlasLoot_Data["EngineeringReagents2"] = {
        { 1, "s3926", "4363", "=q1=Copper Modulator", "=ds=#sr# 65"};
        { 2, "s3924", "4361", "=q1=Copper Tube", "=ds=#sr# 50"};
        { 3, "s3922", "4359", "=q1=Handful of Copper Bolts", "=ds=#sr# 30"};
        { 4, "s3918", "4357", "=q1=Rough Blasting Powder", "=ds=#sr# 1"};
    ...
    AtlasLoot_Data["JewelPurple1"] = {
        ...
        { 16, "s53962", "40022", "=q3=Sovereign Twilight Opal", "=ds="..AL["Drop"]};
        { 17, "s39463", "31863", "=q3=Balanced Nightseye", "=ds=#sr# 350"};
        { 18, "s31104", "24056", "=q3=Glowing Nightseye", "=ds=#sr# 350"};
		{ 19, "s39462", "31865", "=q3=Infused Nightseye", "=ds=#sr# 350"};
        { 20, "s46803", "35707", "=q3=Regal Nightseye", "=ds=#sr# 350"};
		{ 21, "s31105", "24057", "=q3=Royal Nightseye", "=ds=#sr# 350"};
		{ 22, "s31103", "24055", "=q3=Shifting Nightseye", "=ds=#sr# 350"};
		{ 23, "s31102", "24054", "=q3=Sovereign Nightseye", "=ds=#sr# 350"};
        { 24, "s41429", "32836", "=q3=Purified Shadow Pearl", "=ds=#sr# 350"};
        { 25, "s53868", "39938", "=q2=Regal Shadow Crystal", "=ds="..AL["Trainer"] };
        { 26, "s53866", "39937", "=q2=Balanced Shadow Crystal", "=ds="..AL["Trainer"] };
        { 27, "s53869", "39939", "=q2=Defender's Shadow Crystal", "=ds="..BabbleFaction["The Kalu'ak"]..": "..BabbleFaction["Honored"] };
        { 28, "s53862", "39936", "=q2=Glowing Shadow Crystal", "=ds="..AL["Trainer"] };
        { 29, "s53871", "39940", "=q2=Guardian's Shadow Crystal", "=ds="..AL["Trainer"] };
        { 30, "s53867", "39944", "=q2=Infused Shadow Crystal", "=ds="..AL["Trainer"] };
        Next = "JewelPurple2";
        Back = "JEWELCRAFTINGMENU";
    };
    
    AtlasLoot_Data["JewelPurple2"] = {
        { 1, "s53865", "39945", "=q2=Mysterious Shadow Crystal", "=ds=1250 #faction#" };
        { 2, "s53870", "39933", "=q2=Puissant Shadow Crystal", "=ds="..AL["Trainer"] };
        { 3, "s53863", "39941", "=q2=Purified Shadow Crystal", "=ds="..AL["Trainer"] };
        { 4, "s53864", "39943", "=q2=Royal Shadow Crystal", "=ds="..AL["Trainer"] };
        { 5, "s53860", "39935", "=q2=Shifting Shadow Crystal", "=ds="..AL["Trainer"] };
        { 6, "s53859", "39934", "=q2=Sovereign Shadow Crystal", "=ds="..AL["Trainer"] };
        { 7, "s53861", "39942", "=q2=Tenuous Shadow Crystal", "=ds="..AL["Trainer"] };
        { 8, "s41420", "32833", "=q2=Purified Jaggal Pearl", "=ds=#sr# 325"};
        { 9, "s39455", "31862", "=q2=Balanced Shadow Draenite", "=ds=#sr# 325"};
        { 10, "s39458", "31864", "=q2=Infused Shadow Draenite", "=ds=#sr# 325"};
        { 11, "s28936", "23111", "=q2=Sovereign Shadow Draenite", "=ds=#sr# 325"};
        { 12, "s28933", "23110", "=q2=Shifting Shadow Draenite", "=ds=#sr# 315"};
        { 13, "s28927", "23109", "=q2=Royal Shadow Draenite", "=ds=#sr# 305"};
        { 14, "s28925", "23108", "=q2=Glowing Shadow Draenite", "=ds=#sr# 300"};
        Prev = "JewelPurple1";
        Back = "JEWELCRAFTINGMENU";
    };
