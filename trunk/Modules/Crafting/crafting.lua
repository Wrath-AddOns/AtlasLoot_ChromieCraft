...
---- Jewelcrafting
    ...
    AtlasLoot_Data["AlchemyBattleElixir1"] = {
        ...
        { 12, "s17571", "13452", "=q1=Elixir of the Mongoose", "=ds=#sr# 280"};
        { 13, "s17557", "13453", "=q1=Elixir of Brute Force", "=ds="..AL["Trainer"]};
        { 14, "s11477", "9224", "=q1=Elixir of Demonslaying", "=ds=#sr# 250"};
        { 15, "s26277", "21546", "=q1=Elixir of Greater Firepower", "=ds=#sr# 250"};
		{ 16, "s11476", "9264", "=q1=Elixir of Shadow Power", "=ds=#sr# 250"};
        { 17, "s11472", "9206", "=q1=Elixir of Giants", "=ds=#sr# 245"};
        { 18, "s11467", "9187", "=q1=Elixir of Greater Agility", "=ds="..AL["Trainer"]};
        { 19, "s11461", "9155", "=q1=Arcane Elixir", "=ds="..AL["Trainer"]};
        { 20, "s21923", "17708", "=q1=Elixir of Frost Power", "=ds=#sr# 190"};
        { 21, "s11449", "8949", "=q1=Elixir of Agility", "=ds="..AL["Trainer"]};
        { 22, "s3188", "3391", "=q1=Elixir of Ogre's Strength", "=ds=#sr# 150"};
        { 23, "s2333", "3390", "=q1=Elixir of Lesser Agility", "=ds=#sr# 140"};
        { 24, "s7845", "6373", "=q1=Elixir of Firepower", "=ds="..AL["Trainer"]};
        { 25, "s8240", "6662", "=q1=Elixir of Giant Growth", "=ds=#sr# 90"};
        { 26, "s3230", "2457", "=q1=Elixir of Minor Agility", "=ds=#sr# 50"};
    ...
    AtlasLoot_Data["AlchemyGuardianElixir1"] = {
        ...
        { 9, "s24365", "20007", "=q1=Mageblood Elixir", "=ds=#sr# 275"};
        { 10, "s17554", "13445", "=q1=Elixir of Superior Defense", "=ds=#sr# 265"};
		{ 11, "s17555", "13447", "=q1=Elixir of the Sages", "=ds="..AL["Trainer"]};
        { 12, "s11466", "9088", "=q1=Gift of Arthas", "=ds=#sr# 240"};
        { 13, "s11465", "9179", "=q1=Elixir of Greater Intellect", "=ds="..AL["Trainer"]};
        { 14, "s11450", "8951", "=q1=Elixir of Greater Defense", "=ds="..AL["Trainer"]};
        { 15, "s3451", "3826", "=q1=Mighty Troll's Blood Elixir", "=ds=#sr# 180"};
    ...
    AtlasLoot_Data["AlchemyPotion1"] = {
        { 1, "s28586", "22850", "=q1=Super Rejuvenation Potion", "=ds=#sr# 375"};
        ...
        { 30, "s24367", "20008", "=q1=Living Action Potion", "=ds=#sr# 285"};
        Next = "AlchemyPotion2";
    ...
    AtlasLoot_Data["AlchemyPotion2"] = {
        ...
        { 2, "s17570", "13455", "=q1=Greater Stoneshield Potion", "=ds=#sr# 280"};
        { 3, "s24366", "20002", "=q1=Greater Dreamless Sleep Potion", "=ds=#sr# 275"};
        ...
        { 7, "s3175", "3387", "=q1=Limited Invulnerability Potion", "=ds=#sr# 250"};
        { 8, "s11464", "9172", "=q1=Invisibility Potion", "=ds=#sr# 235"};
        { 9, "s15833", "12190", "=q1=Dreamless Sleep Potion", "=ds="..AL["Trainer"]};
        { 10, "s11458", "9144", "=q1=Wildvine Potion", "=ds=#sr# 225"};
        { 11, "s4942", "4623", "=q1=Lesser Stoneshield Potion", "=ds=#sr# 215"};
		{ 12, "s11457", "3928", "=q1=Superior Healing Potion", "=ds="..AL["Trainer"]};
        { 13, "s11453", "9036", "=q1=Magic Resistance Potion", "=ds=#sr# 210"};
		{ 14, "s11452", "9030", "=q1=Restorative Potion", "=ds=#sr# 210"};
        { 15, "s11448", "6149", "=q1=Greater Mana Potion", "=ds="..AL["Trainer"]};
        { 16, "s7258", "6050", "=q1=Frost Protection Potion", "=ds=#sr# 190"};
		{ 17, "s7259", "6052", "=q1=Nature Protection Potion", "=ds=#sr# 190"};
        { 18, "s6618", "5633", "=q1=Great Rage Potion", "=ds=#sr# 175"};
        { 19, "s3448", "3823", "=q1=Lesser Invisibility Potion", "=ds="..AL["Trainer"]};
		{ 20, "s7257", "6049", "=q1=Fire Protection Potion", "=ds=#sr# 165"};
        { 21, "s3452", "3827", "=q1=Mana Potion", "=ds="..AL["Trainer"]};
        { 22, "s7181", "1710", "=q1=Greater Healing Potion", "=ds="..AL["Trainer"]};
        { 23, "s6624", "5634", "=q1=Free Action Potion", "=ds="..AL["Trainer"]};
        { 24, "s7256", "6048", "=q1=Shadow Protection Potion", "=ds=#sr# 135"};
        { 25, "s3173", "3385", "=q1=Lesser Mana Potion", "=ds="..AL["Trainer"]};
		{ 26, "s3174", "3386", "=q1=Potion of Curing", "=ds=#sr# 120"};
        { 27, "s3447", "929", "=q1=Healing Potion", "=ds="..AL["Trainer"]};
		{ 28, "s3172", "3384", "=q1=Minor Magic Resistance Potion", "=ds=#sr# 110"};
        { 29, "s7255", "6051", "=q1=Holy Protection Potion", "=ds=#sr# 100"};
    ...
    AtlasLoot_Data["AlchemyPotion3"] = {
        { 1, "s6617", "5631", "=q1=Rage Potion", "=ds=#sr# 60"};
		{ 2, "s2335", "2459", "=q1=Swiftness Potion", "=ds=#sr# 60"};
    ...
    AtlasLoot_Data["AlchemyTransmute1"] = {
        ...
        { 4, "s28585", "21886", "=q2=Transmute: Primal Earth to Life", "=ds=#sr# 375"};
		{ 5, "s28583", "22457", "=q2=Transmute: Primal Fire to Mana", "=ds=#sr# 375"};
		{ 6, "s28584", "22452", "=q2=Transmute: Primal Life to Earth", "=ds=#sr# 375"};
		{ 7, "s28582", "21884", "=q2=Transmute: Primal Mana to Fire", "=ds=#sr# 375"};
		{ 8, "s28580", "21885", "=q2=Transmute: Primal Shadow to Water", "=ds=#sr# 375"};
		{ 9, "s28581", "22456", "=q2=Transmute: Primal Water to Shadow", "=ds=#sr# 375"};
        ...
        { 14, "s11479", "3577", "=q2=Transmute: Iron to Gold", "=ds=#sr# 225"};
		{ 15, "s11480", "6037", "=q2=Transmute: Mithril to Truesilver", "=ds=#sr# 225"};
        { 16, "s17187", "12360", "=q2=Transmute: Arcanite Bar", "=ds=#sr# 275"};
		{ 17, "s17559", "7078", "=q2=Transmute: Air to Fire", "=ds=#sr# 275"};
		{ 18, "s17566", "12803", "=q2=Transmute: Earth to Life", "=ds=#sr# 275"};
		{ 19, "s17561", "7080", "=q2=Transmute: Earth to Water", "=ds=#sr# 275"};
		{ 20, "s17560", "7076", "=q2=Transmute: Fire to Earth", "=ds=#sr# 275"};
		{ 21, "s17565", "7076", "=q2=Transmute: Life to Earth", "=ds=#sr# 275"};
		{ 22, "s17563", "7080", "=q2=Transmute: Undeath to Water", "=ds=#sr# 275"};
		{ 23, "s17562", "7082", "=q2=Transmute: Water to Air", "=ds=#sr# 275"};
		{ 24, "s17564", "12808", "=q2=Transmute: Water to Undeath", "=ds=#sr# 275"};
    ...
    AtlasLoot_Data["AlchemyFlask1"] = {
		...
		{ 2, "s28590", "22861", "=q1=Flask of Blinding Light", "=ds=#sr# 375"};
		{ 3, "s28587", "22851", "=q1=Flask of Fortification", "=ds=#sr# 375"};
		{ 4, "s28588", "22853", "=q1=Flask of Mighty Restoration", "=ds=#sr# 375"};
		{ 5, "s28591", "22866", "=q1=Flask of Pure Death", "=ds=#sr# 375"};
		{ 6, "s28589", "22854", "=q1=Flask of Relentless Assault", "=ds=#sr# 375"};
    ...
    AtlasLoot_Data["AlchemyMisc1"] = {
        ...
        { 18, "s11468", "9197", "=q1=Elixir of Dream Vision", "=ds=#sr# 240"};
        ...
        { 21, "s11456", "9061", "=q1=Goblin Rocket Fuel", "=ds=#sr# 210"};
        { 22, "s11451", "8956", "=q1=Oil of Immolation", "=ds="..AL["Trainer"]};
        { 23, "s12609", "10592", "=q1=Catseye Elixir", "=ds="..AL["Trainer"]};
        { 24, "s3454", "3829", "=q1=Frost Oil", "=ds=#sr# 200"};
        { 25, "s11459", "9149", "=q1=Philosopher's Stone", "=ds=#sr# 200"};
        { 26, "s3453", "3828", "=q1=Elixir of Detect Lesser Invisibility", "=ds=#sr# 195"};
        { 27, "s3449", "3824", "=q1=Shadow Oil", "=ds=#sr# 165"};
