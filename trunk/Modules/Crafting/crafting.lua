...
---- Jewelcrafting
    ...
    AtlasLoot_Data["EngineeringAmmo1"] = {
        ...
        { 7, "s3947", "8069", "=q1=Crafted Solid Shot", "=ds=#sr# 125"};
        { 8, "s3930", "8068", "=q1=Crafted Heavy Shot", "=ds=#sr# 75"};
        { 9, "s3920", "8067", "=q1=Crafted Light Shot", "=ds=#sr# 1"};
    ...
    AtlasLoot_Data["EngineeringArmor1"] = {
		...
		{ 23, "s41321", "32495", "=q4=Powerheal 4000 Lens", "=ds=#sr# 350"};
		{ 24, "s41314", "32474", "=q4=Surestrike Goggles v2.0", "=ds=#sr# 350"};
		{ 25, "s41312", "32473", "=q4=Tankatronic Goggles", "=ds=#sr# 350"};
		{ 26, "s41318", "32479", "=q4=Wonderheal XT40 Shades", "=ds=#sr# 350"};
        { 27, "s22797", "18168", "=q4=Force Reactive Disk", "=ds=#sr# 300"};
        { 28, "s30325", "23763", "=q3=Hyper-Vision Goggles", "=ds=#sr# 360"};
        { 29, "s30556", "23824", "=q3=Rocket Boots Xtreme", "=ds=#sr# 355"};
		{ 30, "s46697", "35581", "=q3=Rocket Boots Xtreme Lite", "=ds=#sr# 355"};
    ...
    AtlasLoot_Data["EngineeringArmor2"] = {
		...
		{ 2, "s30570", "23825", "=q3=Nigh-Invulnerability Belt", "=ds=#sr# 350"};
		{ 3, "s30318", "23762", "=q3=Ultra-Spectropic Detection Goggles", "=ds=#sr# 350"};
        { 4, "s30316", "23758", "=q3=Cogspinner Goggles", "=ds=#sr# 340"};
        { 5, "s30569", "23835", "=q3=Gnomish Poultryizer", "=ds=#sr# 340"};
		{ 6, "s30317", "23761", "=q3=Power Amplification Goggles", "=ds=#sr# 340"};
        { 7, "s19830", "16022", "=q3=Arcanite Dragonling", "=ds=#sr# 300"};
        { 8, "s24356", "19999", "=q3=Bloodvine Goggles", "=ds=#sr# 300"};
		{ 9, "s24357", "19998", "=q3=Bloodvine Lens", "=ds=#sr# 300"};
        { 10, "s23082", "18639", "=q3=Ultra-Flash Shadow Reflector", "=ds=#sr# 300"};
        { 11, "s23081", "18638", "=q3=Hyper-Radiant Flame Reflector", "=ds=#sr# 290"};
        { 12, "s23077", "18634", "=q3=Gyrofreeze Ice Reflector", "=ds=#sr# 260"};
        { 13, "s12622", "10504", "=q3=Green Lens", "=ds=#sr# 245"};
        { 14, "s19825", "16008", "=q2=Master Engineer's Goggles", "=ds=#sr# 290"};
		{ 15, "s19819", "16009", "=q2=Voice Amplification Modulator", "=ds=#sr# 290"};
        { 16, "s23079", "18637", "=q2=Major Recombobulator", "=ds=#sr# 275"};
        { 17, "s19794", "15999", "=q2=Spellpower Goggles Xtreme Plus", "=ds=#sr# 270"};
        { 18, "s23486", "18984", "=q2=Dimensional Ripper - Everlook", "=ds=#sr# 260"};
		{ 19, "s23489", "18986", "=q2=Ultrasafe Transporter - Gadgetzan", "=ds=#sr# 260"};
        { 20, "s12624", "10576", "=q2=Mithril Mechanical Dragonling", "=ds=#sr# 250"};
        { 21, "s12758", "10588", "=q2=Goblin Rocket Helmet", "=ds=#sr# 245"};
        { 22, "s12907", "10726", "=q2=Gnomish Mind Control Cap", "=ds=#sr# 235"};
        { 23, "s12617", "10506", "=q2=Deepdive Helmet", "=ds=#sr# 230"};
		{ 24, "s12618", "10503", "=q2=Rose Colored Goggles", "=ds=#sr# 230"};
        { 25, "s12905", "10724", "=q2=Gnomish Rocket Boots", "=ds=#sr# 225"};
		{ 26, "s8895", "7189", "=q2=Goblin Rocket Boots", "=ds=#sr# 225"};
		{ 27, "s12616", "10518", "=q2=Parachute Cloak", "=ds=#sr# 225"};
		{ 28, "s12615", "10502", "=q2=Spellpower Goggles Xtreme", "=ds=#sr# 225"};
        { 29, "s12607", "10501", "=q2=Catseye Ultra Goggles", "=ds=#sr# 220"};
        { 30, "s12903", "10721", "=q2=Gnomish Harm Prevention Belt", "=ds=#sr# 215"};
    ...
    AtlasLoot_Data["EngineeringArmor3"] = {
        { 1, "s12897", "10545", "=q2=Gnomish Goggles", "=ds=#sr# 210"};
        { 2, "s12594", "10500", "=q2=Fire Goggles", "=ds=#sr# 205"};
		{ 3, "s12718", "10543", "=q2=Goblin Construction Helmet", "=ds=#sr# 205"};
		{ 4, "s12717", "10542", "=q2=Goblin Mining Helmet", "=ds=#sr# 205"};
        { 5, "s3966", "4393", "=q2=Craftsman's Monocle", "=ds=#sr# 185"};
        { 6, "s12587", "10499", "=q2=Bright-Eye Goggles", "=ds=#sr# 175"};
        { 7, "s3956", "4385", "=q2=Green Tinted Goggles", "=ds=#sr# 150"};
        { 8, "s3952", "4381", "=q2=Minor Recombobulator", "=ds=#sr# 140"};
        { 9, "s9269", "7506", "=q2=Gnomish Universal Remote", "=ds=#sr# 125"};
        { 10, "s3940", "4373", "=q2=Shadow Goggles", "=ds=#sr# 120"};
        { 11, "s3934", "4368", "=q2=Flying Tiger Goggles", "=ds=#sr# 100"};
        { 12, "s12759", "10645", "=q1=Gnomish Death Ray", "=ds=#sr# 240"};
		{ 13, "s12908", "10727", "=q1=Goblin Dragon Gun", "=ds=#sr# 240"};
        { 14, "s12906", "10725", "=q1=Gnomish Battle Chicken", "=ds=#sr# 230"};
        { 15, "s12755", "10587", "=q1=Goblin Bomb Dispenser", "=ds=#sr# 230"};
        { 16, "s12899", "10716", "=q1=Gnomish Shrink Ray", "=ds=#sr# 205"};
        { 17, "s3971", "4397", "=q1=Gnomish Cloaking Device", "=ds=#sr# 200"};
    ...
    AtlasLoot_Data["EngineeringExplosives1"] = {
        ...
        { 6, "s19831", "16040", "=q1=Arcane Bomb", "=ds=#sr# 300"};
        { 7, "s30310", "23736", "=q1=Fel Iron Bomb", "=ds=#sr# 300"};
        { 8, "s19799", "16005", "=q1=Dark Iron Bomb", "=ds=#sr# 285"};
        { 9, "s23080", "18594", "=q1=Powerful Seaforium Charge", "=ds=#sr# 275"};
        { 10, "s19790", "15993", "=q1=Thorium Grenade", "=ds=#sr# 260"};
        { 11, "s23070", "18641", "=q1=Dense Dynamite", "=ds=#sr# 250"};
        { 12, "s12619", "10562", "=q1=Hi-Explosive Bomb", "=ds=#sr# 235"};
		{ 13, "s12754", "10586", "=q1=The Big One", "=ds=#sr# 235"};
        { 14, "s12603", "10514", "=q1=Mithril Frag Bomb", "=ds=#sr# 215"};
        { 15, "s12716", "10577", "=q1=Goblin Mortar", "=ds=#sr# 205"};
        { 16, "s12760", "10646", "=q1=Goblin Sapper Charge", "=ds=#sr# 205"};
        { 17, "s13240", "10577", "=q1=The Mortar: Reloaded", "=ds=#sr# 205"};
        { 18, "s23069", "18588", "=q1=EZ-Thro Dynamite II", "=ds=#sr# 200"};
		{ 19, "s3972", "4398", "=q1=Large Seaforium Charge", "=ds=#sr# 200"};
        { 20, "s3968", "4395", "=q1=Goblin Land Mine", "=ds=#sr# 195"};
        { 21, "s3967", "4394", "=q1=Big Iron Bomb", "=ds=#sr# 190"};
        { 22, "s3962", "4390", "=q1=Iron Grenade", "=ds=#sr# 175"};
        { 23, "s12586", "10507", "=q1=Solid Dynamite", "=ds=#sr# 175"};
        { 24, "s3960", "4403", "=q1=Portable Bronze Mortar", "=ds=#sr# 165"};
        { 25, "s3950", "4380", "=q1=Big Bronze Bomb", "=ds=#sr# 140"};
        { 26, "s3946", "4378", "=q1=Heavy Dynamite", "=ds=#sr# 125"};
        { 27, "s3941", "4374", "=q1=Small Bronze Bomb", "=ds=#sr# 120"};
        { 28, "s3937", "4370", "=q1=Large Copper Bomb", "=ds=#sr# 105"};
        { 29, "s8339", "6714", "=q1=EZ-Thro Dynamite", "=ds=#sr# 100"};
        { 30, "s3933", "4367", "=q1=Small Seaforium Charge", "=ds=#sr# 100"};
        Next = "EngineeringExplosives2";
        Back = "ENGINEERINGMENU";
    };
    
    AtlasLoot_Data["EngineeringExplosives2"] = {
        { 1, "s3931", "4365", "=q1=Coarse Dynamite", "=ds=#sr# 75"};
        { 2, "s3923", "4360", "=q1=Rough Copper Bomb", "=ds=#sr# 30"};
    ...
    AtlasLoot_Data["EngineeringItemEnhancements1"] = {
        ...
        { 3, "s22793", "18283", "=q3=Biznicks 247x128 Accurascope", "=ds=#sr# 300"};
        { 4, "s30329", "23764", "=q2=Adamantite Scope", "=ds=#sr# 335"};
        { 5, "s3979", "4407", "=q2=Accurate Scope", "=ds=#sr# 180"};
        { 6, "s12620", "10548", "=q1=Sniper Scope", "=ds=#sr# 240"};
        { 7, "s12597", "10546", "=q1=Deadly Scope", "=ds=#sr# 210"};
        { 8, "s3978", "4406", "=q1=Standard Scope", "=ds=#sr# 110"};
        { 9, "s3977", "4405", "=q1=Crude Scope", "=ds=#sr# 60"};
        Back = "ENGINEERINGMENU";
    };
    ...
    AtlasLoot_Data["EngineeringMisc1"] = {
        ...
        { 3, "s36954", "30542", "=q2=Dimensional Ripper - Area 52", "=ds=#sr# 350"};
        { 4, "s36955", "30544", "=q2=Ultrasafe Transporter - Toshley's Station", "=ds=#sr# 350"};
        { 5, "s30348", "23774", "=q2=Fel Iron Toolbox", "=ds=#sr# 325"};
        { 6, "s30337", "23767", "=q2=Crashin' Thrashin' Robot", "=ds=#sr# 325"};
        { 7, "s44391", "34113", "=q1=Field Repair Bot 110G", "=ds=#sr# 360"};
        { 8, "s30552", "33093", "=q1=Mana Potion Injector", "=ds=#sr# 345"};
        { 9, "s30344", "23771", "=q1=Green Smoke Flare", "=ds=#sr# 335"};
		{ 10, "s32814", "25886", "=q1=Purple Smoke Flare", "=ds=#sr# 335"};
		{ 11, "s30341", "23768", "=q1=White Smoke Flare", "=ds=#sr# 335"};
        { 12, "s30551", "33092", "=q1=Healing Potion Injector", "=ds=#sr# 330"};
        { 13, "s30568", "23841", "=q1=Gnomish Flame Turret", "=ds=#sr# 325"};
        { 14, "s30548", "23821", "=q1=Zapthrottle Mote Extractor", "=ds=#sr# 305"};
        { 15, "s22704", "18232", "=q1=Field Repair Bot 74A", "=ds=#sr# 300"};
        { 16, "s30573", "23832", "=q1=Gnomish Tonk Controller", "=ds=#sr# 295"};
		{ 17, "s30561", "23831", "=q1=Goblin Tonk Controller", "=ds=#sr# 295"};
        { 18, "s26443", "21570", "=q1=Firework Cluster Launcher", "=ds=#sr# 275"};
		{ 19, "s19814", "16023", "=q1=Masterwork Target Dummy", "=ds=#sr# 275"};
        { 20, "s26426", "21714", "=q1=Large Blue Rocket Cluster", "=ds=#sr# 275"};
		{ 21, "s26427", "21716", "=q1=Large Green Rocket Cluster", "=ds=#sr# 275"};
		{ 22, "s26428", "21718", "=q1=Large Red Rocket Cluster", "=ds=#sr# 275"};
        { 23, "s23096", "18645", "=q1=Alarm-O-Bot", "=ds=#sr# 265"};
		{ 24, "s23078", "18587", "=q1=Goblin Jumper Cables XL", "=ds=#sr# 265"};
		{ 25, "s19793", "15996", "=q1=Lifelike Mechanical Toad", "=ds=#sr# 265"};
        { 26, "s23129", "18660", "=q2=World Enlarger", "=ds=#sr# 260"};
        { 27, "s19567", "15846", "=q1=Salt Shaker", "=ds=#sr# 250"};
		{ 28, "s26011", "21277", "=q1=Tranquil Mechanical Yeti", "=ds=#sr# 250"};
        { 29, "s23507", "19026", "=q1=Snake Burst Firework", "=ds=#sr# 250"};
        { 30, "s26442", "21569", "=q1=Firework Launcher", "=ds=#sr# 225"};
        Next = "EngineeringMisc2";
        Back = "ENGINEERINGMENU";
    };
    
    AtlasLoot_Data["EngineeringMisc2"] = {
        { 1, "s26423", "21571", "=q1=Blue Rocket Cluster", "=ds=#sr# 225"};
		{ 2, "s26424", "21574", "=q1=Green Rocket Cluster", "=ds=#sr# 225"};
		{ 3, "s26425", "21576", "=q1=Red Rocket Cluster", "=ds=#sr# 225"};
        { 4, "s12902", "10720", "=q1=Gnomish Net-o-Matic Projector", "=ds=#sr# 210"};
        { 5, "s12715", "10644", "=q1=Goblin Rocket Fuel Recipe", "=ds=#sr# 205"};
		{ 6, "s12895", "10713", "=q1=Inlaid Mithril Cylinder Plans", "=ds=#sr# 205"};
		{ 7, "s15633", "11826", "=q1=Lil' Smoky", "=ds=#sr# 205"};
		{ 8, "s15628", "11825", "=q1=Pet Bombling", "=ds=#sr# 205"};
		...
		{ 12, "s8243", "4852", "=q1=Flash Bomb", "=ds=#sr# 185"};
        { 13, "s26420", "21589", "=q1=Large Blue Rocket", "=ds=#sr# 175"};
		{ 14, "s26421", "21590", "=q1=Large Green Rocket", "=ds=#sr# 175"};
		{ 15, "s26422", "21592", "=q1=Large Red Rocket", "=ds=#sr# 175"};
		{ 16, "s3963", "4391", "=q1=Compact Harvest Reaper Kit", "=ds=#sr# 175"};
        { 17, "s9273", "7148", "=q1=Goblin Jumper Cables", "=ds=#sr# 165"};
        { 18, "s3959", "4388", "=q1=Discombobulator Ray", "=ds=#sr# 160"};
        { 19, "s3957", "4386", "=q1=Ice Deflector", "=ds=#sr# 155"};
        { 20, "s3955", "4384", "=q1=Explosive Sheep", "=ds=#sr# 150"};
        { 21, "s9271", "6533", "=q1=Aquadynamic Fish Attractor", "=ds=#sr# 150"};
		{ 22, "s23067", "9312", "=q1=Blue Firework", "=ds=#sr# 150"};
		{ 23, "s23068", "9313", "=q1=Green Firework", "=ds=#sr# 150"};
		{ 24, "s23066", "9318", "=q1=Red Firework", "=ds=#sr# 150"};
        { 25, "s6458", "5507", "=q1=Ornate Spyglass", "=ds=#sr# 135"};
        { 26, "s26416", "21558", "=q1=Small Blue Rocket", "=ds=#sr# 125"};
		{ 27, "s26417", "21559", "=q1=Small Green Rocket", "=ds=#sr# 125"};
		{ 28, "s26418", "21557", "=q1=Small Red Rocket", "=ds=#sr# 125"};
    ...
    AtlasLoot_Data["EngineeringMisc3"] = {
        { 1, "s3932", "4366", "=q1=Target Dummy", "=ds=#sr# 85"};
        { 2, "s3928", "4401", "=q1=Mechanical Squirrel", "=ds=#sr# 75"};
    ...
    AtlasLoot_Data["EngineeringReagents1"] = {
        ...
        { 9, "s19815", "16006", "=q1=Delicate Arcanite Converter", "=ds=#sr# 285"};
        { 10, "s19795", "16000", "=q1=Thorium Tube", "=ds=#sr# 275"};
        { 11, "s39895", "7191", "=q1=Fused Wiring", "=ds=#sr# 275"};
        { 12, "s19791", "15994", "=q1=Thorium Widget", "=ds=#sr# 260"};
        { 13, "s23071", "18631", "=q1=Truesilver Transformer", "=ds=#sr# 260"};
        { 14, "s19788", "15992", "=q1=Dense Blasting Powder", "=ds=#sr# 250"};
        { 15, "s12599", "10561", "=q1=Mithril Casing", "=ds=#sr# 215"};
        { 16, "s12591", "10560", "=q1=Unstable Trigger", "=ds=#sr# 200"};
        { 17, "s12589", "10559", "=q1=Mithril Tube", "=ds=#sr# 195"};
        { 18, "s12590", "10498", "=q1=Gyromatic Micro-Adjustor", "=ds=#sr# 175"};
        { 19, "s12585", "10505", "=q1=Solid Blasting Powder", "=ds=#sr# 175"};
        { 20, "s3961", "4389", "=q1=Gyrochronatom", "=ds=#sr# 170"};
        { 21, "s3958", "4387", "=q1=Iron Strut", "=ds=#sr# 160"};
        { 22, "s12584", "10558", "=q1=Gold Power Core", "=ds=#sr# 150"};
        { 23, "s3953", "4382", "=q1=Bronze Framework", "=ds=#sr# 145"};
        { 24, "s3942", "4375", "=q1=Whirring Bronze Gizmo", "=ds=#sr# 125"};
        { 25, "s3945", "4377", "=q1=Heavy Blasting Powder", "=ds=#sr# 125"};
        { 26, "s3938", "4371", "=q1=Bronze Tube", "=ds=#sr# 105"};
        { 27, "s3973", "4404", "=q1=Silver Contact", "=ds=#sr# 90"};
        { 28, "s3929", "4364", "=q1=Coarse Blasting Powder", "=ds=#sr# 75"};
        { 29, "s3926", "4363", "=q1=Copper Modulator", "=ds=#sr# 65"};
        { 30, "s3924", "4361", "=q1=Copper Tube", "=ds=#sr# 50"};
        Next = "EngineeringReagents2";
        Back = "ENGINEERINGMENU";
    };
    
    AtlasLoot_Data["EngineeringReagents2"] = {
        { 1, "s3922", "4359", "=q1=Handful of Copper Bolts", "=ds=#sr# 30"};
        { 2, "s3918", "4357", "=q1=Rough Blasting Powder", "=ds=#sr# 1"};
    ...
    AtlasLoot_Data["EngineeringWeapon1"] = {
        ...
        { 2, "s22795", "18282", "=q4=Core Marksman Rifle", "=ds=#sr# 300"};
        { 3, "s30315", "23748", "=q3=Ornate Khorium Rifle", "=ds=#sr# 375"};
        { 4, "s30314", "23747", "=q3=Felsteel Boomstick", "=ds=#sr# 360"};
        { 5, "s19833", "16007", "=q3=Flawless Arcanite Rifle", "=ds=#sr# 300"};
        { 6, "s19796", "16004", "=q3=Dark Iron Rifle", "=ds=#sr# 275"};
        { 7, "s30313", "23746", "=q2=Adamantite Rifle", "=ds=#sr# 350"};
        { 8, "s30312", "23742", "=q2=Fel Iron Musket", "=ds=#sr# 320"};
        { 9, "s19792", "15995", "=q2=Thorium Rifle", "=ds=#sr# 260"};
        { 10, "s12614", "10510", "=q2=Mithril Heavy-bore Rifle", "=ds=#sr# 220"};
        { 11, "s12595", "10508", "=q2=Mithril Blunderbuss", "=ds=#sr# 205"};
        { 12, "s3954", "4383", "=q2=Moonsight Rifle", "=ds=#sr# 145"};
        { 13, "s3949", "4379", "=q2=Silver-plated Shotgun", "=ds=#sr# 130"};
        { 14, "s3939", "4372", "=q2=Lovingly Crafted Boomstick", "=ds=#sr# 120"};
        { 15, "s3936", "4369", "=q2=Deadly Blunderbuss", "=ds=#sr# 105"};
        { 16, "s3925", "4362", "=q2=Rough Boomstick", "=ds=#sr# 50"};
        { 17, "s7430", "6219", "=q1=Arclight Spanner", "=ds=#sr# 50"};
        Back = "ENGINEERINGMENU";
    };
	...
	AtlasLoot_Data["Gnomish1"] = {
        ...
        { 4, "s30569", "23835", "=q3=Gnomish Poultryizer", "=ds=#sr# 340"};
        { 5, "s36955", "30544", "=q2=Ultrasafe Transporter - Toshley's Station", "=ds=#sr# 350"};
        { 6, "s23489", "18986", "=q2=Ultrasafe Transporter - Gadgetzan", "=ds=#sr# 260"};
        { 7, "s23129", "18660", "=q2=World Enlarger", "=ds=#sr# 260"};
        { 8, "s12907", "10726", "=q2=Gnomish Mind Control Cap", "=ds=#sr# 235"};
        { 9, "s12905", "10724", "=q2=Gnomish Rocket Boots", "=ds=#sr# 225"};
        { 10, "s12903", "10721", "=q2=Gnomish Harm Prevention Belt", "=ds=#sr# 215"};
        { 11, "s12897", "10545", "=q2=Gnomish Goggles", "=ds=#sr# 210"};
        ...
        { 15, "s12906", "10725", "=q1=Gnomish Battle Chicken", "=ds=#sr# 230"};
        { 16, "s12902", "10720", "=q1=Gnomish Net-o-Matic Projector", "=ds=#sr# 210"};
        { 17, "s12899", "10716", "=q1=Gnomish Shrink Ray", "=ds=#sr# 205"};
		{ 18, "s12895", "10713", "=q1=Inlaid Mithril Cylinder Plans", "=ds=#sr# 205"};
		{ 19, "s15633", "11826", "=q1=Lil' Smoky", "=ds=#sr# 205"};
		Back = "ENGINEERINGMENU";
	};
	...
	AtlasLoot_Data["Goblin1"] = {
        ...
        { 10, "s30560", "23827", "=q1=Super Sapper Charge", "=ds=#sr# 340"};
        { 11, "s30558", "23826", "=q1=The Bigger One", "=ds=#sr# 325"};
        { 12, "s23078", "18587", "=q1=Goblin Jumper Cables XL", "=ds=#sr# 265"};
        { 13, "s12908", "10727", "=q1=Goblin Dragon Gun", "=ds=#sr# 240"};
        { 14, "s12754", "10586", "=q1=The Big One", "=ds=#sr# 235"};
        { 15, "s12755", "10587", "=q1=Goblin Bomb Dispenser", "=ds=#sr# 230"};
        { 16, "s12716", "10577", "=q1=Goblin Mortar", "=ds=#sr# 205"};
		{ 17, "s12715", "10644", "=q1=Goblin Rocket Fuel Recipe", "=ds=#sr# 205"};
		{ 18, "s12760", "10646", "=q1=Goblin Sapper Charge", "=ds=#sr# 205"};
