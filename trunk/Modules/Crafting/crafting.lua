...
---- Jewelcrafting
    ...
    AtlasLoot_Data["LeatherItemEnhancement1"] = {
        ...
        { 6, "s44770", "34207", "=q2=Glove Reinforcements", "=ds=#sr# 350"};
        { 7, "s35524", "29488", "=q2=Arcane Armor Kit", "=ds=#sr# 340"};
		{ 8, "s35521", "29485", "=q2=Flame Armor Kit", "=ds=#sr# 340"};
		{ 9, "s35522", "29486", "=q2=Frost Armor Kit", "=ds=#sr# 340"};
        { 10, "s35523", "29487", "=q2=Nature Armor Kit", "=ds=#sr# 340"};
		{ 11, "s35520", "29483", "=q2=Shadow Armor Kit", "=ds=#sr# 340"};
		{ 12, "s44970", "34330", "=q1=Heavy Knothide Armor Kit", "=ds=#sr# 350"};
        { 13, "s32458", "25652", "=q1=Magister's Armor Kit", "=ds=#sr# 325"};
		{ 14, "s32457", "25651", "=q1=Vindicator's Armor Kit", "=ds=#sr# 325"};
        { 15, "s32456", "25650", "=q1=Knothide Armor Kit", "=ds=#sr# 300"};
        { 16, "s32482", "25679", "=q1=Comfortable Insoles", "=ds=#sr# 300"};
        { 17, "s19058", "15564", "=q1=Rugged Armor Kit", "=ds=#sr# 250"};
        { 18, "s10487", "8173", "=q1=Thick Armor Kit", "=ds=#sr# 200"};
        { 19, "s3780", "4265", "=q1=Heavy Armor Kit", "=ds=#sr# 150"};
        { 20, "s2165", "2313", "=q1=Medium Armor Kit", "=ds=#sr# 100"};
        { 21, "s2152", "2304", "=q1=Light Armor Kit", "=ds=#sr# 1"};
        Back = "LEATHERWORKINGMENU";
        };
    ...
    AtlasLoot_Data["LeatherQuiversPouches1"] = {
        ...
        { 5, "s14930", "8217", "=q2=Quickdraw Quiver", "=ds=#sr# 225"};
		{ 6, "s14932", "8218", "=q2=Thick Leather Ammo Pouch", "=ds=#sr# 225"};
        { 7, "s9194", "7372", "=q2=Heavy Leather Ammo Pouch", "=ds=#sr# 150"};
		{ 8, "s9193", "7371", "=q2=Heavy Quiver", "=ds=#sr# 150"};
    ...
    AtlasLoot_Data["LeatherDrumsBagsMisc1"] = {
        ...
        { 10, "s22815", "18258", "=q2=Gordok Ogre Suit", "=ds=#sr# 275"};
        { 11, "s23190", "18662", "=q1=Heavy Leather Ball", "=ds=#sr# 150"};
        { 12, "s5244", "5081", "=q1=Kodo Hide Bag", "=ds=#sr# 40"};
        Back = "LEATHERWORKINGMENU";
        };
    ...
    AtlasLoot_Data["LeatherLeather1"] = {
        ...
        { 3, "s22331", "8170", "=q1=Rugged Leather", "=ds=#sr# 250"};
		{ 4, "s19047", "15407", "=q1=Cured Rugged Hide", "=ds=#sr# 250"};
        { 5, "s20650", "4304", "=q1=Thick Leather", "=ds=#sr# 200"};
        { 6, "s10482", "8172", "=q1=Cured Thick Hide", "=ds=#sr# 200"};
        { 7, "s20649", "4234", "=q1=Heavy Leather", "=ds=#sr# 150"};
        { 8, "s3818", "4236", "=q1=Cured Heavy Hide", "=ds=#sr# 150"};
        { 9, "s20648", "2319", "=q1=Medium Leather", "=ds=#sr# 100"};
		{ 10, "s3817", "4233", "=q1=Cured Medium Hide", "=ds=#sr# 100"};
        { 11, "s3816", "4231", "=q1=Cured Light Hide", "=ds=#sr# 35"};
        { 12, "s2881", "2318", "=q1=Light Leather", "=ds=#sr# 1"};
        Back = "LEATHERWORKINGMENU";
        };
