...
---- Jewelcrafting
    ...
    AtlasLoot_Data["SmithingEnhancement1"] = {
        ...
        { 15, "s16641", "12404", "=q1=Dense Sharpening Stone", "=ds=#sr# 250"};
		{ 16, "s16640", "12643", "=q1=Dense Weightstone", "=ds=#sr# 250"};
        { 17, "s9918", "7964", "=q1=Solid Sharpening Stone", "=ds=#sr# 200"};
		{ 18, "s9921", "7965", "=q1=Solid Weightstone", "=ds=#sr# 200"};
        { 19, "s7224", "6041", "=q1=Steel Weapon Chain", "=ds=#sr# 190"};
        { 20, "s7222", "6043", "=q1=Iron Counterweight", "=ds=#sr# 165"};
        { 21, "s7221", "6042", "=q1=Iron Shield Spike", "=ds=#sr# 150"};
        { 22, "s2674", "2871", "=q1=Heavy Sharpening Stone", "=ds=#sr# 125"};
		{ 23, "s3117", "3241", "=q1=Heavy Weightstone", "=ds=#sr# 125"};
        { 24, "s2665", "2863", "=q1=Coarse Sharpening Stone", "=ds=#sr# 65"};
		{ 25, "s3116", "3240", "=q1=Coarse Weightstone", "=ds=#sr# 65"};
        { 26, "s2660", "2862", "=q1=Rough Sharpening Stone", "=ds=#sr# 1"};
		{ 27, "s3115", "3239", "=q1=Rough Weightstone", "=ds=#sr# 1"};
        Back = "SMITHINGMENU";
    };
    ...
    AtlasLoot_Data["SmithingMisc1"] = {
        ...
        { 5, "s32657", "25845", "=q1=Eternium Rod", "=ds=#sr# 375"};
        { 6, "s32656", "25844", "=q1=Adamantite Rod", "=ds=#sr# 350"};
        { 7, "s32655", "25843", "=q1=Fel Iron Rod", "=ds=#sr# 300"};
        { 8, "s20201", "16206", "=q1=Arcanite Rod", "=ds=#sr# 275"};
        { 9, "s16639", "12644", "=q1=Dense Grinding Stone", "=ds=#sr# 250"};
        { 10, "s11454", "9060", "=q1=Inlaid Mithril Cylinder", "=ds=#sr# 200"};
        { 11, "s14380", "11144", "=q1=Truesilver Rod", "=ds=#sr# 200"};
        { 12, "s9920", "7966", "=q1=Solid Grinding Stone", "=ds=#sr# 200"};
        { 13, "s14379", "11128", "=q1=Golden Rod", "=ds=#sr# 150"};
        { 14, "s8768", "7071", "=q1=Iron Buckle", "=ds=#sr# 150"};
        { 15, "s3337", "3486", "=q1=Heavy Grinding Stone", "=ds=#sr# 125"};
		{ 16, "s7818", "6338", "=q1=Silver Rod", "=ds=#sr# 100"};
        { 17, "s3326", "3478", "=q1=Coarse Grinding Stone", "=ds=#sr# 75"};
        { 18, "s3320", "3470", "=q1=Rough Grinding Stone", "=ds=#sr# 25"};
        Back = "SMITHINGMENU";
    };
