...
---- Jewelcrafting
	...
	AtlasLoot_Data["Armorsmith1"] = {
        ...
        { 5, "s55186", "41189", "=q3=Chestplate of Conquest", "=ds=#sr# 415" };
        { 6, "s55187", "41190", "=q3=Legplates of Conquest", "=ds=#sr# 415" };
		Next = "Weaponsmith1";
	...
	AtlasLoot_Data["Weaponsmith1"] = {
        ...
        { 5, "s55183", "41186", "=q3=Corroded Saronite Edge", "=ds=#sr# 415" };
        { 6, "s55184", "41187", "=q3=Corroded Saronite Woundbringer", "=ds=#sr# 415" };
        { 7, "s55185", "41188", "=q3=Saronite Mindcrusher", "=ds=#sr# 415" };
		Next = "Axesmith1";
		Prev = "Armorsmith1";
		Back = "SMITHINGMENU";
	};
