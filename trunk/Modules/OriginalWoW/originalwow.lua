...
---- Azuregos
	...
	AtlasLoot_Data["UldBaelog"] = {
		...
		{ 5, 0, "INV_Box_01", "=q6=#n46#", ""};
		{ 6, 9394, "", "=q3=Horned Viking Helmet", "=ds=#s1#, #a4#", "", "4.05%"};
		{ 7, 9398, "", "=q3=Worn Running Boots", "=ds=#s12#, #a2#", "", "45.09%"};
		{ 8, 2459, "", "=q1=Swiftness Potion", "=ds=#e2#"};
		{ 10, 0, "INV_Box_01", "=q6=#n47#", ""};
		{ 11, 9404, "", "=q3=Olaf's All Purpose Shield", "=ds=#w8#", "", "11.33%"};
		{ 12, 9403, "", "=q3=Battered Viking Shield", "=ds=#w8#", "", "69.85%"};
		{ 13, 1177, "", "=q1=Oil of Olaf", "=ds=#e2#", "", "76.54%"};
	...
	AtlasLoot_Data["AVMisc"] = {
		...
		{ 6, 17348, "", "=q1=Major Healing Draught", "=ds=#e2#", "10 #silver# 8 #faction#"};
		{ 7, 17349, "", "=q1=Superior Healing Draught", "=ds=#e2#", "5 #silver# 1 #faction#"};
		{ 8, 19301, "", "=q1=Alterac Manna Biscuit", "=ds=#e3#", "70 #silver#"};
		{ 9, 19307, "", "=q1=Alterac Heavy Runecloth Bandage", "=ds=#e5#", "80 #silver#"};
