...
---- Azuregos
	...
	AtlasLoot_Data["AVBlue"] = {
		{ 1, 0, "INV_BannerPVP_02", "=q6=#m7#", "=q5=#b1#"};
		{ 2, 19086, "", "=q3=Stormpike Sage's Cloak", "=ds=#s4#", "1530 #alliance# 10 #av#"};
		{ 3, 19084, "", "=q3=Stormpike Soldier's Cloak", "=ds=#s4#", "1530 #alliance# 10 #av#"};
		...
		{ 8, 19098, "", "=q3=Stormpike Sage's Pendant", "=ds=#s2#", "1530 #alliance# 20 #av#"};
		{ 9, 19097, "", "=q3=Stormpike Soldier's Pendant", "=ds=#s2#", "1530 #alliance# 20 #av#"};
		{ 10, 19100, "", "=q3=Electrified Dagger", "=ds=#h1#, #w4#", "2380 #alliance# 10 #av#"};
		{ 11, 19104, "", "=q3=Stormstrike Hammer", "=ds=#h1#, #w6#", "2380 #alliance# 10 #av#"};
		{ 12, 19102, "", "=q3=Crackling Staff", "=ds=#w9#", "2720 #alliance# 15 #av#"};
		{ 13, 19320, "", "=q3=Gnoll Skin Bandolier", "=ds=#w20#", "1530 #alliance# 10 #av#"};
		{ 14, 19319, "", "=q3=Harpy Hide Quiver", "=ds=#w19#", "1530 #alliance# 10 #av#"};
		{ 16, 0, "INV_BannerPVP_01", "=q6=#m6#", "=q5=#b2#"};
		{ 17, 19085, "", "=q3=Frostwolf Advisor's Cloak", "=ds=#s4#", "1530 #horde# 10 #av#"};
		{ 18, 19083, "", "=q3=Frostwolf Legionnaire's Cloak", "=ds=#s4#", "1530 #horde# 10 #av#"};
		...
		{ 23, 19096, "", "=q3=Frostwolf Advisor's Pendant", "=ds=#s2#", "1530 #horde# 20 #av#"};
		{ 24, 19095, "", "=q3=Frostwolf Legionnaire's Pendant", "=ds=#s2#", "1530 #horde# 20 #av#"};
		{ 25, 19099, "", "=q3=Glacial Blade", "=ds=#h1#, #w4#", "2380 #horde# 10 #av#"};
		{ 26, 19103, "", "=q3=Frostbite", "=ds=#h1#, #w6#", "2380 #horde# 10 #av#"};
		{ 27, 19101, "", "=q3=Whiteout Staff", "=ds=#w9#", "2720 #horde# 15 #av#"};
		{ 28, 19320, "", "=q3=Gnoll Skin Bandolier", "=ds=#w20#", "1530 #horde# 10 #av#"};
		{ 29, 19319, "", "=q3=Harpy Hide Quiver", "=ds=#w19#", "1530 #horde# 10 #av#"};
		Next = "AVPurple";
		Prev = "AVMisc";
		Back = "PVPMENU";
	};
	...
	AtlasLoot_Data["AVPurple"] = {
		{ 1, 19325, "", "=q4=Don Julio's Band", "=ds=#s13#", "4590 #faction# 25 #av#"};
		{ 2, 19312, "", "=q4=Lei of the Lifegiver", "=ds=#s15#", "4760 #faction# 25 #av#"};
		{ 3, 19308, "", "=q4=Tome of Arcane Domination", "=ds=#s15#", "4760 #faction# 25 #av#"};
		{ 4, 19309, "", "=q4=Tome of Shadow Force", "=ds=#s15#", "4760 #faction# 25 #av#"};
		{ 5, 19324, "", "=q4=The Lobotomizer", "=ds=#h1#, #w4#", "4760 #faction# 25 #av#"};
		{ 6, 19321, "", "=q4=The Immovable Object", "=ds=#w8#", "4760 #faction# 25 #av#"};
		{ 8, 0, "INV_BannerPVP_02", "=q6=#m7#", "=q5=#b1#"};
		{ 9, 19030, "", "=q4=Stormpike Battle Charger", "=ds=#e12#", "50 #av#"};
		{ 16, 21563, "", "=q4=Don Rodrigo's Band", "=ds=#s13#", "4590 #faction# 25 #av#"};
		{ 17, 19315, "", "=q4=Therazane's Touch", "=ds=#s15#", "4760 #faction# 25 #av#"};
		{ 18, 19311, "", "=q4=Tome of Fiery Arcana", "=ds=#s15#", "4760 #faction# 25 #av#"};
		{ 19, 19310, "", "=q4=Tome of the Ice Lord", "=ds=#s15#", "4760 #faction# 25 #av#"};
		{ 20, 19323, "", "=q4=The Unstoppable Force", "=ds=#h2#, #w6#", "4760 #faction# 25 #av#"};
		{ 23, 0, "INV_BannerPVP_01", "=q6=#m6#", "=q5=#b2#"};
		{ 24, 19029, "", "=q4=Horn of the Frostwolf Howler", "=ds=#e12#", "50 #av#"};
		Prev = "AVBlue";
		Back = "PVPMENU";
	};
