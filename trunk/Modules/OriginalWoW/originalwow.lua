...
---- Azuregos/Highlord Kruul
	...
	AtlasLoot_Data["OldKeys"] = {
		...
		{ 17, 9240, "", "=q2=Mallet of Zul'Farrak", "=ds=#m27#"};
		{ 18, 17333, "", "=q1=Aqual Quintessence", "=ds=#m3#"};
		{ 19, 22754, "", "=q1=Eternal Quintessence", "=ds=#m3#"};
		{ 20, 13523, "", "=q1=Blood of Innocents", "=ds=#m27#"};
		{ 21, 18746, "", "=q1=Divination Scryer", "=ds=#m27#"};
		{ 22, 18663, "", "=q1=J'eevee's Jar", "=ds=#m27#"};
		{ 23, 19974, "", "=q1=Mudskunk Lure", "=ds=#m27#"};
		{ 24, 7733, "", "=q1=Staff of Prehistoria", "=ds=#m27#"};
		{ 25, 10818, "", "=q1=Yeh'kinya's Scroll", "=ds=#m27#"};
	};
	...
	AtlasLoot_Data["RazorfenKraul1"] = {
		...
		{ 20, 0, "INV_Box_01", "=q6="..BabbleBoss["Overlord Ramtusk"], ""};
	...
	AtlasLoot_Data["ShadowfangKeep2"] = {
		...
		{ 2, 5943, "", "=q2=Rift Bracers", "=ds=#s8#, #a3#", "", "3%"};
	...
	AtlasLoot_Data["STRATBaronRivendare"] = {
		{ 1, 13505, "", "=q4=Runeblade of Baron Rivendare", "=ds=#h2#, #w10#", "", "0.27%"};
	...
	AtlasLoot_Data["T0Druid"] = {
		...
		{ 2, 16720, "", "=q3=Wildheart Cowl", "=ds=Darkmaster Gandling (Scholo)", "", "7.09%"};
		{ 3, 16718, "", "=q3=Wildheart Spaulders", "=ds=Gizrul the Slavener (LBRS)", "", "11.04%"};
		{ 4, 16706, "", "=q3=Wildheart Vest", "=ds=General Drakkisath (UBRS)", "", "7.36%"};
		{ 5, 16714, "", "=q3=Wildheart Bracers", "=ds=Trash Mobs (Strat)", "", "1.85%"};
		{ 6, 16717, "", "=q3=Wildheart Gloves", "=ds=The Unforgiven (Strat)", "", "12.61%"};
		{ 7, 16716, "", "=q3=Wildheart Belt", "=ds=Trash Mobs (Scholo)", "", "2.60%"};
		{ 8, 16719, "", "=q3=Wildheart Kilt", "=ds=Baron Rivendare (Strat)", "", "6.58%"};
		{ 9, 16715, "", "=q3=Wildheart Boots", "=ds=Mor Grayhoof (LBRS)", "", "13.03%"};
	...
	AtlasLoot_Data["T0Hunter"] = {
		...
		{ 2, 16677, "", "=q3=Beaststalker's Cap", "=ds=Darkmaster Gandling (Scholo)", "", "7.00%"};
		{ 3, 16679, "", "=q3=Beaststalker's Mantle", "=ds=Overlord Wyrmthalak (LBRS)", "", "9.89%"};
		{ 4, 16674, "", "=q3=Beaststalker's Tunic", "=ds=General Drakkisath (UBRS)", "", "6.81%"};
		{ 5, 16681, "", "=q3=Beaststalker's Bindings", "=ds=Trash Mobs (Strat)", "", "1.64%"};
		{ 6, 16676, "", "=q3=Beaststalker's Gloves", "=ds=War Master Voone (LBRS)", "", "9.15%"};
		{ 7, 16680, "", "=q3=Beaststalker's Belt", "=ds=Trash Mobs (LBRS)", "", "1.36%"};
		{ 8, 16678, "", "=q3=Beaststalker's Pants", "=ds=Baron Rivendare (Strat)", "", "6.16%"};
	...
	AtlasLoot_Data["T0Mage"] = {
		...
		{ 2, 16686, "", "=q3=Magister's Crown", "=ds=Darkmaster Gandling (Scholo)", "", "8.60%"};
		{ 3, 16689, "", "=q3=Magister's Mantle", "=ds=Ras Frostwhisper (Scholo)", "", "11.93%"};
		{ 4, 16688, "", "=q3=Magister's Robes", "=ds=General Drakkisath (UBRS)", "", "7.24%"};
		{ 5, 16683, "", "=q3=Magister's Bindings", "=ds=Trash Mobs (LBRS)", "", "1.19%"};
		{ 6, 16684, "", "=q3=Magister's Gloves", "=ds=Doctor Theolen Krastinov (Scholo)", "", "9.75%"};
		{ 7, 16685, "", "=q3=Magister's Belt", "=ds=Trash Mobs (Strat)", "", "1.32%"};
		{ 8, 16687, "", "=q3=Magister's Leggings", "=ds=Baron Rivendare (Strat)", "", "6.79%"};
	...
	AtlasLoot_Data["T0Paladin"] = {
		...
		{ 2, 16727, "", "=q3=Lightforge Helm", "=ds=Darkmaster Gandling (Scholo)", "", "5.32%"};
		{ 3, 16729, "", "=q3=Lightforge Spaulders", "=ds=The Beast (UBRS)", "", "13.62%"};
		{ 4, 16726, "", "=q3=Lightforge Breastplate", "=ds=General Drakkisath (UBRS)", "", "3.76%"};
		{ 5, 16722, "", "=q3=Lightforge Bracers", "=ds=Trash Mobs (Scholo)", "", "3.37%"};
		{ 6, 16724, "", "=q3=Lightforge Gauntlets", "=ds=Timmy the Cruel (Strat)", "", "10.42%"};
		{ 7, 16723, "", "=q3=Lightforge Belt", "=ds=Trash Mobs (Strat)", "", "1.93%"};
		{ 8, 16728, "", "=q3=Lightforge Legplates", "=ds=Baron Rivendare (Strat)", "", "4.20%"};
	...
	AtlasLoot_Data["T0Priest"] = {
		...
		{ 2, 16693, "", "=q3=Devout Crown", "=ds=Darkmaster Gandling (Scholo)", "", "7.89%"};
		{ 3, 16695, "", "=q3=Devout Mantle", "=ds=Solakar Flamewreath (UBRS)", "", "12.84%"};
		{ 4, 16690, "", "=q3=Devout Robe", "=ds=General Drakkisath (UBRS)", "", "6.20%"};
		{ 5, 16697, "", "=q3=Devout Bracers", "=ds=Trash Mobs (Strat)", "", "1.13%"};
		{ 6, 16692, "", "=q3=Devout Gloves", "=ds=Archivist Galford (Strat)", "", "12.46%"};
		{ 7, 16696, "", "=q3=Devout Belt", "=ds=Trash Mobs (LBRS)", "", "2.07%"};
		{ 8, 16694, "", "=q3=Devout Skirt", "=ds=Baron Rivendare (Strat)", "", "7.42%"};
	...
	AtlasLoot_Data["T0Rogue"] = {
		...
		{ 2, 16707, "", "=q3=Shadowcraft Cap", "=ds=Darkmaster Gandling (Scholo)", "", "6.65%"};
		{ 3, 16708, "", "=q3=Shadowcraft Spaulders", "=ds=Cannon Master Willey (Strat)", "", "10.68%"};
		{ 4, 16721, "", "=q3=Shadowcraft Tunic", "=ds=General Drakkisath (UBRS)", "", "6.09%"};
		{ 5, 16710, "", "=q3=Shadowcraft Bracers", "=ds=Trash Mobs (Scholo)", "", "3.51%"};
		{ 6, 16712, "", "=q3=Shadowcraft Gloves", "=ds=Shadow Hunter Vosh'gajin (LBRS)", "", "11.89%"};
		{ 7, 16713, "", "=q3=Shadowcraft Belt", "=ds=Trash Mobs (LBRS)", "", "1.05%"};
		{ 8, 16709, "", "=q3=Shadowcraft Pants", "=ds=Baron Rivendare (Strat)", "", "7.76%"};
	...
	AtlasLoot_Data["T0Shaman"] = {
		...
		{ 2, 16667, "", "=q3=Coif of Elements", "=ds=Darkmaster Gandling (Scholo)", "", "2.86%"};
		{ 3, 16669, "", "=q3=Pauldrons of Elements", "=ds=Gyth (UBRS)", "", "14.77%"};
		{ 4, 16666, "", "=q3=Vest of Elements", "=ds=General Drakkisath (UBRS)", "", "3.03%"};
		{ 5, 16671, "", "=q3=Bindings of Elements", "=ds=Trash Mobs (Strat)", "", "1.59%"};
		{ 6, 16672, "", "=q3=Gauntlets of Elements", "=ds=Pyroguard Emberseer (UBRS)", "", "14.23%"};
		{ 7, 16673, "", "=q3=Cord of Elements", "=ds=Trash Mobs (LBRS)", "", "1.06%"};
		{ 8, 16668, "", "=q3=Kilt of Elements", "=ds=Baron Rivendare (Strat)", "", "3.02%"};
	...
	AtlasLoot_Data["T0Warlock"] = {
		...
		{ 2, 16698, "", "=q3=Dreadmist Mask", "=ds=Darkmaster Gandling (Scholo)", "", "8.78%"};
		{ 3, 16701, "", "=q3=Dreadmist Mantle", "=ds=Jandice Barov (Scholo)", "", "12.20%"};
		{ 4, 16700, "", "=q3=Dreadmist Robe", "=ds=General Drakkisath (UBRS)", "", "8.04%"};
		{ 5, 16703, "", "=q3=Dreadmist Bracers", "=ds=Trash Mobs (LBRS)", "", "1.68%"};
		{ 6, 16705, "", "=q3=Dreadmist Wraps", "=ds=Lorekeeper Polkelt (Scholo)", "", "14.54%"};
		{ 7, 16702, "", "=q3=Dreadmist Belt", "=ds=Trash Mobs (Strat)", "", "1.03%"};
		{ 8, 16699, "", "=q3=Dreadmist Leggings", "=ds=Baron Rivendare (Strat)", "", "7.31%"};
	...
	AtlasLoot_Data["T0Warrior"] = {
		...
		{ 2, 16731, "", "=q3=Helm of Valor", "=ds=Darkmaster Gandling (Scholo)", "", "6.54%"};
		{ 3, 16733, "", "=q3=Spaulders of Valor", "=ds=Warchief Rend Blackhand (UBRS)", "", "13.39%"};
		{ 4, 16730, "", "=q3=Breastplate of Valor", "=ds=General Drakkisath (UBRS)", "", "5.83%"};
		{ 5, 16735, "", "=q3=Bracers of Valor", "=ds=Trash Mobs (LBRS)", "", "1.49%"};
		{ 6, 16737, "", "=q3=Gauntlets of Valor", "=ds=Ramstein the Gorger (Strat)", "", "9.58%"};
		{ 7, 16736, "", "=q3=Belt of Valor", "=ds=Trash Mobs (LBRS)", "", "1.96%"};
		{ 8, 16732, "", "=q3=Legplates of Valor", "=ds=Baron Rivendare (Strat)", "", "5.74%"};
	...
	AtlasLoot_Data["T1T2Druid"] = {
		...
		{ 2, 16834, "", "=q4=Cenarion Helm", "=ds=Garr", "", "11.51%"};
		{ 3, 16836, "", "=q4=Cenarion Spaulders", "=ds=Baron Geddon", "", "19.52%"};
		{ 4, 16833, "", "=q4=Cenarion Vestments", "=ds=Golemagg the Incinerator", "", "15.21%"};
		{ 5, 16830, "", "=q4=Cenarion Bracers", "=ds=Trash Mobs", "", "0.17%"};
		{ 6, 16831, "", "=q4=Cenarion Gloves", "=ds=Shazzrah", "", "19.53%"};
		{ 7, 16828, "", "=q4=Cenarion Belt", "=ds=Trash Mobs", "", "0.16%"};
		{ 8, 16835, "", "=q4=Cenarion Leggings", "=ds=Magmadar", "", "12.90%"};
		{ 9, 16829, "", "=q4=Cenarion Boots", "=ds=Lucifron", "", "10.72%"};
		{ 16, 0, "Spell_Nature_Regeneration", "=q6=#t2s1#", "=q1=#m31#"};
		{ 17, 16900, "", "=q4=Stormrage Cover", "=ds=Onyxia", "", "13.08%"};
		{ 18, 16902, "", "=q4=Stormrage Pauldrons", "=ds=Chromaggus", "", "14.63%"};
		{ 19, 16897, "", "=q4=Stormrage Chestguard", "=ds=Nefarian", "", "11.89%"};
		{ 20, 16904, "", "=q4=Stormrage Bracers", "=ds=Razorgore the Untamed", "", "17.38%"};
		{ 21, 16899, "", "=q4=Stormrage Handguards", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "5.34%"};
		{ 22, 16903, "", "=q4=Stormrage Belt", "=ds=Vaelastrasz the Corrupt", "", "16.90%"};
		{ 23, 16901, "", "=q4=Stormrage Legguards", "=ds=Ragnaros", "", "15.49%"};
		{ 24, 16898, "", "=q4=Stormrage Boots", "=ds=Broodlord Lashlayer", "", "13.79%"};
		Back = "T1T2SET";
	};

	AtlasLoot_Data["T1T2Hunter"] = {
		{ 1, 0, "Ability_Hunter_RunningShot", "=q6=#t1s2#", "=q1=#m30#"};
		{ 2, 16846, "", "=q4=Giantstalker's Helmet", "=ds=Garr", "", "11.57%"};
		{ 3, 16848, "", "=q4=Giantstalker's Epaulets", "=ds=Sulfuron Harbinger", "", "19.64%"};
		{ 4, 16845, "", "=q4=Giantstalker's Breastplate", "=ds=Golemagg the Incinerator", "", "15.83%"};
		{ 5, 16850, "", "=q4=Giantstalker's Bracers", "=ds=Trash Mobs", "", "0.18%"};
		{ 6, 16852, "", "=q4=Giantstalker's Gloves", "=ds=Shazzrah", "", "18.58%"};
		{ 7, 16851, "", "=q4=Giantstalker's Belt", "=ds=Trash Mobs", "", "0.17%"};
		{ 8, 16847, "", "=q4=Giantstalker's Leggings", "=ds=Magmadar", "", "13.28%"};
		{ 9, 16849, "", "=q4=Giantstalker's Boots", "=ds=Gehennas", "", "14.54%"};
		{ 16, 0, "Ability_Hunter_RunningShot", "=q6=#t2s2#", "=q1=#m31#"};
		{ 17, 16939, "", "=q4=Dragonstalker's Helm", "=ds=Onyxia", "", "13.91%"};
		{ 18, 16937, "", "=q4=Dragonstalker's Spaulders", "=ds=Chromaggus", "", "16.20%"};
		{ 19, 16942, "", "=q4=Dragonstalker's Breastplate", "=ds=Nefarian", "", "13.30%"};
		{ 20, 16935, "", "=q4=Dragonstalker's Bracers", "=ds=Razorgore the Untamed", "", "19.13%"};
		{ 21, 16940, "", "=q4=Dragonstalker's Gauntlets", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "6.13%"};
		{ 22, 16936, "", "=q4=Dragonstalker's Belt", "=ds=Vaelastrasz the Corrupt", "", "20.17%"};
		{ 23, 16938, "", "=q4=Dragonstalker's Legguards", "=ds=Ragnaros", "", "16.02%"};
		{ 24, 16941, "", "=q4=Dragonstalker's Greaves", "=ds=Broodlord Lashlayer", "", "17.78%"};
		Back = "T1T2SET";
	};

	AtlasLoot_Data["T1T2Mage"] = {
		{ 1, 0, "Spell_Frost_IceStorm", "=q6=#t1s3#", "=q1=#m30#"};
		{ 2, 16795, "", "=q4=Arcanist Crown", "=ds=Garr", "", "11.31%"};
		{ 3, 16797, "", "=q4=Arcanist Mantle", "=ds=Baron Geddon", "", "19.92%"};
		{ 4, 16798, "", "=q4=Arcanist Robes", "=ds=Golemagg the Incinerator", "", "16.51%"};
		{ 5, 16799, "", "=q4=Arcanist Bindings", "=ds=Trash Mobs", "", "0.16%"};
		{ 6, 16801, "", "=q4=Arcanist Gloves", "=ds=Shazzrah", "", "19.59%"};
		{ 7, 16802, "", "=q4=Arcanist Belt", "=ds=Trash Mobs", "", "0.16%"};
		{ 8, 16796, "", "=q4=Arcanist Leggings", "=ds=Magmadar", "", "14.57%"};
		{ 9, 16800, "", "=q4=Arcanist Boots", "=ds=Lucifron", "", "12.06%"};
		{ 16, 0, "Spell_Frost_IceStorm", "=q6=#t2s3#", "=q1=#m31#"};
		{ 17, 16914, "", "=q4=Netherwind Crown", "=ds=Onyxia", "", "14.09%"};
		{ 18, 16917, "", "=q4=Netherwind Mantle", "=ds=Chromaggus", "", "18.09%"};
		{ 19, 16916, "", "=q4=Netherwind Robes", "=ds=Nefarian", "", "14.03%"};
		{ 20, 16918, "", "=q4=Netherwind Bindings", "=ds=Razorgore the Untamed", "", "20.41%"};
		{ 21, 16913, "", "=q4=Netherwind Gloves", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "7.37%"};
		{ 22, 16818, "", "=q4=Netherwind Belt", "=ds=Vaelastrasz the Corrupt", "", "19.94%"};
		{ 23, 16915, "", "=q4=Netherwind Pants", "=ds=Ragnaros", "", "17.37%"};
		{ 24, 16912, "", "=q4=Netherwind Boots", "=ds=Broodlord Lashlayer", "", "17.17%"};
		Back = "T1T2SET";
	};

	AtlasLoot_Data["T1T2Paladin"] = {
		{ 1, 0, "Spell_Holy_SealOfMight", "=q6=#t1s4#", "=q1=#m30#"};
		{ 2, 16854, "", "=q4=Lawbringer Helm", "=ds=Garr", "", "7.23%"};
		{ 3, 16856, "", "=q4=Lawbringer Spaulders", "=ds=Baron Geddon", "", "12.62%"};
		{ 4, 16853, "", "=q4=Lawbringer Chestguard", "=ds=Golemagg the Incinerator", "", "9.53%"};
		...
		{ 8, 16855, "", "=q4=Lawbringer Legplates", "=ds=Magmadar", "", "8.54%"};
		{ 9, 16859, "", "=q4=Lawbringer Boots", "=ds=Lucifron", "", "7.20%"};
		{ 16, 0, "Spell_Holy_SealOfMight", "=q6=#t2s4#", "=q1=#m31#"};
		{ 17, 16955, "", "=q4=Judgement Crown", "=ds=Onyxia", "", "8.64%"};
		{ 18, 16953, "", "=q4=Judgement Spaulders", "=ds=Chromaggus", "", "10.97%"};
		{ 19, 16958, "", "=q4=Judgement Breastplate", "=ds=Nefarian", "", "9.24%"};
		{ 20, 16951, "", "=q4=Judgement Bindings", "=ds=Razorgore the Untamed", "", "13.61%"};
		{ 21, 16956, "", "=q4=Judgement Gauntlets", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "3.58%"};
		{ 22, 16952, "", "=q4=Judgement Belt", "=ds=Vaelastrasz the Corrupt", "", "12.23%"};
		{ 23, 16954, "", "=q4=Judgement Legplates", "=ds=Ragnaros", "", "10.81%"};
		{ 24, 16957, "", "=q4=Judgement Sabatons", "=ds=Broodlord Lashlayer", "", "11.28%"};
		Back = "T1T2SET";
	};

	AtlasLoot_Data["T1T2Priest"] = {
		{ 1, 0, "Spell_Holy_PowerWordShield", "=q6=#t1s5#", "=q1=#m30#"};
		{ 2, 16813, "", "=q4=Circlet of Prophecy", "=ds=Garr", "", "11.36%"};
		{ 3, 16816, "", "=q4=Mantle of Prophecy", "=ds=Sulfuron Harbinger", "", "21.06%"};
		{ 4, 16815, "", "=q4=Robes of Prophecy", "=ds=Golemagg the Incinerator", "", "15.65%"};
		...
		{ 8, 16814, "", "=q4=Pants of Prophecy", "=ds=Magmadar", "", "14.33%"};
		{ 9, 16811, "", "=q4=Boots of Prophecy", "=ds=Shazzrah", "", "14.90%"};
		{ 16, 0, "Spell_Holy_PowerWordShield", "=q6=#t2s5#", "=q1=#m31#"};
		{ 17, 16921, "", "=q4=Halo of Transcendence", "=ds=Onyxia", "", "13.39%"};
		{ 18, 16924, "", "=q4=Pauldrons of Transcendence", "=ds=Chromaggus", "", "17.83%"};
		{ 19, 16923, "", "=q4=Robes of Transcendence", "=ds=Nefarian", "", "14.83%"};
		{ 20, 16926, "", "=q4=Bindings of Transcendence", "=ds=Razorgore the Untamed", "", "20.37%"};
		{ 21, 16920, "", "=q4=Handguards of Transcendence", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "6.01%"};
		{ 22, 16925, "", "=q4=Belt of Transcendence", "=ds=Vaelastrasz the Corrupt", "", "18.76%"};
		{ 23, 16922, "", "=q4=Leggings of Transcendence", "=ds=Ragnaros", "", "17.30%"};
		{ 24, 16919, "", "=q4=Boots of Transcendence", "=ds=Broodlord Lashlayer", "", "14.61%"};
		Back = "T1T2SET";
	};

	AtlasLoot_Data["T1T2Rogue"] = {
		{ 1, 0, "Ability_BackStab", "=q6=#t1s6#", "=q1=#m30#"};
		{ 2, 16821, "", "=q4=Nightslayer Cover", "=ds=Garr", "", "10.38%"};
		{ 3, 16823, "", "=q4=Nightslayer Shoulder Pads", "=ds=Sulfuron Harbinger", "", "20.66%"};
		{ 4, 16820, "", "=q4=Nightslayer Chestpiece", "=ds=Golemagg the Incinerator", "", "16.76%"};
		...
		{ 8, 16822, "", "=q4=Nightslayer Pants", "=ds=Magmadar", "", "13.83%"};
		{ 9, 16824, "", "=q4=Nightslayer Boots", "=ds=Shazzrah", "", "15.58%"};
		{ 16, 0, "Ability_BackStab", "=q6=#t2s6#", "=q1=#m31#"};
		{ 17, 16908, "", "=q4=Bloodfang Hood", "=ds=Onyxia", "", "13.21%"};
		{ 18, 16832, "", "=q4=Bloodfang Spaulders", "=ds=Chromaggus", "", "17.03%"};
		{ 19, 16905, "", "=q4=Bloodfang Chestpiece", "=ds=Nefarian", "", "14.21%"};
		{ 20, 16911, "", "=q4=Bloodfang Bracers", "=ds=Razorgore the Untamed", "", "20.69%"};
		{ 21, 16907, "", "=q4=Bloodfang Gloves", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "6.84%"};
		{ 22, 16910, "", "=q4=Bloodfang Belt", "=ds=Vaelastrasz the Corrupt", "", "19.69%"};
		{ 23, 16909, "", "=q4=Bloodfang Pants", "=ds=Ragnaros", "", "17.18%"};
		{ 24, 16906, "", "=q4=Bloodfang Boots", "=ds=Broodlord Lashlayer", "", "15.66%"};
		Back = "T1T2SET";
	};

	AtlasLoot_Data["T1T2Shaman"] = {
		{ 1, 0, "Spell_FireResistanceTotem_01", "=q6=#t1s7#", "=q1=#m30#"};
		{ 2, 16842, "", "=q4=Earthfury Helmet", "=ds=Garr", "", "3.91%"};
		{ 3, 16844, "", "=q4=Earthfury Epaulets", "=ds=Baron Geddon", "", "7.29%"};
		{ 4, 16841, "", "=q4=Earthfury Vestments", "=ds=Golemagg the Incinerator", "", "6.08%"};
		...
		{ 8, 16843, "", "=q4=Earthfury Legguards", "=ds=Magmadar", "", "4.73%"};
		{ 9, 16837, "", "=q4=Earthfury Boots", "=ds=Lucifron", "", "4.16%"};
		{ 16, 0, "Spell_FireResistanceTotem_01", "=q6=#t2s7#", "=q1=#m31#"};
		{ 17, 16947, "", "=q4=Helmet of Ten Storms", "=ds=Onyxia", "", "4.86%"};
		{ 18, 16945, "", "=q4=Epaulets of Ten Storms", "=ds=Chromaggus", "", "6.73%"};
		{ 19, 16950, "", "=q4=Breastplate of Ten Storms", "=ds=Nefarian", "", "5.65%"};
		{ 20, 16943, "", "=q4=Bracers of Ten Storms", "=ds=Razorgore the Untamed", "", "7.54%"};
		{ 21, 16948, "", "=q4=Gauntlets of Ten Storms", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "2.13%"};
		{ 22, 16944, "", "=q4=Belt of Ten Storms", "=ds=Vaelastrasz the Corrupt", "", "6.93%"};
		{ 23, 16946, "", "=q4=Legplates of Ten Storms", "=ds=Ragnaros", "", "5.97%"};
		{ 24, 16949, "", "=q4=Greaves of Ten Storms", "=ds=Broodlord Lashlayer", "", "5.57%"};
		Back = "T1T2SET";
	};

	AtlasLoot_Data["T1T2Warlock"] = {
		{ 1, 0, "Spell_Shadow_CurseOfTounges", "=q6=#t1s8#", "=q1=#m30#"};
		{ 2, 16808, "", "=q4=Felheart Horns", "=ds=Garr", "", "10.62%"};
		{ 3, 16807, "", "=q4=Felheart Shoulder Pads", "=ds=Baron Geddon", "", "19.78%"};
		{ 4, 16809, "", "=q4=Felheart Robes", "=ds=Golemagg the Incinerator", "", "15.66%"};
		{ 5, 16804, "", "=q4=Felheart Bracers", "=ds=Trash Mobs", "", "0.16%"};
		{ 6, 16805, "", "=q4=Felheart Gloves", "=ds=Lucifron", "", "14.89%"};
		{ 7, 16806, "", "=q4=Felheart Belt", "=ds=Trash Mobs", "", "0.19%"};
		{ 8, 16810, "", "=q4=Felheart Pants", "=ds=Magmadar", "", "13.75%"};
		{ 9, 16803, "", "=q4=Felheart Slippers", "=ds=Shazzrah", "", "15.28%"};
		{ 16, 0, "Spell_Shadow_CurseOfTounges", "=q6=#t2s8#", "=q1=#m31#"};
		{ 17, 16929, "", "=q4=Nemesis Skullcap", "=ds=Onyxia", "", "13.54%"};
		{ 18, 16932, "", "=q4=Nemesis Spaulders", "=ds=Chromaggus", "", "16.26%"};
		{ 19, 16931, "", "=q4=Nemesis Robes", "=ds=Nefarian", "", "12.46%"};
		{ 20, 16934, "", "=q4=Nemesis Bracers", "=ds=Razorgore the Untamed", "", "18.11%"};
		{ 21, 16928, "", "=q4=Nemesis Gloves", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "5.28%"};
		{ 22, 16933, "", "=q4=Nemesis Belt", "=ds=Vaelastrasz the Corrupt", "", "18.42%"};
		{ 23, 16930, "", "=q4=Nemesis Leggings", "=ds=Ragnaros", "", "16.87%"};
		{ 24, 16927, "", "=q4=Nemesis Boots", "=ds=Broodlord Lashlayer", "", "15.32%"};
		Back = "T1T2SET";
	};

	AtlasLoot_Data["T1T2Warrior"] = {
		{ 1, 0, "INV_Shield_05", "=q6=#t1s9#", "=q1=#m30#"};
		{ 2, 16866, "", "=q4=Helm of Might", "=ds=Garr", "", "11.39%"};
		{ 3, 16868, "", "=q4=Pauldrons of Might", "=ds=Sulfuron Harbinger", "", "21.14%"};
		{ 4, 16865, "", "=q4=Breastplate of Might", "=ds=Golemagg the Incinerator", "", "15.28%"};
		{ 5, 16861, "", "=q4=Bracers of Might", "=ds=Trash Mobs", "", "0.16%"};
		{ 6, 16863, "", "=q4=Gauntlets of Might", "=ds=Lucifron", "", "16.40%"};
		{ 7, 16864, "", "=q4=Belt of Might", "=ds=Trash Mobs", "", "0.16%"};
		{ 8, 16867, "", "=q4=Legplates of Might", "=ds=Magmadar", "", "13.97%"};
		{ 9, 16862, "", "=q4=Sabatons of Might", "=ds=Gehennas", "", "14.48%"};
		{ 16, 0, "INV_Shield_05", "=q6=#t2s9#", "=q1=#m31#"};
		{ 17, 16963, "", "=q4=Helm of Wrath", "=ds=Onyxia", "", "13.65%"};
		{ 18, 16961, "", "=q4=Pauldrons of Wrath", "=ds=Chromaggus", "", "16.83%"};
		{ 19, 16966, "", "=q4=Breastplate of Wrath", "=ds=Nefarian", "", "15.06%"};
		{ 20, 16959, "", "=q4=Bracelets of Wrath", "=ds=Razorgore the Untamed", "", "20.29%"};
		{ 21, 16964, "", "=q4=Gauntlets of Wrath", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "5.93%"};
		{ 22, 16960, "", "=q4=Waistband of Wrath", "=ds=Vaelastrasz the Corrupt", "", "20.03%"};
		{ 23, 16962, "", "=q4=Legplates of Wrath", "=ds=Ragnaros", "", "17.23%"};
		{ 24, 16965, "", "=q4=Sabatons of Wrath", "=ds=Broodlord Lashlayer", "", "16.84%"};
		Back = "T1T2SET";
	};
	...
	AtlasLoot_Data["T3Druid"] = {
		...
		{ 2, 22490, "", "=q4=Dreamwalker Headpiece", "=ds=Thaddius"};
		{ 3, 22491, "", "=q4=Dreamwalker Spaulders", "=ds=Patchwerk, Grobbulus"};
		{ 4, 22488, "", "=q4=Dreamwalker Tunic", "=ds=The Four Horsemen"};
		{ 5, 22495, "", "=q4=Dreamwalker Wristguards", "=ds=Anub'Rekhan, Grand Widow Faerlina"};
		{ 6, 22493, "", "=q4=Dreamwalker Handguards", "=ds=Maexxna"};
		{ 7, 22494, "", "=q4=Dreamwalker Girdle", "=ds=Noth the Plaguebringer, Heigan the Unclean"};
		{ 8, 22489, "", "=q4=Dreamwalker Legguards", "=ds=Loatheb"};
		{ 9, 22492, "", "=q4=Dreamwalker Boots", "=ds=Gluth, Instructor Razuvious, Gothik the Harvester"};
		{ 10, 23064, "", "=q4=Ring of the Dreamwalker", "=ds=Kel'Thuzad"};
		Back = "T3SET";
	};

	AtlasLoot_Data["T3Hunter"] = {
		{ 1, 0, "Ability_Hunter_RunningShot", "=q6=#t3s2#", ""};
		{ 2, 22438, "", "=q4=Cryptstalker Headpiece", "=ds=Thaddius"};
		{ 3, 22439, "", "=q4=Cryptstalker Spaulders", "=ds=Patchwerk, Grobbulus"};
		{ 4, 22436, "", "=q4=Cryptstalker Tunic", "=ds=The Four Horsemen"};
		{ 5, 22443, "", "=q4=Cryptstalker Wristguards", "=ds=Anub'Rekhan, Grand Widow Faerlina"};
		{ 6, 22441, "", "=q4=Cryptstalker Handguards", "=ds=Maexxna"};
		{ 7, 22442, "", "=q4=Cryptstalker Girdle", "=ds=Noth the Plaguebringer, Heigan the Unclean"};
		{ 8, 22437, "", "=q4=Cryptstalker Legguards", "=ds=Loatheb"};
		{ 9, 22440, "", "=q4=Cryptstalker Boots", "=ds=Gluth, Instructor Razuvious, Gothik the Harvester"};
		{ 10, 23067, "", "=q4=Ring of the Cryptstalker", "=ds=Kel'Thuzad"};
		Back = "T3SET";
	};

	AtlasLoot_Data["T3Mage"] = {
		{ 1, 0, "Spell_Frost_IceStorm", "=q6=#t3s3#", ""};
		{ 2, 22498, "", "=q4=Frostfire Circlet", "=ds=Thaddius"};
		{ 3, 22499, "", "=q4=Frostfire Shoulderpads", "=ds=Patchwerk, Grobbulus"};
		{ 4, 22496, "", "=q4=Frostfire Robe", "=ds=The Four Horsemen"};
		{ 5, 22503, "", "=q4=Frostfire Bindings", "=ds=Anub'Rekhan, Grand Widow Faerlina"};
		{ 6, 22501, "", "=q4=Frostfire Gloves", "=ds=Maexxna"};
		{ 7, 22502, "", "=q4=Frostfire Belt", "=ds=Noth the Plaguebringer, Heigan the Unclean"};
		{ 8, 22497, "", "=q4=Frostfire Leggings", "=ds=Loatheb"};
		{ 9, 22500, "", "=q4=Frostfire Sandals", "=ds=Gluth, Instructor Razuvious, Gothik the Harvester"};
		{ 10, 23062, "", "=q4=Frostfire Ring", "=ds=Kel'Thuzad"};
		Back = "T3SET";
	};

	AtlasLoot_Data["T3Paladin"] = {
		{ 1, 0, "Spell_Holy_SealOfMight", "=q6=#t3s4#", ""};
		{ 2, 22428, "", "=q4=Redemption Headpiece", "=ds=Thaddius"};
		{ 3, 22429, "", "=q4=Redemption Spaulders", "=ds=Patchwerk, Grobbulus"};
		{ 4, 22425, "", "=q4=Redemption Tunic", "=ds=The Four Horsemen"};
		{ 5, 22424, "", "=q4=Redemption Wristguards", "=ds=Anub'Rekhan, Grand Widow Faerlina"};
		{ 6, 22426, "", "=q4=Redemption Handguards", "=ds=Maexxna"};
		{ 7, 22431, "", "=q4=Redemption Girdle", "=ds=Noth the Plaguebringer, Heigan the Unclean"};
		{ 8, 22427, "", "=q4=Redemption Legguards", "=ds=Loatheb"};
		{ 9, 22430, "", "=q4=Redemption Boots", "=ds=Gluth, Instructor Razuvious, Gothik the Harvester"};
		{ 10, 23066, "", "=q4=Ring of Redemption", "=ds=Kel'Thuzad"};
		Back = "T3SET";
	};

	AtlasLoot_Data["T3Priest"] = {
		{ 1, 0, "Spell_Holy_PowerWordShield", "=q6=#t3s5#", ""};
		{ 2, 22514, "", "=q4=Circlet of Faith", "=ds=Thaddius"};
		{ 3, 22515, "", "=q4=Shoulderpads of Faith", "=ds=Patchwerk, Grobbulus"};
		{ 4, 22512, "", "=q4=Robe of Faith", "=ds=The Four Horsemen"};
		{ 5, 22519, "", "=q4=Bindings of Faith", "=ds=Anub'Rekhan, Grand Widow Faerlina"};
		{ 6, 22517, "", "=q4=Gloves of Faith", "=ds=Maexxna"};
		{ 7, 22518, "", "=q4=Belt of Faith", "=ds=Noth the Plaguebringer, Heigan the Unclean"};
		{ 8, 22513, "", "=q4=Leggings of Faith", "=ds=Loatheb"};
		{ 9, 22516, "", "=q4=Sandals of Faith", "=ds=Gluth, Instructor Razuvious, Gothik the Harvester"};
		{ 10, 23061, "", "=q4=Ring of Faith", "=ds=Kel'Thuzad"};
		Back = "T3SET";
	};

	AtlasLoot_Data["T3Rogue"] = {
		{ 1, 0, "Ability_BackStab", "=q6=#t3s6#", ""};
		{ 2, 22478, "", "=q4=Bonescythe Helmet", "=ds=Thaddius"};
		{ 3, 22479, "", "=q4=Bonescythe Pauldrons", "=ds=Patchwerk, Grobbulus"};
		{ 4, 22476, "", "=q4=Bonescythe Breastplate", "=ds=The Four Horsemen"};
		{ 5, 22483, "", "=q4=Bonescythe Bracers", "=ds=Anub'Rekhan, Grand Widow Faerlina"};
		{ 6, 22481, "", "=q4=Bonescythe Gauntlets", "=ds=Maexxna"};
		{ 7, 22482, "", "=q4=Bonescythe Waistguard", "=ds=Noth the Plaguebringer, Heigan the Unclean"};
		{ 8, 22477, "", "=q4=Bonescythe Legplates", "=ds=Loatheb"};
		{ 9, 22480, "", "=q4=Bonescythe Sabatons", "=ds=Gluth, Instructor Razuvious, Gothik the Harvester"};
		{ 10, 23060, "", "=q4=Bonescythe Ring", "=ds=Kel'Thuzad"};
		Back = "T3SET";
	};

	AtlasLoot_Data["T3Shaman"] = {
		{ 1, 0, "Spell_FireResistanceTotem_01", "=q6=#t3s7#", ""};
		{ 2, 22466, "", "=q4=Earthshatter Headpiece", "=ds=Thaddius"};
		{ 3, 22467, "", "=q4=Earthshatter Spaulders", "=ds=Patchwerk, Grobbulus"};
		{ 4, 22464, "", "=q4=Earthshatter Tunic", "=ds=The Four Horsemen"};
		{ 5, 22471, "", "=q4=Earthshatter Wristguards", "=ds=Anub'Rekhan, Grand Widow Faerlina"};
		{ 6, 22469, "", "=q4=Earthshatter Handguards", "=ds=Maexxna"};
		{ 7, 22470, "", "=q4=Earthshatter Girdle", "=ds=Noth the Plaguebringer, Heigan the Unclean"};
		{ 8, 22465, "", "=q4=Earthshatter Legguards", "=ds=Loatheb"};
		{ 9, 22468, "", "=q4=Earthshatter Boots", "=ds=Gluth, Instructor Razuvious, Gothik the Harvester"};
		{ 10, 23065, "", "=q4=Ring of the Earthshatterer", "=ds=Kel'Thuzad"};
		Back = "T3SET";
	};

	AtlasLoot_Data["T3Warlock"] = {
		{ 1, 0, "Spell_Shadow_CurseOfTounges", "=q6=#t3s8#", ""};
		{ 2, 22506, "", "=q4=Plagueheart Circlet", "=ds=Thaddius"};
		{ 3, 22507, "", "=q4=Plagueheart Shoulderpads", "=ds=Patchwerk, Grobbulus"};
		{ 4, 22504, "", "=q4=Plagueheart Robe", "=ds=The Four Horsemen"};
		{ 5, 22511, "", "=q4=Plagueheart Bindings", "=ds=Anub'Rekhan, Grand Widow Faerlina"};
		{ 6, 22509, "", "=q4=Plagueheart Gloves", "=ds=Maexxna"};
		{ 7, 22510, "", "=q4=Plagueheart Belt", "=ds=Noth the Plaguebringer, Heigan the Unclean"};
		{ 8, 22505, "", "=q4=Plagueheart Leggings", "=ds=Loatheb"};
		{ 9, 22508, "", "=q4=Plagueheart Sandals", "=ds=Gluth, Instructor Razuvious, Gothik the Harvester"};
		{ 10, 23063, "", "=q4=Plagueheart Ring", "=ds=Kel'Thuzad"};
		Back = "T3SET";
	};

	AtlasLoot_Data["T3Warrior"] = {
		{ 1, 0, "INV_Shield_05", "=q6=#t3s9#", ""};
		{ 2, 22418, "", "=q4=Dreadnaught Helmet", "=ds=Thaddius"};
		{ 3, 22419, "", "=q4=Dreadnaught Pauldrons", "=ds=Patchwerk, Grobbulus"};
		{ 4, 22416, "", "=q4=Dreadnaught Breastplate", "=ds=The Four Horsemen"};
		{ 5, 22423, "", "=q4=Dreadnaught Bracers", "=ds=Anub'Rekhan, Grand Widow Faerlina"};
		{ 6, 22421, "", "=q4=Dreadnaught Gauntlets", "=ds=Maexxna"};
		{ 7, 22422, "", "=q4=Dreadnaught Waistguard", "=ds=Noth the Plaguebringer, Heigan the Unclean"};
		{ 8, 22417, "", "=q4=Dreadnaught Legplates", "=ds=Loatheb"};
		{ 9, 22420, "", "=q4=Dreadnaught Sabatons", "=ds=Gluth, Instructor Razuvious, Gothik the Harvester"};
		{ 10, 23059, "", "=q4=Ring of the Dreadnaught", "=ds=Kel'Thuzad"};
		Back = "T3SET";
	};
	...
	AtlasLoot_Data["Mounts11"] = {
		{ 1, 0, "INV_Shield_05", "=q6="..BabbleFaction["Darnassus"].." #j30#", ""};
		...
		{ 8, 0, "INV_Shield_05", "=q6="..BabbleFaction["Gnomeregan Exiles"].." #j30#", ""};
		...
		{ 16, 0, "INV_Shield_05", "=q6="..BabbleFaction["Ironforge"].." #j30#", ""};
		...
		{ 23, 0, "INV_Shield_05", "=q6="..BabbleFaction["Stormwind"].." #j30#", ""};
	...
	AtlasLoot_Data["Mounts12"] = {
		{ 1, 0, "INV_Shield_05", "=q6="..BabbleFaction["Darkspear Trolls"].." #j30#", ""};
		...
		{ 9, 0, "INV_Shield_05", "=q6="..BabbleFaction["Orgrimmar"].." #j30#", ""};
		...
		{ 16, 0, "INV_Shield_05", "=q6="..BabbleFaction["Thunder Bluff"].." #j30#", ""};
		...
		{ 24, 0, "INV_Shield_05", "=q6="..BabbleFaction["Undercity"].." #j30#", ""};
	...
	AtlasLoot_Data["Mounts13"] = {
		...
		{ 16, 0, "INV_Shield_05", "=q6="..BabbleFaction["Wintersaber Trainers"].." #j30#", "=ec1=#m7#"};
		{ 17, 13086, "", "=q4=Reins of the Winterspring Frostsaber", "=ds=#e12#"};
		{ 19, 0, "INV_Shield_05", "=q6=#j34#", ""};
	...
	AtlasLoot_Data["PVPWeapons2"] = {
		...
		{ 21, 18837, "", "=q4=High Warlord's Crossbow", "=ds=#w3#", "12240 #horde# 20 #ab#", ""};
	...
	AtlasLoot_Data["PvP60Accessories2"] = {
		{ 1, 18440, "", "=q3=Sergeant's Cape", "=ds=#s4#", "95 #alliance# 10 #wsg#", ""};
		{ 2, 18441, "", "=q3=Sergeant's Cape", "=ds=#s4#", "208 #alliance# 10 #wsg#", ""};
		{ 3, 16342, "", "=q3=Sergeant's Cape", "=ds=#s4#", "1530 #alliance# 10 #wsg#", ""};
	...
	AtlasLoot_Data["PvP60Accessories3"] = {
		{ 1, 18427, "", "=q3=Sergeant's Cloak", "=ds=#s4#", "95 #horde# 10 #wsg#", ""};
		{ 2, 16341, "", "=q3=Sergeant's Cloak", "=ds=#s4#", "208 #horde# 10 #wsg#", ""};
		{ 3, 18461, "", "=q3=Sergeant's Cloak", "=ds=#s4#", "1530 #horde# 10 #wsg#", ""};
