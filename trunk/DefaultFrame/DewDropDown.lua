...
AtlasLoot_DewDropDown_SubTables = {
	...
	--[[["Naxxramas"] = {
		{ AtlasLoot_TableNames["NAXPatchwerk"][1].."("..AL["Construct Quarter"]..")", "NAXPatchwerk" },
		{ AtlasLoot_TableNames["NAXGrobbulus"][1].."("..AL["Construct Quarter"]..")", "NAXGrobbulus" },
		{ AtlasLoot_TableNames["NAXGluth"][1].."("..AL["Construct Quarter"]..")", "NAXGluth" },
		{ AtlasLoot_TableNames["NAXThaddius"][1].."("..AL["Construct Quarter"]..")", "NAXThaddius" },
		{ AtlasLoot_TableNames["NAXAnubRekhan"][1].."("..AL["Arachnid Quarter"]..")", "NAXAnubRekhan" },
		{ AtlasLoot_TableNames["NAXGrandWidowFaerlina"][1].."("..AL["Arachnid Quarter"]..")", "NAXGrandWidowFaerlina" },
		{ AtlasLoot_TableNames["NAXMaexxna"][1].."("..AL["Arachnid Quarter"]..")", "NAXMaexxna" },
		{ AtlasLoot_TableNames["NAXInstructorRazuvious"][1].."("..AL["Military Quarter"]..")", "NAXInstructorRazuvious" },
		{ AtlasLoot_TableNames["NAXGothikderHarvester"][1].."("..AL["Military Quarter"]..")", "NAXGothikderHarvester" },
		{ AtlasLoot_TableNames["NAXTheFourHorsemen"][1].."("..AL["Military Quarter"]..")", "NAXTheFourHorsemen" },
		{ AtlasLoot_TableNames["NAXNothderPlaguebringer"][1].."("..AL["Plague Quarter"]..")", "NAXNothderPlaguebringer" },
		{ AtlasLoot_TableNames["NAXHeiganderUnclean"][1].."("..AL["Plague Quarter"]..")", "NAXHeiganderUnclean" },
		{ AtlasLoot_TableNames["NAXLoatheb"][1].."("..AL["Plague Quarter"]..")", "NAXLoatheb" },
		{ AtlasLoot_TableNames["NAXSapphiron"][1].."("..AL["Frostwyrm Lair"]..")", "NAXSapphiron" },
		{ AtlasLoot_TableNames["NAXKelThuzard"][1].."("..AL["Frostwyrm Lair"]..")", "NAXKelThuzard" },
		{ "", "NAXTrash" },
	},]]
	["Scarlet Monastery"] = {
