		...
		["Normal"] = {
			{
				...
				{ 9, 53010, "", "=q1=Embersilk Cloth", "", "#JUSTICE:1000#" },
				{ 10, 52185, "", "=q1=Elementium Ore", "", "#JUSTICE:1250#" },
				...
				{ 20, "JusticePoints#6", "inv_misc_greateressence", "=ds="..AL["Weapons"], ""};
		...
		["Normal"] = {
			{
				...
				{ 4, "BHAlizabal#1", "inv_staff_13", "=ds="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], ""};
