...
local BabbleRare = AtlasLoot_GetLocaleLibBabble("LibBabble-Rare-3.0")
	...
	AtlasLoot_Data["WORLDEVENTMENU"] = {
		["Normal"] = {
			{
				{ 1, "ARGENTMENU", "Ability_Paladin_ArtofWar", "=ds="..AL["Argent Tournament"], "=q5="..AtlasLoot_IngameLocales["Icecrown"]};
				...
				{ 10, "BashirLanding", "INV_Trinket_Naxxramas02", "=ds="..AL["Bash'ir Landing Skyguard Raid"], "=q5="..AtlasLoot_IngameLocales["Blade's Edge Mountains"]};
				{ 11, "GurubashiArena", "inv_misc_armorkit_04", "=ds="..AL["Gurubashi Arena Booty Run"], "=q5="..AtlasLoot_IngameLocales["Stranglethorn Vale"]};
				{ 13, "ABYSSALMENU", "INV_Staff_13", "=ds="..AL["Abyssal Council"], "=q5="..AtlasLoot_IngameLocales["Silithus"]};
				{ 14, "SKETTISMENU", "Spell_Nature_NaturesWrath", "=ds="..AL["Skettis"], "=q5="..AtlasLoot_IngameLocales["Terokkar Forest"]};
				{ 16, "DARKMOONMENU", "INV_Misc_Ticket_Tarot_Madness", "=ds="..AtlasLoot_IngameLocales["Darkmoon Faire"], "=q5="..AL["Darkmoon Island"]};
				...
				{ 25, "FishingExtravaganza", "inv_misc_fish_06", "=ds="..AL["Fishing Contests"], "=q5="..AtlasLoot_IngameLocales["Stranglethorn Vale"].." / "..AL["Northrend"]};
				{ 28, "ETHEREUMMENU", "INV_Misc_PunchCards_Prismatic", "=ds="..AL["Ethereum Prison"], "=q5="..AtlasLoot_IngameLocales["Netherstorm"]};
			};
		};
		info = {
