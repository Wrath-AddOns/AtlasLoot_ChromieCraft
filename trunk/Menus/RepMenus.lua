...
local BabbleZone = LibStub("LibBabble-Zone-3.0"):GetLookupTable();
	...
	AtlasLoot_Data["REPMENU"] = {
		...
		{ 24, "AshenVerdict", "INV_Jewelry_Ring_85", "=ds=The Ashen Verdict", "=q5="..BabbleZone["Icecrown"]};
	};
	...
	AtlasLoot_Data["REPMENU_WOTLK"] = {
		...
		{ 22, "AshenVerdict", "INV_Jewelry_Ring_85", "=ds=The Ashen Verdict", "=q5="..BabbleZone["Icecrown"]};
		Back = "REPMENU";
	};
