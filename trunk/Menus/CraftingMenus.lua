...
local SPELLFIRE = GetSpellInfo(26797);
		...
		["Normal"] = {
			{
				...
				{ 14, "SmithingMoPVendor", "inv_scroll_04", "=ds="..AL["Mists of Pandaria Vendor Sold Plans"], "=q5="..AtlasLoot_IngameLocales["Vale of Eternal Blossoms"]};
				...
				{ 29, "SmithingCataVendor", "inv_scroll_04", "=ds="..AL["Cataclysm Vendor Sold Plans"], "=q5="..AtlasLoot_IngameLocales["Twilight Highlands"]};
		...
		["Normal"] = {
			{
				...
				{ 10, "EnchantingCataVendor", "inv_enchant_formulasuperior_01", "=ds="..AL["Cataclysm Vendor Sold Formulas"], "=q5="..AtlasLoot_IngameLocales["Twilight Highlands"]};
		...
		["Normal"] = {
			{
				...
				{ 13, "LeatherworkingMoPVendor", "inv_scroll_04", "=ds="..AL["Mists of Pandaria Vendor Sold Patterns"], "=q5="..AtlasLoot_IngameLocales["Vale of Eternal Blossoms"]};
				...
				{ 28, "LeatherworkingCataVendor", "inv_scroll_03", "=ds="..AL["Cataclysm Vendor Sold Patterns"], "=q5="..AtlasLoot_IngameLocales["Twilight Highlands"]};
			};
		};
		info = {
			name = LEATHERWORKING,
		...
		["Normal"] = {
			{
				...
				{ 11, "TailoringMoPVendor", "inv_scroll_04", "=ds="..AL["Mists of Pandaria Vendor Sold Patterns"], "=q5="..AtlasLoot_IngameLocales["Vale of Eternal Blossoms"]};
				...
				{ 26, "TailoringCataVendor", "inv_scroll_05", "=ds="..AL["Cataclysm Vendor Sold Plans"], "=q5="..AtlasLoot_IngameLocales["Twilight Highlands"]};
			};
		};
		info = {
			name = TAILORING,
	...
	AtlasLoot_Data["COOKINGDAILYMENU"] = {
		["Normal"] = {
			{
				{ 2, "CookingDaily#1", "inv_misc_food_meat_cooked_09", "=ds="..AtlasLoot_IngameLocales["Valley of the Four Winds"], "=q5="..AL["Mists of Pandaria"] };
				{ 3, "CookingDaily#5", "inv_misc_food_12", "=ds="..AtlasLoot_IngameLocales["Dalaran"], "=q5="..AL["Wrath of the Lich King"] };
				{ 17, "CookingDaily#3", "inv_misc_food_meat_cooked_09", "=ds="..AtlasLoot_IngameLocales["Stormwind City"].." / "..AtlasLoot_IngameLocales["Orgrimmar"], "=q5="..AL["Cataclysm"] };
				{ 18, "CookingDaily#7", "inv_misc_cauldron_arcane", "=ds="..AtlasLoot_IngameLocales["Shattrath City"], "=q5="..AL["Burning Crusade"] };
			};
		};
		info = {
	...
	AtlasLoot_Data["FISHINGDAILYMENU"] = {
		["Normal"] = {
			{
				{ 2, "FishingDaily#1", "inv_fishingpole_03", "=ds="..AtlasLoot_IngameLocales["Dalaran"], "=q5="..AL["Wrath of the Lich King"] };
				...
				{ 17, "FishingDaily#2", "achievement_profession_fishing_oldmanbarlowned", "=ds="..AtlasLoot_IngameLocales["Terokkar Forest"], "=q5="..AL["Burning Crusade"] };
