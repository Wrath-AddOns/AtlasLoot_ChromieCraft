		...
		["Normal"] = {
			{
				...
				{ 14, "SmithingArmorRemoved", "Trade_BlackSmithing", "=ds=Removed (Temp Name)", "" };
		...
		["Normal"] = {
			{
				...
				{ 5, "Inscription_DeathKnightPrimeMinor", "spell_deathknight_classicon", "=ds="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "=q5="..AL["Prime Glyph"]..", "..AL["Minor Glyph"] };
				{ 6, "Inscription_DruidPrimeMinor", "ability_druid_maul", "=ds="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Prime Glyph"]..", "..AL["Minor Glyph"] };
				{ 7, "Inscription_HunterPrimeMinor", "inv_weapon_bow_07", "=ds="..LOCALIZED_CLASS_NAMES_MALE["HUNTER"], "=q5="..AL["Prime Glyph"]..", "..AL["Minor Glyph"] };
				{ 8, "Inscription_MagePrimeMinor", "inv_staff_13", "=ds="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], "=q5="..AL["Prime Glyph"]..", "..AL["Minor Glyph"] };
				{ 9, "Inscription_PaladinPrimeMinor", "ability_thunderbolt", "=ds="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Prime Glyph"]..", "..AL["Minor Glyph"] };
				{ 10, "Inscription_PriestPrimeMinor", "inv_staff_30", "=ds="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Prime Glyph"]..", "..AL["Minor Glyph"] };
				{ 11, "Inscription_RoguePrimeMinor", "inv_throwingknife_04", "=ds="..LOCALIZED_CLASS_NAMES_MALE["ROGUE"], "=q5="..AL["Prime Glyph"]..", "..AL["Minor Glyph"] };
				{ 12, "Inscription_ShamanPrimeMinor", "spell_nature_bloodlust", "=ds="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Prime Glyph"]..", "..AL["Minor Glyph"] };
				{ 13, "Inscription_WarlockPrimeMinor", "spell_nature_drowsy", "=ds="..LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], "=q5="..AL["Prime Glyph"]..", "..AL["Minor Glyph"] };
				{ 14, "Inscription_WarriorPrimeMinor", "inv_sword_27", "=ds="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5="..AL["Prime Glyph"]..", "..AL["Minor Glyph"] };
				...
				{ 20, "Inscription_DeathKnightMajor", "spell_deathknight_classicon", "=ds="..LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "=q5="..AL["Major Glyph"] };
				{ 21, "Inscription_DruidMajor", "ability_druid_maul", "=ds="..LOCALIZED_CLASS_NAMES_MALE["DRUID"], "=q5="..AL["Major Glyph"] };
				{ 22, "Inscription_HunterMajor", "inv_weapon_bow_07", "=ds="..LOCALIZED_CLASS_NAMES_MALE["HUNTER"], "=q5="..AL["Major Glyph"] };
				{ 23, "Inscription_MageMajor", "inv_staff_13", "=ds="..LOCALIZED_CLASS_NAMES_MALE["MAGE"], "=q5="..AL["Major Glyph"] };
				{ 24, "Inscription_PaladinMajor", "ability_thunderbolt", "=ds="..LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "=q5="..AL["Major Glyph"] };
				{ 25, "Inscription_PriestMajor", "inv_staff_30", "=ds="..LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "=q5="..AL["Major Glyph"] };
				{ 26, "Inscription_RogueMajor", "inv_throwingknife_04", "=ds="..LOCALIZED_CLASS_NAMES_MALE["ROGUE"], "=q5="..AL["Major Glyph"] };
				{ 27, "Inscription_ShamanMajor", "spell_nature_bloodlust", "=ds="..LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "=q5="..AL["Major Glyph"] };
				{ 28, "Inscription_WarlockMajor", "spell_nature_drowsy", "=ds="..LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], "=q5="..AL["Major Glyph"] };
				{ 29, "Inscription_WarriorMajor", "inv_sword_27", "=ds="..LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "=q5="..AL["Major Glyph"] };
			};
		};
		info = {
			name = INSCRIPTION,
