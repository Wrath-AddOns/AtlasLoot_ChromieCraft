...
local BabbleZone = AtlasLoot_GetLocaleLibBabble("LibBabble-Zone-3.0")
		...
		["Normal"] = {
			{
				...
				{ 9, "PVP80NonSet", "INV_Jewelry_Necklace_36", "=ds="..AL["PvP Accessories"], "=q5="..AL["Level 80"]};
				{ 10, "PVP80Misc", "INV_Scroll_06", "=ds="..AL["PvP Misc"], "=q5="..AL["Level 80"]};
				{ 11, "PVP80SET", "INV_Boots_01", "=ds="..AL["PvP Armor Sets"], "=q5="..AL["Level 80"]};
				{ 13, "PVP85SET", "inv_helm_plate_pvppaladin_c_01", "=ds="..AL["PvP Armor Sets"], "=q5="..AL["Level 85"]};
				...
				{ 25, "PVP80Weapons", "INV_Sword_86", "=ds="..AL["PvP Weapons"], "=q5="..AL["Level 80"] };
				{ 28, "PVP85NonSet", "inv_bracer_51", "=ds="..AL["PvP Non-Set Epics"], "=q5="..AL["Level 85"]};
			};
		};
		info = {
			name = AL["PvP Rewards"],
		...
		["Normal"] = {
			{
				...
				{ 3, "ABSets1", "INV_Jewelry_Amulet_07", "=ds="..AL["Arathi Basin Sets"], ""};
	...
	AtlasLoot_Data["PVP80NONSETEPICS"] = {
		["Normal"] = {
			{
				{ 2, "PVP80NonSet#3", "INV_Boots_Cloth_12", "=ds="..BabbleInventory["Cloth"], ""};
				{ 3, "PVP80NonSet#5", "INV_Boots_Plate_06", "=ds="..BabbleInventory["Mail"], ""};
				{ 4, "PVP80ClassItems", "Spell_Frost_SummonWaterElemental", "=ds="..BabbleInventory["Relic"], "" };
				{ 17, "PVP80NonSet#4", "INV_Boots_08", "=ds="..BabbleInventory["Leather"], ""};
				{ 18, "PVP80NonSet#6", "INV_Boots_Plate_04", "=ds="..BabbleInventory["Plate"], ""};
			};
		};
		info = {
