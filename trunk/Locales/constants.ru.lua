...
if AL then
	...
	AL["Comparison TT"] = "Сравнительные ПДСКИ";
	...
	AL["Use GameTooltip"] = "Исп. игровую подсказку";
	...
	AL["Sort loottable by Instance"] = "Сортировка таблици добычи по подземельям";
	AL["Sort by Boss"] = "Сорт по боссам";
	AL["Sort loottable by Boss"] = "Сортировка таблици добычи по боссам";
	...
	-- Tier 11 Sets
	AL["Stormrider's Vestments"] = "Одежды странника бурь";
	AL["Stormrider's Battlegarb"] = "Военное облачение странника бурь";
	AL["Stormrider's Regalia"] = "Регалии странника бурь";
	AL["Lightning-Charged Battlegear"] = "Заряженная молнией броня";
	AL["Firelord's Vestments"] = "Одежды повелителя огня";
	AL["Reinforced Sapphirium Regalia"] = "Усиленные сапфировые регалии";
	AL["Reinforced Sapphirium Battlearmor"] = "Усиленные сапфировые латы";
	AL["Reinforced Sapphirium Battleplate"] = "Усиленный сапфировый боевой доспех";
	AL["Mercurial Regalia"] = "Регалии переменчивости";
	AL["Mercurial Vestments"] = "Одежды переменчивости";
	AL["Wind Dancer's Regalia"] = "Регалии танцующего с ветром";
	AL["Vestments of the Raging Elements"] = "Одежды бушующих стихий";
	AL["Battlegear of the Raging Elements"] = "Броня бушующих стихий";
	AL["Regalia of the Raging Elements"] = "Регалии бушующих стихий";
	AL["Shadowflame Regalia"] = "Регалии пламени Тьмы";
	AL["Earthen Warplate"] = "Боевые латы земли";
	AL["Earthen Battleplate"] = "Боевой доспех земли";
	AL["Magma Plated Battlegear"] = "Магматическая броня";
	AL["Magma Plated Battlearmor"] = "Магматические латы";
