...
------------------------
	...
	AtlasLoot_TableNames["Mounts11"] = { BabbleFaction["Alliance"].." "..AL["Mounts"].." - "..AL["Original WoW"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Mounts12"] = { BabbleFaction["Horde"].." "..AL["Mounts"].." - "..AL["Original WoW"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Mounts13"] = { AL["Mounts"].." - "..AL["Original WoW"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Mounts21"] = { AL["Mounts"].." - "..AL["Burning Crusade"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["Mounts22"] = { AL["Mounts"].." - "..AL["Burning Crusade"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["Mounts23"] = { AL["Mounts"].." - "..AL["Burning Crusade"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["Mounts24"] = { AL["Mounts"].." - "..AL["Burning Crusade"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["Mounts25"] = { AL["Mounts"].." - "..AL["Burning Crusade"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["Mounts31"] = { AL["Mounts"].." - "..AL["Wrath of the Lich King"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Mounts32"] = { AL["Mounts"].." - "..AL["Wrath of the Lich King"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Mounts33"] = { AL["Mounts"].." - "..AL["Wrath of the Lich King"], "AtlasLootWotLK" };
