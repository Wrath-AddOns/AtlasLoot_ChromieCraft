...
---- Jewelcrafting
    ...
    AtlasLoot_Data["JewelRed1"] ={
        ...
        { 18, "s28907", "23097", "=q2=Delicate Blood Garnet", "=ds=#sr# 325"};
        { 19, "s28906", "23096", "=q2=Runed Blood Garnet", "=ds=#sr# 315"};
        { 20, "s28905", "23095", "=q2=Bold Blood Garnet", "=ds=#sr# 305"};
		{ 21, "s34590", "28595", "=q2=Bright Blood Garnet", "=ds=#sr# 305"};
        { 22, "s28903", "23094", "=q2=Teardrop Blood Garnet", "=ds=#sr# 300"};
    ...
    AtlasLoot_Data["JewelYellow1"] = {
        ...
        { 20, "s39451", "31860", "=q2=Great Golden Draenite", "=ds=#sr# 325"};
        { 21, "s28948", "23116", "=q2=Rigid Golden Draenite", "=ds=#sr# 325"};
		{ 22, "s34069", "28290", "=q2=Smooth Golden Draenite", "=ds=#sr# 325"};
        { 23, "s28947", "23115", "=q2=Thick Golden Draenite", "=ds=#sr# 315"};
        { 24, "s28944", "23114", "=q2=Gleaming Golden Draenite", "=ds=#sr# 305"};
        { 25, "s28938", "23113", "=q2=Brilliant Golden Draenite", "=ds=#sr# 300"};
        Back = "JEWELCRAFTINGMENU";
    };
    ...
    AtlasLoot_Data["JewelGreen1"] = {
        ...
        { 13, "s28924", "23106", "=q2=Dazzling Deep Peridot", "=ds=#sr# 325"};
        { 14, "s28918", "23105", "=q2=Enduring Deep Peridot", "=ds=#sr# 315"};
        { 15, "s28917", "23104", "=q2=Jagged Deep Peridot", "=ds=#sr# 305"};
        { 16, "s28916", "23103", "=q2=Radiant Deep Peridot", "=ds=#sr# 300"};
        Back = "JEWELCRAFTINGMENU";
    };
    ...
    AtlasLoot_Data["JewelOrange1"] = {
        ...
        { 15, "s28915", "23101", "=q2=Potent Flame Spessarite", "=ds=#sr# 325"};
    ...
    AtlasLoot_Data["JewelPurple1"] = {
        ...
        { 15, "s41420", "32833", "=q2=Purified Jaggal Pearl", "=ds=#sr# 325"};
    ...
    AtlasLoot_Data["JewelRing1"] = {
        ...
        { 6, "s31057", "24086", "=q3=Arcane Khorium Band", "=ds=#sr# 365"};
		{ 7, "s31061", "24089", "=q3=Blazing Eternium Band", "=ds=#sr# 365"};
        { 8, "s31056", "24085", "=q3=Khorium Band of Leaves", "=ds=#sr# 360"};
        { 9, "s37855", "30825", "=q3=Ring of Arcane Shielding", "=ds=#sr# 360"};
        { 10, "s31060", "24088", "=q3=Delicate Eternium Ring", "=ds=#sr# 355"};
		{ 11, "s31054", "24080", "=q3=Khorium Band of Frost", "=ds=#sr# 355"};
		{ 12, "s31055", "24082", "=q3=Khorium Inferno Band", "=ds=#sr# 355"};
        { 13, "s31053", "24079", "=q3=Khorium Band of Shadows", "=ds=#sr# 350"};
        { 14, "s31058", "24087", "=q3=Heavy Felsteel Ring", "=ds=#sr# 345"};
        { 15, "s41415", "32774", "=q3=The Black Pearl", "=ds=#sr# 330"};
        { 16, "s41414", "32772", "=q3=Brilliant Pearl Band", "=ds=#sr# 325"};
        { 17, "s26916", "21779", "=q3=Band of Natural Fire", "=ds=#sr# 310"};
        { 18, "s26903", "21768", "=q3=Sapphire Signet", "=ds=#sr# 275"};
        { 19, "s26896", "21753", "=q3=Gem Studded Band", "=ds=#sr# 250"};
        { 20, "s26874", "20964", "=q3=Aquamarine Signet", "=ds=#sr# 210"};
        { 21, "s34959", "29158", "=q3=Truesilver Commander's Ring", "=ds=#sr# 200"};
        { 22, "s34955", "29157", "=q3=Golden Ring of Power", "=ds=#sr# 180"};
        { 23, "s37818", "30804", "=q3=Bronze Band of Force", "=ds=#sr# 65"};
        { 24, "s25305", "20826", "=q3=Heavy Silver Ring", "=ds=#sr# 90"};
        { 25, "s31052", "24078", "=q2=Heavy Adamantite Ring", "=ds=#sr# 335"};
        { 26, "s31050", "24076", "=q2=Azure Moonstone Ring", "=ds=#sr# 320"};
		{ 27, "s31048", "24074", "=q2=Fel Iron Blood Ring", "=ds=#sr# 310"};
		{ 28, "s31049", "24075", "=q2=Golden Draenite Ring", "=ds=#sr# 310"};
        { 29, "s34961", "29160", "=q2=Emerald Lion Ring", "=ds=#sr# 290"};
        { 30, "s26910", "21778", "=q2=Ring of Bitter Shadows", "=ds=#sr# 285"};
        Next = "JewelRing2";
        Back = "JEWELCRAFTINGMENU";
    };
    
    AtlasLoot_Data["JewelRing2"] = {
        { 1, "s34960", "29159", "=q2=Glowing Thorium Band", "=ds=#sr# 280"};
        { 2, "s26907", "21775", "=q2=Onslaught Ring", "=ds=#sr# 280"};
        { 3, "s36526", "30422", "=q2=Diamond Focus Ring", "=ds=#sr# 265"};
        { 4, "s26902", "21767", "=q2=Simple Opal Ring", "=ds=#sr# 260"};
        { 5, "s26887", "21754", "=q2=The Aquamarine Ward", "=ds=#sr# 245"};
        { 6, "s26885", "21765", "=q2=Truesilver Healing Ring", "=ds=#sr# 240"};
        { 7, "s36525", "30421", "=q2=Red Ring of Destruction", "=ds=#sr# 230"};
        { 8, "s25621", "20961", "=q2=Citrine Ring of Rapid Healing", "=ds=#sr# 180"};
        { 9, "s25620", "20960", "=q2=Engraved Truesilver Ring", "=ds=#sr# 170"};
        { 10, "s25619", "20959", "=q2=The Jade Eye", "=ds=#sr# 170"};
        { 11, "s25617", "20958", "=q2=Blazing Citrine Ring", "=ds=#sr# 150"};
        { 12, "s25613", "20955", "=q2=Golden Dragon Ring", "=ds=#sr# 135"};
        { 13, "s25323", "20833", "=q2=Wicked Moonstone Ring", "=ds=#sr# 125"};
        { 14, "s36524", "30420", "=q2=Heavy Jade Ring", "=ds=#sr# 105"};        
        { 15, "s25318", "20828", "=q2=Ring of Twilight Shadows", "=ds=#sr# 100"};
        { 16, "s25317", "20827", "=q2=Ring of Silver Might", "=ds=#sr# 80"};
        { 17, "s25287", "20823", "=q2=Gloom Band", "=ds=#sr# 70"};
        { 18, "s25284", "20820", "=q2=Simple Pearl Ring", "=ds=#sr# 60"};
        { 19, "s25490", "20907", "=q2=Solid Bronze Ring", "=ds=#sr# 50"};
        { 20, "s25280", "20818", "=q2=Elegant Silver Ring", "=ds=#sr# 50"};
        { 21, "s25283", "20821", "=q2=Inlaid Malachite Ring", "=ds=#sr# 30"};
        { 22, "s32179", "25439", "=q2=Tigerseye Band", "=ds=#sr# 20"};
        { 23, "s26926", "21932", "=q2=Heavy Copper Ring", "=ds=#sr# 5"};
        { 24, "s25493", "20906", "=q2=Braided Copper Ring", "=ds=#sr# 1"};
        { 25, "s26925", "21931", "=q2=Woven Copper Ring", "=ds=#sr# 1"};
        Prev = "JewelRing1";
        Back = "JEWELCRAFTINGMENU";
    };
    ...
    AtlasLoot_Data["JewelNeck1"] = {
        ...
        { 19, "s31051", "24077", "=q2=Thick Adamantite Necklace", "=ds=#sr# 335"};
        { 20, "s26908", "21790", "=q2=Sapphire Pendant of Winter Night", "=ds=#sr# 280"};
        { 21, "s26883", "21764", "=q2=Ruby Pendant of Fire", "=ds=#sr# 235"};
        { 22, "s26876", "21755", "=q2=Aquamarine Pendant of the Warrior", "=ds=#sr# 220"};
        { 23, "s25622", "20967", "=q2=Citrine Pendant of Golden Healing", "=ds=#sr# 190"};
        { 24, "s25618", "20966", "=q2=Jade Pendant of Blasting", "=ds=#sr# 160"};
        { 25, "s25320", "20831", "=q2=Heavy Golden Necklace of Battle", "=ds=#sr# 150"};
        { 26, "s25610", "20950", "=q2=Pendant of the Agate Shield", "=ds=#sr# 120"};
        { 27, "s25339", "20830", "=q2=Amulet of the Moon", "=ds=#sr# 110"};
		{ 28, "s25498", "20909", "=q2=Barbaric Iron Collar", "=ds=#sr# 110"};
        { 29, "s38175", "31154", "=q2=Bronze Torc", "=ds=#sr# 80"};
        { 30, "s36523", "30419", "=q2=Brilliant Necklace", "=ds=#sr# 75"};
        Next = "JewelNeck2";
        Back = "JEWELCRAFTINGMENU";
    };
    
    AtlasLoot_Data["JewelNeck2"] = {
        { 1, "s26927", "21933", "=q2=Thick Bronze Necklace", "=ds=#sr# 50"};
        { 2, "s26928", "21934", "=q2=Ornate Tigerseye Necklace", "=ds=#sr# 30"};
        { 3, "s32178", "25438", "=q2=Malachite Pendant", "=ds=#sr# 20"};
        Prev = "JewelNeck1";
        Back = "JEWELCRAFTINGMENU";
    };
    ...
    AtlasLoot_Data["JewelMisc1"] = {
        ...
        { 9, "s25612", "20954", "=q2=Heavy Iron Knuckles", "=ds=#sr# 125"};
        { 10, "s26880", "21752", "=q1=Thorium Setting", "=ds=#sr# 225"};
        { 11, "s32809", "25883", "=q1=Dense Stone Statue", "=ds=#sr# 225"};
        { 12, "s32808", "25882", "=q1=Solid Stone Statue", "=ds=#sr# 175"};
        { 13, "s25615", "20963", "=q1=Mithril Filigree", "=ds=#sr# 150"};
        { 14, "s32807", "25881", "=q1=Heavy Stone Statue", "=ds=#sr# 110"};
        { 15, "s25278", "20817", "=q1=Bronze Setting", "=ds=#sr# 50"};
        { 16, "s32801", "25880", "=q1=Coarse Stone Statue", "=ds=#sr# 50"};
        { 17, "s25255", "20816", "=q1=Delicate Copper Wire", "=ds=#sr# 1"};
        { 18, "s32259", "25498", "=q1=Rough Stone Statue", "=ds=#sr# 1"};
        Back = "JEWELCRAFTINGMENU";
    };
