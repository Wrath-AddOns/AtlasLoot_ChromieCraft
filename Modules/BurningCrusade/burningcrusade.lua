...
--- World Bosses
	...
	AtlasLoot_Data["PvP70NonSet1"] = {
		...
		{ 23, 35129, "", "=q4=Guardian's Band of Dominance", "=ds=", "15300 #faction# 10 #av# #reqrating# 1650", ""};
		{ 24, 35130, "", "=q4=Guardian's Band of Salvation", "=ds=", "15300 #faction# 10 #av# #reqrating# 1650", ""};
		{ 25, 37927, "", "=q4=Guardian's Band of Subjugation", "=ds=", "15300 #faction# 10 #av# #reqrating# 1650", ""};
		{ 26, 35131, "", "=q4=Guardian's Band of Triumph", "=ds=", "15300 #faction# 10 #av# #reqrating# 1650", ""};
	...
	AtlasLoot_Data["PvP70NonSet2"] = {
		{ 1, 35168, "", "=q4=Guardian's Dreadweave Cuffs", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 2, 35153, "", "=q4=Guardian's Dreadweave Belt", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 3, 35138, "", "=q4=Guardian's Dreadweave Stalkers", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
		{ 5, 35174, "", "=q4=Guardian's Mooncloth Cuffs", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 6, 35159, "", "=q4=Guardian's Mooncloth Belt", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 7, 35144, "", "=q4=Guardian's Mooncloth Slippers", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
		{ 9, 35179, "", "=q4=Guardian's Silk Cuffs", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 10, 35164, "", "=q4=Guardian's Silk Belt", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 11, 35149, "", "=q4=Guardian's Silk Footguards", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
	...
	AtlasLoot_Data["PvP70NonSet3"] = {
		{ 1, 35167, "", "=q4=Guardian's Dragonhide Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 2, 35152, "", "=q4=Guardian's Dragonhide Belt", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 3, 35137, "", "=q4=Guardian's Dragonhide Boots", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
		{ 5, 35169, "", "=q4=Guardian's Kodohide Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 6, 35154, "", "=q4=Guardian's Kodohide Belt", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 7, 35139, "", "=q4=Guardian's Kodohide Boots", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
		{ 9, 35171, "", "=q4=Guardian's Leather Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 10, 35156, "", "=q4=Guardian's Leather Belt", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 11, 35141, "", "=q4=Guardian's Leather Boots", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
		{ 13, 35180, "", "=q4=Guardian's Wyrmhide Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 14, 35165, "", "=q4=Guardian's Wyrmhide Belt", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 15, 35150, "", "=q4=Guardian's Wyrmhide Boots", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
	...
	AtlasLoot_Data["PvP70NonSet4"] = {
		{ 1, 35166, "", "=q4=Guardian's Chain Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 2, 35151, "", "=q4=Guardian's Chain Girdle", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 3, 35136, "", "=q4=Guardian's Chain Sabatons", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
		{ 5, 35172, "", "=q4=Guardian's Linked Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 6, 35157, "", "=q4=Guardian's Linked Girdle", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 7, 35142, "", "=q4=Guardian's Linked Sabatons", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
		{ 9, 35173, "", "=q4=Guardian's Mail Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 10, 35158, "", "=q4=Guardian's Mail Girdle", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 11, 35143, "", "=q4=Guardian's Mail Sabatons", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
		{ 13, 35177, "", "=q4=Guardian's Ringmail Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 14, 35162, "", "=q4=Guardian's Ringmail Girdle", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 15, 35147, "", "=q4=Guardian's Ringmail Sabatons", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
	...
	AtlasLoot_Data["PvP70NonSet5"] = {
		{ 1, 35170, "", "=q4=Guardian's Lamellar Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 2, 35155, "", "=q4=Guardian's Lamellar Belt", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 3, 35140, "", "=q4=Guardian's Lamellar Greaves", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
		{ 5, 35175, "", "=q4=Guardian's Ornamented Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 6, 35160, "", "=q4=Guardian's Ornamented Belt", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 7, 35145, "", "=q4=Guardian's Ornamented Greaves", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
		{ 9, 35176, "", "=q4=Guardian's Plate Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 10, 35161, "", "=q4=Guardian's Plate Belt", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 11, 35146, "", "=q4=Guardian's Plate Greaves", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
		{ 13, 35178, "", "=q4=Guardian's Scaled Bracers", "=ds=", "11794 #faction# 20 #wsg# #reqrating# 1575", ""};
		{ 14, 35163, "", "=q4=Guardian's Scaled Belt", "=ds=", "17850 #faction# 40 #ab#", ""};
		{ 15, 35148, "", "=q4=Guardian's Scaled Greaves", "=ds=", "17850 #faction# 40 #eos# #reqrating# 1700", ""};
	...
	AtlasLoot_Data["TBCSets"] = {
		...
		{ 16, 0, "INV_Box_01", "=q6=#bcs2#", "=q2=#n137#, =q1=#z18#"};
	...
	AtlasLoot_Data["Mounts21"] = {
		...
		{ 21, 29744, "", "=q3=Blue Hawkstrider", "=ds=#e12#"};
	...
	AtlasLoot_Data["Mounts24"] = {
		...
		{ 24, 29228, "", "=q4=Reins of the Dark War Talbuk", "=ds=#e12#"};
		Next = "Mounts25";
		Prev = "Mounts23";
		Back = "MOUNTMENU";
	};
	...
	AtlasLoot_Data["Mounts25"] = {
		...
		{ 9, 0, "INV_Box_01", "=q6=#j31#", ""};
		{ 10, 38576, "", "=q4=Big Battle Bear", "=q2=#m24#"};
		{ 11, 33225, "", "=q4=Reins of the Swift Spectral Tiger", "=q2=#m24#"};
		{ 12, 35226, "", "=q4=X-51 Nether-Rocket X-TREME", "=q2=#m24#"};
		{ 13, 33224, "", "=q3=Reins of the Spectral Tiger", "=q2=#m24#"};
		{ 14, 35225, "", "=q3=X-51 Nether-Rocket", "=q2=#m24#"};
		...
		{ 21, 33182, "", "=q4=Swift Flying Broom", "=q2=#n136#"};
		{ 22, 33184, "", "=q4=Swift Magic Broom", "=q2=#n136#"};
		{ 23, 33176, "", "=q3=Flying Broom", "=q2=#n136#"};
		{ 24, 37011, "", "=q3=Magic Broom", "=q2=#n136#"};
		{ 25, 33189, "", "=q2=Rickety Magic Broom", "=q2=#n136#"};
		{ 27, 0, "INV_Box_01", "=q6=#j32#", ""};
		{ 28, 34061, "", "=q4=Turbo-Charged Flying Machine Control", "=ds=#p5#"};
		{ 29, 34060, "", "=q3=Flying Machine Control", "=ds=#p5#"};
		Prev = "Mounts24";
		Back = "MOUNTMENU";
	};
