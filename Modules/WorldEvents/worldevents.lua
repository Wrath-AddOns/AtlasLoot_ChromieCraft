...
---- Scourge Invasion
    ...
    AtlasLoot_Data["ArgentTournament3"] = {
        { 2, 45590, "", "=q4=Great Azuremyst Elekk", "=ds=#e12#", "100 #champseal#"};
		{ 3, 45591, "", "=q4=Swift Darnassus Mistsaber", "=ds=#e12#", "100 #champseal#"};
		{ 4, 45586, "", "=q4=Swift Ironforge Ram", "=ds=#e12#", "100 #champseal#"};
		{ 5, 45125, "", "=q4=Swift Stormwind Steed", "=ds=#e12#", "100 #champseal#"};
		{ 6, 45589, "", "=q4=Turbostrider", "=ds=#e12#", "100 #champseal#"};
		{ 8, 45592, "", "=q4=Great Mulgore Kodo", "=ds=#e12#", "100 #champseal#"};
		{ 9, 45596, "", "=q4=Swift Silvermoon Hawkstrider", "=ds=#e12#", "100 #champseal#"};
		{ 10, 45593, "", "=q4=Swift Darkspear Raptor", "=ds=#e12#", "100 #champseal#"};
		{ 11, 45597, "", "=q4=Swift Forsaken Warhorse", "=ds=#e12#", "100 #champseal#"};
		{ 12, 45595, "", "=q4=Swift Orgrimmar Wolf", "=ds=#e12#", "100 #champseal#"};
        { 14, 45725, "", "=q4=Argent Hippogryph", "=ds=#e12#", "250 #champseal#"};
        { 17, 44970, "", "=q3=Dun Morogh Cub", "=ds=#e13#", "40 #champseal#"};
		{ 18, 44984, "", "=q3=Ammen Vale Lashling", "=ds=#e13#", "40 #champseal#"};
		{ 19, 44974, "", "=q3=Elwynn Lamb", "=ds=#e13#", "40 #champseal#"};
		{ 20, 45002, "", "=q3=Mechanopeep", "=ds=#e13#", "40 #champseal#"};
		{ 21, 44965, "", "=q3=Teldrassil Sproutling", "=ds=#e13#", "40 #champseal#"};
        { 23, 44980, "", "=q3=Mulgore Hatchling", "=ds=#e13#", "40 #champseal#"};
		{ 24, 44982, "", "=q3=Enchanted Broom", "=ds=#e13#", "40 #champseal#"};
		{ 25, 45606, "", "=q3=Sen'jin Fetish", "=ds=#e13#", "40 #champseal#"};
		{ 26, 44971, "", "=q3=Tirisfal Batling", "=ds=#e13#", "40 #champseal#"};
		{ 27, 44973, "", "=q3=Durotar Scorpion", "=ds=#e13#", "40 #champseal#"};
