...
---- Scourge Invasion
	...
	AtlasLoot_Data["ArgentTournament1"] = {
		...
		{ 7, 45581, "", "=q1=Orgrimmar Tabard", "=ds=#s7#"};
		{ 8, 45583, "", "=q1=Undercity Tabard", "=ds=#s7#"};
		{ 9, 45584, "", "=q1=Thunder Bluff Tabard", "=ds=#s7#"};
		{ 10, 45582, "", "=q1=Sen'jin Tabard", "=ds=#s7#"};
		{ 11, 45585, "", "=q1=Silvermoon City Tabard", "=ds=#s7#"};
		...
		{ 22, 45014, "", "=q1=Orgrimmar Banner", "=ds="};
		{ 23, 45016, "", "=q1=Undercity Banner", "=ds="};
		{ 24, 45013, "", "=q1=Thunder Bluff Banner", "=ds="};
		{ 25, 45015, "", "=q1=Sen'jin Banner", "=ds="};
		{ 26, 45017, "", "=q1=Silvermoon City Banner", "=ds="};
	...
	AtlasLoot_Data["ArgentTournament2"] = {
		...
		{ 22, 45592, "", "=q4=Great Mulgore Kodo", "=ds=#e12#"};
		{ 23, 0, "", "=q4=Stabled Silvermoon Hawkstrider", "=ds=#e12#"};
		{ 24, 45593, "", "=q4=Swift Darkspear Raptor", "=ds=#e12#"};
		{ 25, 45597, "", "=q4=Swift Forsaken Warhorse", "=ds=#e12#"};
		{ 26, 45595, "", "=q4=Swift Orgrimmar Wolf", "=ds=#e12#"};
