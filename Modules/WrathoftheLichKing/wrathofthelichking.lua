...
---- Emblem of Frost Items
	...
	AtlasLoot_Data["TrialoftheChampionBlackKnightHEROIC"] = {
		...
		{ 25, 48418, "", "=q1=Fragment of the Black Knight's Soul", "=ds=#m3#", "", "100%"};
		Prev = "TrialoftheChampionEadricthePure";
	};
	...
	AtlasLoot_Data["FoSBronjahm"] = {
		...
		{ 8, 49783, "", "=q4=Lucky Old Sun", "=ds=#h1#, #w6#"};
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
		...
		{ 21, 50196, "", "=q4=Love's Prisoner", "=ds=#s2#"};
		{ 23, 50191, "", "=q4=Nighttime", "=ds=#h1#, #w1#"};
		{ 24, 50169, "", "=q4=Papa's Brand New Knife", "=ds=#w11#"};
		Next = "FoSDevourer";
	};
...
--Plate
	...
	AtlasLoot_Data["PetsRare1"] = {
		...
		{ 13, 44810, "", "=q3=Turkey Cage", "=ds=#e13#"};
		{ 14, 44819, "", "=q1=Baby Blizzard Bear", "=ds=#e13#"};
		{ 15, 49362, "", "=q1=Onyxian Whelpling", "=ds=#e13#"};
