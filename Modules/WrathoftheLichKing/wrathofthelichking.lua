...
---- Emblem of Conquest Items
	...
	AtlasLoot_Data["UlduarIronCouncil"] = {
		...
		{ 20, 45449, "", "=q4=The Masticator", "=ds=#h3#, #w13#"};
		{ 21, 45448, "", "=q4=Perilous Bite", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["UlduarIronCouncil25Man"] = {
		...
		{ 22, 45241, "", "=q4=Belt of Colossal Rage", "=ds=#s10#, #a4#"};
		{ 23, 45857, "", "=q4=Archivum Data Disc", "=ds=#m2#"};
	...
	AtlasLoot_Data["UlduarThorim25Man"] = {
		...
		{ 16, 45638, "", "=q4=Crown of the Wayward Conqueror", "=ds=#e15#"};
		{ 17, 45639, "", "=q4=Crown of the Wayward Protector", "=ds=#e15#"};
		{ 18, 45640, "", "=q4=Crown of the Wayward Vanquisher", "=ds=#e15#"};
	...
	AtlasLoot_Data["UlduarFreya"] = {
		...
		{ 6, 46110, "", "=q3=Alchemist's Cache", "=ds=#p1# (425)"};
		{ 8, 45644, "", "=q4=Gloves of the Wayward Conqueror", "=ds=#e15#"};		
		{ 9, 45645, "", "=q4=Gloves of the Wayward Protector", "=ds=#e15#"};
		{ 10, 45646, "", "=q4=Gloves of the Wayward Vanquisher", "=ds=#e15#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
	...
	AtlasLoot_Data["UlduarFreya25Man"] = {
		...
		{ 17, 45654, "", "=q4=Legplates of the Wayward Protector", "=ds=#e15#"};
		{ 18, 45655, "", "=q4=Legplates of the Wayward Vanquisher", "=ds=#e15#"};
	...
	AtlasLoot_Data["UlduarVezax"] = {
		...
		{ 6, 46008, "", "=q4=Choker of the Abyss", "=ds=#s2#"};
		{ 7, 46015, "", "=q4=Pendant of Endless Despair", "=ds=#s2#"};
		{ 8, 46010, "", "=q4=Darkstone Ring", "=ds=#s13#"};
		{ 9, 46011, "", "=q4=Shadowbite", "=ds=#h1#, #w4#"};
		{ 10, 45996, "", "=q4=Hoperender", "=ds=#w7#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
	...
	AtlasLoot_Data["UlduarYoggSaron"] = {
		...
		{ 8, 46025, "", "=q4=Devotion", "=ds=#w9#"};
		{ 9, 46031, "", "=q4=Touch of Madness", "=ds=#h1#, #w1#"};
	...
	AtlasLoot_Data["UlduarYoggSaron25Man"] = {
		...
		{ 7, 45531, "", "=q4=Chestguard of the Fallen God", "=ds=#s5#, #a3#"};
		{ 8, 45524, "", "=q4=Chestguard of Insidious Intent", "=ds=#s5#, #a3#"};
		{ 9, 45525, "", "=q4=Godbane Signet", "=ds=#s13#"};
		{ 10, 45530, "", "=q4=Sanity's Bond", "=ds=#s13#"};
		{ 11, 45522, "", "=q4=Blood of the Old God", "=ds=#s14#"};
		{ 12, 45527, "", "=q4=Soulscribe", "=ds=#w4#"};
...
--Plate
	...
	AtlasLoot_Data["PetsMerchant1"] = {
		...
		{ 15, 29901, "", "=q1=Blue Moth Egg", "=ds="};
		{ 16, 29364, "", "=q1=Brown Rabbit Crate", "=ds="};
		{ 17, 8485, "", "=q1=Cat Carrier (Bombay)", "=ds="};
		{ 18, 8486, "", "=q1=Cat Carrier (Cornish Rex)", "=ds="};
		{ 19, 8487, "", "=q1=Cat Carrier (Orange Tabby)", "=ds="};
		{ 20, 8490, "", "=q1=Cat Carrier (Siamese)", "=ds="};
		{ 21, 8488, "", "=q1=Cat Carrier (Silver Tabby)", "=ds="};
		{ 22, 8489, "", "=q1=Cat Carrier (White Kitten)", "=ds="};
		{ 23, 10393, "", "=q1=Cockroach", "=ds="};
		{ 24, 10392, "", "=q1=Crimson Snake", "=ds="};
		{ 25, 29953, "", "=q1=Golden Dragonhawk Hatchling", "=ds="};
		{ 26, 8500, "", "=q1=Great Horned Owl", "=ds="};
		{ 27, 8501, "", "=q1=Hawk Owl", "=ds="};
		{ 28, 29363, "", "=q1=Mana Wyrmling", "=ds="};
		{ 29, 8496, "", "=q1=Parrot Cage (Cockatiel)", "=ds="};
		{ 30, 8492, "", "=q1=Parrot Cage (Green Wing Macaw)", "=ds="};
		Next = "PetsMerchant2";
		Back = "PETMENU";
	};

	AtlasLoot_Data["PetsMerchant2"] = {
		{ 1, 8495, "", "=q1=Parrot Cage (Senegal)", "=ds="};
		{ 2, 10394, "", "=q1=Prairie Dog Whistle", "=ds="};
		{ 3, 8497, "", "=q1=Rabbit Crate (Snowshoe)", "=ds="};
		{ 4, 29956, "", "=q1=Red Dragonhawk Hatchling", "=ds="};
		{ 5, 29902, "", "=q1=Red Moth Egg", "=ds="};
		{ 6, 29957, "", "=q1=Silver Dragonhawk Hatchling", "=ds="};
		{ 7, 11026, "", "=q1=Tree Frog Box", "=ds="};
		{ 8, 29904, "", "=q1=White Moth Egg", "=ds="};
	...
	AtlasLoot_Data["PetsRare1"] = {
		...
		{ 25, 29958, "", "=q1=Blue Dragonhawk Hatchling", "=ds="};
		{ 26, 10822, "", "=q1=Dark Whelpling", "=ds="};
		{ 27, 20769, "", "=q1=Disgusting Oozeling", "=ds="};
		{ 28, 29960, "", "=q1=Captured Firefly", "=ds="};
		{ 29, 8491, "", "=q1=Cat Carrier (Black Tabby)", "=ds="};
		{ 30, 27445, "", "=q1=Magical Crawdad Box", "=ds="};
	...
	AtlasLoot_Data["PetsRare2"] = {
		{ 1, 8494, "", "=q1=Parrot Cage (Hyacinth Macaw)", "=ds="};
		{ 2, 8499, "", "=q1=Tiny Crimson Whelpling", "=ds="};
		{ 3, 8498, "", "=q1=Tiny Emerald Whelpling", "=ds="};
		Prev = "PetsRare1";
		Next = "PetsEvent1";
		Back = "PETMENU";
	};
	...
	AtlasLoot_Data["PetsPromotional1"] = {
		...
		{ 9, 25535, "", "=q3=Netherwhelp's Collar", "=ds="};
		{ 10, 13583, "", "=q3=Panda Collar", "=ds="};
		{ 11, 22114, "", "=q3=Pink Murloc Egg", "=ds="};
		{ 12, 34492, "", "=q3=Rocket Chicken", "=ds="};
		{ 13, 38050, "", "=q3=Soul-Trader Beacon", "=ds="};
		{ 14, 39656, "", "=q3=Tyrael's Hilt", "=ds="};
		{ 15, 13582, "", "=q3=Zergling Leash", "=ds="};
		Prev = "PetsEvent1";
		Back = "PETMENU";
	};
