...
---- Emblem of Triumph Items
	...
	AtlasLoot_Data["TrialoftheCrusaderTribute_AHEROIC"] = {
		...
		{ 13, 49044, "", "=q4=Swift Alliance Steed", "=ds=#e12# =ec1=#m7#"};
	...
	AtlasLoot_Data["Onyxia_125Man"] = {
        ...
        { 17, 49467, "", "=q4=Frostforged Greathelm", "=ds=#s1#, #a4#", "" };
	...
	AtlasLoot_Data["Onyxia_225Man"] = {
		{ 1, 49500, "", "=q4=Raging Deathbringer", "=ds=#h1# #w1#", "" };
        { 2, 49465, "", "=q4=Tarnished Gutgore Ripper", "=ds=#h1# #w4#", "" };
        { 3, 49495, "", "=q4=Burnished Quel'Serrar", "=ds=#h1# #w10#", "" };
        { 4, 49501, "", "=q4=Tempered Vis'kag the Bloodletter", "=ds=#h1# #w10#", "" };
        { 5, 49494, "", "=q4=Honed Fang of the Mystics", "=ds=#h3# #w4#", "" };
        { 6, 49499, "", "=q4=Polished Azuresong Mageblade", "=ds=#h3# #w10#", "" };
        { 7, 49496, "", "=q4=Reinforced Shadowstrike", "=ds=#w7#", "" };
        { 8, 49497, "", "=q4=Reinforced Thunderstrike", "=ds=#w7#", "" };
        { 9, 49498, "", "=q4=Sharpened Obsidian Edged Blade", "=ds=#h2# #w10#", "" };
...
--Plate
	...
	AtlasLoot_Data["RelentlessGladiatorWeapons1"] = {
		...
		{ 20, 49191, "", "=q4=Relentless Gladiator's Blade of Celerity", "=ds=#h3#, #w4#", "3585 #arena# #reqrating# 2200"};
	...
	AtlasLoot_Data["PvP80ClassItems1"] = {
		...
		{ 6, 42589, "", "=q4=Furious Gladiator's Idol of Resolve", "6400 #faction# 350 #arena# #reqrating# 700"};
		{ 7, 42584, "", "=q4=Furious Gladiator's Idol of Steadfastness", "6400 #faction# 350 #arena# #reqrating# 700"};
		{ 8, 42579, "", "=q4=Furious Gladiator's Idol of Tenacity", "6400 #faction# 350 #arena# #reqrating# 700"};
		{ 10, 42588, "", "=q4=Deadly Gladiator's Idol of Resolve", "15300 #faction#"};
		{ 11, 42583, "", "=q4=Deadly Gladiator's Idol of Steadfastness", "15300 #faction#"};
		{ 12, 42578, "", "=q4=Deadly Gladiator's Idol of Tenacity", "15300 #faction#"};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleInventory["Librams"], ""};
		{ 17, 42854, "", "=q4=Relentless Gladiator's Libram of Fortitude", "=ds=#w16#", "1150 #arena# #reqrating# 1800"};
		{ 18, 42616, "", "=q4=Relentless Gladiator's Libram of Justice", "=ds=#w16#", "1150 #arena# #reqrating# 1800"};
		...
		{ 23, 42852, "", "=q4=Deadly Gladiator's Libram of Fortitude", "15300 #faction#"};
		{ 24, 42614, "", "=q4=Deadly Gladiator's Libram of Justice", "15300 #faction#"};
	...
	AtlasLoot_Data["PvP80ClassItems2"] = {
		...
		{ 2, 42622, "", "=q4=Relentless Gladiator's Sigil of Strife", "=ds=#w21#", "1150 #arena# #reqrating# 1800"};
		{ 4, 42621, "", "=q4=Furious Gladiator's Sigil of Strife", "6400 #faction# 350 #arena# #reqrating# 700"};
		{ 6, 42620, "", "=q4=Deadly Gladiator's Sigil of Strife", "=ds=", "15300 #faction#"};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleInventory["Totems"], ""};
		{ 17, 42609, "", "=q4=Relentless Gladiator's Totem of Indomitability", "=ds=#w15#", "1150 #arena# #reqrating# 1800"};
		{ 18, 42604, "", "=q4=Relentless Gladiator's Totem of Survival", "=ds=#w15#", "1150 #arena# #reqrating# 1800"};
		{ 19, 42599, "", "=q4=Relentless Gladiator's Totem of the Third Wind", "=ds=#w15#", "1150 #arena# #reqrating# 1800"};
		{ 21, 42608, "", "=q4=Furious Gladiator's Totem of Indomitability", "6400 #faction# 350 #arena# #reqrating# 700"};
		{ 22, 42603, "", "=q4=Furious Gladiator's Totem of Survival", "6400 #faction# 350 #arena# #reqrating# 700"};
		{ 23, 42598, "", "=q4=Furious Gladiator's Totem of the Third Wind", "6400 #faction# 350 #arena# #reqrating# 700"};
		{ 25, 42607, "", "=q4=Deadly Gladiator's Totem of Indomitability", "15300 #faction#"};
		{ 26, 42602, "", "=q4=Deadly Gladiator's Totem of Survival", "15300 #faction#"};
		{ 27, 42597, "", "=q4=Deadly Gladiator's Totem of the Third Wind", "15300 #faction#"};
	...
	AtlasLoot_Data["PetsRare1"] = {
		...
		{ 23, 8494, "", "=q4=Parrot Cage (Hyacinth Macaw)", "=ds=#e13#"};
		{ 24, 43698, "", "=q3=Giant Sewer Rat", "=ds=#e13#"};
		{ 25, 34535, "", "=q1=Azure Whelpling", "=ds=#e13#"};
		{ 26, 29960, "", "=q1=Captured Firefly", "=ds=#e13#"};
		{ 27, 8491, "", "=q1=Cat Carrier (Black Tabby)", "=ds=#e13#"};
		{ 28, 10822, "", "=q1=Dark Whelpling", "=ds=#e13#"};
		{ 29, 48112, "", "=q1=Darting Hatchling", "=ds=#e13#"};
		{ 30, 48114, "", "=q1=Deviate Hatchling", "=ds=#e13#"};
	...
	AtlasLoot_Data["PetsRare2"] = {
		{ 1, 20769, "", "=q1=Disgusting Oozeling", "=ds=#e13#"};
		{ 2, 48116, "", "=q1=Gundrak Hatchling", "=ds=#e13#"};
		{ 3, 48118, "", "=q1=Leaping Hatchling", "=ds=#e13#"};
		{ 4, 27445, "", "=q1=Magical Crawdad Box", "=ds=#e13#"};
	...
	AtlasLoot_Data["PetsEvent1"] = {
		...
		{ 13, 21301, "", "=q1=Green Helper Box", "=ds=#e13#"};
		{ 14, 21308, "", "=q1=Jingling Bell", "=ds=#e13#"};
		{ 15, 23007, "", "=q1=Piglet's Collar", "=ds=#e13#"};
		{ 16, 23015, "", "=q1=Rat Cage", "=ds=#e13#"};
		{ 17, 21305, "", "=q1=Red Helper Box", "=ds=#e13#"};
		{ 18, 21309, "", "=q1=Snowman Kit", "=ds=#e13#"};
		{ 19, 22235, "", "=q1=Truesilver Shafted Arrow", "=ds=#e13#"};
		{ 20, 23002, "", "=q1=Turtle Box", "=ds=#e13#"};
		Prev = "PetsRare1";
	...
	AtlasLoot_Data["PetsPromotional1"] = {
		...
		{ 4, 20371, "", "=q3=Blue Murloc Egg", "=ds=#e13#"};
		{ 5, 13584, "", "=q3=Diablo Stone", "=ds=#e13#"};
		{ 6, 39286, "", "=q3=Frosty's Collar", "=ds=#e13#"};
		{ 7, 37297, "", "=q3=Gold Medallion", "=ds=#e13#"};
		{ 8, 46802, "", "=q3=Heavy Murloc Egg", "=ds=#e13#"};
		{ 9, 30360, "", "=q3=Lurky's Egg", "=ds=#e13#"};
		{ 10, 45180, "", "=q3=Murkimus' Little Spear", "=ds=#e13#"};
		{ 11, 25535, "", "=q3=Netherwhelp's Collar", "=ds=#e13#"};
		{ 12, 13583, "", "=q3=Panda Collar", "=ds=#e13#"};
		{ 13, 22114, "", "=q3=Pink Murloc Egg", "=ds=#e13#"};
		{ 14, 34492, "", "=q3=Rocket Chicken", "=ds=#e13#"};
		{ 15, 38050, "", "=q3=Soul-Trader Beacon", "=ds=#e13#"};
		{ 16, 39656, "", "=q3=Tyrael's Hilt", "=ds=#e13#"};
	...
	AtlasLoot_Data["Heirloom2"] = {
		...
		{ 12, 44115, "", "=q7=Wintergrasp Commendation", "=ds=", "30 #wintergrasp#"};
