...
---- Emblem of Conquest Items
	...
	AtlasLoot_Data["UlduarIronCouncil"] = {
		...
		{ 5, 45333, "", "=q4=Belt of the Iron Servant", "=ds=#s10#, #a3#"};
		{ 6, 45321, "", "=q4=Pauldrons of Tempered Will", "=ds=#s5#, #a4#"};
		{ 7, 45329, "", "=q4=Circlet of True Sight", "=ds=#s13#"};
...
--Plate
	...
	AtlasLoot_Data["NaxxDruidBalance"] = {
		...
		{ 20, 46351, "", "=q4=Valorous Nightsong Gloves", "=ds="..BabbleBoss["Mimiron"]};
