...
--Plate
	...
	AtlasLoot_Data["LakeWintergrasp2"] = {
		...
		{ 7, 48997, "", "=q4=Titan-Forged Trousers of Domination", "=ds=#s11#, #a1#", "40 #wintergraspmark#" };
		...
		{ 22, 48991, "", "=q4=Titan-Forged Leggings of Salvation", "=ds=#s11#, #a1#", "40 #wintergraspmark#" };
	...
	AtlasLoot_Data["PetsPetStore1"] = {
		...
		{ 3, 0, "", "=q3=Wind Rider Cub", "=ds=#e13#"};
		{ 4, 0, "", "=q3=Gryphon Hatchling", "=ds=#e13#"};
