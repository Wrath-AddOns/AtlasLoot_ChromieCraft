...
--NO 10-Man loot known
	...
	AtlasLoot_Data["PvP80Warrior"] = {
		...
		{ 26, 40788, "", "=q4=Furious Gladiator's Plate Chestpiece", "=ds=", "2150 #arena# #reqrating# 1750"};
...
--Cloth
	AtlasLoot_Data["PvP80NonSet3"] = {
		...
		{ 16, 41909, "", "=q4=Furious Gladiator's Cuffs of Dominance", "=ds=", "0 #arena# #reqrating# 1400"};
		{ 17, 41898, "", "=q4=Furious Gladiator's Cord of Dominance", "=ds=", "0 #arena# #reqrating# 1450"};
		{ 18, 41903, "", "=q4=Furious Gladiator's Slippers of Dominance", "=ds=", "0 #arena# #reqrating# 1500"};
		{ 20, 41893, "", "=q4=Furious Gladiator's Cuffs of Salvation", "=ds=", "0 #arena# #reqrating# 1400"};
		{ 21, 41881, "", "=q4=Furious Gladiator's Cord of Salvation", "=ds=", "0 #arena# #reqrating# 1450"};
		{ 22, 41885, "", "=q4=Furious Gladiator's Slippers of Salvation", "=ds=", "0 #arena# #reqrating# 1500"};
		Next = "PvP80NonSet4";
		Prev = "PvP80NonSet2";
		Back = "PVP80NONSETEPICS";
	};
...
--Leather
	AtlasLoot_Data["PvP80NonSet4"] = {
		...
		{ 16, 41640, "", "=q4=Furious Gladiator's Armwraps of Dominance", "=ds=", "0 #arena# #reqrating# 1400"};
		{ 17, 41630, "", "=q4=Furious Gladiator's Belt of Dominance", "=ds=", "0 #arena# #reqrating# 1450"};
		{ 18, 41635, "", "=q4=Furious Gladiator's Boots of Dominance", "=ds=", "0 #arena# #reqrating# 1500"};
		{ 20, 0, "", "=q4=", "=ds=", "0 #arena# #reqrating# 1400"};
		{ 21, 41617, "", "=q4=Furious Gladiator's Belt of Salvation", "=ds=", "0 #arena# #reqrating# 1450"};
		{ 22, 41621, "", "=q4=Furious Gladiator's Boots of Salvation", "=ds=", "0 #arena# #reqrating# 1500"};
		{ 24, 41840, "", "=q4=Furious Gladiator's Armwraps of Triumph", "=ds=", "0 #arena# #reqrating# 1400"};
		{ 25, 41832, "", "=q4=Furious Gladiator's Belt of Triumph", "=ds=", "0 #arena# #reqrating# 1450"};
		{ 26, 41836, "", "=q4=Furious Gladiator's Boots of Triumph", "=ds=", "0 #arena# #reqrating# 1500"};
		Next = "PvP80NonSet5";
		Prev = "PvP80NonSet3";
		Back = "PVP80NONSETEPICS";
	};
...
--Mail
	AtlasLoot_Data["PvP80NonSet5"] = {
		...
		{ 16, 41065, "", "=q4=Furious Gladiator's Wristguards of Dominance", "=ds=", "0 #arena# #reqrating# 1400"};
		{ 17, 41070, "", "=q4=Furious Gladiator's Waistguard of Dominance", "=ds=", "0 #arena# #reqrating# 1450"};
		{ 18, 41075, "", "=q4=Furious Gladiator's Sabatons of Dominance", "=ds=", "0 #arena# #reqrating# 1500"};
		{ 20, 41060, "", "=q4=Furious Gladiator's Wristguards of Salvation", "=ds=", "0 #arena# #reqrating# 1400"};
		{ 21, 41051, "", "=q4=Furious Gladiator's Waistguard of Salvation", "=ds=", "0 #arena# #reqrating# 1450"};
		{ 22, 41055, "", "=q4=Furious Gladiator's Sabatons of Salvation", "=ds=", "0 #arena# #reqrating# 1500"};
		{ 24, 41225, "", "=q4=Furious Gladiator's Wristguards of Triumph", "=ds=", "0 #arena# #reqrating# 1400"};
		{ 25, 41235, "", "=q4=Furious Gladiator's Waistguard of Triumph", "=ds=", "0 #arena# #reqrating# 1450"};
		{ 26, 41230, "", "=q4=Furious Gladiator's Sabatons of Triumph", "=ds=", "0 #arena# #reqrating# 1500"};
		Next = "PvP80NonSet6";
		Prev = "PvP80NonSet4";
		Back = "PVP80NONSETEPICS";
	};
...
--Plate
	AtlasLoot_Data["PvP80NonSet6"] = {
		...
		{ 16, 40983, "", "=q4=Furious Gladiator's Bracers of Salvation", "=ds=", "0 #arena# #reqrating# 1400"};
		{ 17, 40976, "", "=q4=Furious Gladiator's Girdle of Salvation", "=ds=", "0 #arena# #reqrating# 1450"};
		{ 18, 40977, "", "=q4=Furious Gladiator's Greaves of Salvation", "=ds=", "0 #arena# #reqrating# 1500"};
		{ 20, 40889, "", "=q4=Furious Gladiator's Bracers of Triumph", "=ds=", "0 #arena# #reqrating# 1400"};
		{ 21, 40881, "", "=q4=Furious Gladiator's Girdle of Triumph", "=ds=", "0 #arena# #reqrating# 1450"};
		{ 22, 40882, "", "=q4=Furious Gladiator's Greaves of Triumph", "=ds=", "0 #arena# #reqrating# 1500"};
		Prev = "PvP80NonSet5";
		Back = "PVP80NONSETEPICS";
	};
