...
---- Emblem of Conquest Items
	...
	AtlasLoot_Data["UlduarRazorscale25Man"] = {
		...
		{ 13, 45162, "", "=q4=Dragonslayer's Brace", "=ds=#s12#, #a4#"};
		{ 14, 45166, "", "=q4=Charred Saronite Greaves", "=ds=#s12#, #a4#"};
		{ 15, 45148, "", "=q4=Living Flame", "=ds=#s14#"};
		{ 16, 45510, "", "=q4=Libram of Discord", "=ds=#s16#, #w16#"};
		{ 17, 45144, "", "=q4=Sigil of Deflection", "=ds=#s16#, #w21#"};
	...
	AtlasLoot_Data["UlduarDeconstructor25Man"] = {
		...
		{ 14, 45255, "", "=q4=Thunderfall Totem", "=ds=#s16#, #w15#"};
		{ 15, 45254, "", "=q4=Sigil of the Vengeful Heart", "=ds=#s16#, #w21#"};
	...
	AtlasLoot_Data["UlduarIronCouncil"] = {
		...
		{ 9, 45331, "", "=q4=Rune-Etched Nightblade", "=ds=#h1#, #w10#"};
		{ 10, 45332, "", "=q4=Stormtip", "=ds=#h3#, #w4#"};
		{ 11, 45458, "", "=q4=Stormedge", "=ds=#h2#, #w1#"};
		{ 13, 45506, "", "=q4=Archivum Data Disc", "=ds=#m2#"};
		{ 16, 0, "INV_Box_01", "=q6=#j53#", ""};
		{ 17, 45330, "", "=q4=Greaves of Iron Intensity", "=ds=#s12#, #a4#"};
		{ 18, 45456, "", "=q4=Loop of the Agile", "=ds=#s13#"};
	...
	AtlasLoot_Data["UlduarAuriaya25Man"] = {
		...
		{ 13, 45480, "", "=q4=Nymph Heart Charm", "=ds=#s2#"};
		{ 14, 45326, "", "=q4=Platinum Band of the Aesir", "=ds=#s13#"};
		{ 15, 45438, "", "=q4=Ring of the Faithful Servant", "=ds=#s13#"};
		{ 16, 45436, "", "=q4=Libram of the Resolute", "=ds=#s16#, #w16#"};
	...
	AtlasLoot_Data["UlduarThorim"] = {
		...
		{ 5, 45933, "", "=q4=Pendant of the Shallow Grave", "=ds=#s2#"};
		{ 6, 45931, "", "=q4=Mjolnir Runestone", "=ds=#s14#"};	
		{ 7, 45929, "", "=q4=Sif's Remembrance", "=ds=#s14#"};
		{ 8, 45930, "", "=q4=Combatant's Bootblade", "=ds=#h1# #w4#"};
		{ 9, 45892, "", "=q4=Legacy of Thunder", "=ds=#h1# #w6#"};
		{ 11, 45784, "", "=q1=Thorim's Sigil", "=ds=#m3#"};
	...
	AtlasLoot_Data["UlduarFreya"] = {
		...
		{ 6, 45947, "", "=q4=Serilas, Blood Blade of Invar One-Arm", "=ds=#h1# #w10#"};
		{ 8, 46110, "", "=q3=Alchemist's Cache", "=ds=#p1# (425)"};		
	...
	AtlasLoot_Data["UlduarFreya25Man"] = {
		...
		{ 10, 46110, "", "=q3=Alchemist's Cache", "=ds=#p1# (425)"};
	...
	AtlasLoot_Data["UlduarVezax"] = {
		{ 1, 46032, "", "=q4=Drape of the Faceless General", "=ds=#s4#"};
		{ 2, 46014, "", "=q4=Saronite Animus Cloak", "=ds=#s4#"};
		{ 3, 46013, "", "=q4=Underworld Mantle", "=ds=#s3#, #a1#"};
		{ 4, 46012, "", "=q4=Vestments of the Piercing Light", "=ds=#s5#, #a1#"};
		{ 5, 46346, "", "=q4=Boots of Unsettled Prey", "=ds=#s12#, #a2#"};
		{ 6, 46009, "", "=q4=Bindings of the Depths", "=ds=#s8#, #a3#"};
		{ 7, 46008, "", "=q4=Choker of the Abyss", "=ds=#s2#"};
		{ 8, 46015, "", "=q4=Pendant of Endless Despair", "=ds=#s2#"};
		{ 9, 46010, "", "=q4=Darkstone Ring", "=ds=#s13#"};
		{ 10, 46011, "", "=q4=Shadowbite", "=ds=#w12#"};
		Prev = "UlduarMimiron";
...
--Plate
	...
	AtlasLoot_Data["NaxxDeathKnightDPS"] = {
		...
		{ 17, 45342, "", "=q4=Valorous Darkruned Helmet", "=ds="};
		{ 18, 45344, "", "=q4=Valorous Darkruned Shoulderplates", "=ds="};
		{ 19, 45340, "", "=q4=Valorous Darkruned Battleplate", "=ds="};
		{ 20, 45341, "", "=q4=Valorous Darkruned Gauntlets", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45343, "", "=q4=Valorous Darkruned Legplates", "=ds="};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#t8s10_1#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46115, "", "=q4=Conqueror's Darkruned Helmet", "=ds="};
		{ 25, 46117, "", "=q4=Conqueror's Darkruned Shoulderplates", "=ds="};
	...
	AtlasLoot_Data["NaxxDeathKnightTank"] = {
		...
		{ 17, 45336, "", "=q4=Valorous Darkruned Faceguard", "=ds="};
		{ 18, 45339, "", "=q4=Valorous Darkruned Pauldrons", "=ds="};
		{ 19, 45335, "", "=q4=Valorous Darkruned Chestguard", "=ds="};
		{ 20, 45337, "", "=q4=Valorous Darkruned Handguards", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45338, "", "=q4=Valorous Darkruned Legguards", "=ds="};
		{ 23, 0, "Spell_Deathknight_DeathStrike", "=q6=#t8s10_2#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46120, "", "=q4=Conqueror's Darkruned Faceguard", "=ds="};
		{ 25, 46122, "", "=q4=Conqueror's Darkruned Pauldrons", "=ds="};
	...
	AtlasLoot_Data["NaxxDruidFeral"] = {
		...
		{ 17, 45356, "", "=q4=Valorous Nightsong Headguard", "=ds="};
		{ 18, 45359, "", "=q4=Valorous Nightsong Shoulderpads", "=ds="};
		{ 19, 45358, "", "=q4=Valorous Nightsong Raiments", "=ds="};
		{ 20, 45355, "", "=q4=Valorous Nightsong Handgrips", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45357, "", "=q4=Valorous Nightsong Legguards", "=ds="};
		{ 23, 0, "Ability_Druid_Maul", "=q6=#t8s1_2#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46161, "", "=q4=Conqueror's Nightsong Headguard", "=ds="};
		{ 25, 46157, "", "=q4=Conqueror's Nightsong Shoulderpads", "=ds="};
	...
	AtlasLoot_Data["NaxxDruidRestoration"] = {
		...
		{ 17, 45346, "", "=q4=Valorous Nightsong Headpiece", "=ds="};
		{ 18, 45349, "", "=q4=Valorous Nightsong Spaulders", "=ds="};
		{ 19, 45348, "", "=q4=Valorous Nightsong Robe", "=ds="};
		{ 20, 45345, "", "=q4=Valorous Nightsong Handguards", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45347, "", "=q4=Valorous Nightsong Leggings", "=ds="};
		{ 23, 0, "Spell_Nature_Regeneration", "=q6=#t8s1_3#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46184, "", "=q4=Conqueror's Nightsong Headpiece", "=ds="};
		{ 25, 46187, "", "=q4=Conqueror's Nightsong Spaulders", "=ds="};
	...
	AtlasLoot_Data["NaxxDruidBalance"] = {
		...
		{ 17, 46313, "", "=q4=Valorous Nightsong Cover", "=ds="};
		{ 18, 45352, "", "=q4=Valorous Nightsong Mantle", "=ds="};
		{ 19, 45354, "", "=q4=Valorous Nightsong Vestments", "=ds="};
		{ 20, 45351, "", "=q4=Valorous Nightsong Gloves", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45353, "", "=q4=Valorous Nightsong Trousers", "=ds="};
		{ 23, 0, "Spell_Nature_InsectSwarm", "=q6=#t8s1_1#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46191, "", "=q4=Conqueror's Nightsong Cover", "=ds="};
		{ 25, 46196, "", "=q4=Conqueror's Nightsong Mantle", "=ds="};
	...
	AtlasLoot_Data["NaxxHunter"] = {
		...
		{ 17, 45361, "", "=q4=Valorous Scourgestalker Headpiece", "=ds="};
		{ 18, 45363, "", "=q4=Valorous Scourgestalker Spaulders", "=ds="};
		{ 19, 45364, "", "=q4=Valorous Scourgestalker Tunic", "=ds="};
		{ 20, 45360, "", "=q4=Valorous Scourgestalker Handguards", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45362, "", "=q4=Valorous Scourgestalker Legguards", "=ds="};
		{ 23, 0, "Ability_Hunter_RunningShot", "=q6=#t8s2#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46143, "", "=q4=Conqueror's Deathbringer Headpiece", "=ds="};
		{ 25, 46145, "", "=q4=Conqueror's Deathbringer Spaulders", "=ds="};
	...
	AtlasLoot_Data["NaxxMage"] = {
		...
		{ 17, 45365, "", "=q4=Valorous Kirin'dor Hood", "=ds="};
		{ 18, 45369, "", "=q4=Valorous Kirin'dor Shoulderpads", "=ds="};
		{ 19, 45368, "", "=q4=Valorous Kirin'dor Tunic", "=ds="};
		{ 20, 46131, "", "=q4=Valorous Kirin'dor Gauntlets", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45367, "", "=q4=Valorous Kirin'dor Leggings", "=ds="};
		{ 23, 0, "Spell_Frost_IceStorm", "=q6=#t8s3#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46129, "", "=q4=Conqueror's Kirin'dor Hood", "=ds="};
		{ 25, 46134, "", "=q4=Conqueror's Kirin'dor Shoulderpads", "=ds="};
	...
	AtlasLoot_Data["NaxxPaladinHoly"] = {
		...
		{ 17, 45372, "", "=q4=Valorous Aegis Headpiece", "=ds="};
		{ 18, 45373, "", "=q4=Valorous Aegis Spaulders", "=ds="};
		{ 19, 45374, "", "=q4=Valorous Aegis Tunic", "=ds="};
		{ 20, 45370, "", "=q4=Valorous Aegis Gloves", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45371, "", "=q4=Valorous Aegis Greaves", "=ds="};
		{ 23, 0, "Spell_Holy_HolyBolt", "=q6=#t8s4_1#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46180, "", "=q4=Conqueror's Aegis Headpiece", "=ds="};
		{ 25, 46182, "", "=q4=Conqueror's Aegis Spaulders", "=ds="};
	...
	AtlasLoot_Data["NaxxPaladinRetribution"] = {
		...
		{ 17, 45377, "", "=q4=Valorous Aegis Helm", "=ds="};
		{ 18, 45380, "", "=q4=Valorous Aegis Shoulderplates", "=ds="};
		{ 19, 45375, "", "=q4=Valorous Aegis Battleplate", "=ds="};
		{ 20, 45376, "", "=q4=Valorous Aegis Gauntlets", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45379, "", "=q4=Valorous Aegis Legplates", "=ds="};
		{ 23, 0, "Spell_Holy_AuraOfLight", "=q6=#t8s4_2#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46156, "", "=q4=Conqueror's Aegis Helm", "=ds="};
		{ 25, 46152, "", "=q4=Conqueror's Aegis Shoulderplates", "=ds="};
	...
	AtlasLoot_Data["NaxxPaladinProtection"] = {
		...
		{ 17, 45382, "", "=q4=Valorous Aegis Faceguard", "=ds="};
		{ 18, 45385, "", "=q4=Valorous Aegis Shouldergards", "=ds="};
		{ 19, 45381, "", "=q4=Valorous Aegis Breastplate", "=ds="};
		{ 20, 45383, "", "=q4=Valorous Aegis Handguards", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45384, "", "=q4=Valorous Aegis Legguards", "=ds="};
		{ 23, 0, "Spell_Holy_SealOfMight", "=q6=#t8s4_3#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46175, "", "=q4=Conqueror's Aegis Faceguard", "=ds="};
		{ 25, 46177, "", "=q4=Conqueror's Aegis Shouldergards", "=ds="};
	...
	AtlasLoot_Data["NaxxPriestShadow"] = {
		...
		{ 17, 45391, "", "=q4=Valorous Circlet of Sanctification", "=ds="};
		{ 18, 45393, "", "=q4=Valorous Mantle of Sanctification", "=ds="};
		{ 19, 45395, "", "=q4=Valorous Raiments of Sanctification", "=ds="};
		{ 20, 45392, "", "=q4=Valorous Handwraps of Sanctification", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45394, "", "=q4=Valorous Pants of Sanctification", "=ds="};
		{ 23, 0, "Spell_Shadow_AntiShadow", "=q6=#t8s5_2#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46172, "", "=q4=Conqueror's Circlet of Sanctification", "=ds="};
		{ 25, 46165, "", "=q4=Conqueror's Mantle of Sanctification", "=ds="};
	...
	AtlasLoot_Data["NaxxPriestHoly"] = {
		...
		{ 17, 45386, "", "=q4=Valorous Cowl of Sanctification", "=ds="};
		{ 18, 45390, "", "=q4=Valorous Shoulderpads of Sanctification", "=ds="};
		{ 19, 45389, "", "=q4=Valorous Robe of Sanctification", "=ds="};
		{ 20, 45387, "", "=q4=Valorous Gloves of Sanctification", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45388, "", "=q4=Valorous Leggings of Sanctification", "=ds="};
		{ 23, 0, "Spell_Holy_PowerWordShield", "=q6=#t8s5_1#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46197, "", "=q4=Conqueror's Cowl of Sanctification", "=ds="};
		{ 25, 46190, "", "=q4=Conqueror's Shoulderpads of Sanctification", "=ds="};
	...
	AtlasLoot_Data["NaxxRogue"] = {
		...
		{ 17, 45398, "", "=q4=Valorous Terrorblade Helmet", "=ds="};
		{ 18, 45400, "", "=q4=Valorous Terrorblade Pauldrons", "=ds="};
		{ 19, 45396, "", "=q4=Valorous Terrorblade Breastplate", "=ds="};
		{ 20, 45397, "", "=q4=Valorous Terrorblade Gauntlets", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45399, "", "=q4=Valorous Terrorblade Legplates", "=ds="};
		{ 23, 0, "Ability_BackStab", "=q6=#t8s6#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46125, "", "=q4=Conqueror's Terrorblade Helmet", "=ds="};
		{ 25, 46127, "", "=q4=Conqueror's Terrorblade Pauldrons", "=ds="};
	...
	AtlasLoot_Data["NaxxShamanRestoration"] = {
		...
		{ 17, 45402, "", "=q4=Valorous Worldbreaker Headpiece", "=ds="};
		{ 18, 45404, "", "=q4=Valorous Worldbreaker Spaulders", "=ds="};
		{ 19, 45405, "", "=q4=Valorous Worldbreaker Tunic", "=ds="};
		{ 20, 45401, "", "=q4=Valorous Worldbreaker Handguards", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45403, "", "=q4=Valorous Worldbreaker Legguards", "=ds="};
		{ 23, 0, "Spell_Nature_HealingWaveGreater", "=q6=#t8s7_3#", "=q5=("..AL["25 Man"]..")"};
		{ 24, 46201, "", "=q4=Conqueror's Worldbreaker Headpiece", "=ds="};
		{ 25, 46204, "", "=q4=Conqueror's Worldbreaker Spaulders", "=ds="};
	...
	AtlasLoot_Data["NaxxShamanEnhancement"] = {
		...
		{ 17, 45412, "", "=q4=Valorous Worldbreaker Faceguard", "=ds="};
		{ 18, 45415, "", "=q4=Valorous Worldbreaker Shoulderguards", "=ds="};
		{ 19, 45413, "", "=q4=Valorous Worldbreaker Chestguard", "=ds="};
		{ 20, 45414, "", "=q4=Valorous Worldbreaker Grips", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45416, "", "=q4=Valorous Worldbreaker War-Kilt", "=ds="};
		{ 23, 0, "Spell_FireResistanceTotem_01", "=q6=#t8s7_2#", "=q5=("..AL["25 Man"]..")"};
		{ 24, 46212, "", "=q4=Conqueror's Worldbreaker Faceguard", "=ds="};
		{ 25, 46203, "", "=q4=Conqueror's Worldbreaker Shoulderguards", "=ds="};
	...
	AtlasLoot_Data["NaxxShamanElemental"] = {
		...
		{ 17, 45408, "", "=q4=Valorous Worldbreaker Helm", "=ds="};
		{ 18, 45410, "", "=q4=Valorous Worldbreaker Shoulderpads", "=ds="};
		{ 19, 45411, "", "=q4=Valorous Worldbreaker Hauberk", "=ds="};
		{ 20, 45406, "", "=q4=Valorous Worldbreaker Gloves", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45409, "", "=q4=Valorous Worldbreaker Kilt", "=ds="};
		{ 23, 0, "Spell_Nature_Lightning", "=q6=#t8s7_1#", "=q5=("..AL["25 Man"]..")"};
		{ 24, 46209, "", "=q4=Conqueror's Worldbreaker Helm", "=ds="};
		{ 25, 46211, "", "=q4=Conqueror's Worldbreaker Shoulderpads", "=ds="};
	...
	AtlasLoot_Data["NaxxWarlock"] = {
		...
		{ 17, 45417, "", "=q4=Valorous Deathbringer Hood", "=ds="};
		{ 18, 45422, "", "=q4=Valorous Deathbringer Shoulderpads", "=ds="};
		{ 19, 45421, "", "=q4=Valorous Deathbringer Robe", "=ds="};
		{ 20, 45419, "", "=q4=Valorous Deathbringer Gloves", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45420, "", "=q4=Valorous Deathbringer Leggings", "=ds="};
		{ 23, 0, "Spell_Shadow_CurseOfTounges", "=q6=#t8s8#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46140, "", "=q4=Conqueror's Deathbringer Hood", "=ds="};
		{ 25, 46136, "", "=q4=Conqueror's Deathbringer Shoulderpads", "=ds="};
	...
	AtlasLoot_Data["NaxxWarriorFury"] = {
		...
		{ 17, 45431, "", "=q4=Valorous Siegebreaker Helmet", "=ds="};
		{ 18, 45433, "", "=q4=Valorous Siegebreaker Shoulderplates", "=ds="};
		{ 19, 45429, "", "=q4=Valorous Siegebreaker Battleplate", "=ds="};
		{ 20, 45430, "", "=q4=Valorous Siegebreaker Gauntlets", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45432, "", "=q4=Valorous Siegebreaker Legplates", "=ds="};
		{ 23, 0, "Ability_Warrior_BattleShout", "=q6=#t8s9_1#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46151, "", "=q4=Conqueror's Siegebreaker Helmet", "=ds="};
		{ 25, 46149, "", "=q4=Conqueror's Siegebreaker Shoulderplates", "=ds="};
	...
	AtlasLoot_Data["NaxxWarriorProtection"] = {
		...
		{ 17, 45425, "", "=q4=Valorous Siegebreaker Greathelm", "=ds="};
		{ 18, 45428, "", "=q4=Valorous Siegebreaker Pauldrons", "=ds="};
		{ 19, 45424, "", "=q4=Valorous Siegebreaker Breastplate", "=ds="};
		{ 20, 45426, "", "=q4=Valorous Siegebreaker Handguards", "=ds="..BabbleBoss["Mimiron"]};
		{ 21, 45427, "", "=q4=Valorous Siegebreaker Legguards", "=ds="};
		{ 23, 0, "INV_Shield_05", "=q6=#t8s9_2#", "=q5="..AL["Tier 8"].." ("..AL["25 Man"]..")"};
		{ 24, 46166, "", "=q4=Conqueror's Siegebreaker Greathelm", "=ds="};
		{ 25, 46167, "", "=q4=Conqueror's Siegebreaker Pauldrons", "=ds="};
